...
// ce import CH.ifa.draw.framework.HandleEnumeration;
...
public class TextAreaFigure extends AttributeFigure
	...
	//cestatic {
	//ce	initDefaultAttribute("LeftMargin", new Float(5));
	//ce	initDefaultAttribute("RightMargin", new Float(5));
	//ce	initDefaultAttribute("TopMargin", new Float(5));
	//ce	initDefaultAttribute("TabSize", new Float(8));
	//ce}


	/** Constructor for the TextAreaFigure object */
	public TextAreaFigure() {
	setAttribute("LeftMargin", new Float(5));
	setAttribute("RightMargin", new Float(5));
	setAttribute("TopMargin", new Float(5));
	setAttribute("TabSize", new Float(8));
		fParagraphs = new ArrayList();
	...
	protected float drawText(Graphics g, Rectangle displayBox) {
		...
		while (paragraphs.hasNext()) {
			...
			while (measurer.getPosition() < paragraphIter.getEndIndex()) {
				...
				List penPositions = new ArrayList(1);
