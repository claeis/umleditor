...
public class TransferID extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #containsCoding
	 */
	// -beg- preserve=no 36026DB900B4 attach_head36026D4200D1
	// "TransferID::attachCoding"
	public void attachCoding(Coding coding1)
	// -end- 36026DB900B4 attach_head36026D4200D1 "TransferID::attachCoding"
	{
		// -beg- preserve=no 36026DB900B4 attach_body36026D4200D1
		// "TransferID::attachCoding"
		if (coding != null) {
	 ...
	 * @see #attachCoding
	 */
	// -beg- preserve=no 36026DB900B4 detach_head36026D4200D1
	// "TransferID::detachCoding"
	public Coding detachCoding()
	// -end- 36026DB900B4 detach_head36026D4200D1 "TransferID::detachCoding"
	{
		// -beg- preserve=no 36026DB900B4 detach_body36026D4200D1
		// "TransferID::detachCoding"
		Coding ret = null;
		if (coding != null) {
	 ...
	 * @see #attachCoding
	 */
	// -beg- preserve=no 36026DB900B4 get_head36026D4200D1
	// "TransferID::getCoding"
	public Coding getCoding()
	// -end- 36026DB900B4 get_head36026D4200D1 "TransferID::getCoding"
	{
		// -beg- preserve=no 36026DB900B4 get_body36026D4200D1
		// "TransferID::getCoding"
		if (coding == null) {
	 ...
	 * @see #attachCoding
	 */
	// -beg- preserve=no 36026DB900B4 test_head36026D4200D1
	// "TransferID::containsCoding"
	public boolean containsCoding()
	// -end- 36026DB900B4 test_head36026D4200D1 "TransferID::containsCoding"
	{
		// -beg- preserve=no 36026DB900B4 test_body36026D4200D1
		// "TransferID::containsCoding"
		return coding != null;
	 ...
	 */
	// -beg- preserve=no 36026DB900B4 _link_body36026D4200D1
	// "TransferID::_linkCoding"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 36026DB900B4 _unlink_body36026D4200D1
	// "TransferID::_unlinkCoding"
	...
	/**
	 * get current value of kind I16, I32, ANY oder EXPLANATION
	 * 
	...
	/**
	 * get current value of explanation Definition TransferID in Prosa
	 * 
	 * @see #setExplanation
	 */
