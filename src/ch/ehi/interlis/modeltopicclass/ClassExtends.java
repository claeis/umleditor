...
public class ClassExtends extends AbstractGeneralization implements Generalization , java.io.Serializable
              {
                 ...
                 *  @see #containsChild
                 */
                // -beg- preserve=no 335C14A50352 attach_head3C1DABC0011D "Generalization::attachChild"
                public void attachChild(GeneralizableElement child1)
                // -end- 335C14A50352 attach_head3C1DABC0011D "Generalization::attachChild"
                {
                  // -beg- preserve=no 335C14A50352 attach_body3C1DABC0011D "Generalization::attachChild"
                  super.attachChild(child1);
                  // -end- 335C14A50352 attach_body3C1DABC0011D "Generalization::attachChild"
                }

                /** disconnect the currently attached Child.
                 *  @see #attachChild
                 */
                // -beg- preserve=no 335C14A50352 detach_head3C1DABC0011D "Generalization::detachChild"
                public GeneralizableElement detachChild()
                // -end- 335C14A50352 detach_head3C1DABC0011D "Generalization::detachChild"
                {
                  // -beg- preserve=no 335C14A50352 detach_body3C1DABC0011D "Generalization::detachChild"
                  return super.detachChild();
                  // -end- 335C14A50352 detach_body3C1DABC0011D "Generalization::detachChild"
                }

                /** get the currently attached Child.
                 *  @see #attachChild
                 */
                // -beg- preserve=no 335C14A50352 get_head3C1DABC0011D "Generalization::getChild"
                public GeneralizableElement getChild()
                // -end- 335C14A50352 get_head3C1DABC0011D "Generalization::getChild"
                {
                  // -beg- preserve=no 335C14A50352 get_body3C1DABC0011D "Generalization::getChild"
                 ...
                 *  @see #attachChild
                 */
                // -beg- preserve=no 335C14A50352 test_head3C1DABC0011D "Generalization::containsChild"
                public boolean containsChild()
                // -end- 335C14A50352 test_head3C1DABC0011D "Generalization::containsChild"
                {
                  // -beg- preserve=no 335C14A50352 test_body3C1DABC0011D "Generalization::containsChild"
                  return super.containsChild();
                  // -end- 335C14A50352 test_body3C1DABC0011D "Generalization::containsChild"
                }

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 335C14A50352 _link_body3C1DABC0011D "Generalization::_linkChild"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 335C14A50352 _unlink_body3C1DABC0011D "Generalization::_unlinkChild"
                public void _unlinkChild(GeneralizableElement child1)
                {
                  super._unlinkChild(child1);
                }
                // -end- 335C14A50352 _unlink_body3C1DABC0011D "Generalization::_unlinkChild"
                 ...
                 *  @see #containsParent
                 */
                // -beg- preserve=no 335C146B0352 attach_head3C1DABC0011D "Generalization::attachParent"
                ...
                {
                  // -beg- preserve=no 335C146B0352 attach_body3C1DABC0011D "Generalization::attachParent"
                  super.attachParent(parent1);
                  // -end- 335C146B0352 attach_body3C1DABC0011D "Generalization::attachParent"
                }

                /** disconnect the currently attached Parent.
                 *  @see #attachParent
                 */
                // -beg- preserve=no 335C146B0352 detach_head3C1DABC0011D "Generalization::detachParent"
                public GeneralizableElement detachParent()
                // -end- 335C146B0352 detach_head3C1DABC0011D "Generalization::detachParent"
                {
                  // -beg- preserve=no 335C146B0352 detach_body3C1DABC0011D "Generalization::detachParent"
                  return super.detachParent();
                  // -end- 335C146B0352 detach_body3C1DABC0011D "Generalization::detachParent"
                }

                /** get the currently attached Parent.
                 *  @see #attachParent
                 */
                // -beg- preserve=no 335C146B0352 get_head3C1DABC0011D "Generalization::getParent"
                public GeneralizableElement getParent()
                // -end- 335C146B0352 get_head3C1DABC0011D "Generalization::getParent"
                {
                  // -beg- preserve=no 335C146B0352 get_body3C1DABC0011D "Generalization::getParent"
                 ...
                 *  @see #attachParent
                 */
                // -beg- preserve=no 335C146B0352 test_head3C1DABC0011D "Generalization::containsParent"
                public boolean containsParent()
                // -end- 335C146B0352 test_head3C1DABC0011D "Generalization::containsParent"
                {
                  // -beg- preserve=no 335C146B0352 test_body3C1DABC0011D "Generalization::containsParent"
                  return super.containsParent();
                  // -end- 335C146B0352 test_body3C1DABC0011D "Generalization::containsParent"
                }

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 335C146B0352 _link_body3C1DABC0011D "Generalization::_linkParent"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 335C146B0352 _unlink_body3C1DABC0011D "Generalization::_unlinkParent"
                public void _unlinkParent(GeneralizableElement parent1)
                {
                  super._unlinkParent(parent1);
                }
                // -end- 335C146B0352 _unlink_body3C1DABC0011D "Generalization::_unlinkParent"
                ...
                // -end- 3C68E22702BD set_head3C1DABC0011D "extended"
                {
                  ...
                  if(extended != value1){
                    extended = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setExtended"));
                  }
