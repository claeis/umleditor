...
public class TopicExtends extends AbstractGeneralization implements Generalization, java.io.Serializable {
	 ...
	 * @see #containsParent
	 */
	// -beg- preserve=no 335C146B0352 attach_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C146B0352 attach_body3C17718D0099
		// "Generalization::attachParent"
		super.attachParent(parent1);
		// -end- 335C146B0352 attach_body3C17718D0099
		// "Generalization::attachParent"
	}
	 ...
	 * @see #attachParent
	 */
	// -beg- preserve=no 335C146B0352 detach_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C146B0352 detach_body3C17718D0099
		// "Generalization::detachParent"
		return super.detachParent();
		// -end- 335C146B0352 detach_body3C17718D0099
		// "Generalization::detachParent"
	}
	 ...
	 * @see #attachParent
	 */
	// -beg- preserve=no 335C146B0352 get_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C146B0352 get_body3C17718D0099
		// "Generalization::getParent"
	 ...
	 * @see #attachParent
	 */
	// -beg- preserve=no 335C146B0352 test_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C146B0352 test_body3C17718D0099
		// "Generalization::containsParent"
		return super.containsParent();
		// -end- 335C146B0352 test_body3C17718D0099
		// "Generalization::containsParent"
	}
	 ...
	 */
	// -beg- preserve=no 335C146B0352 _link_body3C17718D0099
	 ...
	 * @see #containsChild
	 */
	// -beg- preserve=no 335C14A50352 attach_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C14A50352 attach_body3C17718D0099
		// "Generalization::attachChild"
		super.attachChild(child1);
		// -end- 335C14A50352 attach_body3C17718D0099
		// "Generalization::attachChild"
	}
	 ...
	 * @see #attachChild
	 */
	// -beg- preserve=no 335C14A50352 detach_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C14A50352 detach_body3C17718D0099
		// "Generalization::detachChild"
		return super.detachChild();
		// -end- 335C14A50352 detach_body3C17718D0099
		// "Generalization::detachChild"
	}
	 ...
	 * @see #attachChild
	 */
	// -beg- preserve=no 335C14A50352 test_head3C17718D0099
	...
	{
		// -beg- preserve=no 335C14A50352 test_body3C17718D0099
		// "Generalization::containsChild"
		return super.containsChild();
		// -end- 335C14A50352 test_body3C17718D0099
		// "Generalization::containsChild"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 335C14A50352 _link_body3C17718D0099
