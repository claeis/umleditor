...
public class IdentDef extends AbstractEditorElement implements java.io.Serializable
              {
                 ...
                 */
                // -beg- preserve=no 358A62100395 add_head358A5F2B0354 "IdentDef::addAttributeDef"
                ...
                // -beg- preserve=no 358A62100395 add2_head358A5F2B0354 "IdentDef::add2AttributeDef"
                 ...
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 remove_head358A5F2B0354 "IdentDef::removeAttributeDef"
                ...
                {
                  // -beg- preserve=no 358A62100395 remove_body358A5F2B0354 "IdentDef::removeAttributeDef"
                  ...
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeAttributeDef"));
                  return ret;
                  // -end- 358A62100395 remove_body358A5F2B0354 "IdentDef::removeAttributeDef"
                }

                /** disconnect a AttributeDef.
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 remove2_head358A5F2B0354 "IdentDef::remove2AttributeDef"
                public AttributeDef removeAttributeDef(int index)
                // -end- 358A62100395 remove2_head358A5F2B0354 "IdentDef::remove2AttributeDef"
                {
                  // -beg- preserve=no 358A62100395 remove2_body358A5F2B0354 "IdentDef::remove2AttributeDef"
                  AttributeDef ret=null;
                  ret = (AttributeDef)attributeDef.remove(index);
                  ret._unlinkIdentDef(this);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeAttributeDef"));
                  return ret;
                  // -end- 358A62100395 remove2_body358A5F2B0354 "IdentDef::remove2AttributeDef"
                }

                /** change a AttributeDef.
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 set_head358A5F2B0354 "IdentDef::setAttributeDef"
                ...
                {
                  // -beg- preserve=no 358A62100395 set_body358A5F2B0354 "IdentDef::setAttributeDef"
                  AttributeDef ret=null;
                  ret = (AttributeDef)attributeDef.set(index,attributeDef1);
                  ret._unlinkIdentDef(this);
                  attributeDef1._linkIdentDef(this);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setAttributeDef"));
                  return ret;
                 ...
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 test_head358A5F2B0354 "IdentDef::containsAttributeDef"
                ...
                {
                  // -beg- preserve=no 358A62100395 test_body358A5F2B0354 "IdentDef::containsAttributeDef"
                  return attributeDef.contains(attributeDef1);
                  // -end- 358A62100395 test_body358A5F2B0354 "IdentDef::containsAttributeDef"
                }

                /** used to enumerate all connected AttributeDefs.
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 get_all_head358A5F2B0354 "IdentDef::iteratorAttributeDef"
                public java.util.Iterator iteratorAttributeDef()
                // -end- 358A62100395 get_all_head358A5F2B0354 "IdentDef::iteratorAttributeDef"
                {
                  // -beg- preserve=no 358A62100395 get_all_body358A5F2B0354 "IdentDef::iteratorAttributeDef"
                  return attributeDef.iterator();
                  // -end- 358A62100395 get_all_body358A5F2B0354 "IdentDef::iteratorAttributeDef"
                }

                /** disconnect all AttributeDefs.
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 remove_all_head358A5F2B0354 "IdentDef::clearAttributeDef"
                public void clearAttributeDef()
                // -end- 358A62100395 remove_all_head358A5F2B0354 "IdentDef::clearAttributeDef"
                {
                  // -beg- preserve=no 358A62100395 remove_all_body358A5F2B0354 "IdentDef::clearAttributeDef"
                  if(sizeAttributeDef()>0){
                    for(java.util.Iterator p = attributeDef.iterator(); p.hasNext();){
                      ((AttributeDef)p.next())._unlinkIdentDef(this);
                    }
                    attributeDef.clear();
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearAttributeDef"));
                  }
                  // -end- 358A62100395 remove_all_body358A5F2B0354 "IdentDef::clearAttributeDef"
                }

                /** returns the number of AttributeDefs.
                 *  @see #addAttributeDef
                 */
                // -beg- preserve=no 358A62100395 size_head358A5F2B0354 "IdentDef::sizeAttributeDef"
                public int sizeAttributeDef()
                // -end- 358A62100395 size_head358A5F2B0354 "IdentDef::sizeAttributeDef"
                {
                  // -beg- preserve=no 358A62100395 size_body358A5F2B0354 "IdentDef::sizeAttributeDef"
                 ...
                 */
                // -beg- preserve=no 358A62100395 _link_body358A5F2B0354 "IdentDef::_linkAttributeDef"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 358A62100395 _unlink_body358A5F2B0354 "IdentDef::_unlinkAttributeDef"
                ...
                // -end- 358A62100395 _unlink_body358A5F2B0354 "IdentDef::_unlinkAttributeDef"
