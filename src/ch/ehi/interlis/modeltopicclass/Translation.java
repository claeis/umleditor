...
public class Translation extends AbstractEditorElement implements Element, java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 3C1DC4150214 attach_head3C1DC4060258
	// "Translation::attachModelDef"
	public void attachModelDef(ModelDef modelDef1)
	// -end- 3C1DC4150214 attach_head3C1DC4060258 "Translation::attachModelDef"
	{
		// -beg- preserve=no 3C1DC4150214 attach_body3C1DC4060258
		// "Translation::attachModelDef"
		if (modelDef != null) {
			throw new java.lang.IllegalStateException("already a modelDef attached");
		}
		if (modelDef1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as modelDef");
		}
		modelDef = modelDef1;
		modelDef1._linkTranslation(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachModelDef"));
		return;
		// -end- 3C1DC4150214 attach_body3C1DC4060258
		// "Translation::attachModelDef"
	}
	 ...
	 * @see #attachModelDef
	 */
	// -beg- preserve=no 3C1DC4150214 detach_head3C1DC4060258
	// "Translation::detachModelDef"
	public ModelDef detachModelDef()
	// -end- 3C1DC4150214 detach_head3C1DC4060258 "Translation::detachModelDef"
	{
		// -beg- preserve=no 3C1DC4150214 detach_body3C1DC4060258
		// "Translation::detachModelDef"
		ModelDef ret = null;
		if (modelDef != null) {
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachModelDef"));
		return ret;
		// -end- 3C1DC4150214 detach_body3C1DC4060258
		// "Translation::detachModelDef"
	}
	 ...
	 * @see #attachModelDef
	 */
	// -beg- preserve=no 3C1DC4150214 get_head3C1DC4060258
	// "Translation::getModelDef"
	public ModelDef getModelDef()
	// -end- 3C1DC4150214 get_head3C1DC4060258 "Translation::getModelDef"
	{
		// -beg- preserve=no 3C1DC4150214 get_body3C1DC4060258
		// "Translation::getModelDef"
		if (modelDef == null) {
			throw new java.lang.IllegalStateException("no modelDef attached");
		}
		return modelDef;
	 ...
	 * @see #attachModelDef
	 */
	// -beg- preserve=no 3C1DC4150214 test_head3C1DC4060258
	// "Translation::containsModelDef"
	public boolean containsModelDef()
	// -end- 3C1DC4150214 test_head3C1DC4060258 "Translation::containsModelDef"
	{
		// -beg- preserve=no 3C1DC4150214 test_body3C1DC4060258
		// "Translation::containsModelDef"
		return modelDef != null;
		// -end- 3C1DC4150214 test_body3C1DC4060258
		// "Translation::containsModelDef"
	}
	 ...
	 */
	// -beg- preserve=no 3C1DC4150214 _link_body3C1DC4060258
	// "Translation::_linkModelDef"
	public void _linkModelDef(ModelDef modelDef1) {
		modelDef = modelDef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkModelDef"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C1DC4150214 _unlink_body3C1DC4060258
	// "Translation::_unlinkModelDef"
	public void _unlinkModelDef(ModelDef modelDef1) {
		modelDef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkModelDef"));
		return;
	}
	// -end- 3C1DC4150214 _unlink_body3C1DC4060258
	// "Translation::_unlinkModelDef"
	...
	/**
	 * get current value of language Defines the lanugage used for this
	 * translation.
	 * 
	 * @see #setLanguage
	 */
