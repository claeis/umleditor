 ...
 *  @see #containsChild
 */
// -beg- preserve=no 3940E48403B8 attach_head3C17712203B7 "TopicDepends::attachChild"
public void attachChild(TopicDef child1)
// -end- 3940E48403B8 attach_head3C17712203B7 "TopicDepends::attachChild"
{
        // -beg- preserve=no 3940E48403B8 attach_body3C17712203B7 "TopicDepends::attachChild"
        ...
        return;
        // -end- 3940E48403B8 attach_body3C17712203B7 "TopicDepends::attachChild"
}

/** disconnect the currently attached Child.
 *  @see #attachChild
 */
// -beg- preserve=no 3940E48403B8 detach_head3C17712203B7 "TopicDepends::detachChild"
public TopicDef detachChild()
// -end- 3940E48403B8 detach_head3C17712203B7 "TopicDepends::detachChild"
{
        // -beg- preserve=no 3940E48403B8 detach_body3C17712203B7 "TopicDepends::detachChild"
        TopicDef ret = null;
        if(child!=null) {
        ...
        return ret;
        // -end- 3940E48403B8 detach_body3C17712203B7 "TopicDepends::detachChild"
}

/** get the currently attached Child.
 *  @see #attachChild
 */
// -beg- preserve=no 3940E48403B8 get_head3C17712203B7 "TopicDepends::getChild"
public TopicDef getChild()
// -end- 3940E48403B8 get_head3C17712203B7 "TopicDepends::getChild"
{
        // -beg- preserve=no 3940E48403B8 get_body3C17712203B7 "TopicDepends::getChild"
 ...
 *  @see #attachChild
 */
// -beg- preserve=no 3940E48403B8 test_head3C17712203B7 "TopicDepends::containsChild"
public boolean containsChild()
// -end- 3940E48403B8 test_head3C17712203B7 "TopicDepends::containsChild"
{
        // -beg- preserve=no 3940E48403B8 test_body3C17712203B7 "TopicDepends::containsChild"
        return child!=null;
        // -end- 3940E48403B8 test_body3C17712203B7 "TopicDepends::containsChild"
}

/** DONT USE; link management internal
 */
// -beg- preserve=no 3940E48403B8 _link_body3C17712203B7 "TopicDepends::_linkChild"
...
/** DONT USE; link management internal
 */
// -beg- preserve=no 3940E48403B8 _unlink_body3C17712203B7 "TopicDepends::_unlinkChild"
 ...
 *  @see #sizeSupplier
 */
// -beg- preserve=no 335C0D7A02E4 add_head3C17712203B7 "Dependency::addSupplier"
public void addSupplier(ModelElement supplier1)
// -end- 335C0D7A02E4 add_head3C17712203B7 "Dependency::addSupplier"
{
        // -beg- preserve=no 335C0D7A02E4 add_body3C17712203B7 "Dependency::addSupplier"
 ...
 *  @see #addSupplier
 */
// -beg- preserve=no 335C0D7A02E4 remove_head3C17712203B7 "Dependency::removeSupplier"
...
{
        // -beg- preserve=no 335C0D7A02E4 remove_body3C17712203B7 "Dependency::removeSupplier"
        return super.removeSupplier(supplier1);
        // -end- 335C0D7A02E4 remove_body3C17712203B7 "Dependency::removeSupplier"
}

/** tests if a given Supplier is connected.
 *  @see #addSupplier
 */
// -beg- preserve=no 335C0D7A02E4 test_head3C17712203B7 "Dependency::containsSupplier"
public boolean containsSupplier(ModelElement supplier1)
// -end- 335C0D7A02E4 test_head3C17712203B7 "Dependency::containsSupplier"
{
        // -beg- preserve=no 335C0D7A02E4 test_body3C17712203B7 "Dependency::containsSupplier"
        return super.containsSupplier(supplier1);
        // -end- 335C0D7A02E4 test_body3C17712203B7 "Dependency::containsSupplier"
}

/** used to enumerate all connected Suppliers.
 *  @see #addSupplier
 */
// -beg- preserve=no 335C0D7A02E4 get_all_head3C17712203B7 "Dependency::iteratorSupplier"
public java.util.Iterator iteratorSupplier()
// -end- 335C0D7A02E4 get_all_head3C17712203B7 "Dependency::iteratorSupplier"
{
        // -beg- preserve=no 335C0D7A02E4 get_all_body3C17712203B7 "Dependency::iteratorSupplier"
        return super.iteratorSupplier();
        // -end- 335C0D7A02E4 get_all_body3C17712203B7 "Dependency::iteratorSupplier"
}

/** disconnect all Suppliers.
 *  @see #addSupplier
 */
// -beg- preserve=no 335C0D7A02E4 remove_all_head3C17712203B7 "Dependency::clearSupplier"
public void clearSupplier()
// -end- 335C0D7A02E4 remove_all_head3C17712203B7 "Dependency::clearSupplier"
{
        // -beg- preserve=no 335C0D7A02E4 remove_all_body3C17712203B7 "Dependency::clearSupplier"
        super.clearSupplier();
        // -end- 335C0D7A02E4 remove_all_body3C17712203B7 "Dependency::clearSupplier"
}

/** returns the number of Suppliers.
 *  @see #addSupplier
 */
// -beg- preserve=no 335C0D7A02E4 size_head3C17712203B7 "Dependency::sizeSupplier"
public int sizeSupplier()
// -end- 335C0D7A02E4 size_head3C17712203B7 "Dependency::sizeSupplier"
{
        // -beg- preserve=no 335C0D7A02E4 size_body3C17712203B7 "Dependency::sizeSupplier"
...
/** DONT USE; link management internal
 */
// -beg- preserve=no 335C0D7A02E4 _link_body3C17712203B7 "Dependency::_linkSupplier"
...
/** DONT USE; link management internal
 */
// -beg- preserve=no 335C0D7A02E4 _unlink_body3C17712203B7 "Dependency::_unlinkSupplier"
