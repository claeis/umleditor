...
public class Contract extends AbstractEditorElement implements Element, java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 3940AD300136 attach_head3940AD20009C
	// "Contract::attachModelDef"
	public void attachModelDef(ModelDef modelDef1)
	// -end- 3940AD300136 attach_head3940AD20009C "Contract::attachModelDef"
	{
		// -beg- preserve=no 3940AD300136 attach_body3940AD20009C
		// "Contract::attachModelDef"
		if (modelDef != null) {
	 ...
	 * @see #attachModelDef
	 */
	// -beg- preserve=no 3940AD300136 detach_head3940AD20009C
	// "Contract::detachModelDef"
	public ModelDef detachModelDef()
	// -end- 3940AD300136 detach_head3940AD20009C "Contract::detachModelDef"
	{
		// -beg- preserve=no 3940AD300136 detach_body3940AD20009C
		// "Contract::detachModelDef"
		ModelDef ret = null;
		if (modelDef != null) {
	 ...
	 * @see #attachModelDef
	 */
	// -beg- preserve=no 3940AD300136 get_head3940AD20009C
	// "Contract::getModelDef"
	public ModelDef getModelDef()
	// -end- 3940AD300136 get_head3940AD20009C "Contract::getModelDef"
	{
		// -beg- preserve=no 3940AD300136 get_body3940AD20009C
		// "Contract::getModelDef"
		if (modelDef == null) {
	 ...
	 * @see #attachModelDef
	 */
	// -beg- preserve=no 3940AD300136 test_head3940AD20009C
	// "Contract::containsModelDef"
	public boolean containsModelDef()
	// -end- 3940AD300136 test_head3940AD20009C "Contract::containsModelDef"
	{
		// -beg- preserve=no 3940AD300136 test_body3940AD20009C
		// "Contract::containsModelDef"
	 ...
	 */
	// -beg- preserve=no 3940AD300136 _link_body3940AD20009C
	// "Contract::_linkModelDef"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3940AD300136 _unlink_body3940AD20009C
	// "Contract::_unlinkModelDef"
	...
	/**
	 * get current value of issuer Name des Herausgebers des Kontraktes
	 * 
	 * @see #setIssuer
	 */
	...
	// -end- 3940AD80036B set_head3940AD20009C "issuer"
	{
		...
		if (issuer != value1 && (issuer == null || !issuer.equals(value1))) {
			issuer = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setIssuer"));
		}
