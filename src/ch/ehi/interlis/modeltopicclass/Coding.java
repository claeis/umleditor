...
public class Coding extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 358A60230129 attach_head358A5FF400A0
	// "Coding::attachINTERLIS2Def"
	...
	{
		// -beg- preserve=no 358A60230129 attach_body358A5FF400A0
		// "Coding::attachINTERLIS2Def"
		...
		return;
		// -end- 358A60230129 attach_body358A5FF400A0
		// "Coding::attachINTERLIS2Def"
	}
	 ...
	 */
	// -beg- preserve=no 358A60230129 detach_head358A5FF400A0
	// "Coding::detachINTERLIS2Def"
	public INTERLIS2Def detachINTERLIS2Def()
	// -end- 358A60230129 detach_head358A5FF400A0 "Coding::detachINTERLIS2Def"
	{
		// -beg- preserve=no 358A60230129 detach_body358A5FF400A0
		// "Coding::detachINTERLIS2Def"
		...
		return ret;
		// -end- 358A60230129 detach_body358A5FF400A0
		// "Coding::detachINTERLIS2Def"
	}
	 ...
	 * @see #attachINTERLIS2Def
	 */
	// -beg- preserve=no 358A60230129 get_head358A5FF400A0
	// "Coding::getINTERLIS2Def"
	public INTERLIS2Def getINTERLIS2Def()
	// -end- 358A60230129 get_head358A5FF400A0 "Coding::getINTERLIS2Def"
	{
		// -beg- preserve=no 358A60230129 get_body358A5FF400A0
		// "Coding::getINTERLIS2Def"
		if (iNTERLIS2Def == null) {
	 ...
	 * @see #attachINTERLIS2Def
	 */
	// -beg- preserve=no 358A60230129 test_head358A5FF400A0
	// "Coding::containsINTERLIS2Def"
	public boolean containsINTERLIS2Def()
	// -end- 358A60230129 test_head358A5FF400A0 "Coding::containsINTERLIS2Def"
	{
		// -beg- preserve=no 358A60230129 test_body358A5FF400A0
		// "Coding::containsINTERLIS2Def"
		return iNTERLIS2Def != null;
		// -end- 358A60230129 test_body358A5FF400A0
		// "Coding::containsINTERLIS2Def"
	}
	 ...
	 */
	// -beg- preserve=no 358A60230129 _link_body358A5FF400A0
	// "Coding::_linkINTERLIS2Def"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 358A60230129 _unlink_body358A5FF400A0
	// "Coding::_unlinkINTERLIS2Def"
	 ...
	 */
	// -beg- preserve=no 36026DB90096 attach_head358A5FF400A0
	// "Coding::attachTransferID"
	public void attachTransferID(TransferID transferID1)
	// -end- 36026DB90096 attach_head358A5FF400A0 "Coding::attachTransferID"
	{
		// -beg- preserve=no 36026DB90096 attach_body358A5FF400A0
		// "Coding::attachTransferID"
		if (transferID != null) {
			throw new java.lang.IllegalStateException("already a transferID attached");
		}
		if (transferID1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as transferID");
		}
		transferID = transferID1;
		transferID1._linkCoding(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachTransferID"));
		return;
	 ...
	 */
	// -beg- preserve=no 36026DB90096 detach_head358A5FF400A0
	// "Coding::detachTransferID"
	public TransferID detachTransferID()
	// -end- 36026DB90096 detach_head358A5FF400A0 "Coding::detachTransferID"
	{
		// -beg- preserve=no 36026DB90096 detach_body358A5FF400A0
		// "Coding::detachTransferID"
		TransferID ret = null;
		if (transferID != null) {
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachTransferID"));
		return ret;
	 ...
	 * @see #attachTransferID
	 */
	// -beg- preserve=no 36026DB90096 get_head358A5FF400A0
	// "Coding::getTransferID"
	public TransferID getTransferID()
	// -end- 36026DB90096 get_head358A5FF400A0 "Coding::getTransferID"
	{
		// -beg- preserve=no 36026DB90096 get_body358A5FF400A0
		// "Coding::getTransferID"
		if (transferID == null) {
			throw new java.lang.IllegalStateException("no transferID attached");
		}
		return transferID;
	 ...
	 * @see #attachTransferID
	 */
	// -beg- preserve=no 36026DB90096 test_head358A5FF400A0
	// "Coding::containsTransferID"
	public boolean containsTransferID()
	// -end- 36026DB90096 test_head358A5FF400A0 "Coding::containsTransferID"
	{
		// -beg- preserve=no 36026DB90096 test_body358A5FF400A0
		// "Coding::containsTransferID"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 36026DB90096 _link_body358A5FF400A0
	// "Coding::_linkTransferID"
	public void _linkTransferID(TransferID transferID1) {
		transferID = transferID1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkTransferID"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 36026DB90096 _unlink_body358A5FF400A0
	// "Coding::_unlinkTransferID"
	public void _unlinkTransferID(TransferID transferID1) {
		transferID = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkTransferID"));
		return;
	}
	...
	/**
	 * get current value of font Zeichensatz z.
	 * 
	 * @see #setFont
	 */
	...
	/**
	 * get current value of blank Ersatzzeichen fuer Leerzeichen innerhalb von
	 * Textattributen
	 * 
	 * @see #setBlank
	 */
	...
	// -end- 358A73D70385 set_head358A5FF400A0 "blank"
	{
		...
		if (blank != value1) {
			blank = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setBlank"));
		}
	...
	/**
	 * get current value of undefined Zeichen fuer NULL bei optionalen
	 * Attributen
	 * 
	 * @see #setUndefined
	 */
	...
	// -end- 358A73E2034F set_head358A5FF400A0 "undefined"
	{
		...
		if (undefined != value1) {
			undefined = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setUndefined"));
		}
	...
	/**
	 * get current value of continu Fortsetzungszeichen wenn ein Record in
	 * mehreren Zeilen ausgegeben wird
	 * 
	 * @see #setContinu
	 */
	...
	// -end- 358A73EC01CD set_head358A5FF400A0 "continu"
	{
		...
		if (continu != value1) {
			continu = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setContinu"));
		}
