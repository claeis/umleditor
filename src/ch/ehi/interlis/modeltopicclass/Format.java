...
public class Format extends AbstractEditorElement implements java.io.Serializable
              {
                 ...
                 */
                // -beg- preserve=no 358A60200248 attach_head358A5FEF0337 "Format::attachINTERLIS2Def"
                ...
                {
                  // -beg- preserve=no 358A60200248 attach_body358A5FEF0337 "Format::attachINTERLIS2Def"
                  ...
                  return;
                  // -end- 358A60200248 attach_body358A5FEF0337 "Format::attachINTERLIS2Def"
                }

                /** disconnect the currently attached INTERLIS2Def.
                 *  @see #attachINTERLIS2Def
                 */
                // -beg- preserve=no 358A60200248 detach_head358A5FEF0337 "Format::detachINTERLIS2Def"
                public INTERLIS2Def detachINTERLIS2Def()
                // -end- 358A60200248 detach_head358A5FEF0337 "Format::detachINTERLIS2Def"
                {
                  // -beg- preserve=no 358A60200248 detach_body358A5FEF0337 "Format::detachINTERLIS2Def"
                  ...
                  return ret;
                  // -end- 358A60200248 detach_body358A5FEF0337 "Format::detachINTERLIS2Def"
                }

                /** get the currently attached INTERLIS2Def.
                 *  @see #attachINTERLIS2Def
                 */
                // -beg- preserve=no 358A60200248 get_head358A5FEF0337 "Format::getINTERLIS2Def"
                public INTERLIS2Def getINTERLIS2Def()
                // -end- 358A60200248 get_head358A5FEF0337 "Format::getINTERLIS2Def"
                {
                  // -beg- preserve=no 358A60200248 get_body358A5FEF0337 "Format::getINTERLIS2Def"
                 ...
                 *  @see #attachINTERLIS2Def
                 */
                // -beg- preserve=no 358A60200248 test_head358A5FEF0337 "Format::containsINTERLIS2Def"
                public boolean containsINTERLIS2Def()
                // -end- 358A60200248 test_head358A5FEF0337 "Format::containsINTERLIS2Def"
                {
                  // -beg- preserve=no 358A60200248 test_body358A5FEF0337 "Format::containsINTERLIS2Def"
                  return iNTERLIS2Def!=null;
                  // -end- 358A60200248 test_body358A5FEF0337 "Format::containsINTERLIS2Def"
                }

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 358A60200248 _link_body358A5FEF0337 "Format::_linkINTERLIS2Def"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 358A60200248 _unlink_body358A5FEF0337 "Format::_unlinkINTERLIS2Def"
                ...
                /** get current value of free
                 *  Freies (=true) oder fixes Format
                 *  @see #setFree
                 */
                ...
                // -end- 358A739900AB set_head358A5FEF0337 "free"
                {
                  ...
                  if(free != value1){
                    free = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setFree"));
                  }
                ...
                // -end- 358A73A30019 set_head358A5FEF0337 "linesize"
                {
                  ...
                  if(linesize != value1){
                    linesize = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setLinesize"));
                  }
                ...
                /** get current value of tidsize
                 *  Länge der Objekt-Identifikationen
                 *  @see #setTidsize
                 */
                ...
                // -end- 358A73AA000F set_head358A5FEF0337 "tidsize"
                {
                  ...
                  if(tidsize != value1){
                    tidsize = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setTidsize"));
                  }
...
public class Format extends AbstractEditorElement implements java.io.Serializable {
	...
	/**
	 * get current value of linesize ZeilenlÃ¤nge
	 * 
	 * @see #setLinesize
	 */
	// -beg- preserve=no 358A73A30019 get_head358A5FEF0337 "linesize"
	...
	/**
	 * get current value of tidsize LÃ¤nge der Objekt-Identifikationen
	 * 
	 * @see #setTidsize
	 */
	// -beg- preserve=no 358A73AA000F get_head358A5FEF0337 "tidsize"
