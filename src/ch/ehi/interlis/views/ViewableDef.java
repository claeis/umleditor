...
public interface ViewableDef extends ModelElement, java.io.Serializable {
	 ...
	 * @see #addSupplierDependency
	 */
	// -beg- preserve=no 335C0D7A02A8 remove_all_head396ED2D20204
	// "ModelElement::clearSupplierDependency"
	public void clearSupplierDependency()
	// -end- 335C0D7A02A8 remove_all_head396ED2D20204
	// "ModelElement::clearSupplierDependency"
	; // empty
	 ...
	 * @see #addSupplierDependency
	 */
	// -beg- preserve=no 335C0D7A02A8 size_head396ED2D20204
	// "ModelElement::sizeSupplierDependency"
	public int sizeSupplierDependency()
	// -end- 335C0D7A02A8 size_head396ED2D20204
	// "ModelElement::sizeSupplierDependency"
	; // empty
