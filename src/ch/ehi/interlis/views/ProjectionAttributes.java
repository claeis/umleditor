...
public class ProjectionAttributes extends AbstractEditorElement implements java.io.Serializable {
	...
	private static final long serialVersionUID = 4015802920936799840L;
	 ...
	 * @see #sizeAttr
	 */
	// -beg- preserve=no 3961A32E0008 add_head396197B2014A
	// "ProjectionAttributes::addAttr"
	public void addAttr(ProjectionAttribute attr1)
	// -end- 3961A32E0008 add_head396197B2014A "ProjectionAttributes::addAttr"
	{
		// -beg- preserve=no 3961A32E0008 add_body396197B2014A
		// "ProjectionAttributes::addAttr"
		attr.add(attr1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addAttr"));
		return;
		// -end- 3961A32E0008 add_body396197B2014A
		// "ProjectionAttributes::addAttr"
	}
	 ...
	 * @see #addAttr
	 */
	// -beg- preserve=no 3961A32E0008 remove_head396197B2014A
	// "ProjectionAttributes::removeAttr"
	public ProjectionAttribute removeAttr(ProjectionAttribute attr1)
	// -end- 3961A32E0008 remove_head396197B2014A
	// "ProjectionAttributes::removeAttr"
	{
		// -beg- preserve=no 3961A32E0008 remove_body396197B2014A
		// "ProjectionAttributes::removeAttr"
		...
		attr.remove(attr1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeAttr"));
		return ret;
		// -end- 3961A32E0008 remove_body396197B2014A
		// "ProjectionAttributes::removeAttr"
	}
	 ...
	 * @see #addAttr
	 */
	// -beg- preserve=no 3961A32E0008 test_head396197B2014A
	// "ProjectionAttributes::containsAttr"
	public boolean containsAttr(ProjectionAttribute attr1)
	// -end- 3961A32E0008 test_head396197B2014A
	// "ProjectionAttributes::containsAttr"
	{
		// -beg- preserve=no 3961A32E0008 test_body396197B2014A
		// "ProjectionAttributes::containsAttr"
		return attr.contains(attr1);
		// -end- 3961A32E0008 test_body396197B2014A
		// "ProjectionAttributes::containsAttr"
	}
	...
	// "ProjectionAttributes::iteratorAttr"
	{
		// -beg- preserve=no 3961A32E0008 get_all_body396197B2014A
		// "ProjectionAttributes::iteratorAttr"
		return attr.iterator();
		// -end- 3961A32E0008 get_all_body396197B2014A
		// "ProjectionAttributes::iteratorAttr"
	}
	 ...
	 * @see #addAttr
	 */
	// -beg- preserve=no 3961A32E0008 remove_all_head396197B2014A
	// "ProjectionAttributes::clearAttr"
	public void clearAttr()
	// -end- 3961A32E0008 remove_all_head396197B2014A
	// "ProjectionAttributes::clearAttr"
	{
		// -beg- preserve=no 3961A32E0008 remove_all_body396197B2014A
		// "ProjectionAttributes::clearAttr"
		if (sizeAttr() > 0) {
			attr.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearAttr"));
		}
		// -end- 3961A32E0008 remove_all_body396197B2014A
		// "ProjectionAttributes::clearAttr"
	}
	 ...
	 * @see #addAttr
	 */
	// -beg- preserve=no 3961A32E0008 size_head396197B2014A
	// "ProjectionAttributes::sizeAttr"
	public int sizeAttr()
	// -end- 3961A32E0008 size_head396197B2014A "ProjectionAttributes::sizeAttr"
	{
		// -beg- preserve=no 3961A32E0008 size_body396197B2014A
		// "ProjectionAttributes::sizeAttr"
		return attr.size();
		// -end- 3961A32E0008 size_body396197B2014A
		// "ProjectionAttributes::sizeAttr"
	}
