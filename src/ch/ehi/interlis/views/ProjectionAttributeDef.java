...
public class ProjectionAttributeDef extends AbstractEditorElement implements java.io.Serializable
          {
            ...
            // -end- 3D4FA2180383 head3961A31B0231 "unlinkAll"
              ...
              // Role ProjectionAttribute: ProjectionAttribute object(s) may point to this
            ...
            // -end- 3D4FA2180384 head3961A31B0231 "enumerateChildren"
              ...
              it=iteratorBaseAttributeRef();while(it.hasNext())visitor.visit(it.next());
             ...
             */
            // -beg- preserve=no 3961A7830247 attach_head3961A31B0231 "ProjectionAttributeDef::attachDomainAttribute"
            public void attachDomainAttribute(DomainAttribute domainAttribute1)
            // -end- 3961A7830247 attach_head3961A31B0231 "ProjectionAttributeDef::attachDomainAttribute"
            {
              // -beg- preserve=no 3961A7830247 attach_body3961A31B0231 "ProjectionAttributeDef::attachDomainAttribute"
              ...
              return;
              // -end- 3961A7830247 attach_body3961A31B0231 "ProjectionAttributeDef::attachDomainAttribute"
            }

            /** disconnect the currently attached DomainAttribute.
             *  @see #attachDomainAttribute
             */
            // -beg- preserve=no 3961A7830247 detach_head3961A31B0231 "ProjectionAttributeDef::detachDomainAttribute"
            public DomainAttribute detachDomainAttribute()
            // -end- 3961A7830247 detach_head3961A31B0231 "ProjectionAttributeDef::detachDomainAttribute"
            {
              // -beg- preserve=no 3961A7830247 detach_body3961A31B0231 "ProjectionAttributeDef::detachDomainAttribute"
              ...
              return ret;
              // -end- 3961A7830247 detach_body3961A31B0231 "ProjectionAttributeDef::detachDomainAttribute"
            }

            /** get the currently attached DomainAttribute.
             *  @see #attachDomainAttribute
             */
            // -beg- preserve=no 3961A7830247 get_head3961A31B0231 "ProjectionAttributeDef::getDomainAttribute"
            public DomainAttribute getDomainAttribute()
            // -end- 3961A7830247 get_head3961A31B0231 "ProjectionAttributeDef::getDomainAttribute"
            {
              // -beg- preserve=no 3961A7830247 get_body3961A31B0231 "ProjectionAttributeDef::getDomainAttribute"
              if(domainAttribute==null) {throw new java.lang.IllegalStateException("no domainAttribute attached");}
              return domainAttribute;
              // -end- 3961A7830247 get_body3961A31B0231 "ProjectionAttributeDef::getDomainAttribute"
            }

            /** tests if there is a DomainAttribute attached.
             *  @see #attachDomainAttribute
             */
            // -beg- preserve=no 3961A7830247 test_head3961A31B0231 "ProjectionAttributeDef::containsDomainAttribute"
            public boolean containsDomainAttribute()
            // -end- 3961A7830247 test_head3961A31B0231 "ProjectionAttributeDef::containsDomainAttribute"
            {
              // -beg- preserve=no 3961A7830247 test_body3961A31B0231 "ProjectionAttributeDef::containsDomainAttribute"
              return domainAttribute!=null;
              // -end- 3961A7830247 test_body3961A31B0231 "ProjectionAttributeDef::containsDomainAttribute"
            }
             ...
             */
            // -beg- preserve=no 3961A80302E1 attach_head3961A31B0231 "ProjectionAttributeDef::attachFunctionCall"
            public void attachFunctionCall(FunctionCall functionCall1)
            // -end- 3961A80302E1 attach_head3961A31B0231 "ProjectionAttributeDef::attachFunctionCall"
            {
              // -beg- preserve=no 3961A80302E1 attach_body3961A31B0231 "ProjectionAttributeDef::attachFunctionCall"
              ...
              return;
              // -end- 3961A80302E1 attach_body3961A31B0231 "ProjectionAttributeDef::attachFunctionCall"
            }

            /** disconnect the currently attached FunctionCall.
             *  @see #attachFunctionCall
             */
            // -beg- preserve=no 3961A80302E1 detach_head3961A31B0231 "ProjectionAttributeDef::detachFunctionCall"
            public FunctionCall detachFunctionCall()
            // -end- 3961A80302E1 detach_head3961A31B0231 "ProjectionAttributeDef::detachFunctionCall"
            {
              // -beg- preserve=no 3961A80302E1 detach_body3961A31B0231 "ProjectionAttributeDef::detachFunctionCall"
              ...
              return ret;
              // -end- 3961A80302E1 detach_body3961A31B0231 "ProjectionAttributeDef::detachFunctionCall"
            }

            /** get the currently attached FunctionCall.
             *  @see #attachFunctionCall
             */
            // -beg- preserve=no 3961A80302E1 get_head3961A31B0231 "ProjectionAttributeDef::getFunctionCall"
            public FunctionCall getFunctionCall()
            // -end- 3961A80302E1 get_head3961A31B0231 "ProjectionAttributeDef::getFunctionCall"
            {
              // -beg- preserve=no 3961A80302E1 get_body3961A31B0231 "ProjectionAttributeDef::getFunctionCall"
              if(functionCall==null) {throw new java.lang.IllegalStateException("no functionCall attached");}
              return functionCall;
              // -end- 3961A80302E1 get_body3961A31B0231 "ProjectionAttributeDef::getFunctionCall"
            }

            /** tests if there is a FunctionCall attached.
             *  @see #attachFunctionCall
             */
            // -beg- preserve=no 3961A80302E1 test_head3961A31B0231 "ProjectionAttributeDef::containsFunctionCall"
            public boolean containsFunctionCall()
            // -end- 3961A80302E1 test_head3961A31B0231 "ProjectionAttributeDef::containsFunctionCall"
            {
              // -beg- preserve=no 3961A80302E1 test_body3961A31B0231 "ProjectionAttributeDef::containsFunctionCall"
              return functionCall!=null;
              // -end- 3961A80302E1 test_body3961A31B0231 "ProjectionAttributeDef::containsFunctionCall"
            }
             ...
             */
            // -beg- preserve=no 3961A83901A8 add_head3961A31B0231 "ProjectionAttributeDef::addBaseAttributeRef"
            public void addBaseAttributeRef(BaseAttributeRef baseAttributeRef1)
            // -end- 3961A83901A8 add_head3961A31B0231 "ProjectionAttributeDef::addBaseAttributeRef"
            {
              // -beg- preserve=no 3961A83901A8 add_body3961A31B0231 "ProjectionAttributeDef::addBaseAttributeRef"
              baseAttributeRef.add(baseAttributeRef1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addBaseAttributeRef"));
              return;
              // -end- 3961A83901A8 add_body3961A31B0231 "ProjectionAttributeDef::addBaseAttributeRef"
            }

            /** disconnect a BaseAttributeRef.
             *  @see #addBaseAttributeRef
             */
            // -beg- preserve=no 3961A83901A8 remove_head3961A31B0231 "ProjectionAttributeDef::removeBaseAttributeRef"
            public BaseAttributeRef removeBaseAttributeRef(BaseAttributeRef baseAttributeRef1)
            // -end- 3961A83901A8 remove_head3961A31B0231 "ProjectionAttributeDef::removeBaseAttributeRef"
            {
              // -beg- preserve=no 3961A83901A8 remove_body3961A31B0231 "ProjectionAttributeDef::removeBaseAttributeRef"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeBaseAttributeRef"));
              return ret;
              // -end- 3961A83901A8 remove_body3961A31B0231 "ProjectionAttributeDef::removeBaseAttributeRef"
            }

            /** tests if a given BaseAttributeRef is connected.
             *  @see #addBaseAttributeRef
             */
            // -beg- preserve=no 3961A83901A8 test_head3961A31B0231 "ProjectionAttributeDef::containsBaseAttributeRef"
            public boolean containsBaseAttributeRef(BaseAttributeRef baseAttributeRef1)
            // -end- 3961A83901A8 test_head3961A31B0231 "ProjectionAttributeDef::containsBaseAttributeRef"
            {
              // -beg- preserve=no 3961A83901A8 test_body3961A31B0231 "ProjectionAttributeDef::containsBaseAttributeRef"
              return baseAttributeRef.contains(baseAttributeRef1);
              // -end- 3961A83901A8 test_body3961A31B0231 "ProjectionAttributeDef::containsBaseAttributeRef"
            }

            /** used to enumerate all connected BaseAttributeRefs.
             *  @see #addBaseAttributeRef
             */
            // -beg- preserve=no 3961A83901A8 get_all_head3961A31B0231 "ProjectionAttributeDef::iteratorBaseAttributeRef"
            public java.util.Iterator iteratorBaseAttributeRef()
            // -end- 3961A83901A8 get_all_head3961A31B0231 "ProjectionAttributeDef::iteratorBaseAttributeRef"
            {
              // -beg- preserve=no 3961A83901A8 get_all_body3961A31B0231 "ProjectionAttributeDef::iteratorBaseAttributeRef"
              return baseAttributeRef.iterator();
              // -end- 3961A83901A8 get_all_body3961A31B0231 "ProjectionAttributeDef::iteratorBaseAttributeRef"
            }

            /** disconnect all BaseAttributeRefs.
             *  @see #addBaseAttributeRef
             */
            // -beg- preserve=no 3961A83901A8 remove_all_head3961A31B0231 "ProjectionAttributeDef::clearBaseAttributeRef"
            public void clearBaseAttributeRef()
            // -end- 3961A83901A8 remove_all_head3961A31B0231 "ProjectionAttributeDef::clearBaseAttributeRef"
            {
              // -beg- preserve=no 3961A83901A8 remove_all_body3961A31B0231 "ProjectionAttributeDef::clearBaseAttributeRef"
              if(sizeBaseAttributeRef()>0){
                baseAttributeRef.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearBaseAttributeRef"));
              }
              // -end- 3961A83901A8 remove_all_body3961A31B0231 "ProjectionAttributeDef::clearBaseAttributeRef"
            }

            /** returns the number of BaseAttributeRefs.
             *  @see #addBaseAttributeRef
             */
            // -beg- preserve=no 3961A83901A8 size_head3961A31B0231 "ProjectionAttributeDef::sizeBaseAttributeRef"
            public int sizeBaseAttributeRef()
            // -end- 3961A83901A8 size_head3961A31B0231 "ProjectionAttributeDef::sizeBaseAttributeRef"
            {
              // -beg- preserve=no 3961A83901A8 size_body3961A31B0231 "ProjectionAttributeDef::sizeBaseAttributeRef"
              return baseAttributeRef.size();
              // -end- 3961A83901A8 size_body3961A31B0231 "ProjectionAttributeDef::sizeBaseAttributeRef"
            }
             ...
             *  Name des Attributes in der Projektion.
             *  @see #setName
             */
...
public class ProjectionAttributeDef extends AbstractEditorElement implements java.io.Serializable {
	...
	/**
	 * get current value of properties Vererbungseigenschaften fÃ¼r dieses
	 * Attribut.
	 * 
	 * @see #setProperties
	 */
