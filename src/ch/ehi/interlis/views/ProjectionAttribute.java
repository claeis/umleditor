...
/**
 * Definiert die Attribute der Basissicht, die in der Projektion verwendet
 * werden sollen.
 * 
...
public class ProjectionAttribute extends AbstractEditorElement implements java.io.Serializable {
	...
	// -end- 3D4FA218036F throws3961A2D50316 "unlinkAll"
	{
		...
		detachAttrdef();
		// Role ProjectionAttributes: ProjectionAttributes object(s) may point
		// to this
		setBaseName(null);
		super.unlinkAll();
	 ...
	 * @see #containsAttrdef
	 */
	// -beg- preserve=no 3961A32B0161 attach_head3961A2D50316
	// "ProjectionAttribute::attachAttrdef"
	public void attachAttrdef(ProjectionAttributeDef attrdef1)
	// -end- 3961A32B0161 attach_head3961A2D50316
	// "ProjectionAttribute::attachAttrdef"
	{
		// -beg- preserve=no 3961A32B0161 attach_body3961A2D50316
		// "ProjectionAttribute::attachAttrdef"
		if (attrdef != null) {
			throw new java.lang.IllegalStateException("already a attrdef attached");
		}
		if (attrdef1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as attrdef");
		}
		attrdef = attrdef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachAttrdef"));
		return;
		// -end- 3961A32B0161 attach_body3961A2D50316
		// "ProjectionAttribute::attachAttrdef"
	}
	 ...
	 * @see #attachAttrdef
	 */
	// -beg- preserve=no 3961A32B0161 detach_head3961A2D50316
	// "ProjectionAttribute::detachAttrdef"
	public ProjectionAttributeDef detachAttrdef()
	// -end- 3961A32B0161 detach_head3961A2D50316
	// "ProjectionAttribute::detachAttrdef"
	{
		// -beg- preserve=no 3961A32B0161 detach_body3961A2D50316
		// "ProjectionAttribute::detachAttrdef"
		ProjectionAttributeDef ret = null;
		ret = attrdef;
		attrdef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachAttrdef"));
		return ret;
		// -end- 3961A32B0161 detach_body3961A2D50316
		// "ProjectionAttribute::detachAttrdef"
	}
	 ...
	 * @see #attachAttrdef
	 */
	// -beg- preserve=no 3961A32B0161 get_head3961A2D50316
	// "ProjectionAttribute::getAttrdef"
	public ProjectionAttributeDef getAttrdef()
	// -end- 3961A32B0161 get_head3961A2D50316 "ProjectionAttribute::getAttrdef"
	{
		// -beg- preserve=no 3961A32B0161 get_body3961A2D50316
		// "ProjectionAttribute::getAttrdef"
		if (attrdef == null) {
			throw new java.lang.IllegalStateException("no attrdef attached");
		}
		return attrdef;
		// -end- 3961A32B0161 get_body3961A2D50316
		// "ProjectionAttribute::getAttrdef"
	}
	 ...
	 * @see #attachAttrdef
	 */
	// -beg- preserve=no 3961A32B0161 test_head3961A2D50316
	// "ProjectionAttribute::containsAttrdef"
	public boolean containsAttrdef()
	// -end- 3961A32B0161 test_head3961A2D50316
	// "ProjectionAttribute::containsAttrdef"
	{
		// -beg- preserve=no 3961A32B0161 test_body3961A2D50316
		// "ProjectionAttribute::containsAttrdef"
		return attrdef != null;
		// -end- 3961A32B0161 test_body3961A2D50316
		// "ProjectionAttribute::containsAttrdef"
	}
	...
	/**
	 * get current value of kind ALLOF oder ATTRDEF
	 * 
	...
	/**
	 * get current value of baseName Name der Basisklasse von der alle Attribute
	 * in der Projektion verwendet werden sollen.
	 * 
	 * @see #setBaseName
	 */
