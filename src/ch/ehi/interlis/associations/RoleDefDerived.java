...
public class RoleDefDerived extends AbstractDependency implements IliSyntax , Abstraction , java.io.Serializable
              {
                 ...
                 *  @see #containsFrom
                 */
                // -beg- preserve=no 3C1DB6F5012E attach_head3C1DB6CB0118 "RoleDefDerived::attachFrom"
                public void attachFrom(ObjectPath from1)
                // -end- 3C1DB6F5012E attach_head3C1DB6CB0118 "RoleDefDerived::attachFrom"
                {
                  // -beg- preserve=no 3C1DB6F5012E attach_body3C1DB6CB0118 "RoleDefDerived::attachFrom"
                  ...
                  return;
                  // -end- 3C1DB6F5012E attach_body3C1DB6CB0118 "RoleDefDerived::attachFrom"
                }

                /** disconnect the currently attached From.
                 *  @see #attachFrom
                 */
                // -beg- preserve=no 3C1DB6F5012E detach_head3C1DB6CB0118 "RoleDefDerived::detachFrom"
                public ObjectPath detachFrom()
                // -end- 3C1DB6F5012E detach_head3C1DB6CB0118 "RoleDefDerived::detachFrom"
                {
                  // -beg- preserve=no 3C1DB6F5012E detach_body3C1DB6CB0118 "RoleDefDerived::detachFrom"
                  ObjectPath ret = null;
                  ret = from;
                  from = null;
                  ...
                  return ret;
                  // -end- 3C1DB6F5012E detach_body3C1DB6CB0118 "RoleDefDerived::detachFrom"
                }

                /** get the currently attached From.
                 *  @see #attachFrom
                 */
                // -beg- preserve=no 3C1DB6F5012E get_head3C1DB6CB0118 "RoleDefDerived::getFrom"
                public ObjectPath getFrom()
                // -end- 3C1DB6F5012E get_head3C1DB6CB0118 "RoleDefDerived::getFrom"
                {
                  // -beg- preserve=no 3C1DB6F5012E get_body3C1DB6CB0118 "RoleDefDerived::getFrom"
                 ...
                 *  @see #attachFrom
                 */
                // -beg- preserve=no 3C1DB6F5012E test_head3C1DB6CB0118 "RoleDefDerived::containsFrom"
                public boolean containsFrom()
                // -end- 3C1DB6F5012E test_head3C1DB6CB0118 "RoleDefDerived::containsFrom"
                {
                  // -beg- preserve=no 3C1DB6F5012E test_body3C1DB6CB0118 "RoleDefDerived::containsFrom"
                  return from!=null;
                  // -end- 3C1DB6F5012E test_body3C1DB6CB0118 "RoleDefDerived::containsFrom"
                }
