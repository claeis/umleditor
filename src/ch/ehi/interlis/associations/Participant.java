...
// -beg- preserve=no 448D37E501EC head448933B703CF "unlinkAll"
   ...
   */
  // -beg- preserve=no 4489342E01A0 attach_head448933B703CF "Participant::attachAssociation"
  public void attachAssociation(RoleDef association1)
  // -end- 4489342E01A0 attach_head448933B703CF "Participant::attachAssociation"
  {
    // -beg- preserve=no 4489342E01A0 attach_body448933B703CF "Participant::attachAssociation"
    ...
    return;
    // -end- 4489342E01A0 attach_body448933B703CF "Participant::attachAssociation"
  }

  /** disconnect the currently attached Association.
   *  @see #attachAssociation
   */
  // -beg- preserve=no 4489342E01A0 detach_head448933B703CF "Participant::detachAssociation"
  public RoleDef detachAssociation()
  // -end- 4489342E01A0 detach_head448933B703CF "Participant::detachAssociation"
  {
    // -beg- preserve=no 4489342E01A0 detach_body448933B703CF "Participant::detachAssociation"
    RoleDef ret = null;
    if(association!=null){
    ...
    return ret;
    // -end- 4489342E01A0 detach_body448933B703CF "Participant::detachAssociation"
  }

  /** get the currently attached Association.
   *  @see #attachAssociation
   */
  // -beg- preserve=no 4489342E01A0 get_head448933B703CF "Participant::getAssociation"
  public RoleDef getAssociation()
  // -end- 4489342E01A0 get_head448933B703CF "Participant::getAssociation"
  {
    // -beg- preserve=no 4489342E01A0 get_body448933B703CF "Participant::getAssociation"
   ...
   *  @see #attachAssociation
   */
  // -beg- preserve=no 4489342E01A0 test_head448933B703CF "Participant::containsAssociation"
  public boolean containsAssociation()
  // -end- 4489342E01A0 test_head448933B703CF "Participant::containsAssociation"
  {
    // -beg- preserve=no 4489342E01A0 test_body448933B703CF "Participant::containsAssociation"
    return association!=null;
    // -end- 4489342E01A0 test_body448933B703CF "Participant::containsAssociation"
  }

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 4489342E01A0 _link_body448933B703CF "Participant::_linkAssociation"
  ...
  /** DONT USE; link management internal
   */
  // -beg- preserve=no 4489342E01A0 _unlink_body448933B703CF "Participant::_unlinkAssociation"
  ...
  // -end- 4489342E01A0 _unlink_body448933B703CF "Participant::_unlinkAssociation"
   ...
   */
  // -beg- preserve=no 44893509032B attach_head448933B703CF "Participant::attachParticipant"
  public void attachParticipant(AbstractClassDef participant1)
  // -end- 44893509032B attach_head448933B703CF "Participant::attachParticipant"
  {
    // -beg- preserve=no 44893509032B attach_body448933B703CF "Participant::attachParticipant"
    ...
    return;
    // -end- 44893509032B attach_body448933B703CF "Participant::attachParticipant"
  }

  /** disconnect the currently attached Participant.
   *  @see #attachParticipant
   */
  // -beg- preserve=no 44893509032B detach_head448933B703CF "Participant::detachParticipant"
  public AbstractClassDef detachParticipant()
  // -end- 44893509032B detach_head448933B703CF "Participant::detachParticipant"
  {
    // -beg- preserve=no 44893509032B detach_body448933B703CF "Participant::detachParticipant"
    ...
    return ret;
    // -end- 44893509032B detach_body448933B703CF "Participant::detachParticipant"
  }

  /** get the currently attached Participant.
   *  @see #attachParticipant
   */
  // -beg- preserve=no 44893509032B get_head448933B703CF "Participant::getParticipant"
  public AbstractClassDef getParticipant()
  // -end- 44893509032B get_head448933B703CF "Participant::getParticipant"
  {
    // -beg- preserve=no 44893509032B get_body448933B703CF "Participant::getParticipant"
   ...
   *  @see #attachParticipant
   */
  // -beg- preserve=no 44893509032B test_head448933B703CF "Participant::containsParticipant"
  public boolean containsParticipant()
  // -end- 44893509032B test_head448933B703CF "Participant::containsParticipant"
  {
    // -beg- preserve=no 44893509032B test_body448933B703CF "Participant::containsParticipant"
    return participant!=null;
    // -end- 44893509032B test_body448933B703CF "Participant::containsParticipant"
  }

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 44893509032B _link_body448933B703CF "Participant::_linkParticipant"
  ...
  /** DONT USE; link management internal
   */
  // -beg- preserve=no 44893509032B _unlink_body448933B703CF "Participant::_unlinkParticipant"
  ...
  // -end- 44893509032B _unlink_body448933B703CF "Participant::_unlinkParticipant"
   ...
   *  @see #sizeRestriction
   */
  // -beg- preserve=no 4489358A00CE add_head448933B703CF "Participant::addRestriction"
  public void addRestriction(AbstractClassDef restriction1)
  // -end- 4489358A00CE add_head448933B703CF "Participant::addRestriction"
  {
    // -beg- preserve=no 4489358A00CE add_body448933B703CF "Participant::addRestriction"
   ...
   *  @see #addRestriction
   */
  // -beg- preserve=no 4489358A00CE remove_head448933B703CF "Participant::removeRestriction"
  public AbstractClassDef removeRestriction(AbstractClassDef restriction1)
  // -end- 4489358A00CE remove_head448933B703CF "Participant::removeRestriction"
  {
    // -beg- preserve=no 4489358A00CE remove_body448933B703CF "Participant::removeRestriction"
    AbstractClassDef ret=null;
    ...
    return ret;
    // -end- 4489358A00CE remove_body448933B703CF "Participant::removeRestriction"
  }

  /** tests if a given Restriction is connected.
   *  @see #addRestriction
   */
  // -beg- preserve=no 4489358A00CE test_head448933B703CF "Participant::containsRestriction"
  public boolean containsRestriction(AbstractClassDef restriction1)
  // -end- 4489358A00CE test_head448933B703CF "Participant::containsRestriction"
  {
    // -beg- preserve=no 4489358A00CE test_body448933B703CF "Participant::containsRestriction"
    return restriction.contains(restriction1);
    // -end- 4489358A00CE test_body448933B703CF "Participant::containsRestriction"
  }

  /** used to enumerate all connected Restrictions.
   *  @see #addRestriction
   */
  // -beg- preserve=no 4489358A00CE get_all_head448933B703CF "Participant::iteratorRestriction"
  public java.util.Iterator iteratorRestriction()
  // -end- 4489358A00CE get_all_head448933B703CF "Participant::iteratorRestriction"
  {
    // -beg- preserve=no 4489358A00CE get_all_body448933B703CF "Participant::iteratorRestriction"
    return restriction.iterator();
    // -end- 4489358A00CE get_all_body448933B703CF "Participant::iteratorRestriction"
  }

  /** disconnect all Restrictions.
   *  @see #addRestriction
   */
  // -beg- preserve=no 4489358A00CE remove_all_head448933B703CF "Participant::clearRestriction"
  public void clearRestriction()
  // -end- 4489358A00CE remove_all_head448933B703CF "Participant::clearRestriction"
  {
    // -beg- preserve=no 4489358A00CE remove_all_body448933B703CF "Participant::clearRestriction"
    ...
    // -end- 4489358A00CE remove_all_body448933B703CF "Participant::clearRestriction"
  }

  /** returns the number of Restrictions.
   *  @see #addRestriction
   */
  // -beg- preserve=no 4489358A00CE size_head448933B703CF "Participant::sizeRestriction"
  public int sizeRestriction()
  // -end- 4489358A00CE size_head448933B703CF "Participant::sizeRestriction"
  {
    // -beg- preserve=no 4489358A00CE size_body448933B703CF "Participant::sizeRestriction"
    return restriction.size();
    // -end- 4489358A00CE size_body448933B703CF "Participant::sizeRestriction"
  }

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 4489358A00CE _link_body448933B703CF "Participant::_linkRestriction"
  ...
  /** DONT USE; link management internal
   */
  // -beg- preserve=no 4489358A00CE _unlink_body448933B703CF "Participant::_unlinkRestriction"
