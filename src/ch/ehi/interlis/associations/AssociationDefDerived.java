...
public class AssociationDefDerived extends AbstractDependency implements Abstraction , java.io.Serializable
              {
                 ...
                 *  @see #sizeClient
                 */
                // -beg- preserve=no 33FFE57B03B3 add_head3C1DB4C00011 "Dependency::addClient"
                public void addClient(ModelElement client1)
                // -end- 33FFE57B03B3 add_head3C1DB4C00011 "Dependency::addClient"
                {
                  // -beg- preserve=no 33FFE57B03B3 add_body3C1DB4C00011 "Dependency::addClient"
                 ...
                 *  @see #addClient
                 */
                // -beg- preserve=no 33FFE57B03B3 remove_head3C1DB4C00011 "Dependency::removeClient"
                public ModelElement removeClient(ModelElement client1)
                // -end- 33FFE57B03B3 remove_head3C1DB4C00011 "Dependency::removeClient"
                {
                  // -beg- preserve=no 33FFE57B03B3 remove_body3C1DB4C00011 "Dependency::removeClient"
                 ...
                 *  @see #addClient
                 */
                // -beg- preserve=no 33FFE57B03B3 test_head3C1DB4C00011 "Dependency::containsClient"
                public boolean containsClient(ModelElement client1)
                // -end- 33FFE57B03B3 test_head3C1DB4C00011 "Dependency::containsClient"
                {
                  // -beg- preserve=no 33FFE57B03B3 test_body3C1DB4C00011 "Dependency::containsClient"
                 ...
                 *  @see #addClient
                 */
                // -beg- preserve=no 33FFE57B03B3 get_all_head3C1DB4C00011 "Dependency::iteratorClient"
                public java.util.Iterator iteratorClient()
                // -end- 33FFE57B03B3 get_all_head3C1DB4C00011 "Dependency::iteratorClient"
                {
                  // -beg- preserve=no 33FFE57B03B3 get_all_body3C1DB4C00011 "Dependency::iteratorClient"
                  return super.iteratorClient();
                  // -end- 33FFE57B03B3 get_all_body3C1DB4C00011 "Dependency::iteratorClient"
                }

                /** disconnect all Clients.
                 *  @see #addClient
                 */
                // -beg- preserve=no 33FFE57B03B3 remove_all_head3C1DB4C00011 "Dependency::clearClient"
                public void clearClient()
                // -end- 33FFE57B03B3 remove_all_head3C1DB4C00011 "Dependency::clearClient"
                {
                  // -beg- preserve=no 33FFE57B03B3 remove_all_body3C1DB4C00011 "Dependency::clearClient"
                  super.clearClient();
                  // -end- 33FFE57B03B3 remove_all_body3C1DB4C00011 "Dependency::clearClient"
                }

                /** returns the number of Clients.
                 *  @see #addClient
                 */
                // -beg- preserve=no 33FFE57B03B3 size_head3C1DB4C00011 "Dependency::sizeClient"
                public int sizeClient()
                // -end- 33FFE57B03B3 size_head3C1DB4C00011 "Dependency::sizeClient"
                {
                  // -beg- preserve=no 33FFE57B03B3 size_body3C1DB4C00011 "Dependency::sizeClient"
                 ...
                 */
                // -beg- preserve=no 33FFE57B03B3 _link_body3C1DB4C00011 "Dependency::_linkClient"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 33FFE57B03B3 _unlink_body3C1DB4C00011 "Dependency::_unlinkClient"
                 ...
                 *  @see #sizeSupplier
                 */
                // -beg- preserve=no 335C0D7A02E4 add_head3C1DB4C00011 "Dependency::addSupplier"
                public void addSupplier(ModelElement supplier1)
                // -end- 335C0D7A02E4 add_head3C1DB4C00011 "Dependency::addSupplier"
                {
                  // -beg- preserve=no 335C0D7A02E4 add_body3C1DB4C00011 "Dependency::addSupplier"
                 ...
                 *  @see #addSupplier
                 */
                // -beg- preserve=no 335C0D7A02E4 remove_head3C1DB4C00011 "Dependency::removeSupplier"
                ...
                {
                  // -beg- preserve=no 335C0D7A02E4 remove_body3C1DB4C00011 "Dependency::removeSupplier"
                  return super.removeSupplier(supplier1);
                  // -end- 335C0D7A02E4 remove_body3C1DB4C00011 "Dependency::removeSupplier"
                }

                /** tests if a given Supplier is connected.
                 *  @see #addSupplier
                 */
                // -beg- preserve=no 335C0D7A02E4 test_head3C1DB4C00011 "Dependency::containsSupplier"
                public boolean containsSupplier(ModelElement supplier1)
                // -end- 335C0D7A02E4 test_head3C1DB4C00011 "Dependency::containsSupplier"
                {
                  // -beg- preserve=no 335C0D7A02E4 test_body3C1DB4C00011 "Dependency::containsSupplier"
                  return super.containsSupplier(supplier1);
                  // -end- 335C0D7A02E4 test_body3C1DB4C00011 "Dependency::containsSupplier"
                }

                /** used to enumerate all connected Suppliers.
                 *  @see #addSupplier
                 */
                // -beg- preserve=no 335C0D7A02E4 get_all_head3C1DB4C00011 "Dependency::iteratorSupplier"
                public java.util.Iterator iteratorSupplier()
                // -end- 335C0D7A02E4 get_all_head3C1DB4C00011 "Dependency::iteratorSupplier"
                {
                  // -beg- preserve=no 335C0D7A02E4 get_all_body3C1DB4C00011 "Dependency::iteratorSupplier"
                  return super.iteratorSupplier();
                  // -end- 335C0D7A02E4 get_all_body3C1DB4C00011 "Dependency::iteratorSupplier"
                }

                /** disconnect all Suppliers.
                 *  @see #addSupplier
                 */
                // -beg- preserve=no 335C0D7A02E4 remove_all_head3C1DB4C00011 "Dependency::clearSupplier"
                public void clearSupplier()
                // -end- 335C0D7A02E4 remove_all_head3C1DB4C00011 "Dependency::clearSupplier"
                {
                  // -beg- preserve=no 335C0D7A02E4 remove_all_body3C1DB4C00011 "Dependency::clearSupplier"
                  super.clearSupplier();
                  // -end- 335C0D7A02E4 remove_all_body3C1DB4C00011 "Dependency::clearSupplier"
                }

                /** returns the number of Suppliers.
                 *  @see #addSupplier
                 */
                // -beg- preserve=no 335C0D7A02E4 size_head3C1DB4C00011 "Dependency::sizeSupplier"
                public int sizeSupplier()
                // -end- 335C0D7A02E4 size_head3C1DB4C00011 "Dependency::sizeSupplier"
                {
                  // -beg- preserve=no 335C0D7A02E4 size_body3C1DB4C00011 "Dependency::sizeSupplier"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 335C0D7A02E4 _link_body3C1DB4C00011 "Dependency::_linkSupplier"
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 335C0D7A02E4 _unlink_body3C1DB4C00011 "Dependency::_unlinkSupplier"
                ...
                // -end- 33EB8A4500B4 set_head3C1DB4C00011 "mapping"
                {
                  ...
                  if(mapping!=value1 && (mapping==null || !mapping.equals(value1))){
                    mapping = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setMapping"));
                  }
