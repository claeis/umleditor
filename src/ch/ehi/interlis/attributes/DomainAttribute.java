...
public class DomainAttribute extends AttrType implements java.io.Serializable {
	...
	// -end- 3D4FA21A01C4 throws358A641F019E "unlinkAll"
	{
		...
		// point to this
		// Role ArgumentType: ArgumentType object(s) may point to this
		// Role GraphicParameterDef: GraphicParameterDef object(s) may point to
		// this
		detachDirect();
		// Role Ili1ControlPoints: Ili1ControlPoints object(s) may point to this
		super.unlinkAll();
	 ...
	 * @see #containsDomainDef
	 */
	// -beg- preserve=no 3947A41A020A attach_head358A641F019E
	// "DomainAttribute::attachDomainDef"
	public void attachDomainDef(DomainDef domainDef1)
	// -end- 3947A41A020A attach_head358A641F019E
	// "DomainAttribute::attachDomainDef"
	{
		// -beg- preserve=no 3947A41A020A attach_body358A641F019E
		// "DomainAttribute::attachDomainDef"
		if (domainDef != null) {
		...
		return;
		// -end- 3947A41A020A attach_body358A641F019E
		// "DomainAttribute::attachDomainDef"
	}
	 ...
	 * @see #attachDomainDef
	 */
	// -beg- preserve=no 3947A41A020A detach_head358A641F019E
	// "DomainAttribute::detachDomainDef"
	public DomainDef detachDomainDef()
	// -end- 3947A41A020A detach_head358A641F019E
	// "DomainAttribute::detachDomainDef"
	{
		// -beg- preserve=no 3947A41A020A detach_body358A641F019E
		// "DomainAttribute::detachDomainDef"
		DomainDef ret = null;
		if (domainDef != null) {
			domainDef._unlinkDomainAttribute(this);
		...
		return ret;
		// -end- 3947A41A020A detach_body358A641F019E
		// "DomainAttribute::detachDomainDef"
	}
	 ...
	 * @see #attachDomainDef
	 */
	// -beg- preserve=no 3947A41A020A get_head358A641F019E
	// "DomainAttribute::getDomainDef"
	public DomainDef getDomainDef()
	// -end- 3947A41A020A get_head358A641F019E "DomainAttribute::getDomainDef"
	{
		// -beg- preserve=no 3947A41A020A get_body358A641F019E
		// "DomainAttribute::getDomainDef"
		if (domainDef == null) {
			throw new java.lang.IllegalStateException("no domainDef attached");
		}
		return domainDef;
		// -end- 3947A41A020A get_body358A641F019E
		// "DomainAttribute::getDomainDef"
	}
	 ...
	 * @see #attachDomainDef
	 */
	// -beg- preserve=no 3947A41A020A test_head358A641F019E
	// "DomainAttribute::containsDomainDef"
	public boolean containsDomainDef()
	// -end- 3947A41A020A test_head358A641F019E
	// "DomainAttribute::containsDomainDef"
	{
		// -beg- preserve=no 3947A41A020A test_body358A641F019E
		// "DomainAttribute::containsDomainDef"
		return domainDef != null;
		// -end- 3947A41A020A test_body358A641F019E
		// "DomainAttribute::containsDomainDef"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3947A41A020A _link_body358A641F019E
	// "DomainAttribute::_linkDomainDef"
	public void _linkDomainDef(DomainDef domainDef1) {
		domainDef = domainDef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkDomainDef"));
		return;
	}
	// -end- 3947A41A020A _link_body358A641F019E
	// "DomainAttribute::_linkDomainDef"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3947A41A020A _unlink_body358A641F019E
	// "DomainAttribute::_unlinkDomainDef"
	public void _unlinkDomainDef(DomainDef domainDef1) {
		domainDef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkDomainDef"));
		return;
	}
	// -end- 3947A41A020A _unlink_body358A641F019E
	// "DomainAttribute::_unlinkDomainDef"
	 ...
	 * @see #containsDirect
	 */
	// -beg- preserve=no 3708B22F01CA attach_head358A641F019E
	// "DomainAttribute::attachDirect"
	public void attachDirect(Type direct1)
	// -end- 3708B22F01CA attach_head358A641F019E
	// "DomainAttribute::attachDirect"
	{
		// -beg- preserve=no 3708B22F01CA attach_body358A641F019E
		// "DomainAttribute::attachDirect"
		if (direct != null) {
			throw new java.lang.IllegalStateException("already a direct attached");
		}
		if (direct1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as direct");
		}
		direct = direct1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachDirect"));
		return;
		// -end- 3708B22F01CA attach_body358A641F019E
		// "DomainAttribute::attachDirect"
	}
	 ...
	 * @see #attachDirect
	 */
	// -beg- preserve=no 3708B22F01CA detach_head358A641F019E
	// "DomainAttribute::detachDirect"
	public Type detachDirect()
	// -end- 3708B22F01CA detach_head358A641F019E
	// "DomainAttribute::detachDirect"
	{
		// -beg- preserve=no 3708B22F01CA detach_body358A641F019E
		// "DomainAttribute::detachDirect"
		Type ret = null;
		ret = direct;
		direct = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachDirect"));
		return ret;
		// -end- 3708B22F01CA detach_body358A641F019E
		// "DomainAttribute::detachDirect"
	}
	 ...
	 * @see #attachDirect
	 */
	// -beg- preserve=no 3708B22F01CA get_head358A641F019E
	// "DomainAttribute::getDirect"
	public Type getDirect()
	// -end- 3708B22F01CA get_head358A641F019E "DomainAttribute::getDirect"
	{
		// -beg- preserve=no 3708B22F01CA get_body358A641F019E
		// "DomainAttribute::getDirect"
		if (direct == null) {
			throw new java.lang.IllegalStateException("no direct attached");
		}
		return direct;
		// -end- 3708B22F01CA get_body358A641F019E "DomainAttribute::getDirect"
	}
	 ...
	 * @see #attachDirect
	 */
	// -beg- preserve=no 3708B22F01CA test_head358A641F019E
	// "DomainAttribute::containsDirect"
	public boolean containsDirect()
	// -end- 3708B22F01CA test_head358A641F019E
	// "DomainAttribute::containsDirect"
	{
		// -beg- preserve=no 3708B22F01CA test_body358A641F019E
		// "DomainAttribute::containsDirect"
		return direct != null;
		// -end- 3708B22F01CA test_body358A641F019E
		// "DomainAttribute::containsDirect"
	}
