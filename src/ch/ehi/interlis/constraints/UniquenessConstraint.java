...
public class UniquenessConstraint extends AbstractEditorElement implements java.io.Serializable {
	...
	/**
	 * get current value of compositionAttributes ??? std::list<CString>Kann
	 * leer sein.
	 * 
	 * @see #setCompositionAttributes
	 */
	// -beg- preserve=no 394A364F0031 get_head394A2D1100D0
	// "compositionAttributes"
	public NlsString getCompositionAttributes()
	// -end- 394A364F0031 get_head394A2D1100D0 "compositionAttributes"
	{
		// -beg- preserve=no 394A364F0031 get_body394A2D1100D0
		// "compositionAttributes"
		return compositionAttributes;
		// -end- 394A364F0031 get_body394A2D1100D0 "compositionAttributes"
	}
	 ...
	 * @see #getCompositionAttributes
	 */
	// -beg- preserve=no 394A364F0031 set_head394A2D1100D0
	// "compositionAttributes"
	public void setCompositionAttributes(NlsString value1)
	// -end- 394A364F0031 set_head394A2D1100D0 "compositionAttributes"
	{
		// -beg- preserve=no 394A364F0031 set_body394A2D1100D0
		// "compositionAttributes"
		if (compositionAttributes != value1
				&& (compositionAttributes == null || !compositionAttributes.equals(value1))) {
			compositionAttributes = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(
					new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setCompositionAttributes"));
		}
		// -end- 394A364F0031 set_body394A2D1100D0 "compositionAttributes"
	}
	...
	/**
	 * get current value of attributes Namen der Attribute die zusammen fÃ¼r jede
	 * Instanz der Klasse eindeutig sein mÃ¼ssen.
	 * 
	 * @see #setAttributes
	 */
	// -beg- preserve=no 394A36580070 get_head394A2D1100D0 "attributes"
	...
	// -end- 394A36600112 set_head394A2D1100D0 "object"
	{
		...
		if (object != value1) {
			object = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setObject"));
		}
		// -end- 394A36600112 set_body394A2D1100D0 "object"
	}
