 ...
 */
public class ConstraintExpression extends AbstractEditorElement
		implements BooleanExpression, IliSyntax, java.io.Serializable {
	...
	// -end- 3D4FA21801C1 throws3C178A0A03B5 "enumerateChildren"
	{
		...
		if (containsPlausibility())
			visitor.visit(getPlausibility());
		if (containsUniqueness())
			visitor.visit(getUniqueness());
	 ...
	 */
	// -beg- preserve=no 394A2E3C01FD attach_head3C178A0A03B5
	// "ConstraintExpression::attachPlausibility"
	public void attachPlausibility(PlausibilityConstraint plausibility1)
	// -end- 394A2E3C01FD attach_head3C178A0A03B5
	// "ConstraintExpression::attachPlausibility"
	{
		// -beg- preserve=no 394A2E3C01FD attach_body3C178A0A03B5
		// "ConstraintExpression::attachPlausibility"
		if (plausibility != null) {
			throw new java.lang.IllegalStateException("already a plausibility attached");
		}
		if (plausibility1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as plausibility");
		}
		plausibility = plausibility1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachPlausibility"));
		return;
		// -end- 394A2E3C01FD attach_body3C178A0A03B5
		// "ConstraintExpression::attachPlausibility"
	}
	 ...
	 */
	// -beg- preserve=no 394A2E3C01FD detach_head3C178A0A03B5
	// "ConstraintExpression::detachPlausibility"
	public PlausibilityConstraint detachPlausibility()
	// -end- 394A2E3C01FD detach_head3C178A0A03B5
	// "ConstraintExpression::detachPlausibility"
	{
		// -beg- preserve=no 394A2E3C01FD detach_body3C178A0A03B5
		// "ConstraintExpression::detachPlausibility"
		PlausibilityConstraint ret = null;
		ret = plausibility;
		plausibility = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachPlausibility"));
		return ret;
		// -end- 394A2E3C01FD detach_body3C178A0A03B5
		// "ConstraintExpression::detachPlausibility"
	}
	 ...
	 * @see #attachPlausibility
	 */
	// -beg- preserve=no 394A2E3C01FD get_head3C178A0A03B5
	// "ConstraintExpression::getPlausibility"
	public PlausibilityConstraint getPlausibility()
	// -end- 394A2E3C01FD get_head3C178A0A03B5
	// "ConstraintExpression::getPlausibility"
	{
		// -beg- preserve=no 394A2E3C01FD get_body3C178A0A03B5
		// "ConstraintExpression::getPlausibility"
		if (plausibility == null) {
			throw new java.lang.IllegalStateException("no plausibility attached");
		}
		return plausibility;
		// -end- 394A2E3C01FD get_body3C178A0A03B5
		// "ConstraintExpression::getPlausibility"
	}
	 ...
	 * @see #attachPlausibility
	 */
	// -beg- preserve=no 394A2E3C01FD test_head3C178A0A03B5
	// "ConstraintExpression::containsPlausibility"
	public boolean containsPlausibility()
	// -end- 394A2E3C01FD test_head3C178A0A03B5
	// "ConstraintExpression::containsPlausibility"
	{
		// -beg- preserve=no 394A2E3C01FD test_body3C178A0A03B5
		// "ConstraintExpression::containsPlausibility"
		return plausibility != null;
		// -end- 394A2E3C01FD test_body3C178A0A03B5
		// "ConstraintExpression::containsPlausibility"
	}
	 ...
	 */
	// -beg- preserve=no 394A2E3E03C2 attach_head3C178A0A03B5
	// "ConstraintExpression::attachUniqueness"
	public void attachUniqueness(UniquenessConstraint uniqueness1)
	// -end- 394A2E3E03C2 attach_head3C178A0A03B5
	// "ConstraintExpression::attachUniqueness"
	{
		// -beg- preserve=no 394A2E3E03C2 attach_body3C178A0A03B5
		// "ConstraintExpression::attachUniqueness"
		if (uniqueness != null) {
			throw new java.lang.IllegalStateException("already a uniqueness attached");
		}
		if (uniqueness1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as uniqueness");
		}
		uniqueness = uniqueness1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachUniqueness"));
		return;
		// -end- 394A2E3E03C2 attach_body3C178A0A03B5
		// "ConstraintExpression::attachUniqueness"
	}
	 ...
	 */
	// -beg- preserve=no 394A2E3E03C2 detach_head3C178A0A03B5
	// "ConstraintExpression::detachUniqueness"
	public UniquenessConstraint detachUniqueness()
	// -end- 394A2E3E03C2 detach_head3C178A0A03B5
	// "ConstraintExpression::detachUniqueness"
	{
		// -beg- preserve=no 394A2E3E03C2 detach_body3C178A0A03B5
		// "ConstraintExpression::detachUniqueness"
		UniquenessConstraint ret = null;
		ret = uniqueness;
		uniqueness = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachUniqueness"));
		return ret;
		// -end- 394A2E3E03C2 detach_body3C178A0A03B5
		// "ConstraintExpression::detachUniqueness"
	}
	 ...
	 * @see #attachUniqueness
	 */
	// -beg- preserve=no 394A2E3E03C2 get_head3C178A0A03B5
	// "ConstraintExpression::getUniqueness"
	public UniquenessConstraint getUniqueness()
	// -end- 394A2E3E03C2 get_head3C178A0A03B5
	// "ConstraintExpression::getUniqueness"
	{
		// -beg- preserve=no 394A2E3E03C2 get_body3C178A0A03B5
		// "ConstraintExpression::getUniqueness"
		if (uniqueness == null) {
			throw new java.lang.IllegalStateException("no uniqueness attached");
		}
		return uniqueness;
		// -end- 394A2E3E03C2 get_body3C178A0A03B5
		// "ConstraintExpression::getUniqueness"
	}
	 ...
	 * @see #attachUniqueness
	 */
	// -beg- preserve=no 394A2E3E03C2 test_head3C178A0A03B5
	// "ConstraintExpression::containsUniqueness"
	public boolean containsUniqueness()
	// -end- 394A2E3E03C2 test_head3C178A0A03B5
	// "ConstraintExpression::containsUniqueness"
	{
		// -beg- preserve=no 394A2E3E03C2 test_body3C178A0A03B5
		// "ConstraintExpression::containsUniqueness"
		return uniqueness != null;
		// -end- 394A2E3E03C2 test_body3C178A0A03B5
		// "ConstraintExpression::containsUniqueness"
	}
	...
	// -end- 33E12E5F01CA set_head3C178A0A03B5 "language"
	{
		...
		if (language != value1) {
			language = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setLanguage"));
		}
