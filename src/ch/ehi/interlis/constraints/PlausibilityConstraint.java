...
public class PlausibilityConstraint extends AbstractEditorElement implements java.io.Serializable {
	...
	// -end- 3D4FA2180198 throws394A2CF303A7 "unlinkAll"
	{
		...
		// Role ConstraintExpression: ConstraintExpression object(s) may point
		// to this
		detachExpression();
		super.unlinkAll();
		// -end- 3D4FA2180198 body394A2CF303A7 "unlinkAll"
	 ...
	 * @see #containsExpression
	 */
	// -beg- preserve=no 39620D660070 attach_head394A2CF303A7
	// "PlausibilityConstraint::attachExpression"
	public void attachExpression(Term expression1)
	// -end- 39620D660070 attach_head394A2CF303A7
	// "PlausibilityConstraint::attachExpression"
	{
		// -beg- preserve=no 39620D660070 attach_body394A2CF303A7
		// "PlausibilityConstraint::attachExpression"
		if (expression != null) {
			throw new java.lang.IllegalStateException("already a expression attached");
		}
		if (expression1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as expression");
		}
		expression = expression1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachExpression"));
		return;
		// -end- 39620D660070 attach_body394A2CF303A7
		// "PlausibilityConstraint::attachExpression"
	}
	 ...
	 * @see #attachExpression
	 */
	// -beg- preserve=no 39620D660070 detach_head394A2CF303A7
	// "PlausibilityConstraint::detachExpression"
	public Term detachExpression()
	// -end- 39620D660070 detach_head394A2CF303A7
	// "PlausibilityConstraint::detachExpression"
	{
		// -beg- preserve=no 39620D660070 detach_body394A2CF303A7
		// "PlausibilityConstraint::detachExpression"
		Term ret = null;
		ret = expression;
		expression = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachExpression"));
		return ret;
		// -end- 39620D660070 detach_body394A2CF303A7
		// "PlausibilityConstraint::detachExpression"
	}
	 ...
	 * @see #attachExpression
	 */
	// -beg- preserve=no 39620D660070 get_head394A2CF303A7
	// "PlausibilityConstraint::getExpression"
	public Term getExpression()
	// -end- 39620D660070 get_head394A2CF303A7
	// "PlausibilityConstraint::getExpression"
	{
		// -beg- preserve=no 39620D660070 get_body394A2CF303A7
		// "PlausibilityConstraint::getExpression"
		if (expression == null) {
			throw new java.lang.IllegalStateException("no expression attached");
		}
		return expression;
		// -end- 39620D660070 get_body394A2CF303A7
		// "PlausibilityConstraint::getExpression"
	}
	 ...
	 * @see #attachExpression
	 */
	// -beg- preserve=no 39620D660070 test_head394A2CF303A7
	// "PlausibilityConstraint::containsExpression"
	public boolean containsExpression()
	// -end- 39620D660070 test_head394A2CF303A7
	// "PlausibilityConstraint::containsExpression"
	{
		// -beg- preserve=no 39620D660070 test_body394A2CF303A7
		// "PlausibilityConstraint::containsExpression"
		return expression != null;
		// -end- 39620D660070 test_body394A2CF303A7
		// "PlausibilityConstraint::containsExpression"
	}
	...
	/**
	 * get current value of kind MANDATORY, LESSTHAN oder MORETHAN
	 * 
	 * @see ch.ehi.interlis.constraints.PlausibilityKind
	 * @see #setKind
	 */
	...
	/**
	 * get current value of percentage Prozentanteil der Instanzen der Klasse
	 * die die Bedingung erfÃ¼llen mÃ¼ssen
	 * 
	 * @see #setPercentage
	 */
	// -beg- preserve=no 394A3074018A get_head394A2CF303A7 "percentage"
	...
	// -end- 394A3074018A set_head394A2CF303A7 "percentage"
	{
		...
		if (percentage != value1) {
			percentage = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setPercentage"));
		}
		// -end- 394A3074018A set_body394A2CF303A7 "percentage"
	}
