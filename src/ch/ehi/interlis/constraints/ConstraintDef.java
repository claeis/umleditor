...
public class ConstraintDef extends AbstractModelElement implements Constraint , java.io.Serializable
          {
             ...
             */
            // -beg- preserve=no 33EA67BB010F add_head3941018702C7 "Constraint::addConstrainedElement"
            public void addConstrainedElement(ModelElement constrainedElement1)
            // -end- 33EA67BB010F add_head3941018702C7 "Constraint::addConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F add_body3941018702C7 "Constraint::addConstrainedElement"
              constrainedElement.add(constrainedElement1);
              constrainedElement1._linkConstraint(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addConstrainedElement"));
              return;
              // -end- 33EA67BB010F add_body3941018702C7 "Constraint::addConstrainedElement"
            }

            // -beg- preserve=no 33EA67BB010F add2_head3941018702C7 "Constraint::add2ConstrainedElement"
            public void addConstrainedElement(int index,ModelElement constrainedElement1)
            // -end- 33EA67BB010F add2_head3941018702C7 "Constraint::add2ConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F add2_body3941018702C7 "Constraint::add2ConstrainedElement"
              constrainedElement.add(index,constrainedElement1);
              constrainedElement1._linkConstraint(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addConstrainedElement"));
              return;
              // -end- 33EA67BB010F add2_body3941018702C7 "Constraint::add2ConstrainedElement"
            }

            /** disconnect a ConstrainedElement.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F remove_head3941018702C7 "Constraint::removeConstrainedElement"
            public ModelElement removeConstrainedElement(ModelElement constrainedElement1)
            // -end- 33EA67BB010F remove_head3941018702C7 "Constraint::removeConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F remove_body3941018702C7 "Constraint::removeConstrainedElement"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeConstrainedElement"));
              return ret;
              // -end- 33EA67BB010F remove_body3941018702C7 "Constraint::removeConstrainedElement"
            }

            /** disconnect a ConstrainedElement.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F remove2_head3941018702C7 "Constraint::remove2ConstrainedElement"
            public ModelElement removeConstrainedElement(int index)
            // -end- 33EA67BB010F remove2_head3941018702C7 "Constraint::remove2ConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F remove2_body3941018702C7 "Constraint::remove2ConstrainedElement"
              ModelElement ret=null;
              ret = (ModelElement)constrainedElement.remove(index);
              ret._unlinkConstraint(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeConstrainedElement"));
              return ret;
              // -end- 33EA67BB010F remove2_body3941018702C7 "Constraint::remove2ConstrainedElement"
            }

            /** change a ConstrainedElement.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F set_head3941018702C7 "Constraint::setConstrainedElement"
            public ModelElement setConstrainedElement(int index,ModelElement constrainedElement1)
            // -end- 33EA67BB010F set_head3941018702C7 "Constraint::setConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F set_body3941018702C7 "Constraint::setConstrainedElement"
              ModelElement ret=null;
              ret = (ModelElement)constrainedElement.set(index,constrainedElement1);
              ret._unlinkConstraint(this);
              constrainedElement1._linkConstraint(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setConstrainedElement"));
              return ret;
              // -end- 33EA67BB010F set_body3941018702C7 "Constraint::setConstrainedElement"
            }

            /** tests if a given ConstrainedElement is connected.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F test_head3941018702C7 "Constraint::containsConstrainedElement"
            public boolean containsConstrainedElement(ModelElement constrainedElement1)
            // -end- 33EA67BB010F test_head3941018702C7 "Constraint::containsConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F test_body3941018702C7 "Constraint::containsConstrainedElement"
              return constrainedElement.contains(constrainedElement1);
              // -end- 33EA67BB010F test_body3941018702C7 "Constraint::containsConstrainedElement"
            }

            /** used to enumerate all connected ConstrainedElements.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F get_all_head3941018702C7 "Constraint::iteratorConstrainedElement"
            public java.util.Iterator iteratorConstrainedElement()
            // -end- 33EA67BB010F get_all_head3941018702C7 "Constraint::iteratorConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F get_all_body3941018702C7 "Constraint::iteratorConstrainedElement"
              return constrainedElement.iterator();
              // -end- 33EA67BB010F get_all_body3941018702C7 "Constraint::iteratorConstrainedElement"
            }

            /** disconnect all ConstrainedElements.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F remove_all_head3941018702C7 "Constraint::clearConstrainedElement"
            public void clearConstrainedElement()
            // -end- 33EA67BB010F remove_all_head3941018702C7 "Constraint::clearConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F remove_all_body3941018702C7 "Constraint::clearConstrainedElement"
              if(sizeConstrainedElement()>0){
                ...
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearConstrainedElement"));
              }
              // -end- 33EA67BB010F remove_all_body3941018702C7 "Constraint::clearConstrainedElement"
            }

            /** returns the number of ConstrainedElements.
             *  @see #addConstrainedElement
             */
            // -beg- preserve=no 33EA67BB010F size_head3941018702C7 "Constraint::sizeConstrainedElement"
            public int sizeConstrainedElement()
            // -end- 33EA67BB010F size_head3941018702C7 "Constraint::sizeConstrainedElement"
            {
              // -beg- preserve=no 33EA67BB010F size_body3941018702C7 "Constraint::sizeConstrainedElement"
              return constrainedElement.size();
              // -end- 33EA67BB010F size_body3941018702C7 "Constraint::sizeConstrainedElement"
            }

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33EA67BB010F _link_body3941018702C7 "Constraint::_linkConstrainedElement"
            public void _linkConstrainedElement(ModelElement constrainedElement1)
            {
              constrainedElement.add(constrainedElement1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkConstrainedElement"));
              return;
            }
            // -end- 33EA67BB010F _link_body3941018702C7 "Constraint::_linkConstrainedElement"

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33EA67BB010F _unlink_body3941018702C7 "Constraint::_unlinkConstrainedElement"
            public void _unlinkConstrainedElement(ModelElement constrainedElement1)
            {
              constrainedElement.remove(constrainedElement1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkConstrainedElement"));
              return;
            }
            // -end- 33EA67BB010F _unlink_body3941018702C7 "Constraint::_unlinkConstrainedElement"
             ...
             */
            // -beg- preserve=no 364B66900259 attach_head3941018702C7 "Constraint::attachConstrainedStereotype"
            public void attachConstrainedStereotype(Stereotype constrainedStereotype1)
            // -end- 364B66900259 attach_head3941018702C7 "Constraint::attachConstrainedStereotype"
            {
              // -beg- preserve=no 364B66900259 attach_body3941018702C7 "Constraint::attachConstrainedStereotype"
              if(constrainedStereotype!=null) {throw new java.lang.IllegalStateException("already a constrainedStereotype attached");}
              if(constrainedStereotype1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as constrainedStereotype");}
              constrainedStereotype = constrainedStereotype1;
              constrainedStereotype1._linkStereotypeConstraint(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachConstrainedStereotype"));
              return;
              // -end- 364B66900259 attach_body3941018702C7 "Constraint::attachConstrainedStereotype"
            }

            /** disconnect the currently attached ConstrainedStereotype.
             *  @see #attachConstrainedStereotype
             */
            // -beg- preserve=no 364B66900259 detach_head3941018702C7 "Constraint::detachConstrainedStereotype"
            public Stereotype detachConstrainedStereotype()
            // -end- 364B66900259 detach_head3941018702C7 "Constraint::detachConstrainedStereotype"
            {
              // -beg- preserve=no 364B66900259 detach_body3941018702C7 "Constraint::detachConstrainedStereotype"
              Stereotype ret = null;
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachConstrainedStereotype"));
              return ret;
              // -end- 364B66900259 detach_body3941018702C7 "Constraint::detachConstrainedStereotype"
            }

            /** get the currently attached ConstrainedStereotype.
             *  @see #attachConstrainedStereotype
             */
            // -beg- preserve=no 364B66900259 get_head3941018702C7 "Constraint::getConstrainedStereotype"
            public Stereotype getConstrainedStereotype()
            // -end- 364B66900259 get_head3941018702C7 "Constraint::getConstrainedStereotype"
            {
              // -beg- preserve=no 364B66900259 get_body3941018702C7 "Constraint::getConstrainedStereotype"
              if(constrainedStereotype==null) {throw new java.lang.IllegalStateException("no constrainedStereotype attached");}
              return constrainedStereotype;
              // -end- 364B66900259 get_body3941018702C7 "Constraint::getConstrainedStereotype"
            }

            /** tests if there is a ConstrainedStereotype attached.
             *  @see #attachConstrainedStereotype
             */
            // -beg- preserve=no 364B66900259 test_head3941018702C7 "Constraint::containsConstrainedStereotype"
            public boolean containsConstrainedStereotype()
            // -end- 364B66900259 test_head3941018702C7 "Constraint::containsConstrainedStereotype"
            {
              // -beg- preserve=no 364B66900259 test_body3941018702C7 "Constraint::containsConstrainedStereotype"
              return constrainedStereotype!=null;
              // -end- 364B66900259 test_body3941018702C7 "Constraint::containsConstrainedStereotype"
            }

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 364B66900259 _link_body3941018702C7 "Constraint::_linkConstrainedStereotype"
            public void _linkConstrainedStereotype(Stereotype constrainedStereotype1)
            {
              constrainedStereotype = constrainedStereotype1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkConstrainedStereotype"));
              return;
            }
            // -end- 364B66900259 _link_body3941018702C7 "Constraint::_linkConstrainedStereotype"

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 364B66900259 _unlink_body3941018702C7 "Constraint::_unlinkConstrainedStereotype"
            public void _unlinkConstrainedStereotype(Stereotype constrainedStereotype1)
            {
              constrainedStereotype = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkConstrainedStereotype"));
              return;
            }
            // -end- 364B66900259 _unlink_body3941018702C7 "Constraint::_unlinkConstrainedStereotype"
