...
public class DerivedUnit extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #sizeDerivedUnitFactor
	 */
	// -beg- preserve=no 3949E7A200ED add_head3949E16F0308
	// "DerivedUnit::addDerivedUnitFactor"
	public void addDerivedUnitFactor(DerivedUnitFactor derivedUnitFactor1)
	// -end- 3949E7A200ED add_head3949E16F0308
	// "DerivedUnit::addDerivedUnitFactor"
	{
		// -beg- preserve=no 3949E7A200ED add_body3949E16F0308
		// "DerivedUnit::addDerivedUnitFactor"
		derivedUnitFactor.add(derivedUnitFactor1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addDerivedUnitFactor"));
		return;
		// -end- 3949E7A200ED add_body3949E16F0308
		// "DerivedUnit::addDerivedUnitFactor"
	}
	 ...
	 * @see #addDerivedUnitFactor
	 */
	// -beg- preserve=no 3949E7A200ED remove_head3949E16F0308
	// "DerivedUnit::removeDerivedUnitFactor"
	public DerivedUnitFactor removeDerivedUnitFactor(DerivedUnitFactor derivedUnitFactor1)
	// -end- 3949E7A200ED remove_head3949E16F0308
	// "DerivedUnit::removeDerivedUnitFactor"
	{
		// -beg- preserve=no 3949E7A200ED remove_body3949E16F0308
		// "DerivedUnit::removeDerivedUnitFactor"
		DerivedUnitFactor ret = null;
		if (derivedUnitFactor1 == null || !derivedUnitFactor.contains(derivedUnitFactor1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		derivedUnitFactor.remove(derivedUnitFactor1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeDerivedUnitFactor"));
		return ret;
		// -end- 3949E7A200ED remove_body3949E16F0308
		// "DerivedUnit::removeDerivedUnitFactor"
	}
	 ...
	 * @see #addDerivedUnitFactor
	 */
	// -beg- preserve=no 3949E7A200ED test_head3949E16F0308
	// "DerivedUnit::containsDerivedUnitFactor"
	public boolean containsDerivedUnitFactor(DerivedUnitFactor derivedUnitFactor1)
	// -end- 3949E7A200ED test_head3949E16F0308
	// "DerivedUnit::containsDerivedUnitFactor"
	{
		// -beg- preserve=no 3949E7A200ED test_body3949E16F0308
		// "DerivedUnit::containsDerivedUnitFactor"
		return derivedUnitFactor.contains(derivedUnitFactor1);
		// -end- 3949E7A200ED test_body3949E16F0308
		// "DerivedUnit::containsDerivedUnitFactor"
	}
	...
	// "DerivedUnit::iteratorDerivedUnitFactor"
	{
		// -beg- preserve=no 3949E7A200ED get_all_body3949E16F0308
		// "DerivedUnit::iteratorDerivedUnitFactor"
		return derivedUnitFactor.iterator();
		// -end- 3949E7A200ED get_all_body3949E16F0308
		// "DerivedUnit::iteratorDerivedUnitFactor"
	}
	 ...
	 * @see #addDerivedUnitFactor
	 */
	// -beg- preserve=no 3949E7A200ED remove_all_head3949E16F0308
	// "DerivedUnit::clearDerivedUnitFactor"
	public void clearDerivedUnitFactor()
	// -end- 3949E7A200ED remove_all_head3949E16F0308
	// "DerivedUnit::clearDerivedUnitFactor"
	{
		// -beg- preserve=no 3949E7A200ED remove_all_body3949E16F0308
		// "DerivedUnit::clearDerivedUnitFactor"
		if (sizeDerivedUnitFactor() > 0) {
			derivedUnitFactor.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearDerivedUnitFactor"));
		}
		// -end- 3949E7A200ED remove_all_body3949E16F0308
		// "DerivedUnit::clearDerivedUnitFactor"
	}
	 ...
	 * @see #addDerivedUnitFactor
	 */
	// -beg- preserve=no 3949E7A200ED size_head3949E16F0308
	// "DerivedUnit::sizeDerivedUnitFactor"
	public int sizeDerivedUnitFactor()
	// -end- 3949E7A200ED size_head3949E16F0308
	// "DerivedUnit::sizeDerivedUnitFactor"
	{
		// -beg- preserve=no 3949E7A200ED size_body3949E16F0308
		// "DerivedUnit::sizeDerivedUnitFactor"
		return derivedUnitFactor.size();
		// -end- 3949E7A200ED size_body3949E16F0308
		// "DerivedUnit::sizeDerivedUnitFactor"
	}
	...
	/**
	 * get current value of kind DIRECT, FACTOR oder FUNCTION
	 * 
	 * @see ch.ehi.interlis.units.DerivedUnitKind
	 * @see #setKind
	 */
	...
	/**
	 * get current value of function ErlÃ¤uterung der Funktion die verwendet
