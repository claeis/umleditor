...
public class StructuredUnitDim extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #containsUnitDef
	 */
	// -beg- preserve=no 394A243D01CA attach_head394A241103A8
	// "StructuredUnitDim::attachUnitDef"
	public void attachUnitDef(UnitDef unitDef1)
	// -end- 394A243D01CA attach_head394A241103A8
	// "StructuredUnitDim::attachUnitDef"
	{
		// -beg- preserve=no 394A243D01CA attach_body394A241103A8
		// "StructuredUnitDim::attachUnitDef"
		if (unitDef != null) {
		...
		return;
		// -end- 394A243D01CA attach_body394A241103A8
		// "StructuredUnitDim::attachUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 394A243D01CA detach_head394A241103A8
	// "StructuredUnitDim::detachUnitDef"
	public UnitDef detachUnitDef()
	// -end- 394A243D01CA detach_head394A241103A8
	// "StructuredUnitDim::detachUnitDef"
	{
		// -beg- preserve=no 394A243D01CA detach_body394A241103A8
		// "StructuredUnitDim::detachUnitDef"
		UnitDef ret = null;
		ret = unitDef;
		unitDef = null;
		...
		return ret;
		// -end- 394A243D01CA detach_body394A241103A8
		// "StructuredUnitDim::detachUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 394A243D01CA get_head394A241103A8
	// "StructuredUnitDim::getUnitDef"
	public UnitDef getUnitDef()
	// -end- 394A243D01CA get_head394A241103A8 "StructuredUnitDim::getUnitDef"
	{
		// -beg- preserve=no 394A243D01CA get_body394A241103A8
		// "StructuredUnitDim::getUnitDef"
		if (unitDef == null) {
			throw new java.lang.IllegalStateException("no unitDef attached");
		}
		return unitDef;
		// -end- 394A243D01CA get_body394A241103A8
		// "StructuredUnitDim::getUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 394A243D01CA test_head394A241103A8
	// "StructuredUnitDim::containsUnitDef"
	public boolean containsUnitDef()
	// -end- 394A243D01CA test_head394A241103A8
	// "StructuredUnitDim::containsUnitDef"
	{
		// -beg- preserve=no 394A243D01CA test_body394A241103A8
		// "StructuredUnitDim::containsUnitDef"
		return unitDef != null;
		// -end- 394A243D01CA test_body394A241103A8
		// "StructuredUnitDim::containsUnitDef"
	}
	...
	/**
	 * get current value of range from, to gesetzt?
	 * 
	 * @see #setRange
	 */
	// -beg- preserve=no 394A24400283 get_head394A241103A8 "range"
	...
	// -end- 394A24400283 set_head394A241103A8 "range"
	{
		...
		if (range != value1) {
			range = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setRange"));
		}
		// -end- 394A24400283 set_body394A241103A8 "range"
	}
	...
	/**
	 * get current value of from Untere Grenze
	 * 
	 * @see #setFrom
	 */
	// -beg- preserve=no 394A2454021D get_head394A241103A8 "from"
	...
	// -end- 394A2454021D set_head394A241103A8 "from"
	{
		...
		if (from != value1 && (from == null || !from.equals(value1))) {
			from = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setFrom"));
		}
		// -end- 394A2454021D set_body394A241103A8 "from"
	}
	...
	/**
	 * get current value of to Obere Grenze
	 * 
	 * @see #setTo
	 */
	// -beg- preserve=no 394A24580179 get_head394A241103A8 "to"
	...
	// -end- 394A24580179 set_head394A241103A8 "to"
	{
		...
		if (to != value1 && (to == null || !to.equals(value1))) {
			to = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setTo"));
		}
		// -end- 394A24580179 set_body394A241103A8 "to"
	}
