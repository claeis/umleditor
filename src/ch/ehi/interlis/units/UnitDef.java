 ...
 *  @version $Revision: 1.2 $ $Date: 2005-01-18 14:20:08 $
 */
public class UnitDef extends AbstractModelElement implements ModelElement , IliSyntax , java.io.Serializable
{
  ...
  /** add a NumericalType.
   *  
   *  @see #removeNumericalType
   *  @see #containsNumericalType
   *  @see #iteratorNumericalType
   *  @see #clearNumericalType
   *  @see #sizeNumericalType
   */
  // -beg- preserve=no 3948A0C1035D add_head3940EC1D0094 "UnitDef::addNumericalType"
  public void addNumericalType(NumericalType numericalType1)
  // -end- 3948A0C1035D add_head3940EC1D0094 "UnitDef::addNumericalType"
  {
    // -beg- preserve=no 3948A0C1035D add_body3940EC1D0094 "UnitDef::addNumericalType"
    numericalType.add(numericalType1);
    numericalType1._linkUnitDef(this);
    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addNumericalType"));
    return;
    // -end- 3948A0C1035D add_body3940EC1D0094 "UnitDef::addNumericalType"
  }

  /** disconnect a NumericalType.
   *  @see #addNumericalType
   */
  // -beg- preserve=no 3948A0C1035D remove_head3940EC1D0094 "UnitDef::removeNumericalType"
  public NumericalType removeNumericalType(NumericalType numericalType1)
  // -end- 3948A0C1035D remove_head3940EC1D0094 "UnitDef::removeNumericalType"
  {
    // -beg- preserve=no 3948A0C1035D remove_body3940EC1D0094 "UnitDef::removeNumericalType"
    NumericalType ret=null;
    if(numericalType1==null || !numericalType.contains(numericalType1)){
      throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
    }
    ret = numericalType1;
    numericalType.remove(numericalType1);
    numericalType1._unlinkUnitDef(this);
    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeNumericalType"));
    return ret;
    // -end- 3948A0C1035D remove_body3940EC1D0094 "UnitDef::removeNumericalType"
  }

  /** tests if a given NumericalType is connected.
   *  @see #addNumericalType
   */
  // -beg- preserve=no 3948A0C1035D test_head3940EC1D0094 "UnitDef::containsNumericalType"
  public boolean containsNumericalType(NumericalType numericalType1)
  // -end- 3948A0C1035D test_head3940EC1D0094 "UnitDef::containsNumericalType"
  {
    ...
    return numericalType.contains(numericalType1);
    // -end- 3948A0C1035D test_body3940EC1D0094 "UnitDef::containsNumericalType"
  }

  /** used to enumerate all connected NumericalTypes.
   *  @see #addNumericalType
   */
  // -beg- preserve=no 3948A0C1035D get_all_head3940EC1D0094 "UnitDef::iteratorNumericalType"
  public java.util.Iterator iteratorNumericalType()
  // -end- 3948A0C1035D get_all_head3940EC1D0094 "UnitDef::iteratorNumericalType"
  {
    // -beg- preserve=no 3948A0C1035D get_all_body3940EC1D0094 "UnitDef::iteratorNumericalType"
    return numericalType.iterator();
    // -end- 3948A0C1035D get_all_body3940EC1D0094 "UnitDef::iteratorNumericalType"
  }

  /** disconnect all NumericalTypes.
   *  @see #addNumericalType
   */
  // -beg- preserve=no 3948A0C1035D remove_all_head3940EC1D0094 "UnitDef::clearNumericalType"
  public void clearNumericalType()
  // -end- 3948A0C1035D remove_all_head3940EC1D0094 "UnitDef::clearNumericalType"
  {
    // -beg- preserve=no 3948A0C1035D remove_all_body3940EC1D0094 "UnitDef::clearNumericalType"
    if(sizeNumericalType()>0){
      for(java.util.Iterator p = numericalType.iterator(); p.hasNext();){
        ((NumericalType)p.next())._unlinkUnitDef(this);
      }
      numericalType.clear();
      ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearNumericalType"));
    }
    // -end- 3948A0C1035D remove_all_body3940EC1D0094 "UnitDef::clearNumericalType"
  }

  /** returns the number of NumericalTypes.
   *  @see #addNumericalType
   */
  // -beg- preserve=no 3948A0C1035D size_head3940EC1D0094 "UnitDef::sizeNumericalType"
  public int sizeNumericalType()
  // -end- 3948A0C1035D size_head3940EC1D0094 "UnitDef::sizeNumericalType"
  {
    // -beg- preserve=no 3948A0C1035D size_body3940EC1D0094 "UnitDef::sizeNumericalType"
    return numericalType.size();
    // -end- 3948A0C1035D size_body3940EC1D0094 "UnitDef::sizeNumericalType"
  }
...
public class UnitDef extends AbstractModelElement implements ModelElement, IliSyntax, java.io.Serializable {
	...
	// -end- 3D4FA2180116 throws3940EC1D0094 "unlinkAll"
	{
		...
		detachComposedUnit();
		detachStructuredUnit();
		// Role ComposedUnitFactor: ComposedUnitFactor object(s) may point to
		// this
		// Role StructuredUnitDim: StructuredUnitDim object(s) may point to this
		clearNumericalType();
		// Role NumericConst: NumericConst object(s) may point to this
	...
	// -end- 3D4FA2180120 throws3940EC1D0094 "enumerateChildren"
	{
		...
		if (containsDerivedUnit())
			visitor.visit(getDerivedUnit());
		if (containsComposedUnit())
			visitor.visit(getComposedUnit());
	 ...
	 * @see #createNamespaceLink
	 */
	// -beg- preserve=no 33598CAA030E attach_head3940EC1D0094
	// "ModelElement::attachNamespace"
	public void attachNamespace(Namespace namespace1)
	// -end- 33598CAA030E attach_head3940EC1D0094
	// "ModelElement::attachNamespace"
	{
		// -beg- preserve=no 33598CAA030E attach_body3940EC1D0094
		// "ModelElement::attachNamespace"
		super.attachNamespace(namespace1);
		// -end- 33598CAA030E attach_body3940EC1D0094
		// "ModelElement::attachNamespace"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E attachlink_head3940EC1D0094
	// "ModelElement::attachNamespaceLink"
	public void attachNamespaceLink(ElementOwnership namespace1)
	// -end- 33598CAA030E attachlink_head3940EC1D0094
	// "ModelElement::attachNamespaceLink"
	{
		// -beg- preserve=no 33598CAA030E attachlink_body3940EC1D0094
		// "ModelElement::attachNamespaceLink"
		super.attachNamespaceLink(namespace1);
		// -end- 33598CAA030E attachlink_body3940EC1D0094
		// "ModelElement::attachNamespaceLink"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E detach_head3940EC1D0094
	// "ModelElement::detachNamespace"
	public Namespace detachNamespace()
	// -end- 33598CAA030E detach_head3940EC1D0094
	// "ModelElement::detachNamespace"
	{
		// -beg- preserve=no 33598CAA030E detach_body3940EC1D0094
		// "ModelElement::detachNamespace"
		return super.detachNamespace();
		// -end- 33598CAA030E detach_body3940EC1D0094
		// "ModelElement::detachNamespace"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E get_head3940EC1D0094
	// "ModelElement::getNamespace"
	public Namespace getNamespace()
	// -end- 33598CAA030E get_head3940EC1D0094 "ModelElement::getNamespace"
	{
		// -beg- preserve=no 33598CAA030E get_body3940EC1D0094
		// "ModelElement::getNamespace"
		return super.getNamespace();
		// -end- 33598CAA030E get_body3940EC1D0094 "ModelElement::getNamespace"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E getlink_head3940EC1D0094
	// "ModelElement::getNamespaceLink"
	public ElementOwnership getNamespaceLink()
	// -end- 33598CAA030E getlink_head3940EC1D0094
	// "ModelElement::getNamespaceLink"
	{
		// -beg- preserve=no 33598CAA030E getlink_body3940EC1D0094
		// "ModelElement::getNamespaceLink"
		return super.getNamespaceLink();
		// -end- 33598CAA030E getlink_body3940EC1D0094
		// "ModelElement::getNamespaceLink"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E createlink_head3940EC1D0094
	// "ModelElement::createNamespaceLink"
	public ElementOwnership createNamespaceLink()
	// -end- 33598CAA030E createlink_head3940EC1D0094
	// "ModelElement::createNamespaceLink"
	{
		// -beg- preserve=no 33598CAA030E createlink_body3940EC1D0094
		// "ModelElement::createNamespaceLink"
		return super.createNamespaceLink();
		// -end- 33598CAA030E createlink_body3940EC1D0094
		// "ModelElement::createNamespaceLink"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E test_head3940EC1D0094
	// "ModelElement::containsNamespace"
	public boolean containsNamespace()
	// -end- 33598CAA030E test_head3940EC1D0094
	// "ModelElement::containsNamespace"
	{
		// -beg- preserve=no 33598CAA030E test_body3940EC1D0094
		// "ModelElement::containsNamespace"
		return super.containsNamespace();
		// -end- 33598CAA030E test_body3940EC1D0094
		// "ModelElement::containsNamespace"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 33598CAA030E _link_body3940EC1D0094
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 33598CAA030E _unlink_body3940EC1D0094
	// "ModelElement::_unlinkNamespace"
	public void _unlinkNamespace(ElementOwnership namespace1) {
		super._unlinkNamespace(namespace1);
	}
	// -end- 33598CAA030E _unlink_body3940EC1D0094
	// "ModelElement::_unlinkNamespace"
	 ...
	 * @see #contains_extends
	 */
	// -beg- preserve=no 3949E03F01AC attach_head3940EC1D0094
	// "UnitDef::attach_extends"
	public void attach_extends(UnitDef _extends1)
	// -end- 3949E03F01AC attach_head3940EC1D0094 "UnitDef::attach_extends"
	{
		// -beg- preserve=no 3949E03F01AC attach_body3940EC1D0094
		// "UnitDef::attach_extends"
		if (_extends != null) {
	 ...
	 * @see #attach_extends
	 */
	// -beg- preserve=no 3949E03F01AC detach_head3940EC1D0094
	// "UnitDef::detach_extends"
	public UnitDef detach_extends()
	// -end- 3949E03F01AC detach_head3940EC1D0094 "UnitDef::detach_extends"
	{
		// -beg- preserve=no 3949E03F01AC detach_body3940EC1D0094
		// "UnitDef::detach_extends"
		UnitDef ret = null;
		ret = _extends;
		_extends = null;
	 ...
	 * @see #attach_extends
	 */
	// -beg- preserve=no 3949E03F01AC get_head3940EC1D0094
	// "UnitDef::get_extends"
	public UnitDef get_extends()
	// -end- 3949E03F01AC get_head3940EC1D0094 "UnitDef::get_extends"
	{
		// -beg- preserve=no 3949E03F01AC get_body3940EC1D0094
		// "UnitDef::get_extends"
		if (_extends == null) {
	 ...
	 * @see #attach_extends
	 */
	// -beg- preserve=no 3949E03F01AC test_head3940EC1D0094
	// "UnitDef::contains_extends"
	public boolean contains_extends()
	// -end- 3949E03F01AC test_head3940EC1D0094 "UnitDef::contains_extends"
	{
		// -beg- preserve=no 3949E03F01AC test_body3940EC1D0094
		// "UnitDef::contains_extends"
		return _extends != null;
		// -end- 3949E03F01AC test_body3940EC1D0094 "UnitDef::contains_extends"
	}
	 ...
	 * @see #containsDerivedUnit
	 */
	// -beg- preserve=no 3949E1A2012A attach_head3940EC1D0094
	// "UnitDef::attachDerivedUnit"
	public void attachDerivedUnit(DerivedUnit derivedUnit1)
	// -end- 3949E1A2012A attach_head3940EC1D0094 "UnitDef::attachDerivedUnit"
	{
		// -beg- preserve=no 3949E1A2012A attach_body3940EC1D0094
		// "UnitDef::attachDerivedUnit"
		if (derivedUnit != null) {
			throw new java.lang.IllegalStateException("already a derivedUnit attached");
		}
		if (derivedUnit1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as derivedUnit");
		}
		derivedUnit = derivedUnit1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachDerivedUnit"));
		return;
		// -end- 3949E1A2012A attach_body3940EC1D0094
		// "UnitDef::attachDerivedUnit"
	}
	 ...
	 * @see #attachDerivedUnit
	 */
	// -beg- preserve=no 3949E1A2012A detach_head3940EC1D0094
	// "UnitDef::detachDerivedUnit"
	public DerivedUnit detachDerivedUnit()
	// -end- 3949E1A2012A detach_head3940EC1D0094 "UnitDef::detachDerivedUnit"
	{
		// -beg- preserve=no 3949E1A2012A detach_body3940EC1D0094
		// "UnitDef::detachDerivedUnit"
		DerivedUnit ret = null;
		ret = derivedUnit;
		derivedUnit = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachDerivedUnit"));
		return ret;
		// -end- 3949E1A2012A detach_body3940EC1D0094
		// "UnitDef::detachDerivedUnit"
	}
	 ...
	 * @see #attachDerivedUnit
	 */
	// -beg- preserve=no 3949E1A2012A get_head3940EC1D0094
	// "UnitDef::getDerivedUnit"
	public DerivedUnit getDerivedUnit()
	// -end- 3949E1A2012A get_head3940EC1D0094 "UnitDef::getDerivedUnit"
	{
		// -beg- preserve=no 3949E1A2012A get_body3940EC1D0094
		// "UnitDef::getDerivedUnit"
		if (derivedUnit == null) {
			throw new java.lang.IllegalStateException("no derivedUnit attached");
		}
		return derivedUnit;
		// -end- 3949E1A2012A get_body3940EC1D0094 "UnitDef::getDerivedUnit"
	}
	 ...
	 * @see #attachDerivedUnit
	 */
	// -beg- preserve=no 3949E1A2012A test_head3940EC1D0094
	// "UnitDef::containsDerivedUnit"
	public boolean containsDerivedUnit()
	// -end- 3949E1A2012A test_head3940EC1D0094 "UnitDef::containsDerivedUnit"
	{
		// -beg- preserve=no 3949E1A2012A test_body3940EC1D0094
		// "UnitDef::containsDerivedUnit"
		return derivedUnit != null;
		// -end- 3949E1A2012A test_body3940EC1D0094
		// "UnitDef::containsDerivedUnit"
	}
	 ...
	 * @see #containsComposedUnit
	 */
	// -beg- preserve=no 3949E1A500F3 attach_head3940EC1D0094
	// "UnitDef::attachComposedUnit"
	public void attachComposedUnit(ComposedUnit composedUnit1)
	// -end- 3949E1A500F3 attach_head3940EC1D0094 "UnitDef::attachComposedUnit"
	{
		// -beg- preserve=no 3949E1A500F3 attach_body3940EC1D0094
		// "UnitDef::attachComposedUnit"
		if (composedUnit != null) {
			throw new java.lang.IllegalStateException("already a composedUnit attached");
		}
		if (composedUnit1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as composedUnit");
		}
		composedUnit = composedUnit1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachComposedUnit"));
		return;
		// -end- 3949E1A500F3 attach_body3940EC1D0094
		// "UnitDef::attachComposedUnit"
	}
	 ...
	 * @see #attachComposedUnit
	 */
	// -beg- preserve=no 3949E1A500F3 detach_head3940EC1D0094
	// "UnitDef::detachComposedUnit"
	public ComposedUnit detachComposedUnit()
	// -end- 3949E1A500F3 detach_head3940EC1D0094 "UnitDef::detachComposedUnit"
	{
		// -beg- preserve=no 3949E1A500F3 detach_body3940EC1D0094
		// "UnitDef::detachComposedUnit"
		ComposedUnit ret = null;
		ret = composedUnit;
		composedUnit = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachComposedUnit"));
		return ret;
		// -end- 3949E1A500F3 detach_body3940EC1D0094
		// "UnitDef::detachComposedUnit"
	}
	 ...
	 * @see #attachComposedUnit
	 */
	// -beg- preserve=no 3949E1A500F3 get_head3940EC1D0094
	// "UnitDef::getComposedUnit"
	public ComposedUnit getComposedUnit()
	// -end- 3949E1A500F3 get_head3940EC1D0094 "UnitDef::getComposedUnit"
	{
		// -beg- preserve=no 3949E1A500F3 get_body3940EC1D0094
		// "UnitDef::getComposedUnit"
		if (composedUnit == null) {
			throw new java.lang.IllegalStateException("no composedUnit attached");
		}
		return composedUnit;
		// -end- 3949E1A500F3 get_body3940EC1D0094 "UnitDef::getComposedUnit"
	}
	 ...
	 * @see #attachComposedUnit
	 */
	// -beg- preserve=no 3949E1A500F3 test_head3940EC1D0094
	// "UnitDef::containsComposedUnit"
	public boolean containsComposedUnit()
	// -end- 3949E1A500F3 test_head3940EC1D0094 "UnitDef::containsComposedUnit"
	{
		// -beg- preserve=no 3949E1A500F3 test_body3940EC1D0094
		// "UnitDef::containsComposedUnit"
		return composedUnit != null;
		// -end- 3949E1A500F3 test_body3940EC1D0094
		// "UnitDef::containsComposedUnit"
	}
	 ...
	 * @see #containsStructuredUnit
	 */
	// -beg- preserve=no 3949E1A80133 attach_head3940EC1D0094
	// "UnitDef::attachStructuredUnit"
	public void attachStructuredUnit(StructuredUnit structuredUnit1)
	// -end- 3949E1A80133 attach_head3940EC1D0094
	// "UnitDef::attachStructuredUnit"
	{
		// -beg- preserve=no 3949E1A80133 attach_body3940EC1D0094
		// "UnitDef::attachStructuredUnit"
		if (structuredUnit != null) {
			throw new java.lang.IllegalStateException("already a structuredUnit attached");
		}
		if (structuredUnit1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as structuredUnit");
		}
		structuredUnit = structuredUnit1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachStructuredUnit"));
		return;
		// -end- 3949E1A80133 attach_body3940EC1D0094
		// "UnitDef::attachStructuredUnit"
	}
	 ...
	 * @see #attachStructuredUnit
	 */
	// -beg- preserve=no 3949E1A80133 detach_head3940EC1D0094
	// "UnitDef::detachStructuredUnit"
	public StructuredUnit detachStructuredUnit()
	// -end- 3949E1A80133 detach_head3940EC1D0094
	// "UnitDef::detachStructuredUnit"
	{
		// -beg- preserve=no 3949E1A80133 detach_body3940EC1D0094
		// "UnitDef::detachStructuredUnit"
		StructuredUnit ret = null;
		ret = structuredUnit;
		structuredUnit = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachStructuredUnit"));
		return ret;
		// -end- 3949E1A80133 detach_body3940EC1D0094
		// "UnitDef::detachStructuredUnit"
	}
	 ...
	 * @see #attachStructuredUnit
	 */
	// -beg- preserve=no 3949E1A80133 get_head3940EC1D0094
	// "UnitDef::getStructuredUnit"
	public StructuredUnit getStructuredUnit()
	// -end- 3949E1A80133 get_head3940EC1D0094 "UnitDef::getStructuredUnit"
	{
		// -beg- preserve=no 3949E1A80133 get_body3940EC1D0094
		// "UnitDef::getStructuredUnit"
		if (structuredUnit == null) {
			throw new java.lang.IllegalStateException("no structuredUnit attached");
		}
		return structuredUnit;
		// -end- 3949E1A80133 get_body3940EC1D0094 "UnitDef::getStructuredUnit"
	}
	 ...
	 * @see #attachStructuredUnit
	 */
	// -beg- preserve=no 3949E1A80133 test_head3940EC1D0094
	// "UnitDef::containsStructuredUnit"
	public boolean containsStructuredUnit()
	// -end- 3949E1A80133 test_head3940EC1D0094
	// "UnitDef::containsStructuredUnit"
	{
		// -beg- preserve=no 3949E1A80133 test_body3940EC1D0094
		// "UnitDef::containsStructuredUnit"
		return structuredUnit != null;
		// -end- 3949E1A80133 test_body3940EC1D0094
		// "UnitDef::containsStructuredUnit"
	}
	 ...
	 * @see #sizeNumericalType
	 */
	// -beg- preserve=no 3948A0C1035D add_head3940EC1D0094
	// "UnitDef::addNumericalType"
	public void addNumericalType(NumericalType numericalType1)
	// -end- 3948A0C1035D add_head3940EC1D0094 "UnitDef::addNumericalType"
	{
		// -beg- preserve=no 3948A0C1035D add_body3940EC1D0094
		// "UnitDef::addNumericalType"
		numericalType.add(numericalType1);
		numericalType1._linkUnitDef(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addNumericalType"));
		return;
		// -end- 3948A0C1035D add_body3940EC1D0094 "UnitDef::addNumericalType"
	}
	 ...
	 * @see #addNumericalType
	 */
	// -beg- preserve=no 3948A0C1035D remove_head3940EC1D0094
	// "UnitDef::removeNumericalType"
	public NumericalType removeNumericalType(NumericalType numericalType1)
	// -end- 3948A0C1035D remove_head3940EC1D0094 "UnitDef::removeNumericalType"
	{
		// -beg- preserve=no 3948A0C1035D remove_body3940EC1D0094
		// "UnitDef::removeNumericalType"
		NumericalType ret = null;
		if (numericalType1 == null || !numericalType.contains(numericalType1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		numericalType1._unlinkUnitDef(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeNumericalType"));
		return ret;
		// -end- 3948A0C1035D remove_body3940EC1D0094
		// "UnitDef::removeNumericalType"
	}
	 ...
	 * @see #addNumericalType
	 */
	// -beg- preserve=no 3948A0C1035D test_head3940EC1D0094
	// "UnitDef::containsNumericalType"
	public boolean containsNumericalType(NumericalType numericalType1)
	// -end- 3948A0C1035D test_head3940EC1D0094 "UnitDef::containsNumericalType"
	{
		// -beg- preserve=no 3948A0C1035D test_body3940EC1D0094
		// "UnitDef::containsNumericalType"
		return numericalType.contains(numericalType1);
		// -end- 3948A0C1035D test_body3940EC1D0094
		// "UnitDef::containsNumericalType"
	}
	...
	// "UnitDef::iteratorNumericalType"
	{
		// -beg- preserve=no 3948A0C1035D get_all_body3940EC1D0094
		// "UnitDef::iteratorNumericalType"
		return numericalType.iterator();
		// -end- 3948A0C1035D get_all_body3940EC1D0094
		// "UnitDef::iteratorNumericalType"
	}
	 ...
	 * @see #addNumericalType
	 */
	// -beg- preserve=no 3948A0C1035D remove_all_head3940EC1D0094
	// "UnitDef::clearNumericalType"
	public void clearNumericalType()
	// -end- 3948A0C1035D remove_all_head3940EC1D0094
	// "UnitDef::clearNumericalType"
	{
		...
		if (sizeNumericalType() > 0) {
			...
			numericalType.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearNumericalType"));
		}
		// -end- 3948A0C1035D remove_all_body3940EC1D0094
		// "UnitDef::clearNumericalType"
	}
	 ...
	 * @see #addNumericalType
	 */
	// -beg- preserve=no 3948A0C1035D size_head3940EC1D0094
	// "UnitDef::sizeNumericalType"
	public int sizeNumericalType()
	// -end- 3948A0C1035D size_head3940EC1D0094 "UnitDef::sizeNumericalType"
	{
		// -beg- preserve=no 3948A0C1035D size_body3940EC1D0094
		// "UnitDef::sizeNumericalType"
		return numericalType.size();
		// -end- 3948A0C1035D size_body3940EC1D0094 "UnitDef::sizeNumericalType"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3948A0C1035D _link_body3940EC1D0094
	// "UnitDef::_linkNumericalType"
	public void _linkNumericalType(NumericalType numericalType1) {
		numericalType.add(numericalType1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkNumericalType"));
		return;
	}
	// -end- 3948A0C1035D _link_body3940EC1D0094 "UnitDef::_linkNumericalType"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3948A0C1035D _unlink_body3940EC1D0094
	// "UnitDef::_unlinkNumericalType"
	public void _unlinkNumericalType(NumericalType numericalType1) {
		numericalType.remove(numericalType1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkNumericalType"));
		return;
	}
	// -end- 3948A0C1035D _unlink_body3940EC1D0094
	// "UnitDef::_unlinkNumericalType"
	...
	/**
	 * get current value of name short name of the unit
	 * 
	 * @see #setName
	 */
	// -beg- preserve=no 3949DF3B00EA get_head3940EC1D0094 "name"
	...
	/**
	 * get current value of descName descriptive name of the unit.
	 * 
	 * @see #setDescName
	 */
	// -beg- preserve=no 3949DF400029 get_head3940EC1D0094 "descName"
	...
	// -end- 3949DF400029 set_head3940EC1D0094 "descName"
	{
		...
		if (descName != value1 && (descName == null || !descName.equals(value1))) {
			descName = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setDescName"));
		}
		// -end- 3949DF400029 set_body3940EC1D0094 "descName"
	}
	...
	/**
	 * get current value of isAbstract Abstrakte Einheit?
	 * 
	 * @see #setAbstract
	 */
	// -beg- preserve=no 3949DF46024E get_head3940EC1D0094 "isAbstract"
