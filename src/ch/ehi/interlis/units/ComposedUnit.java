...
public class ComposedUnit extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 394A21150129 add_head3949E17C0356
	// "ComposedUnit::addComposedUnitFactor"
	public void addComposedUnitFactor(ComposedUnitFactor composedUnitFactor1)
	// -end- 394A21150129 add_head3949E17C0356
	// "ComposedUnit::addComposedUnitFactor"
	{
		// -beg- preserve=no 394A21150129 add_body3949E17C0356
		// "ComposedUnit::addComposedUnitFactor"
		composedUnitFactor.add(composedUnitFactor1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addComposedUnitFactor"));
		return;
		// -end- 394A21150129 add_body3949E17C0356
		// "ComposedUnit::addComposedUnitFactor"
	}
	 ...
	 */
	// -beg- preserve=no 394A21150129 remove_head3949E17C0356
	// "ComposedUnit::removeComposedUnitFactor"
	public ComposedUnitFactor removeComposedUnitFactor(ComposedUnitFactor composedUnitFactor1)
	// -end- 394A21150129 remove_head3949E17C0356
	// "ComposedUnit::removeComposedUnitFactor"
	{
		// -beg- preserve=no 394A21150129 remove_body3949E17C0356
		// "ComposedUnit::removeComposedUnitFactor"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeComposedUnitFactor"));
		return ret;
		// -end- 394A21150129 remove_body3949E17C0356
		// "ComposedUnit::removeComposedUnitFactor"
	}
	 ...
	 * @see #addComposedUnitFactor
	 */
	// -beg- preserve=no 394A21150129 test_head3949E17C0356
	// "ComposedUnit::containsComposedUnitFactor"
	public boolean containsComposedUnitFactor(ComposedUnitFactor composedUnitFactor1)
	// -end- 394A21150129 test_head3949E17C0356
	// "ComposedUnit::containsComposedUnitFactor"
	{
		// -beg- preserve=no 394A21150129 test_body3949E17C0356
		// "ComposedUnit::containsComposedUnitFactor"
		return composedUnitFactor.contains(composedUnitFactor1);
		// -end- 394A21150129 test_body3949E17C0356
		// "ComposedUnit::containsComposedUnitFactor"
	}
	...
	// "ComposedUnit::iteratorComposedUnitFactor"
	{
		// -beg- preserve=no 394A21150129 get_all_body3949E17C0356
		// "ComposedUnit::iteratorComposedUnitFactor"
		return composedUnitFactor.iterator();
		// -end- 394A21150129 get_all_body3949E17C0356
		// "ComposedUnit::iteratorComposedUnitFactor"
	}
	 ...
	 * @see #addComposedUnitFactor
	 */
	// -beg- preserve=no 394A21150129 remove_all_head3949E17C0356
	// "ComposedUnit::clearComposedUnitFactor"
	public void clearComposedUnitFactor()
	// -end- 394A21150129 remove_all_head3949E17C0356
	// "ComposedUnit::clearComposedUnitFactor"
	{
		// -beg- preserve=no 394A21150129 remove_all_body3949E17C0356
		// "ComposedUnit::clearComposedUnitFactor"
		if (sizeComposedUnitFactor() > 0) {
			composedUnitFactor.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearComposedUnitFactor"));
		}
		// -end- 394A21150129 remove_all_body3949E17C0356
		// "ComposedUnit::clearComposedUnitFactor"
	}
	 ...
	 * @see #addComposedUnitFactor
	 */
	// -beg- preserve=no 394A21150129 size_head3949E17C0356
	// "ComposedUnit::sizeComposedUnitFactor"
	public int sizeComposedUnitFactor()
	// -end- 394A21150129 size_head3949E17C0356
	// "ComposedUnit::sizeComposedUnitFactor"
	{
		// -beg- preserve=no 394A21150129 size_body3949E17C0356
		// "ComposedUnit::sizeComposedUnitFactor"
		return composedUnitFactor.size();
		// -end- 394A21150129 size_body3949E17C0356
		// "ComposedUnit::sizeComposedUnitFactor"
	}
