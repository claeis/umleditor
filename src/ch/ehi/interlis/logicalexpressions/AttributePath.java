...
public class AttributePath extends AbstractEditorElement implements java.io.Serializable
          {
            ...
            // -end- 3D4FA2180257 head39609BF90168 "unlinkAll"
              ...
              // Role AttributeValueUsage: AttributeValueUsage object(s) may point to this
              super.unlinkAll();
            ...
            // -end- 3D4FA2180261 head39609BF90168 "enumerateChildren"
              ...
              it=iteratorAttributeRef();while(it.hasNext())visitor.visit(it.next());
             ...
             */
            // -beg- preserve=no 3960A72D02A3 attach_head39609BF90168 "AttributePath::attachViewableDef"
            public void attachViewableDef(ViewableDef viewableDef1)
            // -end- 3960A72D02A3 attach_head39609BF90168 "AttributePath::attachViewableDef"
            {
              // -beg- preserve=no 3960A72D02A3 attach_body39609BF90168 "AttributePath::attachViewableDef"
              ...
              return;
              // -end- 3960A72D02A3 attach_body39609BF90168 "AttributePath::attachViewableDef"
            }

            /** disconnect the currently attached ViewableDef.
             *  @see #attachViewableDef
             */
            // -beg- preserve=no 3960A72D02A3 detach_head39609BF90168 "AttributePath::detachViewableDef"
            public ViewableDef detachViewableDef()
            // -end- 3960A72D02A3 detach_head39609BF90168 "AttributePath::detachViewableDef"
            {
              // -beg- preserve=no 3960A72D02A3 detach_body39609BF90168 "AttributePath::detachViewableDef"
              ...
              return ret;
              // -end- 3960A72D02A3 detach_body39609BF90168 "AttributePath::detachViewableDef"
            }

            /** get the currently attached ViewableDef.
             *  @see #attachViewableDef
             */
            // -beg- preserve=no 3960A72D02A3 get_head39609BF90168 "AttributePath::getViewableDef"
            public ViewableDef getViewableDef()
            // -end- 3960A72D02A3 get_head39609BF90168 "AttributePath::getViewableDef"
            {
              // -beg- preserve=no 3960A72D02A3 get_body39609BF90168 "AttributePath::getViewableDef"
              if(viewableDef==null) {throw new java.lang.IllegalStateException("no viewableDef attached");}
              return viewableDef;
              // -end- 3960A72D02A3 get_body39609BF90168 "AttributePath::getViewableDef"
            }

            /** tests if there is a ViewableDef attached.
             *  @see #attachViewableDef
             */
            // -beg- preserve=no 3960A72D02A3 test_head39609BF90168 "AttributePath::containsViewableDef"
            public boolean containsViewableDef()
            // -end- 3960A72D02A3 test_head39609BF90168 "AttributePath::containsViewableDef"
            {
              // -beg- preserve=no 3960A72D02A3 test_body39609BF90168 "AttributePath::containsViewableDef"
              return viewableDef!=null;
              // -end- 3960A72D02A3 test_body39609BF90168 "AttributePath::containsViewableDef"
            }
             ...
             */
            // -beg- preserve=no 3960A74B0378 add_head39609BF90168 "AttributePath::addAttributeRef"
            ...
            {
              // -beg- preserve=no 3960A74B0378 add_body39609BF90168 "AttributePath::addAttributeRef"
              attributeRef.add(attributeRef1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addAttributeRef"));
              return;
              // -end- 3960A74B0378 add_body39609BF90168 "AttributePath::addAttributeRef"
            }

            /** disconnect a AttributeRef.
             *  @see #addAttributeRef
             */
            // -beg- preserve=no 3960A74B0378 remove_head39609BF90168 "AttributePath::removeAttributeRef"
            public AttributeRef removeAttributeRef(AttributeRef attributeRef1)
            // -end- 3960A74B0378 remove_head39609BF90168 "AttributePath::removeAttributeRef"
            {
              // -beg- preserve=no 3960A74B0378 remove_body39609BF90168 "AttributePath::removeAttributeRef"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeAttributeRef"));
              return ret;
              // -end- 3960A74B0378 remove_body39609BF90168 "AttributePath::removeAttributeRef"
            }

            /** tests if a given AttributeRef is connected.
             *  @see #addAttributeRef
             */
            // -beg- preserve=no 3960A74B0378 test_head39609BF90168 "AttributePath::containsAttributeRef"
            public boolean containsAttributeRef(AttributeRef attributeRef1)
            // -end- 3960A74B0378 test_head39609BF90168 "AttributePath::containsAttributeRef"
            {
              // -beg- preserve=no 3960A74B0378 test_body39609BF90168 "AttributePath::containsAttributeRef"
              return attributeRef.contains(attributeRef1);
              // -end- 3960A74B0378 test_body39609BF90168 "AttributePath::containsAttributeRef"
            }

            /** used to enumerate all connected AttributeRefs.
             *  @see #addAttributeRef
             */
            // -beg- preserve=no 3960A74B0378 get_all_head39609BF90168 "AttributePath::iteratorAttributeRef"
            public java.util.Iterator iteratorAttributeRef()
            // -end- 3960A74B0378 get_all_head39609BF90168 "AttributePath::iteratorAttributeRef"
            {
              // -beg- preserve=no 3960A74B0378 get_all_body39609BF90168 "AttributePath::iteratorAttributeRef"
              return attributeRef.iterator();
              // -end- 3960A74B0378 get_all_body39609BF90168 "AttributePath::iteratorAttributeRef"
            }

            /** disconnect all AttributeRefs.
             *  @see #addAttributeRef
             */
            // -beg- preserve=no 3960A74B0378 remove_all_head39609BF90168 "AttributePath::clearAttributeRef"
            public void clearAttributeRef()
            // -end- 3960A74B0378 remove_all_head39609BF90168 "AttributePath::clearAttributeRef"
            {
              // -beg- preserve=no 3960A74B0378 remove_all_body39609BF90168 "AttributePath::clearAttributeRef"
              if(sizeAttributeRef()>0){
                attributeRef.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearAttributeRef"));
              }
              // -end- 3960A74B0378 remove_all_body39609BF90168 "AttributePath::clearAttributeRef"
            }

            /** returns the number of AttributeRefs.
             *  @see #addAttributeRef
             */
            // -beg- preserve=no 3960A74B0378 size_head39609BF90168 "AttributePath::sizeAttributeRef"
            public int sizeAttributeRef()
            // -end- 3960A74B0378 size_head39609BF90168 "AttributePath::sizeAttributeRef"
            {
              // -beg- preserve=no 3960A74B0378 size_body39609BF90168 "AttributePath::sizeAttributeRef"
              return attributeRef.size();
              // -end- 3960A74B0378 size_body39609BF90168 "AttributePath::sizeAttributeRef"
            }
