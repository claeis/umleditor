...
public class FunctionCall extends AbstractEditorElement implements IliSyntax , java.io.Serializable
          {
             ...
             *  @see #sizeArgument
             */
            // -beg- preserve=no 3960AE5B0006 add_head394744420142 "FunctionCall::addArgument"
            public void addArgument(Term argument1)
            // -end- 3960AE5B0006 add_head394744420142 "FunctionCall::addArgument"
            {
              // -beg- preserve=no 3960AE5B0006 add_body394744420142 "FunctionCall::addArgument"
             ...
             *  @see #addArgument
             */
            // -beg- preserve=no 3960AE5B0006 remove_head394744420142 "FunctionCall::removeArgument"
            public Term removeArgument(Term argument1)
            // -end- 3960AE5B0006 remove_head394744420142 "FunctionCall::removeArgument"
            {
              // -beg- preserve=no 3960AE5B0006 remove_body394744420142 "FunctionCall::removeArgument"
              Term ret=null;
              ...
              return ret;
              // -end- 3960AE5B0006 remove_body394744420142 "FunctionCall::removeArgument"
            }

            /** tests if a given Argument is connected.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960AE5B0006 test_head394744420142 "FunctionCall::containsArgument"
            public boolean containsArgument(Term argument1)
            // -end- 3960AE5B0006 test_head394744420142 "FunctionCall::containsArgument"
            {
              // -beg- preserve=no 3960AE5B0006 test_body394744420142 "FunctionCall::containsArgument"
              return argument.contains(argument1);
              // -end- 3960AE5B0006 test_body394744420142 "FunctionCall::containsArgument"
            }

            /** used to enumerate all connected Arguments.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960AE5B0006 get_all_head394744420142 "FunctionCall::iteratorArgument"
            public java.util.Iterator iteratorArgument()
            // -end- 3960AE5B0006 get_all_head394744420142 "FunctionCall::iteratorArgument"
            {
              // -beg- preserve=no 3960AE5B0006 get_all_body394744420142 "FunctionCall::iteratorArgument"
              return argument.iterator();
              // -end- 3960AE5B0006 get_all_body394744420142 "FunctionCall::iteratorArgument"
            }

            /** disconnect all Arguments.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960AE5B0006 remove_all_head394744420142 "FunctionCall::clearArgument"
            public void clearArgument()
            // -end- 3960AE5B0006 remove_all_head394744420142 "FunctionCall::clearArgument"
            {
              // -beg- preserve=no 3960AE5B0006 remove_all_body394744420142 "FunctionCall::clearArgument"
              if(sizeArgument()>0){
                argument.clear();
              ...
              // -end- 3960AE5B0006 remove_all_body394744420142 "FunctionCall::clearArgument"
            }

            /** returns the number of Arguments.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960AE5B0006 size_head394744420142 "FunctionCall::sizeArgument"
            public int sizeArgument()
            // -end- 3960AE5B0006 size_head394744420142 "FunctionCall::sizeArgument"
            {
              // -beg- preserve=no 3960AE5B0006 size_body394744420142 "FunctionCall::sizeArgument"
             ...
             */
            // -beg- preserve=no 396C86B203B7 attach_head394744420142 "FunctionCall::attachFunctionDef"
            public void attachFunctionDef(FunctionDef functionDef1)
            // -end- 396C86B203B7 attach_head394744420142 "FunctionCall::attachFunctionDef"
            {
              // -beg- preserve=no 396C86B203B7 attach_body394744420142 "FunctionCall::attachFunctionDef"
              if(functionDef!=null) {throw new java.lang.IllegalStateException("already a functionDef attached");}
              if(functionDef1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as functionDef");}
              functionDef = functionDef1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachFunctionDef"));
              return;
              // -end- 396C86B203B7 attach_body394744420142 "FunctionCall::attachFunctionDef"
            }

            /** disconnect the currently attached FunctionDef.
             *  @see #attachFunctionDef
             */
            // -beg- preserve=no 396C86B203B7 detach_head394744420142 "FunctionCall::detachFunctionDef"
            public FunctionDef detachFunctionDef()
            // -end- 396C86B203B7 detach_head394744420142 "FunctionCall::detachFunctionDef"
            {
              // -beg- preserve=no 396C86B203B7 detach_body394744420142 "FunctionCall::detachFunctionDef"
              FunctionDef ret = null;
              ret = functionDef;
              functionDef = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachFunctionDef"));
              return ret;
              // -end- 396C86B203B7 detach_body394744420142 "FunctionCall::detachFunctionDef"
            }

            /** get the currently attached FunctionDef.
             *  @see #attachFunctionDef
             */
            // -beg- preserve=no 396C86B203B7 get_head394744420142 "FunctionCall::getFunctionDef"
            public FunctionDef getFunctionDef()
            // -end- 396C86B203B7 get_head394744420142 "FunctionCall::getFunctionDef"
            {
              // -beg- preserve=no 396C86B203B7 get_body394744420142 "FunctionCall::getFunctionDef"
              if(functionDef==null) {throw new java.lang.IllegalStateException("no functionDef attached");}
              return functionDef;
              // -end- 396C86B203B7 get_body394744420142 "FunctionCall::getFunctionDef"
            }

            /** tests if there is a FunctionDef attached.
             *  @see #attachFunctionDef
             */
            // -beg- preserve=no 396C86B203B7 test_head394744420142 "FunctionCall::containsFunctionDef"
            public boolean containsFunctionDef()
            // -end- 396C86B203B7 test_head394744420142 "FunctionCall::containsFunctionDef"
            {
              // -beg- preserve=no 396C86B203B7 test_body394744420142 "FunctionCall::containsFunctionDef"
              return functionDef!=null;
              // -end- 396C86B203B7 test_body394744420142 "FunctionCall::containsFunctionDef"
            }
             ...
             *  Name des Modells in dem die Funktion definiert ist.
             *  @see #setModel
             */
            ...
            // -end- 3960AE030186 set_head394744420142 "model"
            {
              ...
              if(model!=value1 && (model==null || !model.equals(value1))){
                model = value1;
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setModel"));
              }
