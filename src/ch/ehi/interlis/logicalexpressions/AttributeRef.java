...
public class AttributeRef extends AbstractEditorElement implements java.io.Serializable
          {
             ...
             *  ATTRNAME, THISAREA, THATAREA, OBJECT, PARENT oder AXIS
             ...
             *  Name des Attributs wenn kind==ATTRNAME
             *  @see #setAttribute
             */
            ...
            // -end- 3960ACA900C1 set_head3960A740025A "attribute"
            {
              ...
              if(attribute!=value1 && (attribute==null || !attribute.equals(value1))){
                attribute = value1;
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setAttribute"));
              }
             ...
             *  Nummer der Achse wenn kind==AXIS
             *  @see #setAxis
             */
