...
public class Factor extends AbstractEditorElement implements java.io.Serializable
          {
            ...
            // -end- 3D4FA2180224 head394A41E30033 "enumerateChildren"
              ...
              if(containsElement())visitor.visit(getElement());
              if(containsSubterm())visitor.visit(getSubterm());
              it=iteratorExistsin();while(it.hasNext())visitor.visit(it.next());
              if(containsRestrictedto())visitor.visit(getRestrictedto());
             ...
             *  @see #containsElement
             */
            // -beg- preserve=no 39609BB50111 attach_head394A41E30033 "Factor::attachElement"
            public void attachElement(FactElement element1)
            // -end- 39609BB50111 attach_head394A41E30033 "Factor::attachElement"
            {
              // -beg- preserve=no 39609BB50111 attach_body394A41E30033 "Factor::attachElement"
              if(element!=null) {throw new java.lang.IllegalStateException("already a element attached");}
              if(element1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as element");}
              element = element1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachElement"));
              return;
             ...
             *  @see #attachElement
             */
            // -beg- preserve=no 39609BB50111 detach_head394A41E30033 "Factor::detachElement"
            public FactElement detachElement()
            // -end- 39609BB50111 detach_head394A41E30033 "Factor::detachElement"
            {
              // -beg- preserve=no 39609BB50111 detach_body394A41E30033 "Factor::detachElement"
              FactElement ret = null;
              ret = element;
              element = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachElement"));
              return ret;
            ...
            {
              // -beg- preserve=no 39609BB50111 get_body394A41E30033 "Factor::getElement"
              if(element==null) {throw new java.lang.IllegalStateException("no element attached");}
              return element;
             ...
             *  @see #attachElement
             */
            // -beg- preserve=no 39609BB50111 test_head394A41E30033 "Factor::containsElement"
            public boolean containsElement()
            // -end- 39609BB50111 test_head394A41E30033 "Factor::containsElement"
            {
              // -beg- preserve=no 39609BB50111 test_body394A41E30033 "Factor::containsElement"
              return element!=null;
             ...
             *  @see #containsSubterm
             */
            // -beg- preserve=no 39609BD20325 attach_head394A41E30033 "Factor::attachSubterm"
            public void attachSubterm(Term subterm1)
            // -end- 39609BD20325 attach_head394A41E30033 "Factor::attachSubterm"
            {
              // -beg- preserve=no 39609BD20325 attach_body394A41E30033 "Factor::attachSubterm"
              if(subterm!=null) {throw new java.lang.IllegalStateException("already a subterm attached");}
              if(subterm1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as subterm");}
              subterm = subterm1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachSubterm"));
              return;
             ...
             *  @see #attachSubterm
             */
            // -beg- preserve=no 39609BD20325 detach_head394A41E30033 "Factor::detachSubterm"
            public Term detachSubterm()
            // -end- 39609BD20325 detach_head394A41E30033 "Factor::detachSubterm"
            {
              // -beg- preserve=no 39609BD20325 detach_body394A41E30033 "Factor::detachSubterm"
              Term ret = null;
              ret = subterm;
              subterm = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachSubterm"));
              return ret;
            ...
            {
              // -beg- preserve=no 39609BD20325 get_body394A41E30033 "Factor::getSubterm"
              if(subterm==null) {throw new java.lang.IllegalStateException("no subterm attached");}
              return subterm;
             ...
             *  @see #attachSubterm
             */
            // -beg- preserve=no 39609BD20325 test_head394A41E30033 "Factor::containsSubterm"
            public boolean containsSubterm()
            // -end- 39609BD20325 test_head394A41E30033 "Factor::containsSubterm"
            {
              // -beg- preserve=no 39609BD20325 test_body394A41E30033 "Factor::containsSubterm"
              return subterm!=null;
            ...
            {
              // -beg- preserve=no 39609C040364 add_body394A41E30033 "Factor::addExistsin"
              existsin.add(existsin1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addExistsin"));
              return;
             ...
             *  @see #addExistsin
             */
            // -beg- preserve=no 39609C040364 remove_head394A41E30033 "Factor::removeExistsin"
            ...
            {
              // -beg- preserve=no 39609C040364 remove_body394A41E30033 "Factor::removeExistsin"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeExistsin"));
              return ret;
             ...
             *  @see #addExistsin
             */
            // -beg- preserve=no 39609C040364 test_head394A41E30033 "Factor::containsExistsin"
            public boolean containsExistsin(AttributePath existsin1)
            // -end- 39609C040364 test_head394A41E30033 "Factor::containsExistsin"
            {
              // -beg- preserve=no 39609C040364 test_body394A41E30033 "Factor::containsExistsin"
             ...
             *  @see #addExistsin
             */
            // -beg- preserve=no 39609C040364 get_all_head394A41E30033 "Factor::iteratorExistsin"
            public java.util.Iterator iteratorExistsin()
            // -end- 39609C040364 get_all_head394A41E30033 "Factor::iteratorExistsin"
            {
              // -beg- preserve=no 39609C040364 get_all_body394A41E30033 "Factor::iteratorExistsin"
              return existsin.iterator();
              // -end- 39609C040364 get_all_body394A41E30033 "Factor::iteratorExistsin"
            }

            /** disconnect all Existsins.
             *  @see #addExistsin
             */
            // -beg- preserve=no 39609C040364 remove_all_head394A41E30033 "Factor::clearExistsin"
            public void clearExistsin()
            // -end- 39609C040364 remove_all_head394A41E30033 "Factor::clearExistsin"
            {
              // -beg- preserve=no 39609C040364 remove_all_body394A41E30033 "Factor::clearExistsin"
              if(sizeExistsin()>0){
                existsin.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearExistsin"));
              }
              // -end- 39609C040364 remove_all_body394A41E30033 "Factor::clearExistsin"
            }

            /** returns the number of Existsins.
             *  @see #addExistsin
             */
            // -beg- preserve=no 39609C040364 size_head394A41E30033 "Factor::sizeExistsin"
            public int sizeExistsin()
            // -end- 39609C040364 size_head394A41E30033 "Factor::sizeExistsin"
            {
              // -beg- preserve=no 39609C040364 size_body394A41E30033 "Factor::sizeExistsin"
             ...
             */
            // -beg- preserve=no 39609D370061 attach_head394A41E30033 "Factor::attachRestrictedto"
            ...
            {
              // -beg- preserve=no 39609D370061 attach_body394A41E30033 "Factor::attachRestrictedto"
              if(restrictedto!=null) {throw new java.lang.IllegalStateException("already a restrictedto attached");}
              if(restrictedto1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as restrictedto");}
              restrictedto = restrictedto1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachRestrictedto"));
              return;
              // -end- 39609D370061 attach_body394A41E30033 "Factor::attachRestrictedto"
            }

            /** disconnect the currently attached Restrictedto.
             *  @see #attachRestrictedto
             */
            // -beg- preserve=no 39609D370061 detach_head394A41E30033 "Factor::detachRestrictedto"
            public AbstractClassDef detachRestrictedto()
            // -end- 39609D370061 detach_head394A41E30033 "Factor::detachRestrictedto"
            {
              // -beg- preserve=no 39609D370061 detach_body394A41E30033 "Factor::detachRestrictedto"
              AbstractClassDef ret = null;
              ret = restrictedto;
              restrictedto = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachRestrictedto"));
              return ret;
              // -end- 39609D370061 detach_body394A41E30033 "Factor::detachRestrictedto"
            }

            /** get the currently attached Restrictedto.
             *  @see #attachRestrictedto
             */
            // -beg- preserve=no 39609D370061 get_head394A41E30033 "Factor::getRestrictedto"
            public AbstractClassDef getRestrictedto()
            // -end- 39609D370061 get_head394A41E30033 "Factor::getRestrictedto"
            {
              // -beg- preserve=no 39609D370061 get_body394A41E30033 "Factor::getRestrictedto"
              if(restrictedto==null) {throw new java.lang.IllegalStateException("no restrictedto attached");}
              return restrictedto;
             ...
             *  @see #attachRestrictedto
             */
            // -beg- preserve=no 39609D370061 test_head394A41E30033 "Factor::containsRestrictedto"
            public boolean containsRestrictedto()
            // -end- 39609D370061 test_head394A41E30033 "Factor::containsRestrictedto"
            {
              // -beg- preserve=no 39609D370061 test_body394A41E30033 "Factor::containsRestrictedto"
              return restrictedto!=null;
              // -end- 39609D370061 test_body394A41E30033 "Factor::containsRestrictedto"
            }
             ...
             *  ELEMENT, EXISTSIN, SUBTERM, DEFINED oder RESTRICTED
             ...
             *  nur definiert wenn kind==RESTRICTEDstd::list<CString>
             *  @see #setLocalBase
             */
