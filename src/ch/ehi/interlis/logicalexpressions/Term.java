...
public class Term extends AbstractEditorElement implements java.io.Serializable
          {
            ...
            // -end- 3D4FA21801CA head394A41DB0213 "unlinkAll"
              ...
              // Role PlausibilityConstraint: PlausibilityConstraint object(s) may point to this
            ...
            // -end- 3D4FA21801DE head394A41DB0213 "enumerateChildren"
              ...
              it=iteratorRight();while(it.hasNext())visitor.visit(it.next());
              if(containsFactor())visitor.visit(getFactor());
              if(containsLeft())visitor.visit(getLeft());
            ...
            // -end- 394A4203015D add_head394A41DB0213 "Term::addRight"
            {
              ...
              right.add(right1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addRight"));
              return;
             ...
             *  @see #addRight
             */
            // -beg- preserve=no 394A4203015D remove_head394A41DB0213 "Term::removeRight"
            public Term removeRight(Term right1)
            // -end- 394A4203015D remove_head394A41DB0213 "Term::removeRight"
            {
              // -beg- preserve=no 394A4203015D remove_body394A41DB0213 "Term::removeRight"
              Term ret=null;
              ...
              ret = right1;
              right.remove(right1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeRight"));
              return ret;
             ...
             *  @see #addRight
             */
            // -beg- preserve=no 394A4203015D test_head394A41DB0213 "Term::containsRight"
            public boolean containsRight(Term right1)
            // -end- 394A4203015D test_head394A41DB0213 "Term::containsRight"
            {
              // -beg- preserve=no 394A4203015D test_body394A41DB0213 "Term::containsRight"
             ...
             *  @see #addRight
             */
            // -beg- preserve=no 394A4203015D get_all_head394A41DB0213 "Term::iteratorRight"
            public java.util.Iterator iteratorRight()
            // -end- 394A4203015D get_all_head394A41DB0213 "Term::iteratorRight"
            {
              // -beg- preserve=no 394A4203015D get_all_body394A41DB0213 "Term::iteratorRight"
             ...
             *  @see #addRight
             */
            // -beg- preserve=no 394A4203015D remove_all_head394A41DB0213 "Term::clearRight"
            public void clearRight()
            // -end- 394A4203015D remove_all_head394A41DB0213 "Term::clearRight"
            {
              // -beg- preserve=no 394A4203015D remove_all_body394A41DB0213 "Term::clearRight"
              if(sizeRight()>0){
                right.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearRight"));
              }
            ...
            {
              // -beg- preserve=no 394A4203015D size_body394A41DB0213 "Term::sizeRight"
              return right.size();
             ...
             *  @see #containsFactor
             */
            // -beg- preserve=no 394A4207003F attach_head394A41DB0213 "Term::attachFactor"
            public void attachFactor(Factor factor1)
            // -end- 394A4207003F attach_head394A41DB0213 "Term::attachFactor"
            {
              // -beg- preserve=no 394A4207003F attach_body394A41DB0213 "Term::attachFactor"
              if(factor!=null) {throw new java.lang.IllegalStateException("already a factor attached");}
              if(factor1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as factor");}
              factor = factor1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachFactor"));
              return;
             ...
             *  @see #attachFactor
             */
            // -beg- preserve=no 394A4207003F detach_head394A41DB0213 "Term::detachFactor"
            public Factor detachFactor()
            // -end- 394A4207003F detach_head394A41DB0213 "Term::detachFactor"
            {
              // -beg- preserve=no 394A4207003F detach_body394A41DB0213 "Term::detachFactor"
              Factor ret = null;
              ret = factor;
              factor = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachFactor"));
              return ret;
            ...
            // -end- 394A4207003F get_head394A41DB0213 "Term::getFactor"
            {
              ...
              if(factor==null) {throw new java.lang.IllegalStateException("no factor attached");}
              return factor;
             ...
             *  @see #attachFactor
             */
            // -beg- preserve=no 394A4207003F test_head394A41DB0213 "Term::containsFactor"
            public boolean containsFactor()
            // -end- 394A4207003F test_head394A41DB0213 "Term::containsFactor"
            {
              // -beg- preserve=no 394A4207003F test_body394A41DB0213 "Term::containsFactor"
              return factor!=null;
            ...
            {
              // -beg- preserve=no 394A421102BB attach_body394A41DB0213 "Term::attachLeft"
              if(left!=null) {throw new java.lang.IllegalStateException("already a left attached");}
              if(left1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as left");}
              left = left1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachLeft"));
              return;
            ...
            {
              // -beg- preserve=no 394A421102BB detach_body394A41DB0213 "Term::detachLeft"
              Term ret = null;
              ret = left;
              left = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachLeft"));
              return ret;
            ...
            // -end- 394A421102BB get_head394A41DB0213 "Term::getLeft"
            {
              ...
              if(left==null) {throw new java.lang.IllegalStateException("no left attached");}
              return left;
            ...
            {
              // -beg- preserve=no 394A421102BB test_body394A41DB0213 "Term::containsLeft"
              return left!=null;
             ...
             *  NOOP, FACTOR, OR, AND, IMPL, NOT, EQ, NEQ, GLT, LEQ, GEQ, LT oder GT
...
public class Term extends AbstractEditorElement implements java.io.Serializable {
	...
	// -beg- preserve=no 394A4203015D code394A41DB0213 "right"
	private Set<Term> right = new HashSet<Term>();
	// -end- 394A4203015D code394A41DB0213 "right"
	...
	// "Term::iteratorRight"
	public Iterator<Term> iteratorRight()
	// -end- 394A4203015D get_all_head394A41DB0213 "Term::iteratorRight"
	{
