...
/**
 * Definiert eine Bereich innerhalb einer AufzÃ¤hlung.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:34:51 $
 */
public class EnumRange extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #containsFrom
	 */
	// -beg- preserve=no 3961FE4103B5 attach_head3961FDB101A5
	// "EnumRange::attachFrom"
	public void attachFrom(EnumerationConst from1)
	// -end- 3961FE4103B5 attach_head3961FDB101A5 "EnumRange::attachFrom"
	{
		// -beg- preserve=no 3961FE4103B5 attach_body3961FDB101A5
		// "EnumRange::attachFrom"
		if (from != null) {
	 ...
	 * @see #attachFrom
	 */
	// -beg- preserve=no 3961FE4103B5 detach_head3961FDB101A5
	// "EnumRange::detachFrom"
	public EnumerationConst detachFrom()
	// -end- 3961FE4103B5 detach_head3961FDB101A5 "EnumRange::detachFrom"
	{
		// -beg- preserve=no 3961FE4103B5 detach_body3961FDB101A5
		// "EnumRange::detachFrom"
		EnumerationConst ret = null;
		ret = from;
		from = null;
	...
	// -end- 3961FE4103B5 get_head3961FDB101A5 "EnumRange::getFrom"
	{
		// -beg- preserve=no 3961FE4103B5 get_body3961FDB101A5
		// "EnumRange::getFrom"
		if (from == null) {
	 ...
	 * @see #attachFrom
	 */
	// -beg- preserve=no 3961FE4103B5 test_head3961FDB101A5
	// "EnumRange::containsFrom"
	public boolean containsFrom()
	// -end- 3961FE4103B5 test_head3961FDB101A5 "EnumRange::containsFrom"
	{
		// -beg- preserve=no 3961FE4103B5 test_body3961FDB101A5
		// "EnumRange::containsFrom"
		return from != null;
		// -end- 3961FE4103B5 test_body3961FDB101A5 "EnumRange::containsFrom"
	}
	 ...
	 * @see #containsTo
	 */
	// -beg- preserve=no 3961FE480314 attach_head3961FDB101A5
	// "EnumRange::attachTo"
	public void attachTo(EnumerationConst to1)
	// -end- 3961FE480314 attach_head3961FDB101A5 "EnumRange::attachTo"
	{
		// -beg- preserve=no 3961FE480314 attach_body3961FDB101A5
		// "EnumRange::attachTo"
		if (to != null) {
			throw new java.lang.IllegalStateException("already a to attached");
		}
		if (to1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as to");
		}
		to = to1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachTo"));
		return;
		// -end- 3961FE480314 attach_body3961FDB101A5 "EnumRange::attachTo"
	}
	 ...
	 * @see #attachTo
	 */
	// -beg- preserve=no 3961FE480314 detach_head3961FDB101A5
	// "EnumRange::detachTo"
	public EnumerationConst detachTo()
	// -end- 3961FE480314 detach_head3961FDB101A5 "EnumRange::detachTo"
	{
		// -beg- preserve=no 3961FE480314 detach_body3961FDB101A5
		// "EnumRange::detachTo"
		EnumerationConst ret = null;
		ret = to;
		to = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachTo"));
		return ret;
		// -end- 3961FE480314 detach_body3961FDB101A5 "EnumRange::detachTo"
	}
	...
	// -end- 3961FE480314 get_head3961FDB101A5 "EnumRange::getTo"
	{
		// -beg- preserve=no 3961FE480314 get_body3961FDB101A5
		// "EnumRange::getTo"
		if (to == null) {
			throw new java.lang.IllegalStateException("no to attached");
		}
		return to;
		// -end- 3961FE480314 get_body3961FDB101A5 "EnumRange::getTo"
	}
	 ...
	 * @see #attachTo
	 */
	// -beg- preserve=no 3961FE480314 test_head3961FDB101A5
	// "EnumRange::containsTo"
	public boolean containsTo()
	// -end- 3961FE480314 test_head3961FDB101A5 "EnumRange::containsTo"
	{
		// -beg- preserve=no 3961FE480314 test_body3961FDB101A5
		// "EnumRange::containsTo"
		return to != null;
		// -end- 3961FE480314 test_body3961FDB101A5 "EnumRange::containsTo"
	}
