...
/**
 * Definiert einen Parameter fÃ¼r eine grafische Darstellung.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:34:56 $
 */
public class GraphicParameterDef extends AbstractModelElement implements ModelElement, IliSyntax, java.io.Serializable {
	 ...
	 * @see #containsDomainAttribute
	 */
	// -beg- preserve=no 396202860334 attach_head3947A91501AA
	// "GraphicParameterDef::attachDomainAttribute"
	public void attachDomainAttribute(DomainAttribute domainAttribute1)
	// -end- 396202860334 attach_head3947A91501AA
	// "GraphicParameterDef::attachDomainAttribute"
	{
		// -beg- preserve=no 396202860334 attach_body3947A91501AA
		// "GraphicParameterDef::attachDomainAttribute"
		...
		return;
		// -end- 396202860334 attach_body3947A91501AA
		// "GraphicParameterDef::attachDomainAttribute"
	}
	 ...
	 * @see #attachDomainAttribute
	 */
	// -beg- preserve=no 396202860334 detach_head3947A91501AA
	// "GraphicParameterDef::detachDomainAttribute"
	public DomainAttribute detachDomainAttribute()
	// -end- 396202860334 detach_head3947A91501AA
	// "GraphicParameterDef::detachDomainAttribute"
	{
		// -beg- preserve=no 396202860334 detach_body3947A91501AA
		// "GraphicParameterDef::detachDomainAttribute"
		DomainAttribute ret = null;
		ret = domainAttribute;
		domainAttribute = null;
		...
		return ret;
		// -end- 396202860334 detach_body3947A91501AA
		// "GraphicParameterDef::detachDomainAttribute"
	}
	 ...
	 * @see #attachDomainAttribute
	 */
	// -beg- preserve=no 396202860334 get_head3947A91501AA
	// "GraphicParameterDef::getDomainAttribute"
	public DomainAttribute getDomainAttribute()
	// -end- 396202860334 get_head3947A91501AA
	// "GraphicParameterDef::getDomainAttribute"
	{
		// -beg- preserve=no 396202860334 get_body3947A91501AA
		// "GraphicParameterDef::getDomainAttribute"
		if (domainAttribute == null) {
			throw new java.lang.IllegalStateException("no domainAttribute attached");
		}
		return domainAttribute;
		// -end- 396202860334 get_body3947A91501AA
		// "GraphicParameterDef::getDomainAttribute"
	}
	 ...
	 * @see #attachDomainAttribute
	 */
	// -beg- preserve=no 396202860334 test_head3947A91501AA
	// "GraphicParameterDef::containsDomainAttribute"
	public boolean containsDomainAttribute()
	// -end- 396202860334 test_head3947A91501AA
	// "GraphicParameterDef::containsDomainAttribute"
	{
		// -beg- preserve=no 396202860334 test_body3947A91501AA
		// "GraphicParameterDef::containsDomainAttribute"
		return domainAttribute != null;
		// -end- 396202860334 test_body3947A91501AA
		// "GraphicParameterDef::containsDomainAttribute"
	}
	 ...
	 * @see #createNamespaceLink
	 */
	// -beg- preserve=no 33598CAA030E attach_head3947A91501AA
	// "ModelElement::attachNamespace"
	public void attachNamespace(Namespace namespace1)
	// -end- 33598CAA030E attach_head3947A91501AA
	// "ModelElement::attachNamespace"
	{
		// -beg- preserve=no 33598CAA030E attach_body3947A91501AA
		// "ModelElement::attachNamespace"
		super.attachNamespace(namespace1);
		// -end- 33598CAA030E attach_body3947A91501AA
		// "ModelElement::attachNamespace"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E attachlink_head3947A91501AA
	// "ModelElement::attachNamespaceLink"
	public void attachNamespaceLink(ElementOwnership namespace1)
	// -end- 33598CAA030E attachlink_head3947A91501AA
	// "ModelElement::attachNamespaceLink"
	{
		// -beg- preserve=no 33598CAA030E attachlink_body3947A91501AA
		// "ModelElement::attachNamespaceLink"
		super.attachNamespaceLink(namespace1);
		// -end- 33598CAA030E attachlink_body3947A91501AA
		// "ModelElement::attachNamespaceLink"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E detach_head3947A91501AA
	// "ModelElement::detachNamespace"
	public Namespace detachNamespace()
	// -end- 33598CAA030E detach_head3947A91501AA
	// "ModelElement::detachNamespace"
	{
		// -beg- preserve=no 33598CAA030E detach_body3947A91501AA
		// "ModelElement::detachNamespace"
		return super.detachNamespace();
		// -end- 33598CAA030E detach_body3947A91501AA
		// "ModelElement::detachNamespace"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E get_head3947A91501AA
	// "ModelElement::getNamespace"
	public Namespace getNamespace()
	// -end- 33598CAA030E get_head3947A91501AA "ModelElement::getNamespace"
	{
		// -beg- preserve=no 33598CAA030E get_body3947A91501AA
		// "ModelElement::getNamespace"
		return super.getNamespace();
		// -end- 33598CAA030E get_body3947A91501AA "ModelElement::getNamespace"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E getlink_head3947A91501AA
	// "ModelElement::getNamespaceLink"
	public ElementOwnership getNamespaceLink()
	// -end- 33598CAA030E getlink_head3947A91501AA
	// "ModelElement::getNamespaceLink"
	{
		// -beg- preserve=no 33598CAA030E getlink_body3947A91501AA
		// "ModelElement::getNamespaceLink"
		return super.getNamespaceLink();
		// -end- 33598CAA030E getlink_body3947A91501AA
		// "ModelElement::getNamespaceLink"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E createlink_head3947A91501AA
	// "ModelElement::createNamespaceLink"
	public ElementOwnership createNamespaceLink()
	// -end- 33598CAA030E createlink_head3947A91501AA
	// "ModelElement::createNamespaceLink"
	{
		// -beg- preserve=no 33598CAA030E createlink_body3947A91501AA
		// "ModelElement::createNamespaceLink"
		return super.createNamespaceLink();
		// -end- 33598CAA030E createlink_body3947A91501AA
		// "ModelElement::createNamespaceLink"
	}
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 33598CAA030E test_head3947A91501AA
	// "ModelElement::containsNamespace"
	public boolean containsNamespace()
	// -end- 33598CAA030E test_head3947A91501AA
	// "ModelElement::containsNamespace"
	{
		// -beg- preserve=no 33598CAA030E test_body3947A91501AA
		// "ModelElement::containsNamespace"
		return super.containsNamespace();
		// -end- 33598CAA030E test_body3947A91501AA
		// "ModelElement::containsNamespace"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 33598CAA030E _link_body3947A91501AA
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 33598CAA030E _unlink_body3947A91501AA
	// "ModelElement::_unlinkNamespace"
	public void _unlinkNamespace(ElementOwnership namespace1) {
		super._unlinkNamespace(namespace1);
	}
	// -end- 33598CAA030E _unlink_body3947A91501AA
	// "ModelElement::_unlinkNamespace"
	...
	/**
	 * get current value of name Name des Grafikparameters.
	 * 
	 * @see #setName
	 */
	// -beg- preserve=no 39620268010A get_head3947A91501AA "name"
