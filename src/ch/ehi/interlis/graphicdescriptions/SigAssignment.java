...
package ch.ehi.interlis.graphicdescriptions;
          ...
          /** Definiert eine Zuweisung fuer einen Signatur-Parameter.
...
public class SigAssignment extends AbstractEditorElement implements java.io.Serializable
          {
            ...
            // -end- 3D4FA219009F head3961F95C036D "enumerateChildren"
              ...
              it=iteratorEnumAssignment();while(it.hasNext())visitor.visit(it.next());
             ...
             */
            // -beg- preserve=no 3961FB4B010C attach_head3961F95C036D "SigAssignment::attachConstant"
            public void attachConstant(Constant constant1)
            // -end- 3961FB4B010C attach_head3961F95C036D "SigAssignment::attachConstant"
            {
              // -beg- preserve=no 3961FB4B010C attach_body3961F95C036D "SigAssignment::attachConstant"
              ...
              return;
              // -end- 3961FB4B010C attach_body3961F95C036D "SigAssignment::attachConstant"
            }

            /** disconnect the currently attached Constant.
             *  @see #attachConstant
             */
            // -beg- preserve=no 3961FB4B010C detach_head3961F95C036D "SigAssignment::detachConstant"
            public Constant detachConstant()
            // -end- 3961FB4B010C detach_head3961F95C036D "SigAssignment::detachConstant"
            {
              // -beg- preserve=no 3961FB4B010C detach_body3961F95C036D "SigAssignment::detachConstant"
              Constant ret = null;
              ret = constant;
              constant = null;
              ...
              return ret;
              // -end- 3961FB4B010C detach_body3961F95C036D "SigAssignment::detachConstant"
            }

            /** get the currently attached Constant.
             *  @see #attachConstant
             */
            // -beg- preserve=no 3961FB4B010C get_head3961F95C036D "SigAssignment::getConstant"
            public Constant getConstant()
            // -end- 3961FB4B010C get_head3961F95C036D "SigAssignment::getConstant"
            {
              // -beg- preserve=no 3961FB4B010C get_body3961F95C036D "SigAssignment::getConstant"
             ...
             *  @see #attachConstant
             */
            // -beg- preserve=no 3961FB4B010C test_head3961F95C036D "SigAssignment::containsConstant"
            public boolean containsConstant()
            // -end- 3961FB4B010C test_head3961F95C036D "SigAssignment::containsConstant"
            {
              // -beg- preserve=no 3961FB4B010C test_body3961F95C036D "SigAssignment::containsConstant"
              return constant!=null;
              // -end- 3961FB4B010C test_body3961F95C036D "SigAssignment::containsConstant"
            }
             ...
             */
            // -beg- preserve=no 3961FCF30242 add_head3961F95C036D "SigAssignment::addEnumAssignment"
            public void addEnumAssignment(EnumAssignment enumAssignment1)
            // -end- 3961FCF30242 add_head3961F95C036D "SigAssignment::addEnumAssignment"
            {
              // -beg- preserve=no 3961FCF30242 add_body3961F95C036D "SigAssignment::addEnumAssignment"
              enumAssignment.add(enumAssignment1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addEnumAssignment"));
              return;
              // -end- 3961FCF30242 add_body3961F95C036D "SigAssignment::addEnumAssignment"
            }

            /** disconnect a EnumAssignment.
             *  @see #addEnumAssignment
             */
            // -beg- preserve=no 3961FCF30242 remove_head3961F95C036D "SigAssignment::removeEnumAssignment"
            public EnumAssignment removeEnumAssignment(EnumAssignment enumAssignment1)
            // -end- 3961FCF30242 remove_head3961F95C036D "SigAssignment::removeEnumAssignment"
            {
              // -beg- preserve=no 3961FCF30242 remove_body3961F95C036D "SigAssignment::removeEnumAssignment"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeEnumAssignment"));
              return ret;
              // -end- 3961FCF30242 remove_body3961F95C036D "SigAssignment::removeEnumAssignment"
            }

            /** tests if a given EnumAssignment is connected.
             *  @see #addEnumAssignment
             */
            // -beg- preserve=no 3961FCF30242 test_head3961F95C036D "SigAssignment::containsEnumAssignment"
            public boolean containsEnumAssignment(EnumAssignment enumAssignment1)
            // -end- 3961FCF30242 test_head3961F95C036D "SigAssignment::containsEnumAssignment"
            {
              // -beg- preserve=no 3961FCF30242 test_body3961F95C036D "SigAssignment::containsEnumAssignment"
              return enumAssignment.contains(enumAssignment1);
              // -end- 3961FCF30242 test_body3961F95C036D "SigAssignment::containsEnumAssignment"
            }

            /** used to enumerate all connected EnumAssignments.
             *  @see #addEnumAssignment
             */
            // -beg- preserve=no 3961FCF30242 get_all_head3961F95C036D "SigAssignment::iteratorEnumAssignment"
            public java.util.Iterator iteratorEnumAssignment()
            // -end- 3961FCF30242 get_all_head3961F95C036D "SigAssignment::iteratorEnumAssignment"
            {
              // -beg- preserve=no 3961FCF30242 get_all_body3961F95C036D "SigAssignment::iteratorEnumAssignment"
              return enumAssignment.iterator();
              // -end- 3961FCF30242 get_all_body3961F95C036D "SigAssignment::iteratorEnumAssignment"
            }

            /** disconnect all EnumAssignments.
             *  @see #addEnumAssignment
             */
            // -beg- preserve=no 3961FCF30242 remove_all_head3961F95C036D "SigAssignment::clearEnumAssignment"
            public void clearEnumAssignment()
            // -end- 3961FCF30242 remove_all_head3961F95C036D "SigAssignment::clearEnumAssignment"
            {
              // -beg- preserve=no 3961FCF30242 remove_all_body3961F95C036D "SigAssignment::clearEnumAssignment"
              if(sizeEnumAssignment()>0){
                enumAssignment.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearEnumAssignment"));
              }
              // -end- 3961FCF30242 remove_all_body3961F95C036D "SigAssignment::clearEnumAssignment"
            }

            /** returns the number of EnumAssignments.
             *  @see #addEnumAssignment
             */
            // -beg- preserve=no 3961FCF30242 size_head3961F95C036D "SigAssignment::sizeEnumAssignment"
            public int sizeEnumAssignment()
            // -end- 3961FCF30242 size_head3961F95C036D "SigAssignment::sizeEnumAssignment"
            {
              // -beg- preserve=no 3961FCF30242 size_body3961F95C036D "SigAssignment::sizeEnumAssignment"
              return enumAssignment.size();
              // -end- 3961FCF30242 size_body3961F95C036D "SigAssignment::sizeEnumAssignment"
            }
             ...
             */
            // -beg- preserve=no 39620F180313 attach_head3961F95C036D "SigAssignment::attachAttributePath"
            public void attachAttributePath(AttributePath attributePath1)
            // -end- 39620F180313 attach_head3961F95C036D "SigAssignment::attachAttributePath"
            {
              // -beg- preserve=no 39620F180313 attach_body3961F95C036D "SigAssignment::attachAttributePath"
              ...
              return;
              // -end- 39620F180313 attach_body3961F95C036D "SigAssignment::attachAttributePath"
            }

            /** disconnect the currently attached AttributePath.
             *  @see #attachAttributePath
             */
            // -beg- preserve=no 39620F180313 detach_head3961F95C036D "SigAssignment::detachAttributePath"
            public AttributePath detachAttributePath()
            // -end- 39620F180313 detach_head3961F95C036D "SigAssignment::detachAttributePath"
            {
              // -beg- preserve=no 39620F180313 detach_body3961F95C036D "SigAssignment::detachAttributePath"
              ...
              return ret;
              // -end- 39620F180313 detach_body3961F95C036D "SigAssignment::detachAttributePath"
            }

            /** get the currently attached AttributePath.
             *  @see #attachAttributePath
             */
            // -beg- preserve=no 39620F180313 get_head3961F95C036D "SigAssignment::getAttributePath"
            public AttributePath getAttributePath()
            // -end- 39620F180313 get_head3961F95C036D "SigAssignment::getAttributePath"
            {
              // -beg- preserve=no 39620F180313 get_body3961F95C036D "SigAssignment::getAttributePath"
              if(attributePath==null) {throw new java.lang.IllegalStateException("no attributePath attached");}
              return attributePath;
              // -end- 39620F180313 get_body3961F95C036D "SigAssignment::getAttributePath"
            }

            /** tests if there is a AttributePath attached.
             *  @see #attachAttributePath
             */
            // -beg- preserve=no 39620F180313 test_head3961F95C036D "SigAssignment::containsAttributePath"
            public boolean containsAttributePath()
            // -end- 39620F180313 test_head3961F95C036D "SigAssignment::containsAttributePath"
            {
              // -beg- preserve=no 39620F180313 test_body3961F95C036D "SigAssignment::containsAttributePath"
              return attributePath!=null;
              // -end- 39620F180313 test_body3961F95C036D "SigAssignment::containsAttributePath"
            }
            ...
            /** get current value of parameterName
             *  Name des Signaturparameters.
            ...
            // -end- 3961FA60015E set_head3961F95C036D "parameterName"
            {
              ...
              if(parameterName!=value1 && (parameterName==null || !parameterName.equals(value1))){
                ...
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setParameterName"));
              }
