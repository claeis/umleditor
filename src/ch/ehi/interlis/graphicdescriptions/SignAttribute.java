...
public class SignAttribute extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #containsSign
	 */
	// -beg- preserve=no 3961F6D800D2 attach_head3961F2DF02E2
	// "SignAttribute::attachSign"
	public void attachSign(AbstractClassDef sign1)
	// -end- 3961F6D800D2 attach_head3961F2DF02E2 "SignAttribute::attachSign"
	{
		// -beg- preserve=no 3961F6D800D2 attach_body3961F2DF02E2
		// "SignAttribute::attachSign"
		if (sign != null) {
			throw new java.lang.IllegalStateException("already a sign attached");
		}
		if (sign1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as sign");
		}
		sign = sign1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachSign"));
		return;
		// -end- 3961F6D800D2 attach_body3961F2DF02E2
		// "SignAttribute::attachSign"
	}
	 ...
	 * @see #attachSign
	 */
	// -beg- preserve=no 3961F6D800D2 detach_head3961F2DF02E2
	// "SignAttribute::detachSign"
	public AbstractClassDef detachSign()
	// -end- 3961F6D800D2 detach_head3961F2DF02E2 "SignAttribute::detachSign"
	{
		// -beg- preserve=no 3961F6D800D2 detach_body3961F2DF02E2
		// "SignAttribute::detachSign"
		AbstractClassDef ret = null;
		ret = sign;
		sign = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachSign"));
		return ret;
		// -end- 3961F6D800D2 detach_body3961F2DF02E2
		// "SignAttribute::detachSign"
	}
	 ...
	 * @see #attachSign
	 */
	// -beg- preserve=no 3961F6D800D2 get_head3961F2DF02E2
	// "SignAttribute::getSign"
	public AbstractClassDef getSign()
	// -end- 3961F6D800D2 get_head3961F2DF02E2 "SignAttribute::getSign"
	{
		// -beg- preserve=no 3961F6D800D2 get_body3961F2DF02E2
		// "SignAttribute::getSign"
		if (sign == null) {
			throw new java.lang.IllegalStateException("no sign attached");
		}
		return sign;
		// -end- 3961F6D800D2 get_body3961F2DF02E2 "SignAttribute::getSign"
	}
	 ...
	 * @see #attachSign
	 */
	// -beg- preserve=no 3961F6D800D2 test_head3961F2DF02E2
	// "SignAttribute::containsSign"
	public boolean containsSign()
	// -end- 3961F6D800D2 test_head3961F2DF02E2 "SignAttribute::containsSign"
	{
		// -beg- preserve=no 3961F6D800D2 test_body3961F2DF02E2
		// "SignAttribute::containsSign"
		return sign != null;
		// -end- 3961F6D800D2 test_body3961F2DF02E2
		// "SignAttribute::containsSign"
	}
	 ...
	 * @see #sizeCondSigParamAss
	 */
	// -beg- preserve=no 3961F7E8020A add_head3961F2DF02E2
	// "SignAttribute::addCondSigParamAss"
	public void addCondSigParamAss(CondSigParamAss condSigParamAss1)
	// -end- 3961F7E8020A add_head3961F2DF02E2
	// "SignAttribute::addCondSigParamAss"
	{
		// -beg- preserve=no 3961F7E8020A add_body3961F2DF02E2
		// "SignAttribute::addCondSigParamAss"
		condSigParamAss.add(condSigParamAss1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addCondSigParamAss"));
		return;
		// -end- 3961F7E8020A add_body3961F2DF02E2
		// "SignAttribute::addCondSigParamAss"
	}
	 ...
	 * @see #addCondSigParamAss
	 */
	// -beg- preserve=no 3961F7E8020A remove_head3961F2DF02E2
	// "SignAttribute::removeCondSigParamAss"
	public CondSigParamAss removeCondSigParamAss(CondSigParamAss condSigParamAss1)
	// -end- 3961F7E8020A remove_head3961F2DF02E2
	// "SignAttribute::removeCondSigParamAss"
	{
		// -beg- preserve=no 3961F7E8020A remove_body3961F2DF02E2
		// "SignAttribute::removeCondSigParamAss"
		CondSigParamAss ret = null;
		if (condSigParamAss1 == null || !condSigParamAss.contains(condSigParamAss1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		condSigParamAss.remove(condSigParamAss1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeCondSigParamAss"));
		return ret;
		// -end- 3961F7E8020A remove_body3961F2DF02E2
		// "SignAttribute::removeCondSigParamAss"
	}
	 ...
	 * @see #addCondSigParamAss
	 */
	// -beg- preserve=no 3961F7E8020A test_head3961F2DF02E2
	// "SignAttribute::containsCondSigParamAss"
	public boolean containsCondSigParamAss(CondSigParamAss condSigParamAss1)
	// -end- 3961F7E8020A test_head3961F2DF02E2
	// "SignAttribute::containsCondSigParamAss"
	{
		// -beg- preserve=no 3961F7E8020A test_body3961F2DF02E2
		// "SignAttribute::containsCondSigParamAss"
		return condSigParamAss.contains(condSigParamAss1);
		// -end- 3961F7E8020A test_body3961F2DF02E2
		// "SignAttribute::containsCondSigParamAss"
	}
	...
	// "SignAttribute::iteratorCondSigParamAss"
	{
		// -beg- preserve=no 3961F7E8020A get_all_body3961F2DF02E2
		// "SignAttribute::iteratorCondSigParamAss"
		return condSigParamAss.iterator();
		// -end- 3961F7E8020A get_all_body3961F2DF02E2
		// "SignAttribute::iteratorCondSigParamAss"
	}
	 ...
	 * @see #addCondSigParamAss
	 */
	// -beg- preserve=no 3961F7E8020A remove_all_head3961F2DF02E2
	// "SignAttribute::clearCondSigParamAss"
	public void clearCondSigParamAss()
	// -end- 3961F7E8020A remove_all_head3961F2DF02E2
	// "SignAttribute::clearCondSigParamAss"
	{
		// -beg- preserve=no 3961F7E8020A remove_all_body3961F2DF02E2
		// "SignAttribute::clearCondSigParamAss"
		if (sizeCondSigParamAss() > 0) {
			condSigParamAss.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearCondSigParamAss"));
		}
		// -end- 3961F7E8020A remove_all_body3961F2DF02E2
		// "SignAttribute::clearCondSigParamAss"
	}
	 ...
	 * @see #addCondSigParamAss
	 */
	// -beg- preserve=no 3961F7E8020A size_head3961F2DF02E2
	// "SignAttribute::sizeCondSigParamAss"
	public int sizeCondSigParamAss()
	// -end- 3961F7E8020A size_head3961F2DF02E2
	// "SignAttribute::sizeCondSigParamAss"
	{
		// -beg- preserve=no 3961F7E8020A size_body3961F2DF02E2
		// "SignAttribute::sizeCondSigParamAss"
		return condSigParamAss.size();
		// -end- 3961F7E8020A size_body3961F2DF02E2
		// "SignAttribute::sizeCondSigParamAss"
	}
