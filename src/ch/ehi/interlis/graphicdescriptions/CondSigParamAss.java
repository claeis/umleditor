...
package ch.ehi.interlis.graphicdescriptions;
          ...
          /** Definiert bedingte Zuweisungen f¸r ein Signatur-Attribut.
...
/**
 * Definiert bedingte Zuweisungen f√ºr ein Signatur-Attribut.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:34:49 $
 */
public class CondSigParamAss extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #containsWhere
	 */
	// -beg- preserve=no 3961F8CF028E attach_head3961F7DF017A
	// "CondSigParamAss::attachWhere"
	public void attachWhere(Term where1)
	// -end- 3961F8CF028E attach_head3961F7DF017A "CondSigParamAss::attachWhere"
	{
		// -beg- preserve=no 3961F8CF028E attach_body3961F7DF017A
		// "CondSigParamAss::attachWhere"
		if (where != null) {
			throw new java.lang.IllegalStateException("already a where attached");
		}
		if (where1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as where");
		}
		where = where1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachWhere"));
		return;
		// -end- 3961F8CF028E attach_body3961F7DF017A
		// "CondSigParamAss::attachWhere"
	}
	 ...
	 * @see #attachWhere
	 */
	// -beg- preserve=no 3961F8CF028E detach_head3961F7DF017A
	// "CondSigParamAss::detachWhere"
	public Term detachWhere()
	// -end- 3961F8CF028E detach_head3961F7DF017A "CondSigParamAss::detachWhere"
	{
		// -beg- preserve=no 3961F8CF028E detach_body3961F7DF017A
		// "CondSigParamAss::detachWhere"
		Term ret = null;
		ret = where;
		where = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachWhere"));
		return ret;
		// -end- 3961F8CF028E detach_body3961F7DF017A
		// "CondSigParamAss::detachWhere"
	}
	 ...
	 * @see #attachWhere
	 */
	// -beg- preserve=no 3961F8CF028E get_head3961F7DF017A
	// "CondSigParamAss::getWhere"
	public Term getWhere()
	// -end- 3961F8CF028E get_head3961F7DF017A "CondSigParamAss::getWhere"
	{
		// -beg- preserve=no 3961F8CF028E get_body3961F7DF017A
		// "CondSigParamAss::getWhere"
		if (where == null) {
			throw new java.lang.IllegalStateException("no where attached");
		}
		return where;
		// -end- 3961F8CF028E get_body3961F7DF017A "CondSigParamAss::getWhere"
	}
	 ...
	 * @see #attachWhere
	 */
	// -beg- preserve=no 3961F8CF028E test_head3961F7DF017A
	// "CondSigParamAss::containsWhere"
	public boolean containsWhere()
	// -end- 3961F8CF028E test_head3961F7DF017A "CondSigParamAss::containsWhere"
	{
		// -beg- preserve=no 3961F8CF028E test_body3961F7DF017A
		// "CondSigParamAss::containsWhere"
		return where != null;
		// -end- 3961F8CF028E test_body3961F7DF017A
		// "CondSigParamAss::containsWhere"
	}
	 ...
	 * @see #sizeSigAssignment
	 */
	// -beg- preserve=no 3961F97801E8 add_head3961F7DF017A
	// "CondSigParamAss::addSigAssignment"
	public void addSigAssignment(SigAssignment sigAssignment1)
	// -end- 3961F97801E8 add_head3961F7DF017A
	// "CondSigParamAss::addSigAssignment"
	{
		// -beg- preserve=no 3961F97801E8 add_body3961F7DF017A
		// "CondSigParamAss::addSigAssignment"
		sigAssignment.add(sigAssignment1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addSigAssignment"));
		return;
		// -end- 3961F97801E8 add_body3961F7DF017A
		// "CondSigParamAss::addSigAssignment"
	}
	 ...
	 * @see #addSigAssignment
	 */
	// -beg- preserve=no 3961F97801E8 remove_head3961F7DF017A
	// "CondSigParamAss::removeSigAssignment"
	public SigAssignment removeSigAssignment(SigAssignment sigAssignment1)
	// -end- 3961F97801E8 remove_head3961F7DF017A
	// "CondSigParamAss::removeSigAssignment"
	{
		// -beg- preserve=no 3961F97801E8 remove_body3961F7DF017A
		// "CondSigParamAss::removeSigAssignment"
		SigAssignment ret = null;
		if (sigAssignment1 == null || !sigAssignment.contains(sigAssignment1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		sigAssignment.remove(sigAssignment1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeSigAssignment"));
		return ret;
		// -end- 3961F97801E8 remove_body3961F7DF017A
		// "CondSigParamAss::removeSigAssignment"
	}
	 ...
	 * @see #addSigAssignment
	 */
	// -beg- preserve=no 3961F97801E8 test_head3961F7DF017A
	// "CondSigParamAss::containsSigAssignment"
	public boolean containsSigAssignment(SigAssignment sigAssignment1)
	// -end- 3961F97801E8 test_head3961F7DF017A
	// "CondSigParamAss::containsSigAssignment"
	{
		// -beg- preserve=no 3961F97801E8 test_body3961F7DF017A
		// "CondSigParamAss::containsSigAssignment"
		return sigAssignment.contains(sigAssignment1);
		// -end- 3961F97801E8 test_body3961F7DF017A
		// "CondSigParamAss::containsSigAssignment"
	}
	...
	// "CondSigParamAss::iteratorSigAssignment"
	{
		// -beg- preserve=no 3961F97801E8 get_all_body3961F7DF017A
		// "CondSigParamAss::iteratorSigAssignment"
		return sigAssignment.iterator();
		// -end- 3961F97801E8 get_all_body3961F7DF017A
		// "CondSigParamAss::iteratorSigAssignment"
	}
	 ...
	 * @see #addSigAssignment
	 */
	// -beg- preserve=no 3961F97801E8 remove_all_head3961F7DF017A
	// "CondSigParamAss::clearSigAssignment"
	public void clearSigAssignment()
	// -end- 3961F97801E8 remove_all_head3961F7DF017A
	// "CondSigParamAss::clearSigAssignment"
	{
		// -beg- preserve=no 3961F97801E8 remove_all_body3961F7DF017A
		// "CondSigParamAss::clearSigAssignment"
		if (sizeSigAssignment() > 0) {
			sigAssignment.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearSigAssignment"));
		}
		// -end- 3961F97801E8 remove_all_body3961F7DF017A
		// "CondSigParamAss::clearSigAssignment"
	}
	 ...
	 * @see #addSigAssignment
	 */
	// -beg- preserve=no 3961F97801E8 size_head3961F7DF017A
	// "CondSigParamAss::sizeSigAssignment"
	public int sizeSigAssignment()
	// -end- 3961F97801E8 size_head3961F7DF017A
	// "CondSigParamAss::sizeSigAssignment"
	{
		// -beg- preserve=no 3961F97801E8 size_body3961F7DF017A
		// "CondSigParamAss::sizeSigAssignment"
		return sigAssignment.size();
		// -end- 3961F97801E8 size_body3961F7DF017A
		// "CondSigParamAss::sizeSigAssignment"
	}
