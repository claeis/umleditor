...
package ch.ehi.interlis.graphicdescriptions;
          ...
          /** Definiert den Werte eines Signatur-Parameters basierend auf einer Aufzählung.
...
/**
 * Definiert den Werte eines Signatur-Parameters basierend auf einer AufzÃ¤hlung.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:34:50 $
 */
public class EnumAssignment extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #containsConstant
	 */
	// -beg- preserve=no 3961FDC803D9 attach_head3961FCE30307
	// "EnumAssignment::attachConstant"
	public void attachConstant(Constant constant1)
	// -end- 3961FDC803D9 attach_head3961FCE30307
	// "EnumAssignment::attachConstant"
	{
		// -beg- preserve=no 3961FDC803D9 attach_body3961FCE30307
		// "EnumAssignment::attachConstant"
		if (constant != null) {
		...
		return;
		// -end- 3961FDC803D9 attach_body3961FCE30307
		// "EnumAssignment::attachConstant"
	}
	 ...
	 * @see #attachConstant
	 */
	// -beg- preserve=no 3961FDC803D9 detach_head3961FCE30307
	// "EnumAssignment::detachConstant"
	public Constant detachConstant()
	// -end- 3961FDC803D9 detach_head3961FCE30307
	// "EnumAssignment::detachConstant"
	{
		// -beg- preserve=no 3961FDC803D9 detach_body3961FCE30307
		// "EnumAssignment::detachConstant"
		Constant ret = null;
		ret = constant;
		constant = null;
		...
		return ret;
		// -end- 3961FDC803D9 detach_body3961FCE30307
		// "EnumAssignment::detachConstant"
	}
	 ...
	 * @see #attachConstant
	 */
	// -beg- preserve=no 3961FDC803D9 get_head3961FCE30307
	// "EnumAssignment::getConstant"
	public Constant getConstant()
	// -end- 3961FDC803D9 get_head3961FCE30307 "EnumAssignment::getConstant"
	{
		// -beg- preserve=no 3961FDC803D9 get_body3961FCE30307
		// "EnumAssignment::getConstant"
		if (constant == null) {
	 ...
	 * @see #attachConstant
	 */
	// -beg- preserve=no 3961FDC803D9 test_head3961FCE30307
	// "EnumAssignment::containsConstant"
	public boolean containsConstant()
	// -end- 3961FDC803D9 test_head3961FCE30307
	// "EnumAssignment::containsConstant"
	{
		// -beg- preserve=no 3961FDC803D9 test_body3961FCE30307
		// "EnumAssignment::containsConstant"
		return constant != null;
		// -end- 3961FDC803D9 test_body3961FCE30307
		// "EnumAssignment::containsConstant"
	}
	 ...
	 * @see #containsEnumRange
	 */
	// -beg- preserve=no 3961FDCE0049 attach_head3961FCE30307
	// "EnumAssignment::attachEnumRange"
	public void attachEnumRange(EnumRange enumRange1)
	// -end- 3961FDCE0049 attach_head3961FCE30307
	// "EnumAssignment::attachEnumRange"
	{
		// -beg- preserve=no 3961FDCE0049 attach_body3961FCE30307
		// "EnumAssignment::attachEnumRange"
		if (enumRange != null) {
			throw new java.lang.IllegalStateException("already a enumRange attached");
		}
		if (enumRange1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as enumRange");
		}
		enumRange = enumRange1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachEnumRange"));
		return;
		// -end- 3961FDCE0049 attach_body3961FCE30307
		// "EnumAssignment::attachEnumRange"
	}
	 ...
	 * @see #attachEnumRange
	 */
	// -beg- preserve=no 3961FDCE0049 detach_head3961FCE30307
	// "EnumAssignment::detachEnumRange"
	public EnumRange detachEnumRange()
	// -end- 3961FDCE0049 detach_head3961FCE30307
	// "EnumAssignment::detachEnumRange"
	{
		// -beg- preserve=no 3961FDCE0049 detach_body3961FCE30307
		// "EnumAssignment::detachEnumRange"
		EnumRange ret = null;
		ret = enumRange;
		enumRange = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachEnumRange"));
		return ret;
		// -end- 3961FDCE0049 detach_body3961FCE30307
		// "EnumAssignment::detachEnumRange"
	}
	 ...
	 * @see #attachEnumRange
	 */
	// -beg- preserve=no 3961FDCE0049 get_head3961FCE30307
	// "EnumAssignment::getEnumRange"
	public EnumRange getEnumRange()
	// -end- 3961FDCE0049 get_head3961FCE30307 "EnumAssignment::getEnumRange"
	{
		// -beg- preserve=no 3961FDCE0049 get_body3961FCE30307
		// "EnumAssignment::getEnumRange"
		if (enumRange == null) {
			throw new java.lang.IllegalStateException("no enumRange attached");
		}
		return enumRange;
		// -end- 3961FDCE0049 get_body3961FCE30307
		// "EnumAssignment::getEnumRange"
	}
	 ...
	 * @see #attachEnumRange
	 */
	// -beg- preserve=no 3961FDCE0049 test_head3961FCE30307
	// "EnumAssignment::containsEnumRange"
	public boolean containsEnumRange()
	// -end- 3961FDCE0049 test_head3961FCE30307
	// "EnumAssignment::containsEnumRange"
	{
		// -beg- preserve=no 3961FDCE0049 test_body3961FCE30307
		// "EnumAssignment::containsEnumRange"
		return enumRange != null;
		// -end- 3961FDCE0049 test_body3961FCE30307
		// "EnumAssignment::containsEnumRange"
	}
