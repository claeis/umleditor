...
public class Metaobject extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 3C1787A9025B attach_head3C17874F0020
	// "Metaobject::attachAbstractClassDef"
	public void attachAbstractClassDef(AbstractClassDef abstractClassDef1)
	// -end- 3C1787A9025B attach_head3C17874F0020
	// "Metaobject::attachAbstractClassDef"
	{
		// -beg- preserve=no 3C1787A9025B attach_body3C17874F0020
		// "Metaobject::attachAbstractClassDef"
		if (abstractClassDef != null) {
			throw new java.lang.IllegalStateException("already a abstractClassDef attached");
		}
		if (abstractClassDef1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as abstractClassDef");
		}
		abstractClassDef = abstractClassDef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachAbstractClassDef"));
		return;
		// -end- 3C1787A9025B attach_body3C17874F0020
		// "Metaobject::attachAbstractClassDef"
	}
	 ...
	 */
	// -beg- preserve=no 3C1787A9025B detach_head3C17874F0020
	// "Metaobject::detachAbstractClassDef"
	public AbstractClassDef detachAbstractClassDef()
	// -end- 3C1787A9025B detach_head3C17874F0020
	// "Metaobject::detachAbstractClassDef"
	{
		// -beg- preserve=no 3C1787A9025B detach_body3C17874F0020
		// "Metaobject::detachAbstractClassDef"
		AbstractClassDef ret = null;
		ret = abstractClassDef;
		abstractClassDef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachAbstractClassDef"));
		return ret;
		// -end- 3C1787A9025B detach_body3C17874F0020
		// "Metaobject::detachAbstractClassDef"
	}
	 ...
	 * @see #attachAbstractClassDef
	 */
	// -beg- preserve=no 3C1787A9025B get_head3C17874F0020
	// "Metaobject::getAbstractClassDef"
	public AbstractClassDef getAbstractClassDef()
	// -end- 3C1787A9025B get_head3C17874F0020 "Metaobject::getAbstractClassDef"
	{
		// -beg- preserve=no 3C1787A9025B get_body3C17874F0020
		// "Metaobject::getAbstractClassDef"
		if (abstractClassDef == null) {
			throw new java.lang.IllegalStateException("no abstractClassDef attached");
		}
		return abstractClassDef;
		// -end- 3C1787A9025B get_body3C17874F0020
		// "Metaobject::getAbstractClassDef"
	}
	 ...
	 * @see #attachAbstractClassDef
	 */
	// -beg- preserve=no 3C1787A9025B test_head3C17874F0020
	// "Metaobject::containsAbstractClassDef"
	public boolean containsAbstractClassDef()
	// -end- 3C1787A9025B test_head3C17874F0020
	// "Metaobject::containsAbstractClassDef"
	{
		// -beg- preserve=no 3C1787A9025B test_body3C17874F0020
		// "Metaobject::containsAbstractClassDef"
		return abstractClassDef != null;
		// -end- 3C1787A9025B test_body3C17874F0020
		// "Metaobject::containsAbstractClassDef"
	}
