...
public class ParameterDef extends AbstractModelElement implements IliSyntax, java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 3941016100A6 attach_head3940EE310270
	// "ParameterDef::attachClassDef"
	public void attachClassDef(ClassDef classDef1)
	// -end- 3941016100A6 attach_head3940EE310270 "ParameterDef::attachClassDef"
	{
		// -beg- preserve=no 3941016100A6 attach_body3940EE310270
		// "ParameterDef::attachClassDef"
		if (classDef != null) {
			throw new java.lang.IllegalStateException("already a classDef attached");
		}
		if (classDef1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as classDef");
		}
		classDef = classDef1;
		classDef1._linkParameterDef(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachClassDef"));
		return;
		// -end- 3941016100A6 attach_body3940EE310270
		// "ParameterDef::attachClassDef"
	}
	 ...
	 * @see #attachClassDef
	 */
	// -beg- preserve=no 3941016100A6 detach_head3940EE310270
	// "ParameterDef::detachClassDef"
	public ClassDef detachClassDef()
	// -end- 3941016100A6 detach_head3940EE310270 "ParameterDef::detachClassDef"
	{
		// -beg- preserve=no 3941016100A6 detach_body3940EE310270
		// "ParameterDef::detachClassDef"
		ClassDef ret = null;
		if (classDef != null) {
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachClassDef"));
		return ret;
		// -end- 3941016100A6 detach_body3940EE310270
		// "ParameterDef::detachClassDef"
	}
	 ...
	 * @see #attachClassDef
	 */
	// -beg- preserve=no 3941016100A6 get_head3940EE310270
	// "ParameterDef::getClassDef"
	public ClassDef getClassDef()
	// -end- 3941016100A6 get_head3940EE310270 "ParameterDef::getClassDef"
	{
		// -beg- preserve=no 3941016100A6 get_body3940EE310270
		// "ParameterDef::getClassDef"
		if (classDef == null) {
			throw new java.lang.IllegalStateException("no classDef attached");
		}
		return classDef;
	 ...
	 * @see #attachClassDef
	 */
	// -beg- preserve=no 3941016100A6 test_head3940EE310270
	// "ParameterDef::containsClassDef"
	public boolean containsClassDef()
	// -end- 3941016100A6 test_head3940EE310270 "ParameterDef::containsClassDef"
	{
		// -beg- preserve=no 3941016100A6 test_body3940EE310270
		// "ParameterDef::containsClassDef"
		return classDef != null;
		// -end- 3941016100A6 test_body3940EE310270
		// "ParameterDef::containsClassDef"
	}
	 ...
	 */
	// -beg- preserve=no 3941016100A6 _link_body3940EE310270
	// "ParameterDef::_linkClassDef"
	public void _linkClassDef(ClassDef classDef1) {
		classDef = classDef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkClassDef"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3941016100A6 _unlink_body3940EE310270
	// "ParameterDef::_unlinkClassDef"
	public void _unlinkClassDef(ClassDef classDef1) {
		classDef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkClassDef"));
		return;
	}
	// -end- 3941016100A6 _unlink_body3940EE310270
	// "ParameterDef::_unlinkClassDef"
	 ...
	 */
	// -beg- preserve=no 394748950003 attach_head3940EE310270
	// "ParameterDef::attachMetaobject"
	public void attachMetaobject(Metaobject metaobject1)
	// -end- 394748950003 attach_head3940EE310270
	// "ParameterDef::attachMetaobject"
	{
		// -beg- preserve=no 394748950003 attach_body3940EE310270
		// "ParameterDef::attachMetaobject"
		if (metaobject != null) {
			throw new java.lang.IllegalStateException("already a metaobject attached");
		}
		if (metaobject1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as metaobject");
		}
		metaobject = metaobject1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachMetaobject"));
		return;
		// -end- 394748950003 attach_body3940EE310270
		// "ParameterDef::attachMetaobject"
	}
	 ...
	 */
	// -beg- preserve=no 394748950003 detach_head3940EE310270
	// "ParameterDef::detachMetaobject"
	public Metaobject detachMetaobject()
	// -end- 394748950003 detach_head3940EE310270
	// "ParameterDef::detachMetaobject"
	{
		// -beg- preserve=no 394748950003 detach_body3940EE310270
		// "ParameterDef::detachMetaobject"
		Metaobject ret = null;
		ret = metaobject;
		metaobject = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachMetaobject"));
		return ret;
		// -end- 394748950003 detach_body3940EE310270
		// "ParameterDef::detachMetaobject"
	}
	 ...
	 * @see #attachMetaobject
	 */
	// -beg- preserve=no 394748950003 get_head3940EE310270
	// "ParameterDef::getMetaobject"
	public Metaobject getMetaobject()
	// -end- 394748950003 get_head3940EE310270 "ParameterDef::getMetaobject"
	{
		// -beg- preserve=no 394748950003 get_body3940EE310270
		// "ParameterDef::getMetaobject"
		if (metaobject == null) {
			throw new java.lang.IllegalStateException("no metaobject attached");
		}
		return metaobject;
	 ...
	 * @see #attachMetaobject
	 */
	// -beg- preserve=no 394748950003 test_head3940EE310270
	// "ParameterDef::containsMetaobject"
	public boolean containsMetaobject()
	// -end- 394748950003 test_head3940EE310270
	// "ParameterDef::containsMetaobject"
	{
		// -beg- preserve=no 394748950003 test_body3940EE310270
		// "ParameterDef::containsMetaobject"
		return metaobject != null;
		// -end- 394748950003 test_body3940EE310270
		// "ParameterDef::containsMetaobject"
	}
	 ...
	 */
	// -beg- preserve=no 3947491E0303 attach_head3940EE310270
	// "ParameterDef::attachAttrType"
	public void attachAttrType(AttrType attrType1)
	// -end- 3947491E0303 attach_head3940EE310270 "ParameterDef::attachAttrType"
	{
		// -beg- preserve=no 3947491E0303 attach_body3940EE310270
		// "ParameterDef::attachAttrType"
		if (attrType != null) {
		...
		return;
		// -end- 3947491E0303 attach_body3940EE310270
		// "ParameterDef::attachAttrType"
	}
	 ...
	 * @see #attachAttrType
	 */
	// -beg- preserve=no 3947491E0303 detach_head3940EE310270
	// "ParameterDef::detachAttrType"
	public AttrType detachAttrType()
	// -end- 3947491E0303 detach_head3940EE310270 "ParameterDef::detachAttrType"
	{
		// -beg- preserve=no 3947491E0303 detach_body3940EE310270
		// "ParameterDef::detachAttrType"
		AttrType ret = null;
		ret = attrType;
		attrType = null;
		...
		return ret;
		// -end- 3947491E0303 detach_body3940EE310270
		// "ParameterDef::detachAttrType"
	}
	 ...
	 * @see #attachAttrType
	 */
	// -beg- preserve=no 3947491E0303 get_head3940EE310270
	// "ParameterDef::getAttrType"
	public AttrType getAttrType()
	// -end- 3947491E0303 get_head3940EE310270 "ParameterDef::getAttrType"
	{
		// -beg- preserve=no 3947491E0303 get_body3940EE310270
		// "ParameterDef::getAttrType"
		if (attrType == null) {
	 ...
	 * @see #attachAttrType
	 */
	// -beg- preserve=no 3947491E0303 test_head3940EE310270
	// "ParameterDef::containsAttrType"
	public boolean containsAttrType()
	// -end- 3947491E0303 test_head3940EE310270 "ParameterDef::containsAttrType"
	{
		// -beg- preserve=no 3947491E0303 test_body3940EE310270
		// "ParameterDef::containsAttrType"
		return attrType != null;
		// -end- 3947491E0303 test_body3940EE310270
		// "ParameterDef::containsAttrType"
	}
	...
	/**
	 * get current value of name Name des Parameters
	 * 
	 * @see #setName
	 */
