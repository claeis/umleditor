...
public class UnlinkAllChildren extends ChildCollector
    ...
    //ch.softenvironment.util.Tracer.getInstance().debug(this, "unlinkThem()", "{{{start");
    ...
    while(it.hasNext()){
      ...
      if(obj instanceof ch.ehi.uml1_4.foundation.core.Element){
        //boolean old=false;
        //if(obj instanceof ch.ehi.interlis.modeltopicclass.ClassDef)old=ch.ehi.uml1_4.changepropagation.MetaModel.setEventLogging(true);
        ((ch.ehi.uml1_4.foundation.core.Element)obj).unlinkAll();
        //if(obj instanceof ch.ehi.interlis.modeltopicclass.ClassDef)ch.ehi.uml1_4.changepropagation.MetaModel.setEventLogging(old);
    ...
    //ch.softenvironment.util.Tracer.getInstance().debug(this, "unlinkThem()", "}}}end");
    return;
    ...
    return;
                ...
                // -end- 3CC66FC50093 head3CBD9E92024A "visitAbstractClassDef"
                  ...
                  {
                  // please fill in/modify the following section
                  // -beg- preserve=yes 3CC66FC50093 body3CBD9E92024A "visitAbstractClassDef"
