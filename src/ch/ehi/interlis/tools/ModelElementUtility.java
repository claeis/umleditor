...
public class ModelElementUtility {
	...
	// please fill in/modify the following section
	// -beg- preserve=no 3CB2F1BB01F2 throws3CC66649011E
	// "getReferencableElements"

	// -end- 3CB2F1BB01F2 throws3CC66649011E "getReferencableElements"
	{
		// please fill in/modify the following section
		// -beg- preserve=yes 3CB2F1BB01F2 body3CC66649011E
		// "getReferencableElements"
		// find ModelDef
		...
		if (root instanceof ModelDef) {
			...
			if (ch.ehi.uml1_4.tools.NamespaceUtility.deepContainsOwnedElement(umlmodel, ModelDef.class, "INTERLIS")) {
				ModelDef interlisModel = (ModelDef) ch.ehi.uml1_4.tools.NamespaceUtility.deepGetOwnedElement(umlmodel,
						ModelDef.class, "INTERLIS");
	...
	// -end- 3D58C7300021 throws3CC66649011E "getPeerElements"
	{
		...
		Namespace root = athis.getNamespace();
		while (!(root instanceof UmlModel || root instanceof ModelDef || root instanceof TopicDef)
			...
			while (iterator.hasNext()) {
				...
				if (aclass == null || aclass.isAssignableFrom(obj.getClass())) {
					if (obj instanceof UmlPackage) {
						// UmlPackages are not Interlis elements; therefore skip
						// them
					} else {
						children.add(obj);
					}
	...
	{
		// please fill in/modify the following section
		// -beg- preserve=yes 3D7F153B01F8 body3CC66649011E
		// "getIliQualifiedName"
	...
	// -end- 3E64146D02FB throws3CC66649011E "compareDefinition"
	{
		...
		/*
		 * 1. MetaDataUseDef 2. UnitDef 3. FunctionDef 4. LineFormTypeDef 5.
		 * DomainDef 6. RunTimeParameterDef 7. ClassDef 8. AssociationDef 9.
		 * ViewDef 10. GraphicDef 11. UmlPackage 12. TopicDef 13. ModelDef 14.
		 * INTERLIS2Def
		 */
		if (ordering == null) {
