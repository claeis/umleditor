...
public class IliPolyline extends LineType implements java.io.Serializable
              {
                ...
                /** get current value of directed
                 *  Sind die Linien gerichtet.
                 *  @see #setDirected
                 */
                ...
                // -end- 3948E2250111 set_head3948E1A4012A "directed"
                {
                  ...
                  if(directed != value1){
                    directed = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setDirected"));
                  }
