...
package ch.ehi.interlis.domainsandconstants.linetypes;
              ...
              /** Definiert die Art der zul‰ssigen Verbindungsgeometrien.
...
public class LineForm extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 * @see #sizeLineFormCmt
	 */
	// -beg- preserve=no 35B870CB0074 add_head35FB9EC803B9
	// "LineForm::addLineFormCmt"
	public void addLineFormCmt(LineFormCmt lineFormCmt1)
	// -end- 35B870CB0074 add_head35FB9EC803B9 "LineForm::addLineFormCmt"
	{
		// -beg- preserve=no 35B870CB0074 add_body35FB9EC803B9
		// "LineForm::addLineFormCmt"
		lineFormCmt.add(lineFormCmt1);
		lineFormCmt1._linkLineForm(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addLineFormCmt"));
		return;
		// -end- 35B870CB0074 add_body35FB9EC803B9 "LineForm::addLineFormCmt"
	}
	 ...
	 * @see #addLineFormCmt
	 */
	// -beg- preserve=no 35B870CB0074 remove_head35FB9EC803B9
	// "LineForm::removeLineFormCmt"
	public LineFormCmt removeLineFormCmt(LineFormCmt lineFormCmt1)
	// -end- 35B870CB0074 remove_head35FB9EC803B9 "LineForm::removeLineFormCmt"
	{
		// -beg- preserve=no 35B870CB0074 remove_body35FB9EC803B9
		// "LineForm::removeLineFormCmt"
		LineFormCmt ret = null;
		if (lineFormCmt1 == null || !lineFormCmt.contains(lineFormCmt1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		lineFormCmt1._unlinkLineForm(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeLineFormCmt"));
		return ret;
		// -end- 35B870CB0074 remove_body35FB9EC803B9
		// "LineForm::removeLineFormCmt"
	}
	 ...
	 * @see #addLineFormCmt
	 */
	// -beg- preserve=no 35B870CB0074 test_head35FB9EC803B9
	// "LineForm::containsLineFormCmt"
	public boolean containsLineFormCmt(LineFormCmt lineFormCmt1)
	// -end- 35B870CB0074 test_head35FB9EC803B9 "LineForm::containsLineFormCmt"
	{
		// -beg- preserve=no 35B870CB0074 test_body35FB9EC803B9
		// "LineForm::containsLineFormCmt"
		return lineFormCmt.contains(lineFormCmt1);
		// -end- 35B870CB0074 test_body35FB9EC803B9
		// "LineForm::containsLineFormCmt"
	}
	...
	// "LineForm::iteratorLineFormCmt"
	{
		// -beg- preserve=no 35B870CB0074 get_all_body35FB9EC803B9
		// "LineForm::iteratorLineFormCmt"
		return lineFormCmt.iterator();
		// -end- 35B870CB0074 get_all_body35FB9EC803B9
		// "LineForm::iteratorLineFormCmt"
	}
	 ...
	 * @see #addLineFormCmt
	 */
	// -beg- preserve=no 35B870CB0074 remove_all_head35FB9EC803B9
	// "LineForm::clearLineFormCmt"
	public void clearLineFormCmt()
	// -end- 35B870CB0074 remove_all_head35FB9EC803B9
	// "LineForm::clearLineFormCmt"
	{
		...
		if (sizeLineFormCmt() > 0) {
			...
			lineFormCmt.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearLineFormCmt"));
		}
		// -end- 35B870CB0074 remove_all_body35FB9EC803B9
		// "LineForm::clearLineFormCmt"
	}
	 ...
	 * @see #addLineFormCmt
	 */
	// -beg- preserve=no 35B870CB0074 size_head35FB9EC803B9
	// "LineForm::sizeLineFormCmt"
	public int sizeLineFormCmt()
	// -end- 35B870CB0074 size_head35FB9EC803B9 "LineForm::sizeLineFormCmt"
	{
		// -beg- preserve=no 35B870CB0074 size_body35FB9EC803B9
		// "LineForm::sizeLineFormCmt"
		return lineFormCmt.size();
		// -end- 35B870CB0074 size_body35FB9EC803B9 "LineForm::sizeLineFormCmt"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35B870CB0074 _link_body35FB9EC803B9
	// "LineForm::_linkLineFormCmt"
	public void _linkLineFormCmt(LineFormCmt lineFormCmt1) {
		lineFormCmt.add(lineFormCmt1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkLineFormCmt"));
		return;
	}
	// -end- 35B870CB0074 _link_body35FB9EC803B9 "LineForm::_linkLineFormCmt"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35B870CB0074 _unlink_body35FB9EC803B9
	// "LineForm::_unlinkLineFormCmt"
	public void _unlinkLineFormCmt(LineFormCmt lineFormCmt1) {
		lineFormCmt.remove(lineFormCmt1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkLineFormCmt"));
		return;
	}
	// -end- 35B870CB0074 _unlink_body35FB9EC803B9
	// "LineForm::_unlinkLineFormCmt"
	 ...
	 * @see #containsLineType
	 */
	// -beg- preserve=no 35FB9EE500F4 attach_head35FB9EC803B9
	// "LineForm::attachLineType"
	public void attachLineType(LineType lineType1)
	// -end- 35FB9EE500F4 attach_head35FB9EC803B9 "LineForm::attachLineType"
	{
		// -beg- preserve=no 35FB9EE500F4 attach_body35FB9EC803B9
		// "LineForm::attachLineType"
		if (lineType != null) {
	 ...
	 * @see #attachLineType
	 */
	// -beg- preserve=no 35FB9EE500F4 detach_head35FB9EC803B9
	// "LineForm::detachLineType"
	public LineType detachLineType()
	// -end- 35FB9EE500F4 detach_head35FB9EC803B9 "LineForm::detachLineType"
	{
		// -beg- preserve=no 35FB9EE500F4 detach_body35FB9EC803B9
		// "LineForm::detachLineType"
		LineType ret = null;
		if (lineType != null) {
			lineType._unlinkLineForm(this);
	 ...
	 * @see #attachLineType
	 */
	// -beg- preserve=no 35FB9EE500F4 get_head35FB9EC803B9
	// "LineForm::getLineType"
	public LineType getLineType()
	// -end- 35FB9EE500F4 get_head35FB9EC803B9 "LineForm::getLineType"
	{
		// -beg- preserve=no 35FB9EE500F4 get_body35FB9EC803B9
		// "LineForm::getLineType"
		if (lineType == null) {
	 ...
	 * @see #attachLineType
	 */
	// -beg- preserve=no 35FB9EE500F4 test_head35FB9EC803B9
	// "LineForm::containsLineType"
	public boolean containsLineType()
	// -end- 35FB9EE500F4 test_head35FB9EC803B9 "LineForm::containsLineType"
	{
		// -beg- preserve=no 35FB9EE500F4 test_body35FB9EC803B9
		// "LineForm::containsLineType"
		return lineType != null;
		// -end- 35FB9EE500F4 test_body35FB9EC803B9 "LineForm::containsLineType"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35FB9EE500F4 _link_body35FB9EC803B9
	// "LineForm::_linkLineType"
	public void _linkLineType(LineType lineType1) {
		lineType = lineType1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35FB9EE500F4 _unlink_body35FB9EC803B9
	// "LineForm::_unlinkLineType"
	public void _unlinkLineType(LineType lineType1) {
		lineType = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	 ...
	 * @see #sizeLineFormTypeDef
	 */
	// -beg- preserve=no 3948EB9801CF add_head35FB9EC803B9
	// "LineForm::addLineFormTypeDef"
	public void addLineFormTypeDef(LineFormTypeDef lineFormTypeDef1)
	// -end- 3948EB9801CF add_head35FB9EC803B9 "LineForm::addLineFormTypeDef"
	{
		// -beg- preserve=no 3948EB9801CF add_body35FB9EC803B9
		// "LineForm::addLineFormTypeDef"
		lineFormTypeDef.add(lineFormTypeDef1);
		lineFormTypeDef1._linkLineForm(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
		...
		return;
		// -end- 3948EB9801CF add_body35FB9EC803B9
		// "LineForm::addLineFormTypeDef"
	}
	 ...
	 * @see #addLineFormTypeDef
	 */
	// -beg- preserve=no 3948EB9801CF remove_head35FB9EC803B9
	// "LineForm::removeLineFormTypeDef"
	public LineFormTypeDef removeLineFormTypeDef(LineFormTypeDef lineFormTypeDef1)
	// -end- 3948EB9801CF remove_head35FB9EC803B9
	// "LineForm::removeLineFormTypeDef"
	{
		// -beg- preserve=no 3948EB9801CF remove_body35FB9EC803B9
		// "LineForm::removeLineFormTypeDef"
		LineFormTypeDef ret = null;
		if (lineFormTypeDef1 == null || !lineFormTypeDef.contains(lineFormTypeDef1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		return ret;
		// -end- 3948EB9801CF remove_body35FB9EC803B9
		// "LineForm::removeLineFormTypeDef"
	}
	 ...
	 * @see #addLineFormTypeDef
	 */
	// -beg- preserve=no 3948EB9801CF test_head35FB9EC803B9
	// "LineForm::containsLineFormTypeDef"
	public boolean containsLineFormTypeDef(LineFormTypeDef lineFormTypeDef1)
	// -end- 3948EB9801CF test_head35FB9EC803B9
	// "LineForm::containsLineFormTypeDef"
	{
		// -beg- preserve=no 3948EB9801CF test_body35FB9EC803B9
		// "LineForm::containsLineFormTypeDef"
		return lineFormTypeDef.contains(lineFormTypeDef1);
		// -end- 3948EB9801CF test_body35FB9EC803B9
		// "LineForm::containsLineFormTypeDef"
	}
	...
	// "LineForm::iteratorLineFormTypeDef"
	{
		// -beg- preserve=no 3948EB9801CF get_all_body35FB9EC803B9
		// "LineForm::iteratorLineFormTypeDef"
		return lineFormTypeDef.iterator();
		// -end- 3948EB9801CF get_all_body35FB9EC803B9
		// "LineForm::iteratorLineFormTypeDef"
	}
	 ...
	 * @see #addLineFormTypeDef
	 */
	// -beg- preserve=no 3948EB9801CF remove_all_head35FB9EC803B9
	// "LineForm::clearLineFormTypeDef"
	public void clearLineFormTypeDef()
	// -end- 3948EB9801CF remove_all_head35FB9EC803B9
	// "LineForm::clearLineFormTypeDef"
	{
		...
		// -end- 3948EB9801CF remove_all_body35FB9EC803B9
		// "LineForm::clearLineFormTypeDef"
	}
	 ...
	 * @see #addLineFormTypeDef
	 */
	// -beg- preserve=no 3948EB9801CF size_head35FB9EC803B9
	// "LineForm::sizeLineFormTypeDef"
	public int sizeLineFormTypeDef()
	// -end- 3948EB9801CF size_head35FB9EC803B9 "LineForm::sizeLineFormTypeDef"
	{
		// -beg- preserve=no 3948EB9801CF size_body35FB9EC803B9
		// "LineForm::sizeLineFormTypeDef"
		return lineFormTypeDef.size();
		// -end- 3948EB9801CF size_body35FB9EC803B9
		// "LineForm::sizeLineFormTypeDef"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3948EB9801CF _link_body35FB9EC803B9
	// "LineForm::_linkLineFormTypeDef"
	public void _linkLineFormTypeDef(LineFormTypeDef lineFormTypeDef1) {
		lineFormTypeDef.add(lineFormTypeDef1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	...
	// -end- 3948EB9801CF _link_body35FB9EC803B9
	// "LineForm::_linkLineFormTypeDef"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3948EB9801CF _unlink_body35FB9EC803B9
	// "LineForm::_unlinkLineFormTypeDef"
	public void _unlinkLineFormTypeDef(LineFormTypeDef lineFormTypeDef1) {
		lineFormTypeDef.remove(lineFormTypeDef1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	...
	// -end- 3948EB9801CF _unlink_body35FB9EC803B9
	// "LineForm::_unlinkLineFormTypeDef"
	...
	// -end- 3CCC22EB03B4 set_head35FB9EC803B9 "straights"
	{
		...
		if (straights != value1) {
			straights = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setStraights"));
		}
		// -end- 3CCC22EB03B4 set_body35FB9EC803B9 "straights"
	}
	...
	// -end- 3CCC22FD0283 set_head35FB9EC803B9 "arcs"
	{
		...
		if (arcs != value1) {
			arcs = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setArcs"));
		}
		// -end- 3CCC22FD0283 set_body35FB9EC803B9 "arcs"
	}
