...
public class IntersectionDef extends AbstractEditorElement implements Element , java.io.Serializable
              {
                 ...
                 */
                // -beg- preserve=no 35B8730B01C6 attach_head35B872AB0146 "IntersectionDef::attachLineType"
                public void attachLineType(LineType lineType1)
                // -end- 35B8730B01C6 attach_head35B872AB0146 "IntersectionDef::attachLineType"
                {
                  // -beg- preserve=no 35B8730B01C6 attach_body35B872AB0146 "IntersectionDef::attachLineType"
                  ...
                  return;
                  // -end- 35B8730B01C6 attach_body35B872AB0146 "IntersectionDef::attachLineType"
                }

                /** disconnect the currently attached LineType.
                 *  @see #attachLineType
                 */
                // -beg- preserve=no 35B8730B01C6 detach_head35B872AB0146 "IntersectionDef::detachLineType"
                public LineType detachLineType()
                // -end- 35B8730B01C6 detach_head35B872AB0146 "IntersectionDef::detachLineType"
                {
                  // -beg- preserve=no 35B8730B01C6 detach_body35B872AB0146 "IntersectionDef::detachLineType"
                  LineType ret = null;
                  if(lineType!=null){
                  ...
                  return ret;
                  // -end- 35B8730B01C6 detach_body35B872AB0146 "IntersectionDef::detachLineType"
                }

                /** get the currently attached LineType.
                 *  @see #attachLineType
                 */
                // -beg- preserve=no 35B8730B01C6 get_head35B872AB0146 "IntersectionDef::getLineType"
                public LineType getLineType()
                // -end- 35B8730B01C6 get_head35B872AB0146 "IntersectionDef::getLineType"
                {
                  // -beg- preserve=no 35B8730B01C6 get_body35B872AB0146 "IntersectionDef::getLineType"
                  if(lineType==null) {throw new java.lang.IllegalStateException("no lineType attached");}
                  return lineType;
                  // -end- 35B8730B01C6 get_body35B872AB0146 "IntersectionDef::getLineType"
                }

                /** tests if there is a LineType attached.
                 *  @see #attachLineType
                 */
                // -beg- preserve=no 35B8730B01C6 test_head35B872AB0146 "IntersectionDef::containsLineType"
                public boolean containsLineType()
                // -end- 35B8730B01C6 test_head35B872AB0146 "IntersectionDef::containsLineType"
                {
                  // -beg- preserve=no 35B8730B01C6 test_body35B872AB0146 "IntersectionDef::containsLineType"
                  return lineType!=null;
                  // -end- 35B8730B01C6 test_body35B872AB0146 "IntersectionDef::containsLineType"
                }

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 35B8730B01C6 _link_body35B872AB0146 "IntersectionDef::_linkLineType"
                ...
                // -end- 35B8730B01C6 _link_body35B872AB0146 "IntersectionDef::_linkLineType"

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 35B8730B01C6 _unlink_body35B872AB0146 "IntersectionDef::_unlinkLineType"
                ...
                // -end- 35B8730B01C6 _unlink_body35B872AB0146 "IntersectionDef::_unlinkLineType"
...
public class IntersectionDef extends AbstractEditorElement implements Element, java.io.Serializable {
	...
	/**
	 * get current value of maxi Toleranzwert fÃ¼r Ãœberschnneidungen
	 * 
	 * @see #setMaxi
	 */
	// -beg- preserve=no 35B873200343 get_head35B872AB0146 "maxi"
