...
public class Ili1ControlPoints extends AbstractEditorElement implements java.io.Serializable
              {
                ...
                // -end- 3D4FA21B031A head358A6CDF004B "enumerateChildren"
                  ...
                  if(containsCoord())visitor.visit(getCoord());
                 ...
                 */
                // -beg- preserve=no 358A6CE902EE attach_head358A6CDF004B "Ili1ControlPoints::attachLineType"
                public void attachLineType(LineType lineType1)
                // -end- 358A6CE902EE attach_head358A6CDF004B "Ili1ControlPoints::attachLineType"
                {
                  // -beg- preserve=no 358A6CE902EE attach_body358A6CDF004B "Ili1ControlPoints::attachLineType"
                  ...
                  return;
                  // -end- 358A6CE902EE attach_body358A6CDF004B "Ili1ControlPoints::attachLineType"
                }

                /** disconnect the currently attached LineType.
                 *  @see #attachLineType
                 */
                // -beg- preserve=no 358A6CE902EE detach_head358A6CDF004B "Ili1ControlPoints::detachLineType"
                public LineType detachLineType()
                // -end- 358A6CE902EE detach_head358A6CDF004B "Ili1ControlPoints::detachLineType"
                {
                  // -beg- preserve=no 358A6CE902EE detach_body358A6CDF004B "Ili1ControlPoints::detachLineType"
                  LineType ret = null;
                  if(lineType!=null){
                  ...
                  return ret;
                  // -end- 358A6CE902EE detach_body358A6CDF004B "Ili1ControlPoints::detachLineType"
                }

                /** get the currently attached LineType.
                 *  @see #attachLineType
                 */
                // -beg- preserve=no 358A6CE902EE get_head358A6CDF004B "Ili1ControlPoints::getLineType"
                public LineType getLineType()
                // -end- 358A6CE902EE get_head358A6CDF004B "Ili1ControlPoints::getLineType"
                {
                  // -beg- preserve=no 358A6CE902EE get_body358A6CDF004B "Ili1ControlPoints::getLineType"
                  if(lineType==null) {throw new java.lang.IllegalStateException("no lineType attached");}
                  return lineType;
                  // -end- 358A6CE902EE get_body358A6CDF004B "Ili1ControlPoints::getLineType"
                }

                /** tests if there is a LineType attached.
                 *  @see #attachLineType
                 */
                // -beg- preserve=no 358A6CE902EE test_head358A6CDF004B "Ili1ControlPoints::containsLineType"
                public boolean containsLineType()
                // -end- 358A6CE902EE test_head358A6CDF004B "Ili1ControlPoints::containsLineType"
                {
                  // -beg- preserve=no 358A6CE902EE test_body358A6CDF004B "Ili1ControlPoints::containsLineType"
                  return lineType!=null;
                  // -end- 358A6CE902EE test_body358A6CDF004B "Ili1ControlPoints::containsLineType"
                }

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 358A6CE902EE _link_body358A6CDF004B "Ili1ControlPoints::_linkLineType"
                ...
                // -end- 358A6CE902EE _link_body358A6CDF004B "Ili1ControlPoints::_linkLineType"

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 358A6CE902EE _unlink_body358A6CDF004B "Ili1ControlPoints::_unlinkLineType"
                ...
                // -end- 358A6CE902EE _unlink_body358A6CDF004B "Ili1ControlPoints::_unlinkLineType"
                 ...
                 *  @see #containsCoord
                 */
                // -beg- preserve=no 370E081E0090 attach_head358A6CDF004B "Ili1ControlPoints::attachCoord"
                public void attachCoord(DomainAttribute coord1)
                // -end- 370E081E0090 attach_head358A6CDF004B "Ili1ControlPoints::attachCoord"
                {
                  // -beg- preserve=no 370E081E0090 attach_body358A6CDF004B "Ili1ControlPoints::attachCoord"
                  if(coord!=null) {throw new java.lang.IllegalStateException("already a coord attached");}
                  if(coord1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as coord");}
                  coord = coord1;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachCoord"));
                  return;
                  // -end- 370E081E0090 attach_body358A6CDF004B "Ili1ControlPoints::attachCoord"
                }

                /** disconnect the currently attached Coord.
                 *  @see #attachCoord
                 */
                // -beg- preserve=no 370E081E0090 detach_head358A6CDF004B "Ili1ControlPoints::detachCoord"
                public DomainAttribute detachCoord()
                // -end- 370E081E0090 detach_head358A6CDF004B "Ili1ControlPoints::detachCoord"
                {
                  // -beg- preserve=no 370E081E0090 detach_body358A6CDF004B "Ili1ControlPoints::detachCoord"
                  DomainAttribute ret = null;
                  ret = coord;
                  coord = null;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachCoord"));
                  return ret;
                  // -end- 370E081E0090 detach_body358A6CDF004B "Ili1ControlPoints::detachCoord"
                }

                /** get the currently attached Coord.
                 *  @see #attachCoord
                 */
                // -beg- preserve=no 370E081E0090 get_head358A6CDF004B "Ili1ControlPoints::getCoord"
                public DomainAttribute getCoord()
                // -end- 370E081E0090 get_head358A6CDF004B "Ili1ControlPoints::getCoord"
                {
                  // -beg- preserve=no 370E081E0090 get_body358A6CDF004B "Ili1ControlPoints::getCoord"
                  if(coord==null) {throw new java.lang.IllegalStateException("no coord attached");}
                  return coord;
                 ...
                 *  @see #attachCoord
                 */
                // -beg- preserve=no 370E081E0090 test_head358A6CDF004B "Ili1ControlPoints::containsCoord"
                public boolean containsCoord()
                // -end- 370E081E0090 test_head358A6CDF004B "Ili1ControlPoints::containsCoord"
                {
                  // -beg- preserve=no 370E081E0090 test_body358A6CDF004B "Ili1ControlPoints::containsCoord"
                  return coord!=null;
                  // -end- 370E081E0090 test_body358A6CDF004B "Ili1ControlPoints::containsCoord"
                }
                ...
                /** get current value of constraints
                 *  zusaetzliche Bedingung fuer die Stuetzpunkte.
                 *  @see #setConstraints
                 */
                ...
                // -end- 358A6D1200C6 set_head358A6CDF004B "constraints"
                {
                  ...
                  if(constraints!=value1 && (constraints==null || !constraints.equals(value1))){
                    constraints = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setConstraints"));
                  }
...
/**
 * Definiert den Wertebereich fÃ¼r die StÃ¼tzpunkte der Linie.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:34:36 $
 */
