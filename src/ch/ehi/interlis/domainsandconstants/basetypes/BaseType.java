...
public abstract class BaseType extends Type implements java.io.Serializable
              {
                 ...
                 *  @see #sizeOidType
                 */
                // -beg- preserve=no 3FDC4BA900E5 add_head358A64F7038A "BaseType::addOidType"
                public void addOidType(OidType oidType1)
                // -end- 3FDC4BA900E5 add_head358A64F7038A "BaseType::addOidType"
                {
                  // -beg- preserve=no 3FDC4BA900E5 add_body358A64F7038A "BaseType::addOidType"
                  oidType.add(oidType1);
                  oidType1._linkOiddomain(this);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addOidType"));
                  return;
                 ...
                 *  @see #addOidType
                 */
                // -beg- preserve=no 3FDC4BA900E5 remove_head358A64F7038A "BaseType::removeOidType"
                public OidType removeOidType(OidType oidType1)
                // -end- 3FDC4BA900E5 remove_head358A64F7038A "BaseType::removeOidType"
                {
                  // -beg- preserve=no 3FDC4BA900E5 remove_body358A64F7038A "BaseType::removeOidType"
                  OidType ret=null;
                  ...
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeOidType"));
                  return ret;
                 ...
                 *  @see #addOidType
                 */
                // -beg- preserve=no 3FDC4BA900E5 test_head358A64F7038A "BaseType::containsOidType"
                public boolean containsOidType(OidType oidType1)
                // -end- 3FDC4BA900E5 test_head358A64F7038A "BaseType::containsOidType"
                {
                  // -beg- preserve=no 3FDC4BA900E5 test_body358A64F7038A "BaseType::containsOidType"
                 ...
                 *  @see #addOidType
                 */
                // -beg- preserve=no 3FDC4BA900E5 get_all_head358A64F7038A "BaseType::iteratorOidType"
                public java.util.Iterator iteratorOidType()
                // -end- 3FDC4BA900E5 get_all_head358A64F7038A "BaseType::iteratorOidType"
                {
                  // -beg- preserve=no 3FDC4BA900E5 get_all_body358A64F7038A "BaseType::iteratorOidType"
                  return oidType.iterator();
                  // -end- 3FDC4BA900E5 get_all_body358A64F7038A "BaseType::iteratorOidType"
                }

                /** disconnect all OidTypes.
                 *  @see #addOidType
                 */
                // -beg- preserve=no 3FDC4BA900E5 remove_all_head358A64F7038A "BaseType::clearOidType"
                public void clearOidType()
                // -end- 3FDC4BA900E5 remove_all_head358A64F7038A "BaseType::clearOidType"
                {
                  // -beg- preserve=no 3FDC4BA900E5 remove_all_body358A64F7038A "BaseType::clearOidType"
                  if(sizeOidType()>0){
                    for(java.util.Iterator p = oidType.iterator(); p.hasNext();){
                      ((OidType)p.next())._unlinkOiddomain(this);
                    }
                    oidType.clear();
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearOidType"));
                  }
                  // -end- 3FDC4BA900E5 remove_all_body358A64F7038A "BaseType::clearOidType"
                }

                /** returns the number of OidTypes.
                 *  @see #addOidType
                 */
                // -beg- preserve=no 3FDC4BA900E5 size_head358A64F7038A "BaseType::sizeOidType"
                public int sizeOidType()
                // -end- 3FDC4BA900E5 size_head358A64F7038A "BaseType::sizeOidType"
                {
                  // -beg- preserve=no 3FDC4BA900E5 size_body358A64F7038A "BaseType::sizeOidType"
                  return oidType.size();
                 ...
                 */
                // -beg- preserve=no 3FDC4BA900E5 _link_body358A64F7038A "BaseType::_linkOidType"
                public void _linkOidType(OidType oidType1)
                {
                  oidType.add(oidType1);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkOidType"));
                  return;
                }
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 3FDC4BA900E5 _unlink_body358A64F7038A "BaseType::_unlinkOidType"
                public void _unlinkOidType(OidType oidType1)
                {
                  oidType.remove(oidType1);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkOidType"));
                  return;
                }
