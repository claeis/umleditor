...
public class StructUnitConst extends Constant implements java.io.Serializable {
	 ...
	 * @see #containsUnitDef
	 */
	// -beg- preserve=no 3948D832026D attach_head3948D4320116
	// "StructUnitConst::attachUnitDef"
	public void attachUnitDef(UnitDef unitDef1)
	// -end- 3948D832026D attach_head3948D4320116
	// "StructUnitConst::attachUnitDef"
	{
		// -beg- preserve=no 3948D832026D attach_body3948D4320116
		// "StructUnitConst::attachUnitDef"
		if (unitDef != null) {
		...
		return;
		// -end- 3948D832026D attach_body3948D4320116
		// "StructUnitConst::attachUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 3948D832026D detach_head3948D4320116
	// "StructUnitConst::detachUnitDef"
	public UnitDef detachUnitDef()
	// -end- 3948D832026D detach_head3948D4320116
	// "StructUnitConst::detachUnitDef"
	{
		// -beg- preserve=no 3948D832026D detach_body3948D4320116
		// "StructUnitConst::detachUnitDef"
		UnitDef ret = null;
		ret = unitDef;
		unitDef = null;
		...
		return ret;
		// -end- 3948D832026D detach_body3948D4320116
		// "StructUnitConst::detachUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 3948D832026D get_head3948D4320116
	// "StructUnitConst::getUnitDef"
	public UnitDef getUnitDef()
	// -end- 3948D832026D get_head3948D4320116 "StructUnitConst::getUnitDef"
	{
		// -beg- preserve=no 3948D832026D get_body3948D4320116
		// "StructUnitConst::getUnitDef"
		if (unitDef == null) {
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 3948D832026D test_head3948D4320116
	// "StructUnitConst::containsUnitDef"
	public boolean containsUnitDef()
	// -end- 3948D832026D test_head3948D4320116
	// "StructUnitConst::containsUnitDef"
	{
		// -beg- preserve=no 3948D832026D test_body3948D4320116
		// "StructUnitConst::containsUnitDef"
		return unitDef != null;
		// -end- 3948D832026D test_body3948D4320116
		// "StructUnitConst::containsUnitDef"
	}
	...
	/**
	 * get current value of structDec Wert
	 * 
	 * @see #setStructDec
	 */
	...
	// -end- 3948D47B0270 set_head3948D4320116 "structDec"
	{
		...
		if (structDec != value1 && (structDec == null || !structDec.equals(value1))) {
			structDec = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setStructDec"));
		}
