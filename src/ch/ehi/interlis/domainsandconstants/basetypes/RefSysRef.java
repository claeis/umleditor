...
public class RefSysRef extends AbstractEditorElement implements java.io.Serializable
              {
                 ...
                 */
                // -beg- preserve=no 397D982202B2 attach_head39489AFF0050 "RefSysRef::attachDefinition"
                ...
                {
                  // -beg- preserve=no 397D982202B2 attach_body39489AFF0050 "RefSysRef::attachDefinition"
                  if(definition!=null) {throw new java.lang.IllegalStateException("already a definition attached");}
                  if(definition1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as definition");}
                  definition = definition1;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachDefinition"));
                  return;
                  // -end- 397D982202B2 attach_body39489AFF0050 "RefSysRef::attachDefinition"
                }

                /** disconnect the currently attached Definition.
                 *  @see #attachDefinition
                 */
                // -beg- preserve=no 397D982202B2 detach_head39489AFF0050 "RefSysRef::detachDefinition"
                public AbstractClassDef detachDefinition()
                // -end- 397D982202B2 detach_head39489AFF0050 "RefSysRef::detachDefinition"
                {
                  // -beg- preserve=no 397D982202B2 detach_body39489AFF0050 "RefSysRef::detachDefinition"
                  AbstractClassDef ret = null;
                  ret = definition;
                  definition = null;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachDefinition"));
                  return ret;
                  // -end- 397D982202B2 detach_body39489AFF0050 "RefSysRef::detachDefinition"
                }

                /** get the currently attached Definition.
                 *  @see #attachDefinition
                 */
                // -beg- preserve=no 397D982202B2 get_head39489AFF0050 "RefSysRef::getDefinition"
                public AbstractClassDef getDefinition()
                // -end- 397D982202B2 get_head39489AFF0050 "RefSysRef::getDefinition"
                {
                  // -beg- preserve=no 397D982202B2 get_body39489AFF0050 "RefSysRef::getDefinition"
                  if(definition==null) {throw new java.lang.IllegalStateException("no definition attached");}
                  return definition;
                 ...
                 *  @see #attachDefinition
                 */
                // -beg- preserve=no 397D982202B2 test_head39489AFF0050 "RefSysRef::containsDefinition"
                public boolean containsDefinition()
                // -end- 397D982202B2 test_head39489AFF0050 "RefSysRef::containsDefinition"
                {
                  // -beg- preserve=no 397D982202B2 test_body39489AFF0050 "RefSysRef::containsDefinition"
                  return definition!=null;
                  // -end- 397D982202B2 test_body39489AFF0050 "RefSysRef::containsDefinition"
                }
                 ...
                 *  Name des Modells das die Definition enthaelt.
                 *  @see #setModelName
                 */
                ...
                // -end- 39489C8D0143 set_head39489AFF0050 "modelName"
                {
                  ...
                  if(modelName!=value1 && (modelName==null || !modelName.equals(value1))){
                    modelName = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setModelName"));
                  }
                 ...
                 *  Name des Themas das die Definition enthaelt.
                 *  @see #setTopicName
                 */
                ...
                // -end- 39489C970147 set_head39489AFF0050 "topicName"
                {
                  ...
                  if(topicName!=value1 && (topicName==null || !topicName.equals(value1))){
                    topicName = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setTopicName"));
                  }
                ...
                /** get current value of className
                 *  Name der Klasse
                 *  @see #setClassName
                 */
                ...
                // -end- 39489C9D0362 set_head39489AFF0050 "className"
                {
                  ...
                  if(className!=value1 && (className==null || !className.equals(value1))){
                    className = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setClassName"));
                  }
                ...
                /** get current value of refsysName
                 *  Name des Referenzsystem-Objektes in der Transferdatei
                 *  @see #setRefsysName
                 */
                ...
                // -end- 39489CA4015A set_head39489AFF0050 "refsysName"
                {
                  ...
                  if(refsysName!=value1 && (refsysName==null || !refsysName.equals(value1))){
                    refsysName = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setRefsysName"));
                  }
