...
// -end- 38F1E21C0116 set_head38F1E1320160 "value"
{
        ...
        if(value != value1) {
                value = value1;
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setValue"));
        }
...
/** get current value of base10shift
 *  Exponent
 *  @see #setBase10shift
 */
...
// -end- 38F1E22F0128 set_head38F1E1320160 "base10shift"
{
        ...
        if(base10shift != value1) {
                base10shift = value1;
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setBase10shift"));
        }
...
/** get current value of accuracy
 *  Genauigkeit in Anzahl Nachkommastellen
 *  @see #setAccuracy
 */
...
// -end- 38F1E23C0108 set_head38F1E1320160 "accuracy"
{
        ...
        if(accuracy != value1) {
                accuracy = value1;
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setAccuracy"));
        }
