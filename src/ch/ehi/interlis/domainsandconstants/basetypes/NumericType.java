...
public class NumericType extends NumericalType implements java.io.Serializable {
	...
	/**
	 * get current value of rangeDefined sind minDec und maxDec definiert
	 * 
	 * @see #setRangeDefined
	 */
	...
	// -end- 39489FB30336 set_head394882EB009D "rangeDefined"
	{
		...
		if (rangeDefined != value1) {
			...
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setRangeDefined"));
		}
	...
	/**
	 * get current value of minDec min Wert
	 * 
	 * @see #setMinDec
	 */
	...
	// -end- 39489FCF012E set_head394882EB009D "minDec"
	{
		...
		if (minDec != value1 && (minDec == null || !minDec.equals(value1))) {
			minDec = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMinDec"));
		}
	...
	/**
	 * get current value of maxDec max Wert
	 * 
	 * @see #setMaxDec
	 */
	...
	// -end- 39489FD70298 set_head394882EB009D "maxDec"
	{
		...
		if (maxDec != value1 && (maxDec == null || !maxDec.equals(value1))) {
			maxDec = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMaxDec"));
		}
