 ...
 *  @version $Revision: 1.2 $ $Date: 2006-06-13 14:26:18 $
 */
public class Text extends BaseType implements java.io.Serializable
{
  ...
  // -beg- preserve=no 44897C74011E var358A670D0143 "isMultiline"
  private boolean isMultiline;
  // -end- 44897C74011E var358A670D0143 "isMultiline"

  /** get current value of isMultiline
   *  @see #setMultiline
   */
  // -beg- preserve=no 44897C74011E get_head358A670D0143 "isMultiline"
  public  boolean isMultiline()
  // -end- 44897C74011E get_head358A670D0143 "isMultiline"
  {
    // -beg- preserve=no 44897C74011E get_body358A670D0143 "isMultiline"
    return isMultiline;
    // -end- 44897C74011E get_body358A670D0143 "isMultiline"
  }

  /** set current value of isMultiline
   *  @see #isMultiline
   */
  // -beg- preserve=no 44897C74011E set_head358A670D0143 "isMultiline"
  public  void setMultiline(boolean value1)
  // -end- 44897C74011E set_head358A670D0143 "isMultiline"
  {
    // -beg- preserve=no 44897C74011E set_body358A670D0143 "isMultiline"
    if(isMultiline != value1){
      isMultiline = value1;
      ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setMultiline"));
    }
    // -end- 44897C74011E set_body358A670D0143 "isMultiline"
  }
...
public class Text extends BaseType implements java.io.Serializable {
	...
	/**
	 * get current value of maxLength max Anzahl Zeichen in der Zeichenkette.
	 * 
	 * @see #setMaxLength
	 */
	// -beg- preserve=no 358A68CE013E get_head358A670D0143 "maxLength"
	...
	// -end- 358A68CE013E set_head358A670D0143 "maxLength"
	{
		...
		if (maxLength != value1) {
			...
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMaxLength"));
		}
		// -end- 358A68CE013E set_body358A670D0143 "maxLength"
	}
	...
	/**
	 * get current value of kind MAXLEN, ABSTRACT, NAME oder URI
	 * 
	 * @see ch.ehi.interlis.domainsandconstants.basetypes.TextKind
	 * @see #setKind
	 */
	...
	// -end- 44897C74011E set_head358A670D0143 "isMultiline"
	{
		...
		if (isMultiline != value1) {
			isMultiline = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMultiline"));
		}
		// -end- 44897C74011E set_body358A670D0143 "isMultiline"
	}
