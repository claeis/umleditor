...
public class Enumeration extends BaseType implements java.io.Serializable {
	 ...
	 * @see #sizeEnumElement
	 */
	// -beg- preserve=no 358A699B028E add_head358A671C0162
	// "Enumeration::addEnumElement"
	public void addEnumElement(EnumElement enumElement1)
	// -end- 358A699B028E add_head358A671C0162 "Enumeration::addEnumElement"
	{
		// -beg- preserve=no 358A699B028E add_body358A671C0162
		// "Enumeration::addEnumElement"
		enumElement.add(enumElement1);
		enumElement1._linkEnumeration(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addEnumElement"));
		return;
		// -end- 358A699B028E add_body358A671C0162 "Enumeration::addEnumElement"
	}

	// -beg- preserve=no 358A699B028E add2_head358A671C0162
	// "Enumeration::add2EnumElement"
	...
	{
		// -beg- preserve=no 358A699B028E add2_body358A671C0162
		// "Enumeration::add2EnumElement"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addEnumElement"));
		return;
		// -end- 358A699B028E add2_body358A671C0162
		// "Enumeration::add2EnumElement"
	}
	 ...
	 * @see #addEnumElement
	 */
	// -beg- preserve=no 358A699B028E remove_head358A671C0162
	// "Enumeration::removeEnumElement"
	public EnumElement removeEnumElement(EnumElement enumElement1)
	// -end- 358A699B028E remove_head358A671C0162
	// "Enumeration::removeEnumElement"
	{
		// -beg- preserve=no 358A699B028E remove_body358A671C0162
		// "Enumeration::removeEnumElement"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeEnumElement"));
		return ret;
		// -end- 358A699B028E remove_body358A671C0162
		// "Enumeration::removeEnumElement"
	}
	 ...
	 * @see #addEnumElement
	 */
	// -beg- preserve=no 358A699B028E remove2_head358A671C0162
	// "Enumeration::remove2EnumElement"
	public EnumElement removeEnumElement(int index)
	// -end- 358A699B028E remove2_head358A671C0162
	// "Enumeration::remove2EnumElement"
	{
		// -beg- preserve=no 358A699B028E remove2_body358A671C0162
		// "Enumeration::remove2EnumElement"
		EnumElement ret = null;
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeEnumElement"));
		return ret;
		// -end- 358A699B028E remove2_body358A671C0162
		// "Enumeration::remove2EnumElement"
	}
	 ...
	 * @see #addEnumElement
	 */
	// -beg- preserve=no 358A699B028E set_head358A671C0162
	// "Enumeration::setEnumElement"
	...
	{
		// -beg- preserve=no 358A699B028E set_body358A671C0162
		// "Enumeration::setEnumElement"
		EnumElement ret = null;
		...
		enumElement1._linkEnumeration(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setEnumElement"));
		return ret;
	 ...
	 * @see #addEnumElement
	 */
	// -beg- preserve=no 358A699B028E test_head358A671C0162
	// "Enumeration::containsEnumElement"
	public boolean containsEnumElement(EnumElement enumElement1)
	// -end- 358A699B028E test_head358A671C0162
	// "Enumeration::containsEnumElement"
	{
		// -beg- preserve=no 358A699B028E test_body358A671C0162
		// "Enumeration::containsEnumElement"
		return enumElement.contains(enumElement1);
		// -end- 358A699B028E test_body358A671C0162
		// "Enumeration::containsEnumElement"
	}
	...
	// "Enumeration::iteratorEnumElement"
	{
		// -beg- preserve=no 358A699B028E get_all_body358A671C0162
		// "Enumeration::iteratorEnumElement"
		return enumElement.iterator();
		// -end- 358A699B028E get_all_body358A671C0162
		// "Enumeration::iteratorEnumElement"
	}
	 ...
	 * @see #addEnumElement
	 */
	// -beg- preserve=no 358A699B028E remove_all_head358A671C0162
	// "Enumeration::clearEnumElement"
	public void clearEnumElement()
	// -end- 358A699B028E remove_all_head358A671C0162
	// "Enumeration::clearEnumElement"
	{
		...
		if (sizeEnumElement() > 0) {
			...
			enumElement.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearEnumElement"));
		}
		// -end- 358A699B028E remove_all_body358A671C0162
		// "Enumeration::clearEnumElement"
	}
	 ...
	 * @see #addEnumElement
	 */
	// -beg- preserve=no 358A699B028E size_head358A671C0162
	// "Enumeration::sizeEnumElement"
	public int sizeEnumElement()
	// -end- 358A699B028E size_head358A671C0162 "Enumeration::sizeEnumElement"
	{
		// -beg- preserve=no 358A699B028E size_body358A671C0162
		// "Enumeration::sizeEnumElement"
		return enumElement.size();
		// -end- 358A699B028E size_body358A671C0162
		// "Enumeration::sizeEnumElement"
	}
	 ...
	 */
	// -beg- preserve=no 358A699B028E _link_body358A671C0162
	// "Enumeration::_linkEnumElement"
	public void _linkEnumElement(EnumElement enumElement1) {
		enumElement.add(enumElement1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkEnumElement"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 358A699B028E _unlink_body358A671C0162
	// "Enumeration::_unlinkEnumElement"
	public void _unlinkEnumElement(EnumElement enumElement1) {
		enumElement.remove(enumElement1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkEnumElement"));
		return;
	}
	// -end- 358A699B028E _unlink_body358A671C0162
	// "Enumeration::_unlinkEnumElement"
	 ...
	 * @see #containsParent
	 */
	// -beg- preserve=no 358A69A40331 attach_head358A671C0162
	// "Enumeration::attachParent"
	public void attachParent(EnumElement parent1)
	// -end- 358A69A40331 attach_head358A671C0162 "Enumeration::attachParent"
	{
		// -beg- preserve=no 358A69A40331 attach_body358A671C0162
		// "Enumeration::attachParent"
		if (parent != null) {
		...
		return;
		// -end- 358A69A40331 attach_body358A671C0162
		// "Enumeration::attachParent"
	}
	 ...
	 * @see #attachParent
	 */
	// -beg- preserve=no 358A69A40331 detach_head358A671C0162
	// "Enumeration::detachParent"
	public EnumElement detachParent()
	// -end- 358A69A40331 detach_head358A671C0162 "Enumeration::detachParent"
	{
		// -beg- preserve=no 358A69A40331 detach_body358A671C0162
		// "Enumeration::detachParent"
		EnumElement ret = null;
		if (parent != null) {
		...
		return ret;
		// -end- 358A69A40331 detach_body358A671C0162
		// "Enumeration::detachParent"
	}
	 ...
	 * @see #attachParent
	 */
	// -beg- preserve=no 358A69A40331 test_head358A671C0162
	// "Enumeration::containsParent"
	public boolean containsParent()
	// -end- 358A69A40331 test_head358A671C0162 "Enumeration::containsParent"
	{
		// -beg- preserve=no 358A69A40331 test_body358A671C0162
		// "Enumeration::containsParent"
		return parent != null;
		// -end- 358A69A40331 test_body358A671C0162
		// "Enumeration::containsParent"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 358A69A40331 _link_body358A671C0162
	// "Enumeration::_linkParent"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 358A69A40331 _unlink_body358A671C0162
	// "Enumeration::_unlinkParent"
	...
	/**
	 * get current value of kind UNDEFINED, ORDERED oder CIRCULAR
	 * 
