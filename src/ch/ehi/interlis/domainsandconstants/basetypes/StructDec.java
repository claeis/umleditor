...
public class StructDec extends AbstractEditorElement implements java.io.Serializable
	...
	return ret.toString();
                ...
                // -end- 3CCBFEAA0029 head39488BFE0396 "parseStructDec"
                  // declare any checked exceptions
                  // please fill in/modify the following section
                  // -beg- preserve=yes 3CCBFEAA0029 throws39488BFE0396 "parseStructDec"
	...
	int cp;
        ...
        if(cp>0){
          try{
            ...
            throw new java.lang.NumberFormatException(value+" doesn't conform to syntax rule StructDec ("+syntaxRule+")");
          }
        }else if(cp==0){
          throw new java.lang.NumberFormatException(value+" doesn't conform to syntax rule StructDec ("+syntaxRule+")");
        }else{
	...
	return ret;
                 ...
                 *  @see #sizeSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 add_head39488BFE0396 "StructDec::addSubPart"
                public void addSubPart(Integer subPart1)
                // -end- 3CCBFE340228 add_head39488BFE0396 "StructDec::addSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 add_body39488BFE0396 "StructDec::addSubPart"
                  subPart.add(subPart1);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addSubPart"));
                  return;
                  // -end- 3CCBFE340228 add_body39488BFE0396 "StructDec::addSubPart"
                }

                // -beg- preserve=no 3CCBFE340228 add2_head39488BFE0396 "StructDec::add2SubPart"
                public void addSubPart(int index,Integer subPart1)
                // -end- 3CCBFE340228 add2_head39488BFE0396 "StructDec::add2SubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 add2_body39488BFE0396 "StructDec::add2SubPart"
                 ...
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 remove_head39488BFE0396 "StructDec::removeSubPart"
                public Integer removeSubPart(Integer subPart1)
                // -end- 3CCBFE340228 remove_head39488BFE0396 "StructDec::removeSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 remove_body39488BFE0396 "StructDec::removeSubPart"
                  Integer ret=null;
                  ...
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeSubPart"));
                  return ret;
                 ...
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 remove2_head39488BFE0396 "StructDec::remove2SubPart"
                public Integer removeSubPart(int index)
                // -end- 3CCBFE340228 remove2_head39488BFE0396 "StructDec::remove2SubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 remove2_body39488BFE0396 "StructDec::remove2SubPart"
                  Integer ret=null;
                  ret = (Integer)subPart.remove(index);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeSubPart"));
                  return ret;
                  // -end- 3CCBFE340228 remove2_body39488BFE0396 "StructDec::remove2SubPart"
                }

                /** change a SubPart.
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 set_head39488BFE0396 "StructDec::setSubPart"
                public Integer setSubPart(int index,Integer subPart1)
                // -end- 3CCBFE340228 set_head39488BFE0396 "StructDec::setSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 set_body39488BFE0396 "StructDec::setSubPart"
                  Integer ret=null;
                  ret = (Integer)subPart.set(index,subPart1);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setSubPart"));
                  return ret;
                 ...
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 test_head39488BFE0396 "StructDec::containsSubPart"
                public boolean containsSubPart(Integer subPart1)
                // -end- 3CCBFE340228 test_head39488BFE0396 "StructDec::containsSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 test_body39488BFE0396 "StructDec::containsSubPart"
                 ...
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 get_all_head39488BFE0396 "StructDec::iteratorSubPart"
                public java.util.Iterator iteratorSubPart()
                // -end- 3CCBFE340228 get_all_head39488BFE0396 "StructDec::iteratorSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 get_all_body39488BFE0396 "StructDec::iteratorSubPart"
                  return subPart.iterator();
                  // -end- 3CCBFE340228 get_all_body39488BFE0396 "StructDec::iteratorSubPart"
                }

                /** disconnect all SubParts.
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 remove_all_head39488BFE0396 "StructDec::clearSubPart"
                public void clearSubPart()
                // -end- 3CCBFE340228 remove_all_head39488BFE0396 "StructDec::clearSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 remove_all_body39488BFE0396 "StructDec::clearSubPart"
                  if(sizeSubPart()>0){
                    subPart.clear();
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearSubPart"));
                  }
                  // -end- 3CCBFE340228 remove_all_body39488BFE0396 "StructDec::clearSubPart"
                }

                /** returns the number of SubParts.
                 *  @see #addSubPart
                 */
                // -beg- preserve=no 3CCBFE340228 size_head39488BFE0396 "StructDec::sizeSubPart"
                public int sizeSubPart()
                // -end- 3CCBFE340228 size_head39488BFE0396 "StructDec::sizeSubPart"
                {
                  // -beg- preserve=no 3CCBFE340228 size_body39488BFE0396 "StructDec::sizeSubPart"
                  return subPart.size();
                 ...
                 *  @see #containsDecPart
                 */
                // -beg- preserve=no 3CCBFE380379 attach_head39488BFE0396 "StructDec::attachDecPart"
                public void attachDecPart(Integer decPart1)
                // -end- 3CCBFE380379 attach_head39488BFE0396 "StructDec::attachDecPart"
                {
                  // -beg- preserve=no 3CCBFE380379 attach_body39488BFE0396 "StructDec::attachDecPart"
                  if(decPart!=null) {throw new java.lang.IllegalStateException("already a decPart attached");}
                  if(decPart1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as decPart");}
                  decPart = decPart1;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachDecPart"));
                  return;
                 ...
                 *  @see #attachDecPart
                 */
                // -beg- preserve=no 3CCBFE380379 detach_head39488BFE0396 "StructDec::detachDecPart"
                public Integer detachDecPart()
                // -end- 3CCBFE380379 detach_head39488BFE0396 "StructDec::detachDecPart"
                {
                  // -beg- preserve=no 3CCBFE380379 detach_body39488BFE0396 "StructDec::detachDecPart"
                  Integer ret = null;
                  ret = decPart;
                  decPart = null;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachDecPart"));
                  return ret;
                 ...
                 *  @see #attachDecPart
                 */
                // -beg- preserve=no 3CCBFE380379 get_head39488BFE0396 "StructDec::getDecPart"
                public Integer getDecPart()
                // -end- 3CCBFE380379 get_head39488BFE0396 "StructDec::getDecPart"
                {
                  // -beg- preserve=no 3CCBFE380379 get_body39488BFE0396 "StructDec::getDecPart"
                  if(decPart==null) {throw new java.lang.IllegalStateException("no decPart attached");}
                  return decPart;
                 ...
                 *  @see #attachDecPart
                 */
                // -beg- preserve=no 3CCBFE380379 test_head39488BFE0396 "StructDec::containsDecPart"
                public boolean containsDecPart()
                // -end- 3CCBFE380379 test_head39488BFE0396 "StructDec::containsDecPart"
                {
                  // -beg- preserve=no 3CCBFE380379 test_body39488BFE0396 "StructDec::containsDecPart"
                  return decPart!=null;
                ...
                // -end- 39659AC0000B set_head39488BFE0396 "front"
                {
                  ...
                  if(front != value1){
                    front = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setFront"));
                  }
