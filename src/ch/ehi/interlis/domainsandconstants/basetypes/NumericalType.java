...
/**
 * Definiert Grundeigenschaften fÃ¼r numerische Datentypen.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:34:23 $
 */
public abstract class NumericalType extends BaseType implements java.io.Serializable {
	 ...
	 * @see #containsUnitDef
	 */
	// -beg- preserve=no 3948A0C1035E attach_head3948DB550222
	// "NumericalType::attachUnitDef"
	public void attachUnitDef(UnitDef unitDef1)
	// -end- 3948A0C1035E attach_head3948DB550222 "NumericalType::attachUnitDef"
	{
		// -beg- preserve=no 3948A0C1035E attach_body3948DB550222
		// "NumericalType::attachUnitDef"
		if (unitDef != null) {
		...
		return;
		// -end- 3948A0C1035E attach_body3948DB550222
		// "NumericalType::attachUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 3948A0C1035E detach_head3948DB550222
	// "NumericalType::detachUnitDef"
	public UnitDef detachUnitDef()
	// -end- 3948A0C1035E detach_head3948DB550222 "NumericalType::detachUnitDef"
	{
		// -beg- preserve=no 3948A0C1035E detach_body3948DB550222
		// "NumericalType::detachUnitDef"
		UnitDef ret = null;
		if (unitDef != null) {
			unitDef._unlinkNumericalType(this);
		...
		return ret;
		// -end- 3948A0C1035E detach_body3948DB550222
		// "NumericalType::detachUnitDef"
	}
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 3948A0C1035E get_head3948DB550222
	// "NumericalType::getUnitDef"
	public UnitDef getUnitDef()
	// -end- 3948A0C1035E get_head3948DB550222 "NumericalType::getUnitDef"
	{
		// -beg- preserve=no 3948A0C1035E get_body3948DB550222
		// "NumericalType::getUnitDef"
		if (unitDef == null) {
	 ...
	 * @see #attachUnitDef
	 */
	// -beg- preserve=no 3948A0C1035E test_head3948DB550222
	// "NumericalType::containsUnitDef"
	public boolean containsUnitDef()
	// -end- 3948A0C1035E test_head3948DB550222 "NumericalType::containsUnitDef"
	{
		// -beg- preserve=no 3948A0C1035E test_body3948DB550222
		// "NumericalType::containsUnitDef"
		return unitDef != null;
		// -end- 3948A0C1035E test_body3948DB550222
		// "NumericalType::containsUnitDef"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3948A0C1035E _link_body3948DB550222
	// "NumericalType::_linkUnitDef"
	public void _linkUnitDef(UnitDef unitDef1) {
		unitDef = unitDef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkUnitDef"));
		return;
	}
	// -end- 3948A0C1035E _link_body3948DB550222 "NumericalType::_linkUnitDef"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3948A0C1035E _unlink_body3948DB550222
	// "NumericalType::_unlinkUnitDef"
	public void _unlinkUnitDef(UnitDef unitDef1) {
		unitDef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkUnitDef"));
		return;
	}
	// -end- 3948A0C1035E _unlink_body3948DB550222
	// "NumericalType::_unlinkUnitDef"
	 ...
	 * @see #containsRefSys
	 */
	// -beg- preserve=no 3948A1D70212 attach_head3948DB550222
	// "NumericalType::attachRefSys"
	public void attachRefSys(RefSys refSys1)
	// -end- 3948A1D70212 attach_head3948DB550222 "NumericalType::attachRefSys"
	{
		// -beg- preserve=no 3948A1D70212 attach_body3948DB550222
		// "NumericalType::attachRefSys"
		if (refSys != null) {
			throw new java.lang.IllegalStateException("already a refSys attached");
		}
		if (refSys1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as refSys");
		}
		refSys = refSys1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachRefSys"));
		return;
		// -end- 3948A1D70212 attach_body3948DB550222
		// "NumericalType::attachRefSys"
	}
	 ...
	 * @see #attachRefSys
	 */
	// -beg- preserve=no 3948A1D70212 detach_head3948DB550222
	// "NumericalType::detachRefSys"
	public RefSys detachRefSys()
	// -end- 3948A1D70212 detach_head3948DB550222 "NumericalType::detachRefSys"
	{
		// -beg- preserve=no 3948A1D70212 detach_body3948DB550222
		// "NumericalType::detachRefSys"
		RefSys ret = null;
		ret = refSys;
		refSys = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachRefSys"));
		return ret;
		// -end- 3948A1D70212 detach_body3948DB550222
		// "NumericalType::detachRefSys"
	}
	 ...
	 * @see #attachRefSys
	 */
	// -beg- preserve=no 3948A1D70212 get_head3948DB550222
	// "NumericalType::getRefSys"
	public RefSys getRefSys()
	// -end- 3948A1D70212 get_head3948DB550222 "NumericalType::getRefSys"
	{
		// -beg- preserve=no 3948A1D70212 get_body3948DB550222
		// "NumericalType::getRefSys"
		if (refSys == null) {
			throw new java.lang.IllegalStateException("no refSys attached");
		}
		return refSys;
		// -end- 3948A1D70212 get_body3948DB550222 "NumericalType::getRefSys"
	}
	 ...
	 * @see #attachRefSys
	 */
	// -beg- preserve=no 3948A1D70212 test_head3948DB550222
	// "NumericalType::containsRefSys"
	public boolean containsRefSys()
	// -end- 3948A1D70212 test_head3948DB550222 "NumericalType::containsRefSys"
	{
		// -beg- preserve=no 3948A1D70212 test_body3948DB550222
		// "NumericalType::containsRefSys"
		return refSys != null;
		// -end- 3948A1D70212 test_body3948DB550222
		// "NumericalType::containsRefSys"
	}
	...
	/**
	 * get current value of circular Ist der Wereberich zirkulÃ¤r.
	 * 
	 * @see #setCircular
	 */
	// -beg- preserve=no 3948D09F000C get_head3948DB550222 "circular"
	...
	// -end- 3948D09F000C set_head3948DB550222 "circular"
	{
		...
		if (circular != value1) {
			circular = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setCircular"));
		}
		// -end- 3948D09F000C set_body3948DB550222 "circular"
	}
	...
	/**
	 * get current value of direction UNDEFINED, CLOCKWISE oder COUNTERCLOCKWISE
	 * 
	 * @see ch.ehi.interlis.domainsandconstants.basetypes.RotationKind
	 * @see #setDirection
	 */
	...
	// -end- 3948D14202C4 set_head3948DB550222 "direction"
	{
		...
		if (direction != value1) {
			direction = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setDirection"));
		}
		// -end- 3948D14202C4 set_body3948DB550222 "direction"
	}
