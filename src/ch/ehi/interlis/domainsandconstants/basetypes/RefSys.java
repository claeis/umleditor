...
package ch.ehi.interlis.domainsandconstants.basetypes;
              ...
              /** Definiert das Referenzsystem fuer Nummerische Werte.
...
public class RefSys extends AbstractEditorElement implements IliSyntax , java.io.Serializable
              {
                ...
                // -end- 3D4FA21B01A7 head3948A1BC012D "enumerateChildren"
                  ...
                  if(containsDomainDef())visitor.visit(getDomainDef());
                  if(containsRefSysRef())visitor.visit(getRefSysRef());
                 ...
                 */
                // -beg- preserve=no 3948CA6400A9 attach_head3948A1BC012D "RefSys::attachDomainDef"
                public void attachDomainDef(DomainDef domainDef1)
                // -end- 3948CA6400A9 attach_head3948A1BC012D "RefSys::attachDomainDef"
                {
                  // -beg- preserve=no 3948CA6400A9 attach_body3948A1BC012D "RefSys::attachDomainDef"
                 ...
                 *  @see #attachDomainDef
                 */
                // -beg- preserve=no 3948CA6400A9 detach_head3948A1BC012D "RefSys::detachDomainDef"
                public DomainDef detachDomainDef()
                // -end- 3948CA6400A9 detach_head3948A1BC012D "RefSys::detachDomainDef"
                {
                  // -beg- preserve=no 3948CA6400A9 detach_body3948A1BC012D "RefSys::detachDomainDef"
                  DomainDef ret = null;
                  ret = domainDef;
                  domainDef = null;
                 ...
                 *  @see #attachDomainDef
                 */
                // -beg- preserve=no 3948CA6400A9 get_head3948A1BC012D "RefSys::getDomainDef"
                public DomainDef getDomainDef()
                // -end- 3948CA6400A9 get_head3948A1BC012D "RefSys::getDomainDef"
                {
                  // -beg- preserve=no 3948CA6400A9 get_body3948A1BC012D "RefSys::getDomainDef"
                 ...
                 *  @see #attachDomainDef
                 */
                // -beg- preserve=no 3948CA6400A9 test_head3948A1BC012D "RefSys::containsDomainDef"
                public boolean containsDomainDef()
                // -end- 3948CA6400A9 test_head3948A1BC012D "RefSys::containsDomainDef"
                {
                  // -beg- preserve=no 3948CA6400A9 test_body3948A1BC012D "RefSys::containsDomainDef"
                 ...
                 */
                // -beg- preserve=no 3948CA6701F8 attach_head3948A1BC012D "RefSys::attachRefSysRef"
                public void attachRefSysRef(RefSysRef refSysRef1)
                // -end- 3948CA6701F8 attach_head3948A1BC012D "RefSys::attachRefSysRef"
                {
                  // -beg- preserve=no 3948CA6701F8 attach_body3948A1BC012D "RefSys::attachRefSysRef"
                  if(refSysRef!=null) {throw new java.lang.IllegalStateException("already a refSysRef attached");}
                  if(refSysRef1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as refSysRef");}
                  refSysRef = refSysRef1;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachRefSysRef"));
                  return;
                 ...
                 *  @see #attachRefSysRef
                 */
                // -beg- preserve=no 3948CA6701F8 detach_head3948A1BC012D "RefSys::detachRefSysRef"
                public RefSysRef detachRefSysRef()
                // -end- 3948CA6701F8 detach_head3948A1BC012D "RefSys::detachRefSysRef"
                {
                  // -beg- preserve=no 3948CA6701F8 detach_body3948A1BC012D "RefSys::detachRefSysRef"
                  RefSysRef ret = null;
                  ret = refSysRef;
                  refSysRef = null;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachRefSysRef"));
                  return ret;
                 ...
                 *  @see #attachRefSysRef
                 */
                // -beg- preserve=no 3948CA6701F8 get_head3948A1BC012D "RefSys::getRefSysRef"
                public RefSysRef getRefSysRef()
                // -end- 3948CA6701F8 get_head3948A1BC012D "RefSys::getRefSysRef"
                {
                  // -beg- preserve=no 3948CA6701F8 get_body3948A1BC012D "RefSys::getRefSysRef"
                  if(refSysRef==null) {throw new java.lang.IllegalStateException("no refSysRef attached");}
                  return refSysRef;
                 ...
                 *  @see #attachRefSysRef
                 */
                // -beg- preserve=no 3948CA6701F8 test_head3948A1BC012D "RefSys::containsRefSysRef"
                public boolean containsRefSysRef()
                // -end- 3948CA6701F8 test_head3948A1BC012D "RefSys::containsRefSysRef"
                {
                  // -beg- preserve=no 3948CA6701F8 test_body3948A1BC012D "RefSys::containsRefSysRef"
                ...
                // -end- 3948CA85009C set_head3948A1BC012D "axis"
                {
                  ...
                  if(axis != value1){
                    axis = value1;
                    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setAxis"));
                  }
