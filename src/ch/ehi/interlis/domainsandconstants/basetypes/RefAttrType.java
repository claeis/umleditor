...
public class RefAttrType extends BaseType {
	 ...
	 */
	// -beg- preserve=no 4EF99D22005C add_head4EF997E40008
	// "RefAttrType::addRestrictedTo"
	...
	{
		// -beg- preserve=no 4EF99D22005C add_body4EF997E40008
		// "RefAttrType::addRestrictedTo"
		...
		return;
		// -end- 4EF99D22005C add_body4EF997E40008
		// "RefAttrType::addRestrictedTo"
	}
	 ...
	 * @see #addRestrictedTo
	 */
	// -beg- preserve=no 4EF99D22005C remove_head4EF997E40008
	// "RefAttrType::removeRestrictedTo"
	public AbstractClassDef removeRestrictedTo(AbstractClassDef restrictedTo1)
	// -end- 4EF99D22005C remove_head4EF997E40008
	// "RefAttrType::removeRestrictedTo"
	{
		// -beg- preserve=no 4EF99D22005C remove_body4EF997E40008
		// "RefAttrType::removeRestrictedTo"
		...
		return ret;
		// -end- 4EF99D22005C remove_body4EF997E40008
		// "RefAttrType::removeRestrictedTo"
	}
	 ...
	 * @see #addRestrictedTo
	 */
	// -beg- preserve=no 4EF99D22005C test_head4EF997E40008
	// "RefAttrType::containsRestrictedTo"
	public boolean containsRestrictedTo(AbstractClassDef restrictedTo1)
	// -end- 4EF99D22005C test_head4EF997E40008
	// "RefAttrType::containsRestrictedTo"
	{
		// -beg- preserve=no 4EF99D22005C test_body4EF997E40008
		// "RefAttrType::containsRestrictedTo"
		return restrictedTo.contains(restrictedTo1);
		// -end- 4EF99D22005C test_body4EF997E40008
		// "RefAttrType::containsRestrictedTo"
	}
	...
	// "RefAttrType::iteratorRestrictedTo"
	{
		// -beg- preserve=no 4EF99D22005C get_all_body4EF997E40008
		// "RefAttrType::iteratorRestrictedTo"
		return restrictedTo.iterator();
		// -end- 4EF99D22005C get_all_body4EF997E40008
		// "RefAttrType::iteratorRestrictedTo"
	}
	 ...
	 * @see #addRestrictedTo
	 */
	// -beg- preserve=no 4EF99D22005C remove_all_head4EF997E40008
	// "RefAttrType::clearRestrictedTo"
	public void clearRestrictedTo()
	// -end- 4EF99D22005C remove_all_head4EF997E40008
	// "RefAttrType::clearRestrictedTo"
	{
		...
		// -end- 4EF99D22005C remove_all_body4EF997E40008
		// "RefAttrType::clearRestrictedTo"
	}
	 ...
	 * @see #addRestrictedTo
	 */
	// -beg- preserve=no 4EF99D22005C size_head4EF997E40008
	// "RefAttrType::sizeRestrictedTo"
	public int sizeRestrictedTo()
	// -end- 4EF99D22005C size_head4EF997E40008 "RefAttrType::sizeRestrictedTo"
	{
		// -beg- preserve=no 4EF99D22005C size_body4EF997E40008
		// "RefAttrType::sizeRestrictedTo"
		return restrictedTo.size();
		// -end- 4EF99D22005C size_body4EF997E40008
		// "RefAttrType::sizeRestrictedTo"
	}
	 ...
	 */
	// -beg- preserve=no 4EF99D22005C _link_body4EF997E40008
	// "RefAttrType::_linkRestrictedTo"
	...
	// -end- 4EF99D22005C _link_body4EF997E40008
	// "RefAttrType::_linkRestrictedTo"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 4EF99D22005C _unlink_body4EF997E40008
	// "RefAttrType::_unlinkRestrictedTo"
	...
	// -end- 4EF99D22005C _unlink_body4EF997E40008
	// "RefAttrType::_unlinkRestrictedTo"
	 ...
	 */
	// -beg- preserve=no 4EF99D2B0099 attach_head4EF997E40008
	// "RefAttrType::attachParticipant"
	public void attachParticipant(AbstractClassDef participant1)
	// -end- 4EF99D2B0099 attach_head4EF997E40008
	// "RefAttrType::attachParticipant"
	{
		// -beg- preserve=no 4EF99D2B0099 attach_body4EF997E40008
		// "RefAttrType::attachParticipant"
		if (participant != null) {
		...
		return;
		// -end- 4EF99D2B0099 attach_body4EF997E40008
		// "RefAttrType::attachParticipant"
	}
	 ...
	 */
	// -beg- preserve=no 4EF99D2B0099 detach_head4EF997E40008
	// "RefAttrType::detachParticipant"
	public AbstractClassDef detachParticipant()
	// -end- 4EF99D2B0099 detach_head4EF997E40008
	// "RefAttrType::detachParticipant"
	{
		// -beg- preserve=no 4EF99D2B0099 detach_body4EF997E40008
		// "RefAttrType::detachParticipant"
		AbstractClassDef ret = null;
		if (participant != null) {
		...
		return ret;
		// -end- 4EF99D2B0099 detach_body4EF997E40008
		// "RefAttrType::detachParticipant"
	}
	 ...
	 * @see #attachParticipant
	 */
	// -beg- preserve=no 4EF99D2B0099 get_head4EF997E40008
	// "RefAttrType::getParticipant"
	public AbstractClassDef getParticipant()
	// -end- 4EF99D2B0099 get_head4EF997E40008 "RefAttrType::getParticipant"
	{
		// -beg- preserve=no 4EF99D2B0099 get_body4EF997E40008
		// "RefAttrType::getParticipant"
		if (participant == null) {
	 ...
	 * @see #attachParticipant
	 */
	// -beg- preserve=no 4EF99D2B0099 test_head4EF997E40008
	// "RefAttrType::containsParticipant"
	public boolean containsParticipant()
	// -end- 4EF99D2B0099 test_head4EF997E40008
	// "RefAttrType::containsParticipant"
	{
		// -beg- preserve=no 4EF99D2B0099 test_body4EF997E40008
		// "RefAttrType::containsParticipant"
		return participant != null;
		// -end- 4EF99D2B0099 test_body4EF997E40008
		// "RefAttrType::containsParticipant"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 4EF99D2B0099 _link_body4EF997E40008
	// "RefAttrType::_linkParticipant"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 4EF99D2B0099 _unlink_body4EF997E40008
	// "RefAttrType::_unlinkParticipant"
	...
	// -end- 4EF99D2B0099 _unlink_body4EF997E40008
	// "RefAttrType::_unlinkParticipant"
