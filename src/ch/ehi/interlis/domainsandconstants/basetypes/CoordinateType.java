...
public class CoordinateType extends BaseType implements java.io.Serializable {
	...
	/**
	 * attaches a RotationDef. defines the anchor and the orientation of the
	 ...
	 */
	// -beg- preserve=no 3948DEA400C1 attach_head394886B10363
	// "CoordinateType::attachRotationDef"
	public void attachRotationDef(RotationDef rotationDef1)
	// -end- 3948DEA400C1 attach_head394886B10363
	// "CoordinateType::attachRotationDef"
	{
		// -beg- preserve=no 3948DEA400C1 attach_body394886B10363
		// "CoordinateType::attachRotationDef"
		if (rotationDef != null) {
			throw new java.lang.IllegalStateException("already a rotationDef attached");
		}
		if (rotationDef1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as rotationDef");
		}
		rotationDef = rotationDef1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachRotationDef"));
		return;
		// -end- 3948DEA400C1 attach_body394886B10363
		// "CoordinateType::attachRotationDef"
	}
	 ...
	 */
	// -beg- preserve=no 3948DEA400C1 detach_head394886B10363
	// "CoordinateType::detachRotationDef"
	public RotationDef detachRotationDef()
	// -end- 3948DEA400C1 detach_head394886B10363
	// "CoordinateType::detachRotationDef"
	{
		// -beg- preserve=no 3948DEA400C1 detach_body394886B10363
		// "CoordinateType::detachRotationDef"
		RotationDef ret = null;
		ret = rotationDef;
		rotationDef = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachRotationDef"));
		return ret;
		// -end- 3948DEA400C1 detach_body394886B10363
		// "CoordinateType::detachRotationDef"
	}
	 ...
	 * @see #attachRotationDef
	 */
	// -beg- preserve=no 3948DEA400C1 get_head394886B10363
	// "CoordinateType::getRotationDef"
	public RotationDef getRotationDef()
	// -end- 3948DEA400C1 get_head394886B10363 "CoordinateType::getRotationDef"
	{
		// -beg- preserve=no 3948DEA400C1 get_body394886B10363
		// "CoordinateType::getRotationDef"
		if (rotationDef == null) {
			throw new java.lang.IllegalStateException("no rotationDef attached");
		}
		return rotationDef;
		// -end- 3948DEA400C1 get_body394886B10363
		// "CoordinateType::getRotationDef"
	}
	 ...
	 * @see #attachRotationDef
	 */
	// -beg- preserve=no 3948DEA400C1 test_head394886B10363
	// "CoordinateType::containsRotationDef"
	public boolean containsRotationDef()
	// -end- 3948DEA400C1 test_head394886B10363
	// "CoordinateType::containsRotationDef"
	{
		// -beg- preserve=no 3948DEA400C1 test_body394886B10363
		// "CoordinateType::containsRotationDef"
		return rotationDef != null;
		// -end- 3948DEA400C1 test_body394886B10363
		// "CoordinateType::containsRotationDef"
	}
	...
	/**
	 * add a Dim. the domain for each of the dimensions of the coordinate
	 * 
	 * @see #removeDim
	 * @see #containsDim
	 * @see #iteratorDim
	 ...
	 * @see #sizeDim
	 */
	// -beg- preserve=no 39EEB6C10061 add_head394886B10363
	// "CoordinateType::addDim"
	public void addDim(NumericalType dim1)
	// -end- 39EEB6C10061 add_head394886B10363 "CoordinateType::addDim"
	{
		// -beg- preserve=no 39EEB6C10061 add_body394886B10363
		// "CoordinateType::addDim"
		dim.add(dim1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	...
	// -beg- preserve=no 39EEB6C10061 add2_head394886B10363
	// "CoordinateType::add2Dim"
	public void addDim(int index, NumericalType dim1)
	// -end- 39EEB6C10061 add2_head394886B10363 "CoordinateType::add2Dim"
	{
		// -beg- preserve=no 39EEB6C10061 add2_body394886B10363
		// "CoordinateType::add2Dim"
		dim.add(index, dim1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addDim"));
	 ...
	 * @see #addDim
	 */
	// -beg- preserve=no 39EEB6C10061 remove_head394886B10363
	// "CoordinateType::removeDim"
	public NumericalType removeDim(NumericalType dim1)
	// -end- 39EEB6C10061 remove_head394886B10363 "CoordinateType::removeDim"
	{
		// -beg- preserve=no 39EEB6C10061 remove_body394886B10363
		// "CoordinateType::removeDim"
		...
		return ret;
		// -end- 39EEB6C10061 remove_body394886B10363
		// "CoordinateType::removeDim"
	}
	 ...
	 * @see #addDim
	 */
	// -beg- preserve=no 39EEB6C10061 remove2_head394886B10363
	// "CoordinateType::remove2Dim"
	public NumericalType removeDim(int index)
	// -end- 39EEB6C10061 remove2_head394886B10363 "CoordinateType::remove2Dim"
	{
		// -beg- preserve=no 39EEB6C10061 remove2_body394886B10363
		// "CoordinateType::remove2Dim"
		NumericalType ret = null;
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeDim"));
		return ret;
		// -end- 39EEB6C10061 remove2_body394886B10363
		// "CoordinateType::remove2Dim"
	}
	 ...
	 * @see #addDim
	 */
	// -beg- preserve=no 39EEB6C10061 set_head394886B10363
	// "CoordinateType::setDim"
	public NumericalType setDim(int index, NumericalType dim1)
	// -end- 39EEB6C10061 set_head394886B10363 "CoordinateType::setDim"
	{
		// -beg- preserve=no 39EEB6C10061 set_body394886B10363
		// "CoordinateType::setDim"
		NumericalType ret = null;
		ret = (NumericalType) dim.set(index, dim1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setDim"));
		return ret;
	 ...
	 * @see #addDim
	 */
	// -beg- preserve=no 39EEB6C10061 test_head394886B10363
	// "CoordinateType::containsDim"
	public boolean containsDim(NumericalType dim1)
	// -end- 39EEB6C10061 test_head394886B10363 "CoordinateType::containsDim"
	{
		// -beg- preserve=no 39EEB6C10061 test_body394886B10363
		// "CoordinateType::containsDim"
		return dim.contains(dim1);
		// -end- 39EEB6C10061 test_body394886B10363
		// "CoordinateType::containsDim"
	}
	...
	// -end- 39EEB6C10061 get_all_head394886B10363 "CoordinateType::iteratorDim"
	{
		...
		// "CoordinateType::iteratorDim"
		return dim.iterator();
		// -end- 39EEB6C10061 get_all_body394886B10363
		// "CoordinateType::iteratorDim"
	}
	 ...
	 * @see #addDim
	 */
	// -beg- preserve=no 39EEB6C10061 remove_all_head394886B10363
	// "CoordinateType::clearDim"
	public void clearDim()
	// -end- 39EEB6C10061 remove_all_head394886B10363 "CoordinateType::clearDim"
	{
		// -beg- preserve=no 39EEB6C10061 remove_all_body394886B10363
		// "CoordinateType::clearDim"
		if (sizeDim() > 0) {
			dim.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
		...
		// -end- 39EEB6C10061 remove_all_body394886B10363
		// "CoordinateType::clearDim"
	}
	 ...
	 * @see #addDim
	 */
	// -beg- preserve=no 39EEB6C10061 size_head394886B10363
	// "CoordinateType::sizeDim"
	public int sizeDim()
	// -end- 39EEB6C10061 size_head394886B10363 "CoordinateType::sizeDim"
	{
		// -beg- preserve=no 39EEB6C10061 size_body394886B10363
		// "CoordinateType::sizeDim"
		return dim.size();
