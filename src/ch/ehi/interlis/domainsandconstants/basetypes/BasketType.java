...
package ch.ehi.interlis.domainsandconstants.basetypes;
              ...
              /** Definiert einen Behaelterdatentyp.
...
public class BasketType extends BaseType implements java.io.Serializable
              {
                 ...
                 */
                // -beg- preserve=no 3CC001F302E9 attach_head394887020189 "BasketType::attachBasketSchema"
                public void attachBasketSchema(TopicDef basketSchema1)
                // -end- 3CC001F302E9 attach_head394887020189 "BasketType::attachBasketSchema"
                {
                  // -beg- preserve=no 3CC001F302E9 attach_body394887020189 "BasketType::attachBasketSchema"
                  if(basketSchema!=null) {throw new java.lang.IllegalStateException("already a basketSchema attached");}
                  if(basketSchema1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as basketSchema");}
                  basketSchema = basketSchema1;
                  basketSchema1._linkBasketType(this);
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachBasketSchema"));
                  return;
                  // -end- 3CC001F302E9 attach_body394887020189 "BasketType::attachBasketSchema"
                }

                /** disconnect the currently attached BasketSchema.
                 *  @see #attachBasketSchema
                 */
                // -beg- preserve=no 3CC001F302E9 detach_head394887020189 "BasketType::detachBasketSchema"
                public TopicDef detachBasketSchema()
                // -end- 3CC001F302E9 detach_head394887020189 "BasketType::detachBasketSchema"
                {
                  // -beg- preserve=no 3CC001F302E9 detach_body394887020189 "BasketType::detachBasketSchema"
                  TopicDef ret = null;
                  ...
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachBasketSchema"));
                  return ret;
                  // -end- 3CC001F302E9 detach_body394887020189 "BasketType::detachBasketSchema"
                }

                /** get the currently attached BasketSchema.
                 *  @see #attachBasketSchema
                 */
                // -beg- preserve=no 3CC001F302E9 get_head394887020189 "BasketType::getBasketSchema"
                public TopicDef getBasketSchema()
                // -end- 3CC001F302E9 get_head394887020189 "BasketType::getBasketSchema"
                {
                  // -beg- preserve=no 3CC001F302E9 get_body394887020189 "BasketType::getBasketSchema"
                  if(basketSchema==null) {throw new java.lang.IllegalStateException("no basketSchema attached");}
                  return basketSchema;
                 ...
                 *  @see #attachBasketSchema
                 */
                // -beg- preserve=no 3CC001F302E9 test_head394887020189 "BasketType::containsBasketSchema"
                public boolean containsBasketSchema()
                // -end- 3CC001F302E9 test_head394887020189 "BasketType::containsBasketSchema"
                {
                  // -beg- preserve=no 3CC001F302E9 test_body394887020189 "BasketType::containsBasketSchema"
                  return basketSchema!=null;
                  // -end- 3CC001F302E9 test_body394887020189 "BasketType::containsBasketSchema"
                }

                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 3CC001F302E9 _link_body394887020189 "BasketType::_linkBasketSchema"
                public void _linkBasketSchema(TopicDef basketSchema1)
                {
                  basketSchema = basketSchema1;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkBasketSchema"));
                  return;
                }
                ...
                /** DONT USE; link management internal
                 */
                // -beg- preserve=no 3CC001F302E9 _unlink_body394887020189 "BasketType::_unlinkBasketSchema"
                public void _unlinkBasketSchema(TopicDef basketSchema1)
                {
                  basketSchema = null;
                  ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkBasketSchema"));
                  return;
                }
                // -end- 3CC001F302E9 _unlink_body394887020189 "BasketType::_unlinkBasketSchema"
                 ...
                 *  defines the kind of basket describted by this type.
