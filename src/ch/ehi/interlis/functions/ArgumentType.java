...
public class ArgumentType extends AbstractEditorElement implements java.io.Serializable {
	 ...
	 */
	// -beg- preserve=no 3960B29A03DF attach_head3960B11E02DE
	// "ArgumentType::attachDomainAttribute"
	public void attachDomainAttribute(DomainAttribute domainAttribute1)
	// -end- 3960B29A03DF attach_head3960B11E02DE
	// "ArgumentType::attachDomainAttribute"
	{
		// -beg- preserve=no 3960B29A03DF attach_body3960B11E02DE
		// "ArgumentType::attachDomainAttribute"
		...
		return;
		// -end- 3960B29A03DF attach_body3960B11E02DE
		// "ArgumentType::attachDomainAttribute"
	}
	 ...
	 */
	// -beg- preserve=no 3960B29A03DF detach_head3960B11E02DE
	// "ArgumentType::detachDomainAttribute"
	public DomainAttribute detachDomainAttribute()
	// -end- 3960B29A03DF detach_head3960B11E02DE
	// "ArgumentType::detachDomainAttribute"
	{
		// -beg- preserve=no 3960B29A03DF detach_body3960B11E02DE
		// "ArgumentType::detachDomainAttribute"
		...
		return ret;
		// -end- 3960B29A03DF detach_body3960B11E02DE
		// "ArgumentType::detachDomainAttribute"
	}
	 ...
	 * @see #attachDomainAttribute
	 */
	// -beg- preserve=no 3960B29A03DF get_head3960B11E02DE
	// "ArgumentType::getDomainAttribute"
	public DomainAttribute getDomainAttribute()
	// -end- 3960B29A03DF get_head3960B11E02DE
	// "ArgumentType::getDomainAttribute"
	{
		// -beg- preserve=no 3960B29A03DF get_body3960B11E02DE
		// "ArgumentType::getDomainAttribute"
		if (domainAttribute == null) {
			throw new java.lang.IllegalStateException("no domainAttribute attached");
		}
		return domainAttribute;
		// -end- 3960B29A03DF get_body3960B11E02DE
		// "ArgumentType::getDomainAttribute"
	}
	 ...
	 * @see #attachDomainAttribute
	 */
	// -beg- preserve=no 3960B29A03DF test_head3960B11E02DE
	// "ArgumentType::containsDomainAttribute"
	public boolean containsDomainAttribute()
	// -end- 3960B29A03DF test_head3960B11E02DE
	// "ArgumentType::containsDomainAttribute"
	{
		// -beg- preserve=no 3960B29A03DF test_body3960B11E02DE
		// "ArgumentType::containsDomainAttribute"
		return domainAttribute != null;
		// -end- 3960B29A03DF test_body3960B11E02DE
		// "ArgumentType::containsDomainAttribute"
	}
