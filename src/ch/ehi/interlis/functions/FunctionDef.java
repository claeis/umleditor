...
public class FunctionDef extends AbstractModelElement implements ModelElement , IliSyntax , java.io.Serializable
          {
             ...
             *  @see #sizeArgument
             */
            // -beg- preserve=no 3960B129038F add_head3960AFB50130 "FunctionDef::addArgument"
            public void addArgument(ArgumentType argument1)
            // -end- 3960B129038F add_head3960AFB50130 "FunctionDef::addArgument"
            {
              // -beg- preserve=no 3960B129038F add_body3960AFB50130 "FunctionDef::addArgument"
              argument.add(argument1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addArgument"));
              return;
             ...
             *  @see #addArgument
             */
            // -beg- preserve=no 3960B129038F remove_head3960AFB50130 "FunctionDef::removeArgument"
            ...
            {
              // -beg- preserve=no 3960B129038F remove_body3960AFB50130 "FunctionDef::removeArgument"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeArgument"));
              return ret;
              // -end- 3960B129038F remove_body3960AFB50130 "FunctionDef::removeArgument"
            }

            /** tests if a given Argument is connected.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960B129038F test_head3960AFB50130 "FunctionDef::containsArgument"
            ...
            {
              // -beg- preserve=no 3960B129038F test_body3960AFB50130 "FunctionDef::containsArgument"
              return argument.contains(argument1);
              // -end- 3960B129038F test_body3960AFB50130 "FunctionDef::containsArgument"
            }

            /** used to enumerate all connected Arguments.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960B129038F get_all_head3960AFB50130 "FunctionDef::iteratorArgument"
            public java.util.Iterator iteratorArgument()
            // -end- 3960B129038F get_all_head3960AFB50130 "FunctionDef::iteratorArgument"
            {
              // -beg- preserve=no 3960B129038F get_all_body3960AFB50130 "FunctionDef::iteratorArgument"
              return argument.iterator();
              // -end- 3960B129038F get_all_body3960AFB50130 "FunctionDef::iteratorArgument"
            }

            /** disconnect all Arguments.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960B129038F remove_all_head3960AFB50130 "FunctionDef::clearArgument"
            public void clearArgument()
            // -end- 3960B129038F remove_all_head3960AFB50130 "FunctionDef::clearArgument"
            {
              // -beg- preserve=no 3960B129038F remove_all_body3960AFB50130 "FunctionDef::clearArgument"
              if(sizeArgument()>0){
                argument.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearArgument"));
              }
              // -end- 3960B129038F remove_all_body3960AFB50130 "FunctionDef::clearArgument"
            }

            /** returns the number of Arguments.
             *  @see #addArgument
             */
            // -beg- preserve=no 3960B129038F size_head3960AFB50130 "FunctionDef::sizeArgument"
            public int sizeArgument()
            // -end- 3960B129038F size_head3960AFB50130 "FunctionDef::sizeArgument"
            {
              // -beg- preserve=no 3960B129038F size_body3960AFB50130 "FunctionDef::sizeArgument"
             ...
             *  @see #containsResult
             */
            // -beg- preserve=no 3960B1A9014D attach_head3960AFB50130 "FunctionDef::attachResult"
            public void attachResult(ArgumentType result1)
            // -end- 3960B1A9014D attach_head3960AFB50130 "FunctionDef::attachResult"
            {
              // -beg- preserve=no 3960B1A9014D attach_body3960AFB50130 "FunctionDef::attachResult"
              if(result!=null) {throw new java.lang.IllegalStateException("already a result attached");}
              if(result1==null) {throw new java.lang.IllegalArgumentException("null may not be attached as result");}
              result = result1;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"attachResult"));
              return;
              // -end- 3960B1A9014D attach_body3960AFB50130 "FunctionDef::attachResult"
            }

            /** disconnect the currently attached Result.
             *  @see #attachResult
             */
            // -beg- preserve=no 3960B1A9014D detach_head3960AFB50130 "FunctionDef::detachResult"
            public ArgumentType detachResult()
            // -end- 3960B1A9014D detach_head3960AFB50130 "FunctionDef::detachResult"
            {
              // -beg- preserve=no 3960B1A9014D detach_body3960AFB50130 "FunctionDef::detachResult"
              ArgumentType ret = null;
              ret = result;
              result = null;
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"detachResult"));
              return ret;
              // -end- 3960B1A9014D detach_body3960AFB50130 "FunctionDef::detachResult"
            }

            /** get the currently attached Result.
             *  @see #attachResult
             */
            // -beg- preserve=no 3960B1A9014D get_head3960AFB50130 "FunctionDef::getResult"
            public ArgumentType getResult()
            // -end- 3960B1A9014D get_head3960AFB50130 "FunctionDef::getResult"
            {
              // -beg- preserve=no 3960B1A9014D get_body3960AFB50130 "FunctionDef::getResult"
              if(result==null) {throw new java.lang.IllegalStateException("no result attached");}
              return result;
             ...
             *  @see #attachResult
             */
            // -beg- preserve=no 3960B1A9014D test_head3960AFB50130 "FunctionDef::containsResult"
            public boolean containsResult()
            // -end- 3960B1A9014D test_head3960AFB50130 "FunctionDef::containsResult"
            {
              // -beg- preserve=no 3960B1A9014D test_body3960AFB50130 "FunctionDef::containsResult"
              return result!=null;
              // -end- 3960B1A9014D test_body3960AFB50130 "FunctionDef::containsResult"
            }
             ...
             */
            // -beg- preserve=no 33598CAA030E attach_head3960AFB50130 "ModelElement::attachNamespace"
            public void attachNamespace(Namespace namespace1)
            // -end- 33598CAA030E attach_head3960AFB50130 "ModelElement::attachNamespace"
            {
              // -beg- preserve=no 33598CAA030E attach_body3960AFB50130 "ModelElement::attachNamespace"
              super.attachNamespace(namespace1);
              // -end- 33598CAA030E attach_body3960AFB50130 "ModelElement::attachNamespace"
            }

            /** attaches a link to a Namespace.
             *  @see #attachNamespace
             */
            // -beg- preserve=no 33598CAA030E attachlink_head3960AFB50130 "ModelElement::attachNamespaceLink"
            public void attachNamespaceLink(ElementOwnership namespace1)
            // -end- 33598CAA030E attachlink_head3960AFB50130 "ModelElement::attachNamespaceLink"
            {
              // -beg- preserve=no 33598CAA030E attachlink_body3960AFB50130 "ModelElement::attachNamespaceLink"
              super.attachNamespaceLink(namespace1);
              // -end- 33598CAA030E attachlink_body3960AFB50130 "ModelElement::attachNamespaceLink"
            }

            /** disconnect the currently attached Namespace.
             *  @see #attachNamespace
             */
            // -beg- preserve=no 33598CAA030E detach_head3960AFB50130 "ModelElement::detachNamespace"
            public Namespace detachNamespace()
            // -end- 33598CAA030E detach_head3960AFB50130 "ModelElement::detachNamespace"
            {
              // -beg- preserve=no 33598CAA030E detach_body3960AFB50130 "ModelElement::detachNamespace"
              return super.detachNamespace();
              // -end- 33598CAA030E detach_body3960AFB50130 "ModelElement::detachNamespace"
            }

            /** get the currently attached Namespace.
             *  @see #attachNamespace
             */
            // -beg- preserve=no 33598CAA030E get_head3960AFB50130 "ModelElement::getNamespace"
            public Namespace getNamespace()
            // -end- 33598CAA030E get_head3960AFB50130 "ModelElement::getNamespace"
            {
              // -beg- preserve=no 33598CAA030E get_body3960AFB50130 "ModelElement::getNamespace"
             ...
             *  @see #attachNamespace
             */
            // -beg- preserve=no 33598CAA030E getlink_head3960AFB50130 "ModelElement::getNamespaceLink"
            public ElementOwnership getNamespaceLink()
            // -end- 33598CAA030E getlink_head3960AFB50130 "ModelElement::getNamespaceLink"
            {
              // -beg- preserve=no 33598CAA030E getlink_body3960AFB50130 "ModelElement::getNamespaceLink"
              return super.getNamespaceLink();
              // -end- 33598CAA030E getlink_body3960AFB50130 "ModelElement::getNamespaceLink"
            }

            /** create a link class for a new link to a Namespace.
             *  @see #attachNamespace
             */
            // -beg- preserve=no 33598CAA030E createlink_head3960AFB50130 "ModelElement::createNamespaceLink"
            public ElementOwnership createNamespaceLink()
            // -end- 33598CAA030E createlink_head3960AFB50130 "ModelElement::createNamespaceLink"
            {
              // -beg- preserve=no 33598CAA030E createlink_body3960AFB50130 "ModelElement::createNamespaceLink"
              return super.createNamespaceLink();
              // -end- 33598CAA030E createlink_body3960AFB50130 "ModelElement::createNamespaceLink"
            }

            /** tests if there is a Namespace attached.
             *  @see #attachNamespace
             */
            // -beg- preserve=no 33598CAA030E test_head3960AFB50130 "ModelElement::containsNamespace"
            public boolean containsNamespace()
            // -end- 33598CAA030E test_head3960AFB50130 "ModelElement::containsNamespace"
            {
              // -beg- preserve=no 33598CAA030E test_body3960AFB50130 "ModelElement::containsNamespace"
              return super.containsNamespace();
              // -end- 33598CAA030E test_body3960AFB50130 "ModelElement::containsNamespace"
            }

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33598CAA030E _link_body3960AFB50130 "ModelElement::_linkNamespace"
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33598CAA030E _unlink_body3960AFB50130 "ModelElement::_unlinkNamespace"
            public void _unlinkNamespace(ElementOwnership namespace1)
            {
              super._unlinkNamespace(namespace1);
            }
            // -end- 33598CAA030E _unlink_body3960AFB50130 "ModelElement::_unlinkNamespace"
             ...
             *  Beschreibung der Funktion oder Code.
             *  @see #setExplanation
             */
