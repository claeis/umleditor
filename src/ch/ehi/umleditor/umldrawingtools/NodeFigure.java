...
/**
 * Fiure Specification for all Elements treated as Nodes in an
 * UML-Class-Diagram.
 * 
 * @see EdgeFigure
 *
...
=======
	 ...
	 * Return default handles on all four edges for this figure.
	 *
	 * If a this figure is selected => show only that it is selected (no resize
	...
	/**
	 * Overwrites because relocation of new Nodes comes after adding the figure
	 * to the DrawingView.
	 * 
	 * @see ClassDiagramView.saveNodeInDiagram(..)
	 * @see StandardDrawingView.add(Figure)
	...
	public void basicDisplayBox(Point origin, Point corner) {
		...
		/* || (this instanceof NoteFigure) */) {
			// TODO hack: anchorPoint set afterwards by
	...
	protected void initialize() {
		...
		setAttribute(Figure.POPUP_MENU, adaptPopupMenu(new JPopupMenu()));
		setAttribute(JHotDrawConstants.FILL_COLOR,
				ch.ehi.umleditor.application.LauncherView.getSettings().getBackgroundColor());
		setAttribute(JHotDrawConstants.FRAME_COLOR,
				ch.ehi.umleditor.application.LauncherView.getSettings().getForegroundColor());
	}
