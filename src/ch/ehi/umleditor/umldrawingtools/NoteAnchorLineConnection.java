...
/**
 * Draw an anchor line from a Note to any Figure. A Note anchor line is drawn
 * dotted.
 *
...
public class NoteAnchorLineConnection extends EdgeFigure {
	...
	/**
	 * Factory method to create a popup menu. Overwrites
	 *
	...
	/**
	 * Draw the line which is a dotted line for a Note Anchor connection in UML.
	 * Instead of drawing one line from start point to end point, the line is
	 * divided into several small lines each 2 pixels long and 5 pixels away
	 * from the previous line. Some minor inaccuracy are possible due to
	 ...
	 * NoteFigure - ClassFigure - PackageFigure - any other in principle
	 * 
	 * @return Element
	 */
	...
	/**
	 * Return the starting Element of the Relationship, which is always a
	 * NoteFigure in this case.
	 * 
	 ...
	 *
	 * @param start
	 *            figure representing the start Node (always NoteFigure)
	 * @param end
	 *            figure representing the end Node
	 * @see canConnect(..)
	 * @see removeInModel()
	 */
	protected void handleConnect(Figure start, Figure end) {
		try {
			...
			BaseDialog.showError(LauncherView.getInstance(), CREATION_ERROR,
					resNoteAnchorLineConnection.getString("CENoteNotConnected"), e); //$NON-NLS-1$
		}
	}
