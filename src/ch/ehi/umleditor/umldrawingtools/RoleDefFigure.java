...
public RoleDefFigure(LinkFigure linkFigure) {
	...
	// actually PresentationRoleFigure and RoleDefFigure belong to the same edge
...
/**
 * This Figure is not connectable at all. 
 * Overwrites.
 */
...
/**
 * Overwrites.
 * Same Diagram as in parent Figure.
 */
		...
		public void setText(String newText) {
			if (newText != null) {
		    	...
		    	if (type == CARDINALITY) {
			    	...
			    	try {
				    	ch.ehi.uml1_4.foundation.datatypes.Multiplicity multiplicity = MultiplicityConverter.createMultiplicity(newText);
				    	if (!MultiplicityConverter.isSame(multiplicity, edgeFigure.getEndAssociationEnd().getMultiplicity())) {
