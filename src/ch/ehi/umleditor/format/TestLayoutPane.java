...
public class TestLayoutPane extends JPanel
  implements javax.swing.event.ChangeListener
{
  ...
  public void stateChanged(javax.swing.event.ChangeEvent event){
    if(!ignoreModelChanges)updateView();
  }

  public void updateView(){
    String txt="";
    // -beg- preserve=no 3CD943F50117 updateViewFmt3CD943D700CE "delta1"
    if(thismodel!=null)txt=Double.toString(getValueDelta1(thismodel));
    ...
    if(thismodel!=null)txt=Double.toString(getValueDelta2(thismodel));
    ...
    if(thismodel!=null)txt=Double.toString(getValueDelta3(thismodel));
    ...
    if(thismodel!=null)txt=Double.toString(getValueDelta4(thismodel));
    ...
    if(thismodel!=null)txt=Double.toString(getValueDelta10(thismodel));
    ...
    if(thismodel!=null)txt=Double.toString(getValueDelta11(thismodel));
