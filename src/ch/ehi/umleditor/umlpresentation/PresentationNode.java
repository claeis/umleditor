 ...
 */
public abstract class PresentationNode extends AbstractEditorElement
	...
	// -end- 3C2C493003C8 set_head3C2C47C102EE "width"
	{
		...
		if (width != value1) {
			width = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setWidth"));
		}
	...
	// -end- 3C2C493303D6 set_head3C2C47C102EE "height"
	{
		...
		if (height != value1) {
			height = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setHeight"));
		}
	...
	// -end- 3C34382C00AA set_head3C2C47C102EE "foreground"
	{
		...
		if (foreground != value1 && (foreground == null || !foreground.equals(value1))) {
			foreground = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setForeground"));
		}
	...
	// -end- 3C34383A0385 set_head3C2C47C102EE "background"
	{
		...
		if (background != value1 && (background == null || !background.equals(value1))) {
			background = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setBackground"));
		}
	...
	// -end- 3C34389101F0 set_head3C2C47C102EE "font"
	{
		...
		if (font != value1) {
			font = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setFont"));
		}
	 ...
	 * @see #sizeSubject
	 */
	// -beg- preserve=no 362409A803C0 add_head3C2C47C102EE
	...
	{
		// -beg- preserve=no 362409A803C0 add_body3C2C47C102EE
		// "PresentationElement::addSubject"
		...
		return;
		// -end- 362409A803C0 add_body3C2C47C102EE
		// "PresentationElement::addSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_head3C2C47C102EE
	// "PresentationElement::removeSubject"
	public ModelElement removeSubject(ModelElement subject1)
	// -end- 362409A803C0 remove_head3C2C47C102EE
	// "PresentationElement::removeSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_body3C2C47C102EE
		// "PresentationElement::removeSubject"
		...
		return ret;
		// -end- 362409A803C0 remove_body3C2C47C102EE
		// "PresentationElement::removeSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 test_head3C2C47C102EE
	// "PresentationElement::containsSubject"
	public boolean containsSubject(ModelElement subject1)
	// -end- 362409A803C0 test_head3C2C47C102EE
	// "PresentationElement::containsSubject"
	{
		// -beg- preserve=no 362409A803C0 test_body3C2C47C102EE
		// "PresentationElement::containsSubject"
		return subject.contains(subject1);
		// -end- 362409A803C0 test_body3C2C47C102EE
		// "PresentationElement::containsSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 get_all_head3C2C47C102EE
	// "PresentationElement::iteratorSubject"
	public java.util.Iterator iteratorSubject()
	// -end- 362409A803C0 get_all_head3C2C47C102EE
	// "PresentationElement::iteratorSubject"
	{
		// -beg- preserve=no 362409A803C0 get_all_body3C2C47C102EE
		// "PresentationElement::iteratorSubject"
		return subject.iterator();
		// -end- 362409A803C0 get_all_body3C2C47C102EE
		// "PresentationElement::iteratorSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_all_head3C2C47C102EE
	// "PresentationElement::clearSubject"
	public void clearSubject()
	// -end- 362409A803C0 remove_all_head3C2C47C102EE
	// "PresentationElement::clearSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_all_body3C2C47C102EE
		// "PresentationElement::clearSubject"
		if (sizeSubject() > 0) {
		...
		// -end- 362409A803C0 remove_all_body3C2C47C102EE
		// "PresentationElement::clearSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 size_head3C2C47C102EE
	// "PresentationElement::sizeSubject"
	public int sizeSubject()
	// -end- 362409A803C0 size_head3C2C47C102EE
	// "PresentationElement::sizeSubject"
	{
		// -beg- preserve=no 362409A803C0 size_body3C2C47C102EE
		// "PresentationElement::sizeSubject"
		return subject.size();
		// -end- 362409A803C0 size_body3C2C47C102EE
		// "PresentationElement::sizeSubject"
	}
	 ...
	 */
	// -beg- preserve=no 362409A803C0 _link_body3C2C47C102EE
	...
	// -end- 362409A803C0 _link_body3C2C47C102EE
	// "PresentationElement::_linkSubject"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 362409A803C0 _unlink_body3C2C47C102EE
	...
	// -end- 362409A803C0 _unlink_body3C2C47C102EE
	// "PresentationElement::_unlinkSubject"
	 ...
	 * @see #containsDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 attach_head3C2C47C102EE
	// "PresentationElement::attachDiagram"
	public void attachDiagram(Diagram diagram1)
	// -end- 3C2C4C9F0169 attach_head3C2C47C102EE
	// "PresentationElement::attachDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 attach_body3C2C47C102EE
		// "PresentationElement::attachDiagram"
		if (diagram != null) {
		...
		return;
		// -end- 3C2C4C9F0169 attach_body3C2C47C102EE
		// "PresentationElement::attachDiagram"
	}
	 ...
	 * @see #attachDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 detach_head3C2C47C102EE
	// "PresentationElement::detachDiagram"
	public Diagram detachDiagram()
	// -end- 3C2C4C9F0169 detach_head3C2C47C102EE
	// "PresentationElement::detachDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 detach_body3C2C47C102EE
		// "PresentationElement::detachDiagram"
		Diagram ret = null;
		if (diagram != null) {
		...
		return ret;
		// -end- 3C2C4C9F0169 detach_body3C2C47C102EE
		// "PresentationElement::detachDiagram"
	}
	 ...
	 * @see #attachDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 test_head3C2C47C102EE
	// "PresentationElement::containsDiagram"
	public boolean containsDiagram()
	// -end- 3C2C4C9F0169 test_head3C2C47C102EE
	// "PresentationElement::containsDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 test_body3C2C47C102EE
		// "PresentationElement::containsDiagram"
		return diagram != null;
		// -end- 3C2C4C9F0169 test_body3C2C47C102EE
		// "PresentationElement::containsDiagram"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4C9F0169 _link_body3C2C47C102EE
	...
	// -end- 3C2C4C9F0169 _link_body3C2C47C102EE
	// "PresentationElement::_linkDiagram"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4C9F0169 _unlink_body3C2C47C102EE
	...
	// -end- 3C2C4C9F0169 _unlink_body3C2C47C102EE
	// "PresentationElement::_unlinkDiagram"
	 ...
	 */
	// -beg- preserve=no 3C2C49E3019E add_head3C2C47C102EE
	// "PresentationElement::addPresentationEdge"
	public void addPresentationEdge(PresentationEdge presentationEdge1)
	// -end- 3C2C49E3019E add_head3C2C47C102EE
	// "PresentationElement::addPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E add_body3C2C47C102EE
		// "PresentationElement::addPresentationEdge"
		...
		return;
		// -end- 3C2C49E3019E add_body3C2C47C102EE
		// "PresentationElement::addPresentationEdge"
	}
	 ...
	 */
	// -beg- preserve=no 3C2C49E3019E remove_head3C2C47C102EE
	...
	// -end- 3C2C49E3019E remove_head3C2C47C102EE
	// "PresentationElement::removePresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E remove_body3C2C47C102EE
		// "PresentationElement::removePresentationEdge"
		...
		return ret;
		// -end- 3C2C49E3019E remove_body3C2C47C102EE
		// "PresentationElement::removePresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E test_head3C2C47C102EE
	// "PresentationElement::containsPresentationEdge"
	public boolean containsPresentationEdge(PresentationEdge presentationEdge1)
	// -end- 3C2C49E3019E test_head3C2C47C102EE
	// "PresentationElement::containsPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E test_body3C2C47C102EE
		// "PresentationElement::containsPresentationEdge"
		return presentationEdge.contains(presentationEdge1);
		// -end- 3C2C49E3019E test_body3C2C47C102EE
		// "PresentationElement::containsPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E get_all_head3C2C47C102EE
	// "PresentationElement::iteratorPresentationEdge"
	public java.util.Iterator iteratorPresentationEdge()
	// -end- 3C2C49E3019E get_all_head3C2C47C102EE
	// "PresentationElement::iteratorPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E get_all_body3C2C47C102EE
		// "PresentationElement::iteratorPresentationEdge"
		return presentationEdge.iterator();
		// -end- 3C2C49E3019E get_all_body3C2C47C102EE
		// "PresentationElement::iteratorPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E remove_all_head3C2C47C102EE
	// "PresentationElement::clearPresentationEdge"
	public void clearPresentationEdge()
	// -end- 3C2C49E3019E remove_all_head3C2C47C102EE
	// "PresentationElement::clearPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E remove_all_body3C2C47C102EE
		// "PresentationElement::clearPresentationEdge"
		...
		// -end- 3C2C49E3019E remove_all_body3C2C47C102EE
		// "PresentationElement::clearPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E size_head3C2C47C102EE
	// "PresentationElement::sizePresentationEdge"
	public int sizePresentationEdge()
	// -end- 3C2C49E3019E size_head3C2C47C102EE
	// "PresentationElement::sizePresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E size_body3C2C47C102EE
		// "PresentationElement::sizePresentationEdge"
		return presentationEdge.size();
		// -end- 3C2C49E3019E size_body3C2C47C102EE
		// "PresentationElement::sizePresentationEdge"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C49E3019E _link_body3C2C47C102EE
	...
	// -end- 3C2C49E3019E _link_body3C2C47C102EE
	// "PresentationElement::_linkPresentationEdge"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C49E3019E _unlink_body3C2C47C102EE
	...
	// -end- 3C2C49E3019E _unlink_body3C2C47C102EE
	// "PresentationElement::_unlinkPresentationEdge"
