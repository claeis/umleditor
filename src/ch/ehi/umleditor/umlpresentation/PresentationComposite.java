 ...
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:41:19 $
 */
public abstract class PresentationComposite extends AbstractEditorElement
		implements PresentationElement, java.io.Serializable {
	// declare/define something only in the code
	// please fill in/modify the following section
	// -beg- preserve=no 3C346EED0276 detail_begin "PresentationComposite"
	...
	// -end- 3D4FA21702E2 throws3C346EED0276 "unlinkAll"
	{
		...
		clearSubject();
		detachDiagram();
		// Role PresentationComposite: PresentationComposite object(s) may point
		// to this
		clearPresentationEdge();
		setMetaAttrb(null);
		setDocumentation(null);
	 ...
	 * @see #sizeChild
	 */
	// -beg- preserve=no 3C346F0402C0 add_head3C346EED0276
	// "PresentationComposite::addChild"
	public void addChild(PresentationElement child1)
	// -end- 3C346F0402C0 add_head3C346EED0276 "PresentationComposite::addChild"
	{
		// -beg- preserve=no 3C346F0402C0 add_body3C346EED0276
		// "PresentationComposite::addChild"
		child.add(child1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addChild"));
		return;
		// -end- 3C346F0402C0 add_body3C346EED0276
		// "PresentationComposite::addChild"
	}
	 ...
	 * @see #addChild
	 */
	// -beg- preserve=no 3C346F0402C0 remove_head3C346EED0276
	// "PresentationComposite::removeChild"
	public PresentationElement removeChild(PresentationElement child1)
	// -end- 3C346F0402C0 remove_head3C346EED0276
	// "PresentationComposite::removeChild"
	{
		// -beg- preserve=no 3C346F0402C0 remove_body3C346EED0276
		// "PresentationComposite::removeChild"
		PresentationElement ret = null;
		if (child1 == null || !child.contains(child1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		child.remove(child1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeChild"));
		return ret;
		// -end- 3C346F0402C0 remove_body3C346EED0276
		// "PresentationComposite::removeChild"
	}
	 ...
	 * @see #addChild
	 */
	// -beg- preserve=no 3C346F0402C0 test_head3C346EED0276
	// "PresentationComposite::containsChild"
	public boolean containsChild(PresentationElement child1)
	// -end- 3C346F0402C0 test_head3C346EED0276
	// "PresentationComposite::containsChild"
	{
		// -beg- preserve=no 3C346F0402C0 test_body3C346EED0276
		// "PresentationComposite::containsChild"
		return child.contains(child1);
		// -end- 3C346F0402C0 test_body3C346EED0276
		// "PresentationComposite::containsChild"
	}
	 ...
	 * @see #addChild
	 */
	// -beg- preserve=no 3C346F0402C0 get_all_head3C346EED0276
	// "PresentationComposite::iteratorChild"
	public java.util.Iterator iteratorChild()
	// -end- 3C346F0402C0 get_all_head3C346EED0276
	// "PresentationComposite::iteratorChild"
	{
		// -beg- preserve=no 3C346F0402C0 get_all_body3C346EED0276
		// "PresentationComposite::iteratorChild"
		return child.iterator();
		// -end- 3C346F0402C0 get_all_body3C346EED0276
		// "PresentationComposite::iteratorChild"
	}
	 ...
	 * @see #addChild
	 */
	// -beg- preserve=no 3C346F0402C0 remove_all_head3C346EED0276
	// "PresentationComposite::clearChild"
	public void clearChild()
	// -end- 3C346F0402C0 remove_all_head3C346EED0276
	// "PresentationComposite::clearChild"
	{
		// -beg- preserve=no 3C346F0402C0 remove_all_body3C346EED0276
		// "PresentationComposite::clearChild"
		if (sizeChild() > 0) {
			child.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearChild"));
		}
		// -end- 3C346F0402C0 remove_all_body3C346EED0276
		// "PresentationComposite::clearChild"
	}
	 ...
	 * @see #addChild
	 */
	// -beg- preserve=no 3C346F0402C0 size_head3C346EED0276
	// "PresentationComposite::sizeChild"
	public int sizeChild()
	// -end- 3C346F0402C0 size_head3C346EED0276
	// "PresentationComposite::sizeChild"
	{
		// -beg- preserve=no 3C346F0402C0 size_body3C346EED0276
		// "PresentationComposite::sizeChild"
		return child.size();
		// -end- 3C346F0402C0 size_body3C346EED0276
		// "PresentationComposite::sizeChild"
	}
	 ...
	 * @see #sizeSubject
	 */
	// -beg- preserve=no 362409A803C0 add_head3C346EED0276
	// "PresentationElement::addSubject"
	public void addSubject(ModelElement subject1)
	// -end- 362409A803C0 add_head3C346EED0276 "PresentationElement::addSubject"
	{
		// -beg- preserve=no 362409A803C0 add_body3C346EED0276
		// "PresentationElement::addSubject"
		subject.add(subject1);
		subject1._linkPresentation(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addSubject"));
		return;
		// -end- 362409A803C0 add_body3C346EED0276
		// "PresentationElement::addSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_head3C346EED0276
	// "PresentationElement::removeSubject"
	public ModelElement removeSubject(ModelElement subject1)
	// -end- 362409A803C0 remove_head3C346EED0276
	// "PresentationElement::removeSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_body3C346EED0276
		// "PresentationElement::removeSubject"
		ModelElement ret = null;
		if (subject1 == null || !subject.contains(subject1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		subject1._unlinkPresentation(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeSubject"));
		return ret;
		// -end- 362409A803C0 remove_body3C346EED0276
		// "PresentationElement::removeSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 test_head3C346EED0276
	// "PresentationElement::containsSubject"
	public boolean containsSubject(ModelElement subject1)
	// -end- 362409A803C0 test_head3C346EED0276
	// "PresentationElement::containsSubject"
	{
		// -beg- preserve=no 362409A803C0 test_body3C346EED0276
		// "PresentationElement::containsSubject"
		return subject.contains(subject1);
		// -end- 362409A803C0 test_body3C346EED0276
		// "PresentationElement::containsSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 get_all_head3C346EED0276
	// "PresentationElement::iteratorSubject"
	public java.util.Iterator iteratorSubject()
	// -end- 362409A803C0 get_all_head3C346EED0276
	// "PresentationElement::iteratorSubject"
	{
		// -beg- preserve=no 362409A803C0 get_all_body3C346EED0276
		// "PresentationElement::iteratorSubject"
		return subject.iterator();
		// -end- 362409A803C0 get_all_body3C346EED0276
		// "PresentationElement::iteratorSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_all_head3C346EED0276
	// "PresentationElement::clearSubject"
	public void clearSubject()
	// -end- 362409A803C0 remove_all_head3C346EED0276
	// "PresentationElement::clearSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_all_body3C346EED0276
		// "PresentationElement::clearSubject"
		if (sizeSubject() > 0) {
			for (java.util.Iterator p = subject.iterator(); p.hasNext();) {
				((ModelElement) p.next())._unlinkPresentation(this);
			...
			subject.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearSubject"));
		}
		// -end- 362409A803C0 remove_all_body3C346EED0276
		// "PresentationElement::clearSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 size_head3C346EED0276
	// "PresentationElement::sizeSubject"
	public int sizeSubject()
	// -end- 362409A803C0 size_head3C346EED0276
	// "PresentationElement::sizeSubject"
	{
		// -beg- preserve=no 362409A803C0 size_body3C346EED0276
		// "PresentationElement::sizeSubject"
		return subject.size();
		// -end- 362409A803C0 size_body3C346EED0276
		// "PresentationElement::sizeSubject"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 362409A803C0 _link_body3C346EED0276
	// "PresentationElement::_linkSubject"
	public void _linkSubject(ModelElement subject1) {
		subject.add(subject1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkSubject"));
		return;
	}
	// -end- 362409A803C0 _link_body3C346EED0276
	// "PresentationElement::_linkSubject"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 362409A803C0 _unlink_body3C346EED0276
	// "PresentationElement::_unlinkSubject"
	public void _unlinkSubject(ModelElement subject1) {
		subject.remove(subject1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkSubject"));
		return;
	}
	// -end- 362409A803C0 _unlink_body3C346EED0276
	// "PresentationElement::_unlinkSubject"
	 ...
	 * @see #containsDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 attach_head3C346EED0276
	// "PresentationElement::attachDiagram"
	public void attachDiagram(Diagram diagram1)
	// -end- 3C2C4C9F0169 attach_head3C346EED0276
	// "PresentationElement::attachDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 attach_body3C346EED0276
		// "PresentationElement::attachDiagram"
		if (diagram != null) {
			throw new java.lang.IllegalStateException("already a diagram attached");
		}
		if (diagram1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as diagram");
		}
		diagram = diagram1;
		diagram1._linkPresentationElement(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachDiagram"));
		return;
		// -end- 3C2C4C9F0169 attach_body3C346EED0276
		// "PresentationElement::attachDiagram"
	}
	 ...
	 * @see #attachDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 detach_head3C346EED0276
	// "PresentationElement::detachDiagram"
	public Diagram detachDiagram()
	// -end- 3C2C4C9F0169 detach_head3C346EED0276
	// "PresentationElement::detachDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 detach_body3C346EED0276
		// "PresentationElement::detachDiagram"
		Diagram ret = null;
		if (diagram != null) {
			diagram._unlinkPresentationElement(this);
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachDiagram"));
		return ret;
		// -end- 3C2C4C9F0169 detach_body3C346EED0276
		// "PresentationElement::detachDiagram"
	}
	 ...
	 * @see #attachDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 get_head3C346EED0276
	// "PresentationElement::getDiagram"
	public Diagram getDiagram()
	// -end- 3C2C4C9F0169 get_head3C346EED0276 "PresentationElement::getDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 get_body3C346EED0276
		// "PresentationElement::getDiagram"
		if (diagram == null) {
			throw new java.lang.IllegalStateException("no diagram attached");
		}
		return diagram;
		// -end- 3C2C4C9F0169 get_body3C346EED0276
		// "PresentationElement::getDiagram"
	}
	 ...
	 * @see #attachDiagram
	 */
	// -beg- preserve=no 3C2C4C9F0169 test_head3C346EED0276
	// "PresentationElement::containsDiagram"
	public boolean containsDiagram()
	// -end- 3C2C4C9F0169 test_head3C346EED0276
	// "PresentationElement::containsDiagram"
	{
		// -beg- preserve=no 3C2C4C9F0169 test_body3C346EED0276
		// "PresentationElement::containsDiagram"
		return diagram != null;
		// -end- 3C2C4C9F0169 test_body3C346EED0276
		// "PresentationElement::containsDiagram"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4C9F0169 _link_body3C346EED0276
	// "PresentationElement::_linkDiagram"
	public void _linkDiagram(Diagram diagram1) {
		diagram = diagram1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	...
	// -end- 3C2C4C9F0169 _link_body3C346EED0276
	// "PresentationElement::_linkDiagram"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4C9F0169 _unlink_body3C346EED0276
	// "PresentationElement::_unlinkDiagram"
	public void _unlinkDiagram(Diagram diagram1) {
		diagram = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
	...
	// -end- 3C2C4C9F0169 _unlink_body3C346EED0276
	// "PresentationElement::_unlinkDiagram"
	 ...
	 * @see #sizePresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E add_head3C346EED0276
	// "PresentationElement::addPresentationEdge"
	public void addPresentationEdge(PresentationEdge presentationEdge1)
	// -end- 3C2C49E3019E add_head3C346EED0276
	// "PresentationElement::addPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E add_body3C346EED0276
		// "PresentationElement::addPresentationEdge"
		presentationEdge.add(presentationEdge1);
		presentationEdge1._linkEndpoint(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addPresentationEdge"));
		return;
		// -end- 3C2C49E3019E add_body3C346EED0276
		// "PresentationElement::addPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E remove_head3C346EED0276
	// "PresentationElement::removePresentationEdge"
	public PresentationEdge removePresentationEdge(PresentationEdge presentationEdge1)
	// -end- 3C2C49E3019E remove_head3C346EED0276
	// "PresentationElement::removePresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E remove_body3C346EED0276
		// "PresentationElement::removePresentationEdge"
		PresentationEdge ret = null;
		if (presentationEdge1 == null || !presentationEdge.contains(presentationEdge1)) {
			throw new java.lang.IllegalArgumentException("cannot remove null or unknown object");
		...
		presentationEdge1._unlinkEndpoint(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removePresentationEdge"));
		return ret;
		// -end- 3C2C49E3019E remove_body3C346EED0276
		// "PresentationElement::removePresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E test_head3C346EED0276
	// "PresentationElement::containsPresentationEdge"
	public boolean containsPresentationEdge(PresentationEdge presentationEdge1)
	// -end- 3C2C49E3019E test_head3C346EED0276
	// "PresentationElement::containsPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E test_body3C346EED0276
		// "PresentationElement::containsPresentationEdge"
		return presentationEdge.contains(presentationEdge1);
		// -end- 3C2C49E3019E test_body3C346EED0276
		// "PresentationElement::containsPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E get_all_head3C346EED0276
	// "PresentationElement::iteratorPresentationEdge"
	public java.util.Iterator iteratorPresentationEdge()
	// -end- 3C2C49E3019E get_all_head3C346EED0276
	// "PresentationElement::iteratorPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E get_all_body3C346EED0276
		// "PresentationElement::iteratorPresentationEdge"
		return presentationEdge.iterator();
		// -end- 3C2C49E3019E get_all_body3C346EED0276
		// "PresentationElement::iteratorPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E remove_all_head3C346EED0276
	// "PresentationElement::clearPresentationEdge"
	public void clearPresentationEdge()
	// -end- 3C2C49E3019E remove_all_head3C346EED0276
	// "PresentationElement::clearPresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E remove_all_body3C346EED0276
		// "PresentationElement::clearPresentationEdge"
		if (sizePresentationEdge() > 0) {
			for (java.util.Iterator p = presentationEdge.iterator(); p.hasNext();) {
				((PresentationEdge) p.next())._unlinkEndpoint(this);
			...
			presentationEdge.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearPresentationEdge"));
		}
		// -end- 3C2C49E3019E remove_all_body3C346EED0276
		// "PresentationElement::clearPresentationEdge"
	}
	 ...
	 * @see #addPresentationEdge
	 */
	// -beg- preserve=no 3C2C49E3019E size_head3C346EED0276
	// "PresentationElement::sizePresentationEdge"
	public int sizePresentationEdge()
	// -end- 3C2C49E3019E size_head3C346EED0276
	// "PresentationElement::sizePresentationEdge"
	{
		// -beg- preserve=no 3C2C49E3019E size_body3C346EED0276
		// "PresentationElement::sizePresentationEdge"
		return presentationEdge.size();
		// -end- 3C2C49E3019E size_body3C346EED0276
		// "PresentationElement::sizePresentationEdge"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C49E3019E _link_body3C346EED0276
	// "PresentationElement::_linkPresentationEdge"
	public void _linkPresentationEdge(PresentationEdge presentationEdge1) {
		presentationEdge.add(presentationEdge1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkPresentationEdge"));
		return;
	}
	// -end- 3C2C49E3019E _link_body3C346EED0276
	// "PresentationElement::_linkPresentationEdge"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C49E3019E _unlink_body3C346EED0276
	// "PresentationElement::_unlinkPresentationEdge"
	public void _unlinkPresentationEdge(PresentationEdge presentationEdge1) {
		presentationEdge.remove(presentationEdge1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkPresentationEdge"));
		return;
	}
	// -end- 3C2C49E3019E _unlink_body3C346EED0276
	// "PresentationElement::_unlinkPresentationEdge"
