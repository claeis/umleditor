 ...
 * @version $Revision: 1.4 $ $Date: 2006-06-13 14:32:01 $
 */
public class Diagram extends AbstractEditorElement implements Element, java.io.Serializable {
	...
	// -end- 3D4FA217010B throws3C2C4C8D0362 "enumerateChildren"
	{
		...
		it = iteratorPresentationElement();
		while (it.hasNext())
			visitor.visit(it.next());
		it = iteratorPureVisual();
		while (it.hasNext())
			visitor.visit(it.next());
	 ...
	 */
	// -beg- preserve=no 3C2C4C9F017D add_head3C2C4C8D0362
	// "Diagram::addPresentationElement"
	...
	{
		// -beg- preserve=no 3C2C4C9F017D add_body3C2C4C8D0362
		// "Diagram::addPresentationElement"
		presentationElement.add(presentationElement1);
		presentationElement1._linkDiagram(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addPresentationElement"));
		return;
		// -end- 3C2C4C9F017D add_body3C2C4C8D0362
		// "Diagram::addPresentationElement"
	}
	 ...
	 */
	// -beg- preserve=no 3C2C4C9F017D remove_head3C2C4C8D0362
	// "Diagram::removePresentationElement"
	public PresentationElement removePresentationElement(PresentationElement presentationElement1)
	// -end- 3C2C4C9F017D remove_head3C2C4C8D0362
	// "Diagram::removePresentationElement"
	{
		// -beg- preserve=no 3C2C4C9F017D remove_body3C2C4C8D0362
		// "Diagram::removePresentationElement"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removePresentationElement"));
		return ret;
		// -end- 3C2C4C9F017D remove_body3C2C4C8D0362
		// "Diagram::removePresentationElement"
	}
	 ...
	 * @see #addPresentationElement
	 */
	// -beg- preserve=no 3C2C4C9F017D test_head3C2C4C8D0362
	// "Diagram::containsPresentationElement"
	public boolean containsPresentationElement(PresentationElement presentationElement1)
	// -end- 3C2C4C9F017D test_head3C2C4C8D0362
	// "Diagram::containsPresentationElement"
	{
		// -beg- preserve=no 3C2C4C9F017D test_body3C2C4C8D0362
		// "Diagram::containsPresentationElement"
		return presentationElement.contains(presentationElement1);
		// -end- 3C2C4C9F017D test_body3C2C4C8D0362
		// "Diagram::containsPresentationElement"
	}
	 ...
	 * @see #addPresentationElement
	 */
	// -beg- preserve=no 3C2C4C9F017D get_all_head3C2C4C8D0362
	// "Diagram::iteratorPresentationElement"
	public java.util.Iterator iteratorPresentationElement()
	// -end- 3C2C4C9F017D get_all_head3C2C4C8D0362
	// "Diagram::iteratorPresentationElement"
	{
		// -beg- preserve=no 3C2C4C9F017D get_all_body3C2C4C8D0362
		// "Diagram::iteratorPresentationElement"
		return presentationElement.iterator();
		// -end- 3C2C4C9F017D get_all_body3C2C4C8D0362
		// "Diagram::iteratorPresentationElement"
	}
	 ...
	 * @see #addPresentationElement
	 */
	// -beg- preserve=no 3C2C4C9F017D remove_all_head3C2C4C8D0362
	// "Diagram::clearPresentationElement"
	public void clearPresentationElement()
	// -end- 3C2C4C9F017D remove_all_head3C2C4C8D0362
	// "Diagram::clearPresentationElement"
	{
		// -beg- preserve=no 3C2C4C9F017D remove_all_body3C2C4C8D0362
		// "Diagram::clearPresentationElement"
		if (sizePresentationElement() > 0) {
			...
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(
					new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearPresentationElement"));
		}
		// -end- 3C2C4C9F017D remove_all_body3C2C4C8D0362
		// "Diagram::clearPresentationElement"
	}
	 ...
	 * @see #addPresentationElement
	 */
	// -beg- preserve=no 3C2C4C9F017D size_head3C2C4C8D0362
	// "Diagram::sizePresentationElement"
	public int sizePresentationElement()
	// -end- 3C2C4C9F017D size_head3C2C4C8D0362
	// "Diagram::sizePresentationElement"
	{
		// -beg- preserve=no 3C2C4C9F017D size_body3C2C4C8D0362
		// "Diagram::sizePresentationElement"
		return presentationElement.size();
		// -end- 3C2C4C9F017D size_body3C2C4C8D0362
		// "Diagram::sizePresentationElement"
	}
	 ...
	 */
	// -beg- preserve=no 3C2C4C9F017D _link_body3C2C4C8D0362
	// "Diagram::_linkPresentationElement"
	public void _linkPresentationElement(PresentationElement presentationElement1) {
		presentationElement.add(presentationElement1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkPresentationElement"));
		return;
	}
	// -end- 3C2C4C9F017D _link_body3C2C4C8D0362
	// "Diagram::_linkPresentationElement"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4C9F017D _unlink_body3C2C4C8D0362
	// "Diagram::_unlinkPresentationElement"
	public void _unlinkPresentationElement(PresentationElement presentationElement1) {
		presentationElement.remove(presentationElement1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkPresentationElement"));
		return;
	}
	// -end- 3C2C4C9F017D _unlink_body3C2C4C8D0362
	// "Diagram::_unlinkPresentationElement"
	 ...
	 */
	// -beg- preserve=no 3C2C4E4F0246 attach_head3C2C4C8D0362
	// "Diagram::attachNamespace"
	public void attachNamespace(Namespace namespace1)
	// -end- 3C2C4E4F0246 attach_head3C2C4C8D0362 "Diagram::attachNamespace"
	{
		// -beg- preserve=no 3C2C4E4F0246 attach_body3C2C4C8D0362
		// "Diagram::attachNamespace"
		if (namespace != null) {
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 3C2C4E4F0246 detach_head3C2C4C8D0362
	// "Diagram::detachNamespace"
	public Namespace detachNamespace()
	// -end- 3C2C4E4F0246 detach_head3C2C4C8D0362 "Diagram::detachNamespace"
	{
		// -beg- preserve=no 3C2C4E4F0246 detach_body3C2C4C8D0362
		// "Diagram::detachNamespace"
		Namespace ret = null;
		if (namespace != null) {
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 3C2C4E4F0246 get_head3C2C4C8D0362
	// "Diagram::getNamespace"
	public Namespace getNamespace()
	// -end- 3C2C4E4F0246 get_head3C2C4C8D0362 "Diagram::getNamespace"
	{
		// -beg- preserve=no 3C2C4E4F0246 get_body3C2C4C8D0362
		// "Diagram::getNamespace"
		if (namespace == null) {
	 ...
	 * @see #attachNamespace
	 */
	// -beg- preserve=no 3C2C4E4F0246 test_head3C2C4C8D0362
	// "Diagram::containsNamespace"
	public boolean containsNamespace()
	// -end- 3C2C4E4F0246 test_head3C2C4C8D0362 "Diagram::containsNamespace"
	{
		// -beg- preserve=no 3C2C4E4F0246 test_body3C2C4C8D0362
		// "Diagram::containsNamespace"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4E4F0246 _link_body3C2C4C8D0362
	// "Diagram::_linkNamespace"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C2C4E4F0246 _unlink_body3C2C4C8D0362
	// "Diagram::_unlinkNamespace"
	...
	/**
	 * add a PureVisual. additional figures, purely visual and not related to
	 * any model element
	 * 
	 ...
	 * @see #sizePureVisual
	 */
	// -beg- preserve=no 3C6946440349 add_head3C2C4C8D0362
	// "Diagram::addPureVisual"
	public void addPureVisual(AbstractFigure pureVisual1)
	// -end- 3C6946440349 add_head3C2C4C8D0362 "Diagram::addPureVisual"
	{
		// -beg- preserve=no 3C6946440349 add_body3C2C4C8D0362
		// "Diagram::addPureVisual"
		pureVisual.add(pureVisual1);
		pureVisual1._linkDiagram(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addPureVisual"));
		return;
	 ...
	 * @see #addPureVisual
	 */
	// -beg- preserve=no 3C6946440349 remove_head3C2C4C8D0362
	// "Diagram::removePureVisual"
	...
	{
		// -beg- preserve=no 3C6946440349 remove_body3C2C4C8D0362
		// "Diagram::removePureVisual"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removePureVisual"));
		return ret;
		// -end- 3C6946440349 remove_body3C2C4C8D0362
		// "Diagram::removePureVisual"
	}
	 ...
	 * @see #addPureVisual
	 */
	// -beg- preserve=no 3C6946440349 test_head3C2C4C8D0362
	// "Diagram::containsPureVisual"
	...
	{
		// -beg- preserve=no 3C6946440349 test_body3C2C4C8D0362
		// "Diagram::containsPureVisual"
		return pureVisual.contains(pureVisual1);
		// -end- 3C6946440349 test_body3C2C4C8D0362
		// "Diagram::containsPureVisual"
	}
	 ...
	 * @see #addPureVisual
	 */
	// -beg- preserve=no 3C6946440349 get_all_head3C2C4C8D0362
	// "Diagram::iteratorPureVisual"
	public java.util.Iterator iteratorPureVisual()
	// -end- 3C6946440349 get_all_head3C2C4C8D0362 "Diagram::iteratorPureVisual"
	{
		// -beg- preserve=no 3C6946440349 get_all_body3C2C4C8D0362
		// "Diagram::iteratorPureVisual"
		return pureVisual.iterator();
		// -end- 3C6946440349 get_all_body3C2C4C8D0362
		// "Diagram::iteratorPureVisual"
	}
	 ...
	 * @see #addPureVisual
	 */
	// -beg- preserve=no 3C6946440349 remove_all_head3C2C4C8D0362
	// "Diagram::clearPureVisual"
	public void clearPureVisual()
	// -end- 3C6946440349 remove_all_head3C2C4C8D0362 "Diagram::clearPureVisual"
	{
		// -beg- preserve=no 3C6946440349 remove_all_body3C2C4C8D0362
		// "Diagram::clearPureVisual"
		if (sizePureVisual() > 0) {
			...
			pureVisual.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearPureVisual"));
		}
		// -end- 3C6946440349 remove_all_body3C2C4C8D0362
		// "Diagram::clearPureVisual"
	}
	 ...
	 * @see #addPureVisual
	 */
	// -beg- preserve=no 3C6946440349 size_head3C2C4C8D0362
	// "Diagram::sizePureVisual"
	public int sizePureVisual()
	// -end- 3C6946440349 size_head3C2C4C8D0362 "Diagram::sizePureVisual"
	{
		// -beg- preserve=no 3C6946440349 size_body3C2C4C8D0362
		// "Diagram::sizePureVisual"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C6946440349 _link_body3C2C4C8D0362
	// "Diagram::_linkPureVisual"
	public void _linkPureVisual(AbstractFigure pureVisual1) {
		pureVisual.add(pureVisual1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkPureVisual"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3C6946440349 _unlink_body3C2C4C8D0362
	// "Diagram::_unlinkPureVisual"
	public void _unlinkPureVisual(AbstractFigure pureVisual1) {
		pureVisual.remove(pureVisual1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkPureVisual"));
		return;
	}
	...
	{
		// -beg- preserve=no 3E4118B201D4 get_body3C2C4C8D0362
		// "showAttributeType"
	...
	{
		// -beg- preserve=no 3E4118B201D4 set_body3C2C4C8D0362
		// "showAttributeType"
		if (showAttributeType != value1) {
			showAttributeType = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setShowAttributeType"));
		}
		// -end- 3E4118B201D4 set_body3C2C4C8D0362 "showAttributeType"
	}

	// -beg- preserve=no 3E4118CB01A8 var3C2C4C8D0362
	 ...
	 */
	// -beg- preserve=no 448D2DBC02E6 get_head3C2C4C8D0362 "showNamePrefix"
	public int getShowNamePrefix()
	// -end- 448D2DBC02E6 get_head3C2C4C8D0362 "showNamePrefix"
	{
		// -beg- preserve=no 448D2DBC02E6 get_body3C2C4C8D0362 "showNamePrefix"
		return showNamePrefix;
		// -end- 448D2DBC02E6 get_body3C2C4C8D0362 "showNamePrefix"
	}
	 ...
	 */
	// -beg- preserve=no 448D2DBC02E6 set_head3C2C4C8D0362 "showNamePrefix"
	public void setShowNamePrefix(int value1)
	// -end- 448D2DBC02E6 set_head3C2C4C8D0362 "showNamePrefix"
	{
		// -beg- preserve=no 448D2DBC02E6 set_body3C2C4C8D0362 "showNamePrefix"
		...
		// -end- 448D2DBC02E6 set_body3C2C4C8D0362 "showNamePrefix"
	}
