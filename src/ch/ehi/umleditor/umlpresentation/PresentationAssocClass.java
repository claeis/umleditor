...
public class PresentationAssocClass extends PresentationAbstractClass {
	 ...
	 */
	// -beg- preserve=no 3D4658500348 attach_head3D47AB4300A6
	// "PresentationAssocClass::attachAssociation"
	public void attachAssociation(Association association1)
	// -end- 3D4658500348 attach_head3D47AB4300A6
	// "PresentationAssocClass::attachAssociation"
	{
		// -beg- preserve=no 3D4658500348 attach_body3D47AB4300A6
		// "PresentationAssocClass::attachAssociation"
		if (association != null) {
		...
		return;
		// -end- 3D4658500348 attach_body3D47AB4300A6
		// "PresentationAssocClass::attachAssociation"
	}
	 ...
	 */
	// -beg- preserve=no 3D4658500348 detach_head3D47AB4300A6
	// "PresentationAssocClass::detachAssociation"
	public Association detachAssociation()
	// -end- 3D4658500348 detach_head3D47AB4300A6
	// "PresentationAssocClass::detachAssociation"
	{
		// -beg- preserve=no 3D4658500348 detach_body3D47AB4300A6
		// "PresentationAssocClass::detachAssociation"
		...
		return ret;
		// -end- 3D4658500348 detach_body3D47AB4300A6
		// "PresentationAssocClass::detachAssociation"
	}
	 ...
	 * @see #attachAssociation
	 */
	// -beg- preserve=no 3D4658500348 get_head3D47AB4300A6
	// "PresentationAssocClass::getAssociation"
	public Association getAssociation()
	// -end- 3D4658500348 get_head3D47AB4300A6
	// "PresentationAssocClass::getAssociation"
	{
		// -beg- preserve=no 3D4658500348 get_body3D47AB4300A6
		// "PresentationAssocClass::getAssociation"
		if (association == null) {
			throw new java.lang.IllegalStateException("no association attached");
		}
		return association;
		// -end- 3D4658500348 get_body3D47AB4300A6
		// "PresentationAssocClass::getAssociation"
	}
	 ...
	 * @see #attachAssociation
	 */
	// -beg- preserve=no 3D4658500348 test_head3D47AB4300A6
	// "PresentationAssocClass::containsAssociation"
	public boolean containsAssociation()
	// -end- 3D4658500348 test_head3D47AB4300A6
	// "PresentationAssocClass::containsAssociation"
	{
		// -beg- preserve=no 3D4658500348 test_body3D47AB4300A6
		// "PresentationAssocClass::containsAssociation"
		return association != null;
		// -end- 3D4658500348 test_body3D47AB4300A6
		// "PresentationAssocClass::containsAssociation"
	}
	 ...
	 */
	// -beg- preserve=no 3D4658500348 _link_body3D47AB4300A6
	// "PresentationAssocClass::_linkAssociation"
	...
	// -end- 3D4658500348 _link_body3D47AB4300A6
	// "PresentationAssocClass::_linkAssociation"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3D4658500348 _unlink_body3D47AB4300A6
	// "PresentationAssocClass::_unlinkAssociation"
	...
	// -end- 3D4658500348 _unlink_body3D47AB4300A6
	// "PresentationAssocClass::_unlinkAssociation"
	...
	/**
	 * get current value of classAngle together with classRadius the relative
	 * position of the class figure
	 * 
	 * @see #setClassAngle
	 */
	...
	// -end- 3D53E03900D5 set_head3D47AB4300A6 "classAngle"
	{
		...
		if (classAngle != value1) {
			classAngle = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setClassAngle"));
		}
	...
	/**
	 * get current value of classRadius together with classAngle the relative
	 * position of the class figure
	 * 
	 * @see #setClassRadius
	 */
	...
	// -end- 3D53E0420038 set_head3D47AB4300A6 "classRadius"
	{
		...
		if (classRadius != value1) {
			classRadius = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setClassRadius"));
		}
	...
	// -end- 3D59081A01AF get_head3D47AB4300A6 "east"
	{
		...
		if (containsAssociation()) {
			...
			int ret;
			/*
			 * ret=((int)startCenter.getX() + (int)endCenter.getX())/2; return
			 * ret;
			 */
	...
	// -end- 3D5908240236 get_head3D47AB4300A6 "south"
	{
		...
		if (containsAssociation()) {
			...
			int ret;
			/*
			 * ret=((int)startCenter.getY() + (int)endCenter.getY())/2; return
			 * ret;
			 */
	...
	private java.awt.Point getCenter(java.awt.Rectangle rect) {
		return new java.awt.Point((int) rect.getX() + (int) (rect.getWidth() / 2.0),
