...
public class Association extends PresentationComposite implements java.io.Serializable {
	...
	// -end- 3D465C070006 throws3C2C43470264 "isLinkMoveable"
	{
		...
		if (!subji.hasNext())
			return false;
		ch.ehi.uml1_4.foundation.core.Association subject = (ch.ehi.uml1_4.foundation.core.Association) subji.next();
	...
	// -end- 3D4FA2170025 throws3C2C43470264 "enumerateChildren"
	{
		...
		it = iteratorRolePresentation();
		while (it.hasNext())
			visitor.visit(it.next());
		if (containsLinkPresentation())
			visitor.visit(getLinkPresentation());
	 ...
	 */
	// -beg- preserve=no 3D46531B03CD add_head3C2C43470264
	// "Association::addRolePresentation"
	public void addRolePresentation(PresentationRole rolePresentation1)
	// -end- 3D46531B03CD add_head3C2C43470264
	// "Association::addRolePresentation"
	{
		// -beg- preserve=no 3D46531B03CD add_body3C2C43470264
		// "Association::addRolePresentation"
		rolePresentation.add(rolePresentation1);
		rolePresentation1._linkAssociation(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addRolePresentation"));
		return;
		// -end- 3D46531B03CD add_body3C2C43470264
		// "Association::addRolePresentation"
	}
	 ...
	 */
	// -beg- preserve=no 3D46531B03CD remove_head3C2C43470264
	// "Association::removeRolePresentation"
	public PresentationRole removeRolePresentation(PresentationRole rolePresentation1)
	// -end- 3D46531B03CD remove_head3C2C43470264
	// "Association::removeRolePresentation"
	{
		// -beg- preserve=no 3D46531B03CD remove_body3C2C43470264
		// "Association::removeRolePresentation"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeRolePresentation"));
		return ret;
		// -end- 3D46531B03CD remove_body3C2C43470264
		// "Association::removeRolePresentation"
	}
	 ...
	 * @see #addRolePresentation
	 */
	// -beg- preserve=no 3D46531B03CD test_head3C2C43470264
	// "Association::containsRolePresentation"
	public boolean containsRolePresentation(PresentationRole rolePresentation1)
	// -end- 3D46531B03CD test_head3C2C43470264
	// "Association::containsRolePresentation"
	{
		// -beg- preserve=no 3D46531B03CD test_body3C2C43470264
		// "Association::containsRolePresentation"
		return rolePresentation.contains(rolePresentation1);
		// -end- 3D46531B03CD test_body3C2C43470264
		// "Association::containsRolePresentation"
	}
	 ...
	 * @see #addRolePresentation
	 */
	// -beg- preserve=no 3D46531B03CD get_all_head3C2C43470264
	// "Association::iteratorRolePresentation"
	public java.util.Iterator iteratorRolePresentation()
	// -end- 3D46531B03CD get_all_head3C2C43470264
	// "Association::iteratorRolePresentation"
	{
		// -beg- preserve=no 3D46531B03CD get_all_body3C2C43470264
		// "Association::iteratorRolePresentation"
		return rolePresentation.iterator();
		// -end- 3D46531B03CD get_all_body3C2C43470264
		// "Association::iteratorRolePresentation"
	}
	 ...
	 * @see #addRolePresentation
	 */
	// -beg- preserve=no 3D46531B03CD remove_all_head3C2C43470264
	// "Association::clearRolePresentation"
	public void clearRolePresentation()
	// -end- 3D46531B03CD remove_all_head3C2C43470264
	// "Association::clearRolePresentation"
	{
		// -beg- preserve=no 3D46531B03CD remove_all_body3C2C43470264
		// "Association::clearRolePresentation"
		if (sizeRolePresentation() > 0) {
			...
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearRolePresentation"));
		}
		// -end- 3D46531B03CD remove_all_body3C2C43470264
		// "Association::clearRolePresentation"
	}
	 ...
	 * @see #addRolePresentation
	 */
	// -beg- preserve=no 3D46531B03CD size_head3C2C43470264
	// "Association::sizeRolePresentation"
	public int sizeRolePresentation()
	// -end- 3D46531B03CD size_head3C2C43470264
	// "Association::sizeRolePresentation"
	{
		// -beg- preserve=no 3D46531B03CD size_body3C2C43470264
		// "Association::sizeRolePresentation"
		return rolePresentation.size();
		// -end- 3D46531B03CD size_body3C2C43470264
		// "Association::sizeRolePresentation"
	}
	 ...
	 */
	// -beg- preserve=no 3D46531B03CD _link_body3C2C43470264
	// "Association::_linkRolePresentation"
	public void _linkRolePresentation(PresentationRole rolePresentation1) {
		rolePresentation.add(rolePresentation1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkRolePresentation"));
		return;
	}
	// -end- 3D46531B03CD _link_body3C2C43470264
	// "Association::_linkRolePresentation"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3D46531B03CD _unlink_body3C2C43470264
	// "Association::_unlinkRolePresentation"
	public void _unlinkRolePresentation(PresentationRole rolePresentation1) {
		rolePresentation.remove(rolePresentation1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkRolePresentation"));
		return;
	}
	// -end- 3D46531B03CD _unlink_body3C2C43470264
	// "Association::_unlinkRolePresentation"
	 ...
	 */
	// -beg- preserve=no 3D465850037A attach_head3C2C43470264
	// "Association::attachLinkPresentation"
	public void attachLinkPresentation(PresentationAssocClass linkPresentation1)
	// -end- 3D465850037A attach_head3C2C43470264
	// "Association::attachLinkPresentation"
	{
		// -beg- preserve=no 3D465850037A attach_body3C2C43470264
		// "Association::attachLinkPresentation"
		if (linkPresentation != null) {
			throw new java.lang.IllegalStateException("already a linkPresentation attached");
		}
		if (linkPresentation1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as linkPresentation");
		}
		linkPresentation = linkPresentation1;
		linkPresentation1._linkAssociation(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachLinkPresentation"));
		return;
		// -end- 3D465850037A attach_body3C2C43470264
		// "Association::attachLinkPresentation"
	}
	 ...
	 */
	// -beg- preserve=no 3D465850037A detach_head3C2C43470264
	// "Association::detachLinkPresentation"
	public PresentationAssocClass detachLinkPresentation()
	// -end- 3D465850037A detach_head3C2C43470264
	// "Association::detachLinkPresentation"
	{
		// -beg- preserve=no 3D465850037A detach_body3C2C43470264
		// "Association::detachLinkPresentation"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachLinkPresentation"));
		return ret;
		// -end- 3D465850037A detach_body3C2C43470264
		// "Association::detachLinkPresentation"
	}
	 ...
	 * @see #attachLinkPresentation
	 */
	// -beg- preserve=no 3D465850037A get_head3C2C43470264
	// "Association::getLinkPresentation"
	public PresentationAssocClass getLinkPresentation()
	// -end- 3D465850037A get_head3C2C43470264
	// "Association::getLinkPresentation"
	{
		// -beg- preserve=no 3D465850037A get_body3C2C43470264
		// "Association::getLinkPresentation"
		if (linkPresentation == null) {
			throw new java.lang.IllegalStateException("no linkPresentation attached");
		}
		return linkPresentation;
		// -end- 3D465850037A get_body3C2C43470264
		// "Association::getLinkPresentation"
	}
	 ...
	 * @see #attachLinkPresentation
	 */
	// -beg- preserve=no 3D465850037A test_head3C2C43470264
	// "Association::containsLinkPresentation"
	public boolean containsLinkPresentation()
	// -end- 3D465850037A test_head3C2C43470264
	// "Association::containsLinkPresentation"
	{
		// -beg- preserve=no 3D465850037A test_body3C2C43470264
		// "Association::containsLinkPresentation"
		return linkPresentation != null;
		// -end- 3D465850037A test_body3C2C43470264
		// "Association::containsLinkPresentation"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3D465850037A _link_body3C2C43470264
	// "Association::_linkLinkPresentation"
	public void _linkLinkPresentation(PresentationAssocClass linkPresentation1) {
		linkPresentation = linkPresentation1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkLinkPresentation"));
		return;
	}
	// -end- 3D465850037A _link_body3C2C43470264
	// "Association::_linkLinkPresentation"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3D465850037A _unlink_body3C2C43470264
	// "Association::_unlinkLinkPresentation"
	public void _unlinkLinkPresentation(PresentationAssocClass linkPresentation1) {
		linkPresentation = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkLinkPresentation"));
		return;
	}
	// -end- 3D465850037A _unlink_body3C2C43470264
	// "Association::_unlinkLinkPresentation"
	 ...
	 * @see #sizeSubject
	 */
	// -beg- preserve=no 362409A803C0 add_head3C2C43470264
	...
	{
		// -beg- preserve=no 362409A803C0 add_body3C2C43470264
		// "PresentationElement::addSubject"
		super.addSubject(subject1);
		// -end- 362409A803C0 add_body3C2C43470264
		// "PresentationElement::addSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_head3C2C43470264
	// "PresentationElement::removeSubject"
	public ModelElement removeSubject(ModelElement subject1)
	// -end- 362409A803C0 remove_head3C2C43470264
	// "PresentationElement::removeSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_body3C2C43470264
		// "PresentationElement::removeSubject"
		return super.removeSubject(subject1);
		// -end- 362409A803C0 remove_body3C2C43470264
		// "PresentationElement::removeSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 test_head3C2C43470264
	// "PresentationElement::containsSubject"
	public boolean containsSubject(ModelElement subject1)
	// -end- 362409A803C0 test_head3C2C43470264
	// "PresentationElement::containsSubject"
	{
		// -beg- preserve=no 362409A803C0 test_body3C2C43470264
		// "PresentationElement::containsSubject"
		return super.containsSubject(subject1);
		// -end- 362409A803C0 test_body3C2C43470264
		// "PresentationElement::containsSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 get_all_head3C2C43470264
	// "PresentationElement::iteratorSubject"
	public java.util.Iterator iteratorSubject()
	// -end- 362409A803C0 get_all_head3C2C43470264
	// "PresentationElement::iteratorSubject"
	{
		// -beg- preserve=no 362409A803C0 get_all_body3C2C43470264
		// "PresentationElement::iteratorSubject"
		return super.iteratorSubject();
		// -end- 362409A803C0 get_all_body3C2C43470264
		// "PresentationElement::iteratorSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_all_head3C2C43470264
	// "PresentationElement::clearSubject"
	public void clearSubject()
	// -end- 362409A803C0 remove_all_head3C2C43470264
	// "PresentationElement::clearSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_all_body3C2C43470264
		// "PresentationElement::clearSubject"
		super.clearSubject();
		// -end- 362409A803C0 remove_all_body3C2C43470264
		// "PresentationElement::clearSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 size_head3C2C43470264
	// "PresentationElement::sizeSubject"
	public int sizeSubject()
	// -end- 362409A803C0 size_head3C2C43470264
	// "PresentationElement::sizeSubject"
	{
		// -beg- preserve=no 362409A803C0 size_body3C2C43470264
		// "PresentationElement::sizeSubject"
		return super.sizeSubject();
		// -end- 362409A803C0 size_body3C2C43470264
		// "PresentationElement::sizeSubject"
	}
	...
	// -end- 3E410253002A set_head3C2C43470264 "showName"
	{
		...
		if (showName != value1) {
			showName = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setShowName"));
		}
	...
	public boolean isAssocClassVisible() {
		...
		AssociationClass assoc = (AssociationClass) subject;
		if (assoc.sizeGeneralization() > 0)
			return true;
		if (assoc.sizeSpecialization() > 0)
			return true;
