...
public class PresentationRole extends PresentationEdge {
	 ...
	 */
	// -beg- preserve=no 3D46531B03C3 attach_head3D4652270282
	// "PresentationRole::attachAssociation"
	public void attachAssociation(Association association1)
	// -end- 3D46531B03C3 attach_head3D4652270282
	// "PresentationRole::attachAssociation"
	{
		// -beg- preserve=no 3D46531B03C3 attach_body3D4652270282
		// "PresentationRole::attachAssociation"
		if (association != null) {
		...
		return;
		// -end- 3D46531B03C3 attach_body3D4652270282
		// "PresentationRole::attachAssociation"
	}
	 ...
	 */
	// -beg- preserve=no 3D46531B03C3 detach_head3D4652270282
	// "PresentationRole::detachAssociation"
	public Association detachAssociation()
	// -end- 3D46531B03C3 detach_head3D4652270282
	// "PresentationRole::detachAssociation"
	{
		// -beg- preserve=no 3D46531B03C3 detach_body3D4652270282
		// "PresentationRole::detachAssociation"
		...
		return ret;
		// -end- 3D46531B03C3 detach_body3D4652270282
		// "PresentationRole::detachAssociation"
	}
	 ...
	 * @see #attachAssociation
	 */
	// -beg- preserve=no 3D46531B03C3 get_head3D4652270282
	// "PresentationRole::getAssociation"
	public Association getAssociation()
	// -end- 3D46531B03C3 get_head3D4652270282
	// "PresentationRole::getAssociation"
	{
		// -beg- preserve=no 3D46531B03C3 get_body3D4652270282
		// "PresentationRole::getAssociation"
		if (association == null) {
			throw new java.lang.IllegalStateException("no association attached");
		}
		return association;
		// -end- 3D46531B03C3 get_body3D4652270282
		// "PresentationRole::getAssociation"
	}
	 ...
	 * @see #attachAssociation
	 */
	// -beg- preserve=no 3D46531B03C3 test_head3D4652270282
	// "PresentationRole::containsAssociation"
	public boolean containsAssociation()
	// -end- 3D46531B03C3 test_head3D4652270282
	// "PresentationRole::containsAssociation"
	{
		// -beg- preserve=no 3D46531B03C3 test_body3D4652270282
		// "PresentationRole::containsAssociation"
		return association != null;
		// -end- 3D46531B03C3 test_body3D4652270282
		// "PresentationRole::containsAssociation"
	}
	 ...
	 */
	// -beg- preserve=no 3D46531B03C3 _link_body3D4652270282
	// "PresentationRole::_linkAssociation"
	...
	// -end- 3D46531B03C3 _link_body3D4652270282
	// "PresentationRole::_linkAssociation"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3D46531B03C3 _unlink_body3D4652270282
	// "PresentationRole::_unlinkAssociation"
	...
	// -end- 3D46531B03C3 _unlink_body3D4652270282
	// "PresentationRole::_unlinkAssociation"
	 ...
	 * @see #sizeSubject
	 */
	// -beg- preserve=no 362409A803C0 add_head3D4652270282
	...
	{
		// -beg- preserve=no 362409A803C0 add_body3D4652270282
		// "PresentationElement::addSubject"
		super.addSubject(subject1);
		// -end- 362409A803C0 add_body3D4652270282
		// "PresentationElement::addSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_head3D4652270282
	// "PresentationElement::removeSubject"
	public ModelElement removeSubject(ModelElement subject1)
	// -end- 362409A803C0 remove_head3D4652270282
	// "PresentationElement::removeSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_body3D4652270282
		// "PresentationElement::removeSubject"
		return super.removeSubject(subject1);
		// -end- 362409A803C0 remove_body3D4652270282
		// "PresentationElement::removeSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 test_head3D4652270282
	// "PresentationElement::containsSubject"
	public boolean containsSubject(ModelElement subject1)
	// -end- 362409A803C0 test_head3D4652270282
	// "PresentationElement::containsSubject"
	{
		// -beg- preserve=no 362409A803C0 test_body3D4652270282
		// "PresentationElement::containsSubject"
		return super.containsSubject(subject1);
		// -end- 362409A803C0 test_body3D4652270282
		// "PresentationElement::containsSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 get_all_head3D4652270282
	// "PresentationElement::iteratorSubject"
	public java.util.Iterator iteratorSubject()
	// -end- 362409A803C0 get_all_head3D4652270282
	// "PresentationElement::iteratorSubject"
	{
		// -beg- preserve=no 362409A803C0 get_all_body3D4652270282
		// "PresentationElement::iteratorSubject"
		return super.iteratorSubject();
		// -end- 362409A803C0 get_all_body3D4652270282
		// "PresentationElement::iteratorSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 remove_all_head3D4652270282
	// "PresentationElement::clearSubject"
	public void clearSubject()
	// -end- 362409A803C0 remove_all_head3D4652270282
	// "PresentationElement::clearSubject"
	{
		// -beg- preserve=no 362409A803C0 remove_all_body3D4652270282
		// "PresentationElement::clearSubject"
		super.clearSubject();
		// -end- 362409A803C0 remove_all_body3D4652270282
		// "PresentationElement::clearSubject"
	}
	 ...
	 * @see #addSubject
	 */
	// -beg- preserve=no 362409A803C0 size_head3D4652270282
	// "PresentationElement::sizeSubject"
	public int sizeSubject()
	// -end- 362409A803C0 size_head3D4652270282
	// "PresentationElement::sizeSubject"
	{
		// -beg- preserve=no 362409A803C0 size_body3D4652270282
		// "PresentationElement::sizeSubject"
		return super.sizeSubject();
		// -end- 362409A803C0 size_body3D4652270282
		// "PresentationElement::sizeSubject"
	}
	...
	// -end- 3D4654050289 set_head3D4652270282 "nameAngle"
	{
		...
		if (nameAngle != value1) {
			nameAngle = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setNameAngle"));
		}
	...
	// -end- 3D46546A0090 set_head3D4652270282 "nameRadius"
	{
		...
		if (nameRadius != value1) {
			nameRadius = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setNameRadius"));
		}
	...
	{
		// -beg- preserve=no 3D46547B0379 get_body3D4652270282
		// "multiplicityAngle"
	...
	{
		// -beg- preserve=no 3D46547B0379 set_body3D4652270282
		// "multiplicityAngle"
		if (multiplicityAngle != value1) {
			multiplicityAngle = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMultiplicityAngle"));
		}
	...
	{
		// -beg- preserve=no 3D465488030A get_body3D4652270282
		// "multiplicityRadius"
	...
	{
		// -beg- preserve=no 3D465488030A set_body3D4652270282
		// "multiplicityRadius"
		if (multiplicityRadius != value1) {
			multiplicityRadius = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMultiplicityRadius"));
		}
	...
	// -end- 3D61FD3303D3 set_head3D4652270282 "nameVisible"
	{
		...
		if (nameVisible != value1) {
			nameVisible = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setNameVisible"));
		}
	...
	{
		// -beg- preserve=no 3D61FD7C01B1 get_body3D4652270282
		// "multiplicityVisible"
	...
	{
		// -beg- preserve=no 3D61FD7C01B1 set_body3D4652270282
		// "multiplicityVisible"
		if (multiplicityVisible != value1) {
			multiplicityVisible = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setMultiplicityVisible"));
		}
