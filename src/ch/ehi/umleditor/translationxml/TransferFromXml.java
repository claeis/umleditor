...
public class TransferFromXml {
	 ...
	 * 
	 * @param modelElement The Element to Chance
	 * @param translationElement Import Translation XML
	 */
	private void mergeTranslationElementToModelElement(ModelElement modelElement,
		...
		if (translationElement.getDocumentation_de() != null) {
			if (!translationElement.getDocumentation_de().isEmpty() && (translationElement.getDocumentation_de() != null
		...
		if (translationElement.getDocumentation_en() != null) {
			if (!translationElement.getDocumentation_en().isEmpty() && (translationElement.getDocumentation_en() != null
		...
		if (translationElement.getDocumentation_fr() != null) {
			if (!translationElement.getDocumentation_fr().isEmpty() && (translationElement.getDocumentation_fr() != null
		...
		if (translationElement.getDocumentation_it() != null) {
			if (!translationElement.getDocumentation_it().isEmpty() && (translationElement.getDocumentation_it() != null
