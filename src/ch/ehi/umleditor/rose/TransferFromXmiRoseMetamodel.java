...
// please fill in/modify the following section
// -beg- preserve=yes 3E0DB0710357 detail_begin "TransferFromXmiRoseMetamodel"
static java.util.ResourceBundle rsrc = ch.ehi.basics.i18n.ResourceBundle.getBundle(TransferFromXmiRoseMetamodel.class);
...
// -end- 3E0F4B22025F throws3E0DB0710357 "findTaggedValue"
{
        ...
        while(topi.hasNext()) {
                XMIObject obj=(XMIObject)topi.next();
                if(obj.getXMIValueOfValue("modelElement").equals(id)
                   && obj.getXMIValueOfValue("tag").equals(tag)) {
        ...
        if(pass==1) {
                if(aclass.getXMIName().equals("UML:Class")) {
                        ...
                        if("ILISTRUCTURE".equals(stereotype)) {
                                ((ch.ehi.interlis.modeltopicclass.ClassDef)impclass).setKind(ch.ehi.interlis.modeltopicclass.ClassDefKind.STRUCTURE);
...
{
        // please fill in/modify the following section
        // -beg- preserve=yes 3E0F4D9B036D body3E0DB0710357 "visitGeneralization"
        if(pass==2) {
                ...
                if(!(ele instanceof ch.ehi.interlis.modeltopicclass.ClassDef)) {
                        log(java.text.MessageFormat.format(rsrc.getString("CIerrGenIgnored"),new String[] {(String)parent.getXMIValueOfValue("name"),(String)child.getXMIValueOfValue("name")}));
                        return null;
                }
...
{
        // please fill in/modify the following section
        // -beg- preserve=yes 3E0F4DB1024D body3E0DB0710357 "visitAssociationEnd"
        ...
        if(pass==2) {
                ...
                ch.ehi.uml1_4.foundation.core.ModelElement impele=(ch.ehi.uml1_4.foundation.core.ModelElement)xmi2imp.get(participant);
...
// declare any checked exceptions
// please fill in/modify the following section
// -beg- preserve=no 3E0F4DF203AF throws3E0DB0710357 "visitMultiplicityRange"

// -end- 3E0F4DF203AF throws3E0DB0710357 "visitMultiplicityRange"
{
        // please fill in/modify the following section
        // -beg- preserve=yes 3E0F4DF203AF body3E0DB0710357 "visitMultiplicityRange"
        // lower, upper
        if(pass==2) {
        ...
        if("Rational Rose 98".equals(diagram.getXMIValueOfValue("toolName"))
           && "ClassDiagram".equals(diagram.getXMIValueOfValue("diagramType"))) {
                ...
                if(pass==1) {
                        ...
                        ch.ehi.uml1_4.foundation.core.Namespace impowner=(ch.ehi.uml1_4.foundation.core.Namespace)xmi2imp.get(owner);
                ...
                //System.out.println("visitDiagram: "+diagram.getXMIValueOfValue("name"));
...
{
        // please fill in/modify the following section
        // -beg- preserve=yes 3E0F4E0A01B4 body3E0DB0710357 "visitDiagramElement"
        ...
        if(style.startsWith("Association:")) {
                if(pass==2) {
                        ...
                        ch.ehi.uml1_4.foundation.core.ModelElement impsubject=(ch.ehi.uml1_4.foundation.core.ModelElement)xmi2imp.get(subject);
                        ...
                        while(!skipAssoc && rolei.hasNext()) {
                                ...
                                ch.ehi.interlis.modeltopicclass.ClassDef end=(ch.ehi.interlis.modeltopicclass.ClassDef)role.getParticipant();
                        ...
                        if(!skipAssoc) {
                                ...
                                while(rolei.hasNext()) {
                                        ch.ehi.interlis.associations.RoleDef role=(ch.ehi.interlis.associations.RoleDef)rolei.next();
                                        ch.ehi.interlis.modeltopicclass.AbstractClassDef end=(ch.ehi.interlis.modeltopicclass.AbstractClassDef)role.getParticipant();
                                        ...
                                        roleFig.addEndpoint((ch.ehi.umleditor.umlpresentation.Class)findPresentationElement(impdiag,end));
                ...
                if(pass==2) {
                        ...
                        ch.ehi.uml1_4.foundation.core.ModelElement impannotatedElement=(ch.ehi.uml1_4.foundation.core.ModelElement)xmi2imp.get(annotatedElement);
                        ...
                        // create edge that links the note to the presentation of the modelelement
                        ch.ehi.uml1_4.foundation.core.PresentationElement fig=findPresentationElement(impdiag,impannotatedElement);
                        if(fig!=null) {
                ...
                if(pass==2) {
                        ...
                        node=(ch.ehi.umleditor.umlpresentation.PresentationNode)findPresentationElement(impdiag,((ch.ehi.uml1_4.foundation.core.Generalization)impsubject).getChild());
                        edge.addEndpoint(node);
                        node=(ch.ehi.umleditor.umlpresentation.PresentationNode)findPresentationElement(impdiag,((ch.ehi.uml1_4.foundation.core.Generalization)impsubject).getParent());
                        edge.addEndpoint(node);
                        impdiag.addPresentationElement(edge);
                }
        }else{
                ...
                if(pass==1) {
                        ...
                        if(impsubject instanceof ch.ehi.interlis.associations.AssociationDef) {
                                ch.ehi.uml1_4.foundation.core.PresentationElement fig=findPresentationElement(impdiag,impsubject);
...
private static ch.ehi.uml1_4.foundation.core.PresentationElement findPresentationElement(
        ch.ehi.umleditor.umlpresentation.Diagram diagram
        ,ch.ehi.uml1_4.foundation.core.ModelElement subject){
        Iterator elei=diagram.iteratorPresentationElement();
        while(elei.hasNext()) {
                ch.ehi.uml1_4.foundation.core.PresentationElement ele=(ch.ehi.uml1_4.foundation.core.PresentationElement)elei.next();
...
private ch.ehi.interlis.modeltopicclass.ClassDef findStructure(ch.ehi.interlis.domainsandconstants.DomainDef impele){
        ch.ehi.interlis.modeltopicclass.ClassDef impparticipant=(ch.ehi.interlis.modeltopicclass.ClassDef)domain2struct.get(impele);
