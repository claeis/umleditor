...
public class HtmlWriter
{
  ...
  // -end- 3CEE8B46037F head3CEE891B03C7 "visitPackage"
    ...
    //aName - wird f�r die Angabe vom Link innerhalb der HTML - Datei ben�tigt
    //bsp: <a name="aName....">
    String aName = numeration+"_"+defLangName;

    //??concated value f�r die Angabe der Werte+serialNumber, bzw. index vom Value
    String value;
    if(suppressChNr){
		value = defLangName;
    }else{
  ...
  /**
   * Geht �ber die ganze Struktur.
   * Die einzelnen �berschriften des HTML-Files werden auch hier geschrieben
    ...
    throws java.io.IOException
  {
    ...
    if(pass==INDEX)
    {
      ...
      {
        //value: Object, bzw. String auf der list, dass dann in HTML geschrieben wird sp�ter
  ...
  /**
   * die INT - Werte, die f�r die ID's der Element gebraucht werden (Nummerierung der Element), werden wieder
   * auf ihren Ursprungswert zur�ckgesetzt.
   */
