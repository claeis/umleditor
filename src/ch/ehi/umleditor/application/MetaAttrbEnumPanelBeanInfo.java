...
/**
 * Gets the addMetaAttrEnumbPanelListener(ch.ehi.umleditor.application.MetaAttrbEnumPanelListener) method descriptor.
...
public java.beans.MethodDescriptor addMetaAttrbEnumPanelListener_chehiumleditorapplicationMetaAttrbEnumPanelListenerMethodDescriptor() {
								...
								try {
																/* Create and return the addMetaAttrbEnumPanelListener(ch.ehi.umleditor.application.MetaAttrbEnumPanelListener) method descriptor. */
...
public java.beans.EventSetDescriptor metaAttrbEnumPanelEventSetDescriptor() {
								...
								try {
																try {
																								/* Try using method descriptors to create the MetaAttrbEnumPanel event set descriptor. */
																								...
																								try {
																																...
																																aRemoveMethod = getBeanClass().getMethod("removeMetaAttrbEnumPanelListener", aRemoveMethodParameterTypes);
																								} catch (java.lang.Throwable exception) {
																																/* Since getMethod failed, call findMethod. */
																																handleException(exception);
																								...
																								aDescriptor = new java.beans.EventSetDescriptor(getBeanClass(),
																																																																								...
																																																																								ch.ehi.umleditor.application.MetaAttrbEnumPanelListener.class,
																																																																								eventMethodNames,
																																																																								"addMetaAttrbEnumPanelListener",
																																																																								"removeMetaAttrbEnumPanelListener");
																};
...
/**
 * Gets the metaAttrbEnumPanel.pnlEditSimpleEditPanel_txaEditKey_keyReleased(java.util.EventObject) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor metaAttrbEnumPanelpnlEditSimpleEditPanel_txaEditKey_keyReleased_javautilEventObjectMethodEventDescriptor() {
								java.beans.MethodDescriptor aDescriptor = null;
								try {
																/* Create and return the metaAttrbEnumPanel.pnlEditSimpleEditPanel_txaEditKey_keyReleased(java.util.EventObject) method descriptor. */
																java.lang.reflect.Method aMethod = null;
																try {
																								/* Attempt to find the method using getMethod with parameter types. */
																								Class aParameterTypes[] = {
																								...
																								aMethod = (ch.ehi.umleditor.application.MetaAttrbEnumPanelListener.class).getMethod("pnlEditSimpleEditPanel_txaEditKey_keyReleased", aParameterTypes);
																} catch (java.lang.Throwable exception) {
																								/* Since getMethod failed, call findMethod. */
																								handleException(exception);
																								aMethod = findMethod((ch.ehi.umleditor.application.MetaAttrbEnumPanelListener.class), "pnlEditSimpleEditPanel_txaEditKey_keyReleased", 1);
																};
																try {
																								/* Try creating the method descriptor with parameter descriptors. */
																								java.beans.ParameterDescriptor aParameterDescriptor1 = new java.beans.ParameterDescriptor();
																...
																/* aDescriptor.setDisplayName("pnlEditSimpleEditPanel_txaEditKey_keyReleased"); */
																/* aDescriptor.setShortMetaAttrbEnum("pnlEditSimpleEditPanel_txaEditKey_keyReleased"); */
																/* aDescriptor.setExpert(false); */
																/* aDescriptor.setHidden(false); */
																/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
								} catch (java.lang.Throwable exception) {
...
public java.beans.EventSetDescriptor[] getEventSetDescriptors() {
								try {
																java.beans.EventSetDescriptor aDescriptorList[] = {
																								metaAttrbEnumPanelEventSetDescriptor()
																};
...
/**
 * Gets the pnlEditSimpleEditPanel_txaEditKey_keyReleased(java.util.EventObject) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor pnlEditSimpleEditPanel_txaEditKey_keyReleased_javautilEventObjectMethodEventDescriptor() {
								java.beans.MethodDescriptor aDescriptor = null;
								try {
																/* Create and return the pnlEditSimpleEditPanel_txaEditKey_keyReleased(java.util.EventObject) method descriptor. */
																java.lang.reflect.Method aMethod = null;
																try {
																								/* Attempt to find the method using getMethod with parameter types. */
																...
																/* aDescriptor.setShortMetaAttrbEnum("pnlEditSimpleEditPanel_txaEditKey_keyReleased(java.util.EventObject)"); */
																/* aDescriptor.setExpert(false); */
																/* aDescriptor.setHidden(false); */
																/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
								} catch (java.lang.Throwable exception) {
...
/**
 * Gets the removeMetaAttrbEnumPanelListener(ch.ehi.umleditor.application.MetaAttrbEnumPanelListener) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor removeMetaAttrbEnumPanelListener_chehiumleditorapplicationMetaAttrbEnumPanelListenerMethodDescriptor() {
								java.beans.MethodDescriptor aDescriptor = null;
								try {
																/* Create and return the removeMetaAttrbEnumPanelListener(ch.ehi.umleditor.application.MetaAttrbEnumPanelListener) method descriptor. */
																java.lang.reflect.Method aMethod = null;
																try {
																								/* Attempt to find the method using getMethod with parameter types. */
																								java.lang.Class aParameterTypes[] = {
																...
																/* aDescriptor.setDisplayName("removeMetaAttrbEnumPanelListener(ch.ehi.umleditor.application.MetaAttrbEnumPanelListener)"); */
																/* aDescriptor.setShortMetaAttrbEnum("removeMetaAttrbEnumPanelListener(ch.ehi.umleditor.application.MetaAttrbEnumPanelListener)"); */
																/* aDescriptor.setExpert(false); */
																/* aDescriptor.setHidden(false); */
																/* aDescriptor.setValue("preferred", new java.lang.Boolean(false)); */
								} catch (java.lang.Throwable exception) {
