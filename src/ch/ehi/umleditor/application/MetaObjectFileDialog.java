...
public class MetaObjectFileDialog extends BaseDialog {
	// ModelElement
	private static java.util.ResourceBundle resMetaObjectFileDialog = java.util.ResourceBundle.getBundle("ch/ehi/umleditor/application/resources/MetaObjectFileDialog");  //$NON-NLS-1$
=======
...
private void btnFileSearch() {
	...
	if (openDialog.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
		try {
			LauncherView.getInstance().getSettings().setWorkingDirectory(openDialog.getCurrentDirectory().getAbsolutePath());
...
/**
 * connEtoC4:  (BtnFileSearch.action.actionPerformed(java.awt.event.ActionEvent) --> MetaObjectFileDialog.btnFileSearch()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * connEtoM1:  (TxtFilename.focus.focusGained(java.awt.event.FocusEvent) --> TxtFilename.selectAll()V)
...
private javax.swing.JPanel getBaseDialogContentPane() {
	if (ivjBaseDialogContentPane == null) {
		try {
			...
			constraintsLblFilename.gridx = 1; constraintsLblFilename.gridy = 1;
			...
			constraintsTxtFilename.gridx = 3; constraintsTxtFilename.gridy = 1;
			...
			constraintsBtnFileSearch.gridx = 5; constraintsBtnFileSearch.gridy = 1;
	 ...
	 */
	 private void addEscapeKey() {
		 ...
		 Action escapeAction = new AbstractAction() {
			...
			private static final long serialVersionUID = -8379561253471923621L;
...
protected boolean save() {
	...
	metaObjectFile.setName(new ch.ehi.basics.types.NlsString(metaObjectFile.getName(), "", getTxtFilename().getText()));//$NON-NLS-1$
