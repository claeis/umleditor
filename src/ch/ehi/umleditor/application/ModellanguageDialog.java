...
public class ModellanguageDialog extends ch.softenvironment.view.BaseDialog {
	...
	private javax.swing.JPanel getBaseDialogContentPane() {
		if (ivjBaseDialogContentPane == null) {
			try {
				...
				constraintsBtnPane.gridx = 0;
				constraintsBtnPane.gridy = 2;
				...
				constraintsCbxLanguage.gridx = 1;
	...
	private void initialize() {
		...
		{
			java.util.Set set = ch.ehi.interlis.tools.ModelElementUtility
					.getChildElements(LauncherView.getInstance().getModel(), INTERLIS2Def.class);
