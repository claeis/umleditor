...
=======
	...
	public void adaptUserAction(EventObject event, Object control) {
		...
		if (modelAdapter != null) {
			if (modelAdapter.getOrdering().equals(NavigationTreeModel.SORT_BY_NAME)) {
				...
				getMniSortbyKindName()
						.setSelected(modelAdapter.getOrdering().equals(NavigationTreeModel.SORT_BY_KIND_NAME));
			}
		} else {
			getMniSortbyName().setSelected(false);
			getMniSortbyKindName().setSelected(false);
		...
		if (selected) {
			if (ch.ehi.umleditor.umldrawingtools.ClassDiagramView.allowsPackages(treeNode)
					|| ch.ehi.umleditor.umldrawingtools.ClassDiagramView.allowsClasses(treeNode)) {
				addMenuItem(getMniClassDiagram()); // ClassDiagram's may be
													// added to any package
				addMenuItem(getMniUmlPackage()); // UmlPackage's may be added to
													// any package
				getMnuNew().add(new javax.swing.JSeparator());
			}
			...
			if (isInsideUmlModel(treeNode)) {
				...
				/*
				 * addMenuItem(getMniIli2ModelSet()); } else if
				 * (userObject.isIli2ModelSet()) {
				 * addMenuItem(getMniInterlis2Def());
				 */
			} else if (isInsideInterlis2Def(treeNode)) {
				addMenuItem(getMniModelDef());
		...
		mniMoveElement.setEnabled(selected);
		mniDiagramReferences.setEnabled((treeNode instanceof ModelElement) && (!((treeNode instanceof AssociationEnd)
				|| (treeNode instanceof Attribute) || (treeNode instanceof UmlOperation))));
	}
	...
	/**
	 * connEtoC1: (TreNavigation.mouse.mouseReleased(java.awt.event.MouseEvent)
	 * -->
	...
	/**
	 * connEtoC10:
	 * (MniMetaDataUseDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.mniMetaDataUseDef_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
	 * 
	 * @param arg1
	...
	/**
	 * connEtoC11:
	 * (MniUnitDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newUnitDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC12:
	 * (MniFunctionDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newFunctionDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC13:
	 * (MniLineFormTypeDef.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavigationView.newLineFormTypeDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC14:
	 * (MniGraphicParameterDef.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavigationView.newGraphicParameterDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC15:
	 * (MniPatternDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newPatternDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC16:
	 * (MniTopicDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.mniTopicDef_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC17:
	 * (MniClassDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.mniClassDef_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC18:
	 * (MniAttributeDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newAttributeDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC19:
	 * (MniAddToDiagram.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.mniAddToDiagram()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC2:
	 * (MniOpenSpecification.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavTree.openSpecification()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC20:
	 * (MniViewDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newViewDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC21:
	 * (MniViewProjectionDef.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavigationView.newViewProjectionDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC22:
	 * (MniGraphicDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newGraphicDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC23:
	 * (MniRoleDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newRoleDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC24:
	 * (MniMetaObjectFile.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newMetaObjectFile()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC25:
	 * (MniUmlPackage.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newUmlPackage()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC26:
	 * (MniSortbyName.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.sortByName()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC27:
	 * (MniSortbyKindName.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.sortByKindName()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC28: (MniOpen.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavigationView.mniOpen()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC29: (MniPrint.action.actionPerformed(java.awt.event.ActionEvent)
	...
	/**
	 * connEtoC3:
	 * (MniRemoveNode.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavTree.removeNode()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC30: (TreNavigation.mouse.mousePressed(java.awt.event.MouseEvent)
	 * -->
	 * NavigationView.genericPopupDisplay(Ljava.awt.event.MouseEvent;Ljavax.swing.JPopupMenu;)V)
	 * 
	 * @param arg1
	...
	/**
	 * connEtoC4: (MniRename.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavTree.renameNode()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC5:
	 * (MniNewUmlModell.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavTree.newUmlModell()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
...
=======
	...
	/**
	 * connEtoC6:
	 * (MniNewInterlisFile.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavTree.newInterlisFile()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
...
=======
	...
	/**
	 * connEtoC7:
	 * (MniNewInterlisModel.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> NavTree.newInterlisModel()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
...
=======
	...
	/**
	 * connEtoC8:
	 * (TreNavigation.treeSelection.valueChanged(javax.swing.event.TreeSelectionEvent)
	 * -->
	 * NavigationView.selectionChanged(Ljavax.swing.event.TreeSelectionEvent;)V)
	 * 
	 * @param arg1
...
=======
	...
	/**
	 * connEtoC9:
	 * (MniIliDomainDef.action.actionPerformed(java.awt.event.ActionEvent) -->
	 * NavigationView.newDomainDef()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
...
=======
	...
	private void initialize() {
		...
		mniDiagramReferences = new javax.swing.JMenuItem();
		mniDiagramReferences.setName("MniAddDiagramReferences");
		// mniDiagramReferences.setToolTipText("FÃ¼gt Selektierten Knoten im
	...
	private void initializeTree() {
		 ...
		 * getTreNavigation().getRowForLocation(e.getX(), e.getY()); if
		 * (selectedRow != -1) { TreePath selectedPath =
		 * getTreNavigation().getPathForLocation(e.getX(), e.getY());
		 * MutableTreeNode selectedNode =
		 * (MutableTreeNode)selectedPath.getLastPathComponent(); if
		 * (selectedNode != null) { if (e.getClickCount() == 2) { // HACK: this
		 * event comes twicely doubleClickTreated = !doubleClickTreated; if
		...
		// show lines from Parent to leaf
		getTreNavigation().putClientProperty("JTree.lineStyle", "Angled");//$NON-NLS-2$//$NON-NLS-1$
		// ds = new TreeDragSource(getTreNavigation(),
	...
	private void moveElement() {
		try {
			MoveElementDialog moveDialog = new MoveElementDialog(LauncherView.getInstance(), "Select Target Package",
					true, LauncherView.getInstance().getModel());
			if (moveDialog.isSaved()) {
				ch.ehi.uml1_4.foundation.core.Namespace apackage = moveDialog.getSelectedPackage();
	...
	private void newMetaObjectFile() {
		try {
			selectElement(ElementFactory.createMetaObjectFile(
					(ch.ehi.uml1_4.implementation.UmlModel) LauncherView.getInstance().getModel()));
			renameNode();
		} catch (Throwable e) {
			handleException(e);
		}
	...
	private void newUmlPackage() {
		try {
			selectElement(ElementFactory.createOwnedElement(ch.ehi.uml1_4.implementation.UmlPackage.class,
					getSelectedNode()));
			renameNode();
		} catch (Throwable e) {
			handleException(e);
	...
	/**
	 * Select given Element in NavigationTree. If necessary make path visible
	 * before.
	 */
	public void selectElement(Element element) {
		if (element instanceof ch.ehi.interlis.associations.Participant) {
	...
	/**
	 * Build the visual Tree with a given UML-Model. All Nodes have a userObject
	 * of type ElementMapper. Hierarchy: -> RootNode has a null ModelElement
	 * (though it shows the FileName of UmlModel) -> LogicalView -> contains the
	 * real model-root => UmlModel -> Ili2ModelSet -> ... (according to
	 * INTERLIS-Model)
	 * 
	 * @see ElementMapper#createElement(*)
	 */
	public synchronized void setModel(Namespace namespace) {
		try {
			if (modelAdapter != null && ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.containsMetaModelListener(modelAdapter)) {
				// unregister Listener while building new model
				ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().removeMetaModelListener(modelAdapter);
			}
			...
			// kept in UmlModel)
			// getTreNavigation().setModel(new DefaultTreeModel(new
			// NavigationTreeNode()));
			modelAdapter = new NavigationTreeModel(namespace, false);
			modelAdapter.setOrdering(((UserSettings) LauncherView.getSettings()).getNavigationSort());
			getTreNavigation().setModel(modelAdapter);
	...
	private void setOrdering(String ordering) {
		if (!modelAdapter.getOrdering().equals(ordering)) {
			...
			((UserSettings) LauncherView.getSettings()).setNavigationSort(ordering);
			// get list of expanded
			java.util.Enumeration expi = getTreNavigation()
					.getExpandedDescendants(modelAdapter.getTreePath((Element) modelAdapter.getRoot()));
			java.util.ArrayList expv = new java.util.ArrayList();
			while (expi.hasMoreElements()) {
				expv.add(expi.nextElement());
			}
	...
	public void showSpecification() {
		...
		if (treeNode == null) {
			// show UmlModel Specification which is actually in LogicalView node
			// but showed as root node
			LauncherView.getInstance().showSpecification(LauncherView.getInstance().getModel());
		} else if (!NavigationTreeNodeUtility.hasSpecification(treeNode)) {
			// generic case
			new CommonSpecificationDialog(LauncherView.getInstance(), treeNode);
	...
	private void showDiagramReferences() {
		...
		// TODO evtl. add this code to a Tool/Utility
		// add root namespace to todo-list; so it is processed as a first
		// element
		todo.add(LauncherView.getInstance().getModel());
		// process todo-list
		while (!todo.isEmpty()) {
		...
		new FindDialog(LauncherView.getInstance(), false, foundElements,
