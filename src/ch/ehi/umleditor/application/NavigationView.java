...
private javax.swing.JMenuItem getMniAddToDiagram() {
	if (ivjMniAddToDiagram == null) {
		try {
			...
			ivjMniAddToDiagram.setToolTipText("Fuegt Selektierten Knoten im aktuellen Diagram ein");
			ivjMniAddToDiagram.setText("Einfuegen in Diagram");
			// user code begin {1}
...
private javax.swing.JMenuItem getMniMetaObjectFile() {
	if (ivjMniMetaObjectFile == null) {
		try {
			...
			ivjMniMetaObjectFile.setText("Metadatenbehaelter-Datei");
			// user code begin {1}
...
private javax.swing.JMenuItem getMniOpenSpecification() {
	if (ivjMniOpenSpecification == null) {
		try {
			...
			ivjMniOpenSpecification.setText("Oeffne Spezifikation...");
			// user code begin {1}
...
private javax.swing.JMenuItem getMniRemove() {
	if (ivjMniRemove == null) {
		try {
			...
			ivjMniRemove.setText("Loeschen (im Modell)");
			// user code begin {1}
...
//  mniDiagramReferences.setToolTipText("Fuegt Selektierten Knoten im aktuellen Diagram ein");
