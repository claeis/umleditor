...
public class FindDialog extends ch.softenvironment.view.BaseDialog {
	...
	/**
	 * connEtoC3:
	 * (LstSearchList.listSelection.valueChanged(javax.swing.event.ListSelectionEvent)
	 * --> FindDialog.selectElement(Ljavax.swing.event.ListSelectionEvent;)V)
	 * 
	 * @param arg1
	...
	private void search() {
		try {
			...
			results = ch.ehi.uml1_4.tools.NamespaceUtility.deepFindOwnedElements(LauncherView.getInstance().getModel(),
					condition);
			showResults(results);
		} catch (Throwable e) {
