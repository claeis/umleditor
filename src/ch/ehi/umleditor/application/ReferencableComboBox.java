...
=======
	...
	/**
	 * Fill ComboBox with potential Dependency-Elements and set the current
	 * element.
	 * 
	 * @param client
	 *            of Dependency
	...
	/**
	 * Fill a ComboBox with all owned Elements of the given ModelElement's
	 * parent-TopicDef. The names are displayed with a qualified path.
	 * 
	 * @param modelElement
	 *            (the element to find referenceClass-Elements for)
	...
	private boolean setDisplayList(java.util.Set set, ModelElement modelElement, ModelElement currentModelElement) {
		...
		// enable that currentModelElement is shown; in case it is not
		// referencable
		if ((currentModelElement != null) && !referencables.contains(currentModelElement)) {
			referencables.add(currentModelElement);
		}
		...
		if (currentModelElement != null) {
			...
			/*
			 * new
			 * ch.softenvironment.view.WarningDialog(LauncherView.getInstance(),
			 * resReferencableComboBox.getString("CTMissingElement"),
			 * //$NON-NLS-1$
			 * resReferencableComboBox.getString("CWMissingElement") + "\n[" +
			 * currentModelElement.toString() + "]\n" +
			 * resReferencableComboBox.getString("CWLostReference") +
			 * "\n[@see ReferencableComboBox#setDisplayList(..)]");//$NON-NLS-5$
	 ...
	 *            (type of namespace-elements to be found)
	 * @param modelElement
	 *            (the element to find referenceClass-Elements for)
	 * @param currentModelElement
	 *            (the currently chosen one)
	 ...
	 * @see ElementMapper#getReferencableElements()
	 */
	protected void setElement(java.lang.Class referenceClass, ModelElement modelElement,
	...
	protected void setElement(Set referencableElements, ModelElement modelElement, ModelElement currentModelElement) {
		setDisplayList(referencableElements, modelElement, currentModelElement);
	}
	...
	protected boolean setUsage(ModelElement modelElement) {
		...
		return setDisplayList(ownedElements, modelElement,
				getSupplier(ch.ehi.uml1_4.implementation.UmlUsage.class, modelElement));
	}
>>>>>>> 803fe805af2eebe1581931014fa25d7f5559e1e9
}
