...
public class OptionsDialog extends BaseDialog {
	...
	public OptionsDialog(java.awt.Frame owner) {
		...
		initialize();
		addEscapeKey();
		addUndoRedo(getTxtDiagramHeight(),getTxtDiagramWidth(),getTxtImportDirectory(),getTxtWorkingDirectory());
	 ...
	 */
	 private void addEscapeKey() {
		 ...
		 Action escapeAction = new AbstractAction() {
			...
			private static final long serialVersionUID = -4490968426639901546L;
	...
	/**
	 * connEtoC3:
	 * (BtnWorkingDirectory.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> OptionsDialog.btnFilePrompter(Ljava.awt.event.ActionEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	/**
	 * connEtoC4:
	 * (BtnImportDirectory.action.actionPerformed(java.awt.event.ActionEvent)
	 * --> OptionsDialog.btnFilePrompter(Ljava.awt.event.ActionEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	...
	private javax.swing.JPanel getBaseDialogContentPane() {
		if (ivjBaseDialogContentPane == null) {
			try {
				...
				constraintsTbpOptions.gridx = 1;
				constraintsTbpOptions.gridy = 1;
	...
	private javax.swing.JPanel getPnlPaths() {
		if (ivjPnlPaths == null) {
			try {
				...
				constraintsLblWorkingDirectery.gridx = 1;
				constraintsLblWorkingDirectery.gridy = 1;
				...
				constraintsTxtWorkingDirectory.gridx = 2;
				constraintsTxtWorkingDirectory.gridy = 1;
				...
				constraintsBtnWorkingDirectory.gridx = 3;
				constraintsBtnWorkingDirectory.gridy = 1;
				...
				constraintsLblImportDirectory.gridx = 1;
				constraintsLblImportDirectory.gridy = 2;
				...
				constraintsTxtImportDirectory.gridx = 2;
				constraintsTxtImportDirectory.gridy = 2;
				...
				constraintsBtnImportDirectory.gridx = 3;
				constraintsBtnImportDirectory.gridy = 2;
	...
	private javax.swing.JTabbedPane getTbpOptions() {
		if (ivjTbpOptions == null) {
			try {
				...
				ivjTbpOptions.insertTab(resOptionsDialog.getString("TbpClassdiagramms_title"), null, getPnlDiagrams(),
						null, 1);
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
