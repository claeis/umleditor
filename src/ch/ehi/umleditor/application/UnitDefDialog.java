...
public class UnitDefDialog extends BaseDialog {
	...
	public UnitDefDialog(java.awt.Frame owner, ch.ehi.uml1_4.foundation.core.Element element) {
		...
		initialize();
		addEscapeKey();
		addUndoRedo(getTxtDescName(), getTxtName());
	 ...
	 */
	 private void addEscapeKey() {
		 ...
		 Action escapeAction = new AbstractAction() {
			...
			private static final long serialVersionUID = 5540071078842143059L;
	...
	/**
	 * connEtoM2: (TxtShortName.focus.focusGained(java.awt.event.FocusEvent) -->
	 * TxtShortName.selectAll()V)
	 * 
	 * @param arg1
	 *            java.awt.event.FocusEvent
	 */
	...
	private javax.swing.JPanel getBaseDialogContentPane() {
		if (ivjBaseDialogContentPane == null) {
			try {
				...
				constraintsLblDescName.gridx = 1;
				constraintsLblDescName.gridy = 2;
				...
				constraintsTxtDescName.gridx = 3;
				constraintsTxtDescName.gridy = 2;
	...
	private javax.swing.JTabbedPane getTbpGeneral() {
		if (ivjTbpGeneral == null) {
			try {
				...
				ivjTbpGeneral.insertTab(resUnitDefDialog.getString("TbpDefinition_title"), null, getPnlSyntax(), null,
						1);
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
