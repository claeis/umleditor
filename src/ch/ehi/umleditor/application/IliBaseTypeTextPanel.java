...
public class IliBaseTypeTextPanel extends BasePanel implements DataPanel {
	...
	/**
	 * connEtoC1: (RbtLength.item.itemStateChanged(java.awt.event.ItemEvent) -->
	 * IliBaseTypeTextPanel.rbtLength_ItemStateChanged(Ljava.awt.event.ItemEvent;)V)
	 * 
	 * @param arg1
	...
	/**
	 * connEtoM1: (TxtLength.focus.focusGained(java.awt.event.FocusEvent) -->
	 * TxtLength.selectAll()V)
	 * 
	 * @param arg1
