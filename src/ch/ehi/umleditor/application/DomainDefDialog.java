...
public class DomainDefDialog extends BaseDialog {
	...
	public DomainDefDialog(java.awt.Frame owner, ch.ehi.uml1_4.foundation.core.Element element) {
		...
		initialize();
		addEscapeKey();
		addUndoRedo(getTxtName(),getTxtMetaAttrbDom());
	 ...
	 */
	 private void addEscapeKey() {
		 ...
		 Action escapeAction = new AbstractAction() {
			...
			private static final long serialVersionUID = -8162918271597948933L;
	 ...
	 * --> DomainDefDialog.cancelPressed()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	 ...
	 * --> DomainDefDialog.applyPressed()V)
	 * 
	 * @param arg1
	 *            java.awt.event.ActionEvent
	 */
	...
	private javax.swing.JPanel getBaseDialogContentPane() {
		if (ivjBaseDialogContentPane == null) {
			try {
				...
				constraintsTxtMetaAttrbDom.gridx = 2;
				constraintsTxtMetaAttrbDom.gridy = 1;
				...
				constraintsTbpTypes.gridx = 1;
				constraintsTbpTypes.gridy = 3;
	...
	private javax.swing.JPanel getPnlDetail() {
		if (ivjPnlDetail == null) {
			try {
				...
				constraintsChxMandatory.gridx = 1;
				constraintsChxMandatory.gridy = 3;
				...
				constraintsPnlExtended.gridy = 4;
	 ...
	 */
	public void dispose() {
		domainDef = null; // try to avoid OutOfMemoryException in case dialog
							// might not be garbaged
		super.dispose();
	}
}
