...
public class IliBaseTypeCoordPanel extends BasePanel implements DataPanel {
	...
	// generated code
	// private java.util.ArrayList numericDimensions = new
	// java.util.ArrayList();
	...
	public IliBaseTypeCoordPanel() {
		super();
		initialize();
		addUndoRedo(getTxtPiHalfAxis(),getTxtRefSys(),getTxtZeroAxis());
	}
	/**
	...
	/**
	 * connEtoC1: (Rbt1D.item.itemStateChanged(java.awt.event.ItemEvent) -->
	 * IliBaseTypeCoordPanel.dimensionChanged(Ljava.awt.event.ItemEvent;)V)
	 * 
	 * @param arg1
	...
	/**
	 * connEtoC2: (Rbt2D.item.itemStateChanged(java.awt.event.ItemEvent) -->
	 * IliBaseTypeCoordPanel.dimensionChanged(Ljava.awt.event.ItemEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ItemEvent
	...
	/**
	 * connEtoC3: (Rbt3D.item.itemStateChanged(java.awt.event.ItemEvent) -->
	 * IliBaseTypeCoordPanel.dimensionChanged(Ljava.awt.event.ItemEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ItemEvent
	...
	/**
	 * connEtoC4:
	 * (ChxRotationDef.item.itemStateChanged(java.awt.event.ItemEvent) -->
	 * IliBaseTypeCoordPanel.chxRotationDef_ItemStateChanged(Ljava.awt.event.ItemEvent;)V)
	 * 
	 * @param arg1
	 *            java.awt.event.ItemEvent
	 */
	...
	/**
	 * connEtoM1: (TxtZeroAxis.focus.focusGained(java.awt.event.FocusEvent) -->
	 * TxtZeroAxis.selectAll()V)
	 * 
	 * @param arg1
	...
	/**
	 * connEtoM2: (TxtPiHalfAxis.focus.focusGained(java.awt.event.FocusEvent)
	 * --> TxtPiHalfAxis.selectAll()V)
	 * 
	 * @param arg1
	 *            java.awt.event.FocusEvent
	 */
	...
	public java.lang.Object getObject() {
		...
		// save Dimensions
		type.addDim((NumericalType) getPnlNumeric1D().getObject()); // 1D always
																	// is
