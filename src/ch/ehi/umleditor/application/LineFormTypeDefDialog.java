...
private JPanel getPnlDetail() {
	if (ivjPnlDetail == null) {
		try {
			...
			constraintsCbxStructure.gridx = 1; constraintsCbxStructure.gridy = 0;
			constraintsCbxStructure.gridwidth = 1; constraintsCbxStructure.gridheight = 1;
			...
			constraintsLblStructure.gridx = 0; constraintsLblStructure.gridy = 0;
			constraintsLblStructure.gridwidth = 1; constraintsLblStructure.gridheight = 1;
