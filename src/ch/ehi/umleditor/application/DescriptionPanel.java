...
=======
	 ...
	 */
	public void addDescriptionPanelListener(ch.ehi.umleditor.application.DescriptionPanelListener newListener) {
		fieldDescriptionPanelListenerEventMulticaster = ch.ehi.umleditor.application.DescriptionPanelListenerEventMulticaster
				.add(fieldDescriptionPanelListenerEventMulticaster, newListener);
		return;
	}
	 ...
	 * -->
	 * DescriptionPanel.firePnlEditorSimpleEditorPanel_txaEditorKey_keyReleased(Ljava.util.EventObject;)V)
	 * 
	 * @param arg1
	...
	public java.lang.Object getObject() {
		element.setDocumentation(
				new ch.ehi.basics.types.NlsString(element.getDocumentation(), getPnlEditor().getText()));
	...
	public void removeDescriptionPanelListener(ch.ehi.umleditor.application.DescriptionPanelListener newListener) {
		fieldDescriptionPanelListenerEventMulticaster = ch.ehi.umleditor.application.DescriptionPanelListenerEventMulticaster
				.remove(fieldDescriptionPanelListenerEventMulticaster, newListener);
		return;
	}
