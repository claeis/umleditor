...
public class PrintWrapper implements java.awt.print.Printable {
	...
	public int print(java.awt.Graphics graphics, java.awt.print.PageFormat pageFormat, int pageIndex)
		...
		if (false) {
			...
			Rectangle2D printArea = new Rectangle2D.Double(0.0, 0.0, pageFormat.getImageableWidth(),
					pageFormat.getImageableHeight());
			g2d.draw(printArea);
			printArea = new Rectangle2D.Double(0.0, 0.0, pageFormat.getImageableWidth() + 10,
		...
		// System.out.println("w,h: "+Double.toString(w0)+",
		// "+Double.toString(h0));
		...
		// System.out.println("scale: "+Double.toString(scaleX)+",
		// "+Double.toString(scaleY));
		if (scaleX < 1.0) {
			if (scaleX <= scaleY) {
