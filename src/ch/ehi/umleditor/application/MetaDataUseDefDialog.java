...
public class MetaDataUseDefDialog extends BaseDialog {
	// ModelElement
	private static java.util.ResourceBundle resMetaDataUseDefDialog = java.util.ResourceBundle.getBundle("ch/ehi/umleditor/application/resources/MetaDataUseDefDialog");  //$NON-NLS-1$
...
/**
 * connEtoC1:  (BtnOk.action.actionPerformed(java.awt.event.ActionEvent) --> MetaDataUseDefDialog.okPressed()V)
...
/**
 * connEtoC2:  (BtnCancel.action.actionPerformed(java.awt.event.ActionEvent) --> MetaDataUseDefDialog.cancelPressed()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * connEtoC3:  (BtnApply.action.actionPerformed(java.awt.event.ActionEvent) --> MetaDataUseDefDialog.applyPressed()V)
 * @param arg1 java.awt.event.ActionEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
/**
 * connEtoM2:  (TxtBasketOID.focus.focusGained(java.awt.event.FocusEvent) --> TxtBasketOID.selectAll()V)
 * @param arg1 java.awt.event.FocusEvent
 */
/* WARNING: THIS METHOD WILL BE REGENERATED. */
...
private javax.swing.JPanel getBaseDialogContentPane() {
	if (ivjBaseDialogContentPane == null) {
		try {
			...
			constraintsTbpGeneral.gridx = 1; constraintsTbpGeneral.gridy = 4;
			...
			constraintsBtnOk.gridx = 1; constraintsBtnOk.gridy = 5;
			...
			constraintsBtnCancel.gridx = 2; constraintsBtnCancel.gridy = 5;
			...
			constraintsBtnApply.gridx = 3; constraintsBtnApply.gridy = 5;
			...
			constraintsLblBasketOID.gridx = 1; constraintsLblBasketOID.gridy = 2;
			...
			constraintsTxtBasketOID.gridx = 2; constraintsTxtBasketOID.gridy = 2;
