...
public class ContractDialog extends BaseDialog {
	...
	// ModelElement
	private static java.util.ResourceBundle resContractDialog = java.util.ResourceBundle
			.getBundle("ch/ehi/umleditor/application/resources/ContractDialog");
	 ...
	 */
	 private void addEscapeKey() {
		 ...
		 Action escapeAction = new AbstractAction() {
			...
			private static final long serialVersionUID = 3528049881602122954L;
	...
	/**
	 * connEtoM1: (TxtIssuer.focus.focusGained(java.awt.event.FocusEvent) -->
	 * TxtIssuer.selectAll()V)
	 * 
	 * @param arg1
	...
	protected boolean save() {
		...
		// ch.ehi.basics.types.NlsString(contract.getExplanation(),
		// getTxtExplanation().getText()));
