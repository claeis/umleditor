...
public java.beans.PropertyDescriptor classifierExtensionPropertyDescriptor() {
								...
								try {
																try {
																								/* Using methods via getMethod is the faster way to create the classifierExtension property descriptor. */
																								...
																								aDescriptor = new java.beans.PropertyDescriptor("classifierExtension"
...
public java.beans.PropertyDescriptor extensionPropertyDescriptor() {
								...
								try {
																try {
																								/* Using methods via getMethod is the faster way to create the extension property descriptor. */
																								java.lang.reflect.Method aGetMethod = null;
																								java.lang.reflect.Method aSetMethod = null;
																								try {
																																/* Attempt to find the method using getMethod with parameter types. */
																								...
																								aDescriptor = new java.beans.PropertyDescriptor("extension"
																																																																								, aGetMethod, aSetMethod);
																} catch (Throwable exception) {
																								/* Since we failed using methods, try creating a default property descriptor. */
																								handleException(exception);
...
public java.beans.PropertyDescriptor[] getPropertyDescriptors() {
								try {
																java.beans.PropertyDescriptor aDescriptorList[] = {
																								classifierExtensionPropertyDescriptor()
																								,componentOrientationPropertyDescriptor()
																								,extensionPropertyDescriptor()
																};
																return aDescriptorList;
								} catch (Throwable exception) {
																handleException(exception);
...
/**
 * Gets the setClassifierExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setClassifierExtension_chehiuml1_4foundationcoreGeneralizableElementMethodDescriptor() {
								java.beans.MethodDescriptor aDescriptor = null;
								try {
																/* Create and return the setClassifierExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement) method descriptor. */
																java.lang.reflect.Method aMethod = null;
																try {
																								/* Attempt to find the method using getMethod with parameter types. */
																								java.lang.Class aParameterTypes[] = {
																...
																/* aDescriptor.setDisplayName("setClassifierExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement)"); */
																/* aDescriptor.setShortDescription("setClassifierExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement)"); */
																/* aDescriptor.setExpert(false); */
																/* aDescriptor.setHidden(false); */
																/* aDescriptor.setValue("preferred", new Boolean(false)); */
								} catch (Throwable exception) {
...
/**
 * Gets the setExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement) method descriptor.
 * @return java.beans.MethodDescriptor
 */
public java.beans.MethodDescriptor setExtension_chehiuml1_4foundationcoreGeneralizableElementMethodDescriptor() {
								java.beans.MethodDescriptor aDescriptor = null;
								try {
																/* Create and return the setExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement) method descriptor. */
																java.lang.reflect.Method aMethod = null;
																try {
																								/* Attempt to find the method using getMethod with parameter types. */
																								java.lang.Class aParameterTypes[] = {
																...
																/* aDescriptor.setDisplayName("setExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement)"); */
																/* aDescriptor.setShortDescription("setExtension(ch.ehi.uml1_4.foundation.core.GeneralizableElement)"); */
																/* aDescriptor.setExpert(false); */
																/* aDescriptor.setHidden(false); */
																/* aDescriptor.setValue("preferred", new Boolean(false)); */
								} catch (Throwable exception) {
