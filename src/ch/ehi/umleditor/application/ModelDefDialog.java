...
public class ModelDefDialog extends BaseDialog implements ListMenuChoice {
	...
	public ModelDefDialog(java.awt.Frame owner, ch.ehi.uml1_4.foundation.core.Element element) {
		...
		initialize();
		addEscapeKey();
		addUndoRedo(getTxtName(),getTxtIDGeoIV(),getTxtVersion(),getTxtVersionComment(),getTxtIssuerURI(),getTxtFurtherInformation(),getTxtTechnicalContact());
	 ...
	 */
	 private void addEscapeKey() {
		 ...
		 Action escapeAction = new AbstractAction() {
			...
			private static final long serialVersionUID = -5027628823618533683L;
