...
public class IliBaseTypeBasketPanel extends BasePanel implements DataPanel {
	...
	private int getkind() {
		/*
		 * if (getRbtUnspecified().isSelected()) { return TextKind.ABSTRACT; }
		 * else if (getRbtLength().isSelected()) { return TextKind.MAXLEN; }
		 * else if (getRbtName().isSelected()) { return TextKind.NAME; } else if
		 * (getRbtURI().isSelected()) { return TextKind.URI; } else {
		 */
	...
	private void initialize() {
		try {
			...
			constraintsRbtData.gridx = 2;
			constraintsRbtData.gridy = 2;
			...
			constraintsRbtView.gridx = 2;
			constraintsRbtView.gridy = 3;
			...
			constraintsRbtBase.gridx = 2;
			constraintsRbtBase.gridy = 4;
			...
			constraintsRbtGraphic.gridx = 2;
			constraintsRbtGraphic.gridy = 5;
			...
			constraintsLblAccordingTo.gridx = 1;
			constraintsLblAccordingTo.gridy = 6;
			...
			constraintsCbxTopicDef.gridx = 2;
			constraintsCbxTopicDef.gridy = 6;
			...
			constraintsRbtUndefined.gridx = 2;
			constraintsRbtUndefined.gridy = 1;
