...
public class GeneralizableElementUtility
          {
            ...
            /** checks if there is a Generalization relationship accros multiple levels between the given child and parent
             */
            // -beg- preserve=no 3CC03F830345 head3CC03F43036B "deepContainsGeneralizationParent"
            ...
            // -end- 3CC03F830345 head3CC03F43036B "deepContainsGeneralizationParent"
              ...
              // please fill in/modify the following section
              // -beg- preserve=no 3CC03F830345 throws3CC03F43036B "deepContainsGeneralizationParent"

              // -end- 3CC03F830345 throws3CC03F43036B "deepContainsGeneralizationParent"
              {
              // please fill in/modify the following section
              // -beg- preserve=yes 3CC03F830345 body3CC03F43036B "deepContainsGeneralizationParent"
    java.util.HashSet parents=new java.util.HashSet(); // collection of all parents visited so far
    java.util.ArrayList todo=new java.util.ArrayList(); // collection of parents not yet visited
    ...
    return false;
              // -end- 3CC03F830345 body3CC03F43036B "deepContainsGeneralizationParent"
              }
