 ...
 * conformance with itstag definition.
 * 
 * @author Claude Eisenhut
 * @version $Revision: 1.1.1.1 $ $Date: 2003-12-23 10:37:48 $
 */
public interface TaggedValue extends Element, ModelElement, java.io.Serializable {
	 ...
	 * @see #containsModelElement
	 */
	// -beg- preserve=no 33E901E10028 attach_head337A4EF7002C
	// "TaggedValue::attachModelElement"
	public void attachModelElement(ModelElement modelElement1)
	// -end- 33E901E10028 attach_head337A4EF7002C
	// "TaggedValue::attachModelElement"
	; // empty
	 ...
	 * @see #attachModelElement
	 */
	// -beg- preserve=no 33E901E10028 detach_head337A4EF7002C
	// "TaggedValue::detachModelElement"
	public ModelElement detachModelElement()
	// -end- 33E901E10028 detach_head337A4EF7002C
	// "TaggedValue::detachModelElement"
	; // empty
	 ...
	 * @see #attachModelElement
	 */
	// -beg- preserve=no 33E901E10028 get_head337A4EF7002C
	 ...
	 * @see #attachModelElement
	 */
	// -beg- preserve=no 33E901E10028 test_head337A4EF7002C
	// "TaggedValue::containsModelElement"
	public boolean containsModelElement()
	// -end- 33E901E10028 test_head337A4EF7002C
	// "TaggedValue::containsModelElement"
	; // empty
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 33E901E10028 _link_body337A4EF7002C
	// "TaggedValue::_linkModelElement"
	public void _linkModelElement(ModelElement modelElement1);
	// -end- 33E901E10028 _link_body337A4EF7002C
	// "TaggedValue::_linkModelElement"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 33E901E10028 _unlink_body337A4EF7002C
	// "TaggedValue::_unlinkModelElement"
	public void _unlinkModelElement(ModelElement modelElement1);
	// -end- 33E901E10028 _unlink_body337A4EF7002C
	// "TaggedValue::_unlinkModelElement"
	 ...
	 * @see #sizeReferenceValue
	 */
	// -beg- preserve=no 39B9B0F80000 add_head337A4EF7002C
	 ...
	 * @see #addReferenceValue
	 */
	// -beg- preserve=no 39B9B0F80000 remove_head337A4EF7002C
	// "TaggedValue::removeReferenceValue"
	public ModelElement removeReferenceValue(ModelElement referenceValue1)
	// -end- 39B9B0F80000 remove_head337A4EF7002C
	// "TaggedValue::removeReferenceValue"
	; // empty
	 ...
	 * @see #addReferenceValue
	 */
	// -beg- preserve=no 39B9B0F80000 test_head337A4EF7002C
	// "TaggedValue::containsReferenceValue"
	public boolean containsReferenceValue(ModelElement referenceValue1)
	// -end- 39B9B0F80000 test_head337A4EF7002C
	// "TaggedValue::containsReferenceValue"
	; // empty
	 ...
	 * @see #addReferenceValue
	 */
	// -beg- preserve=no 39B9B0F80000 remove_all_head337A4EF7002C
	// "TaggedValue::clearReferenceValue"
	public void clearReferenceValue()
	// -end- 39B9B0F80000 remove_all_head337A4EF7002C
	// "TaggedValue::clearReferenceValue"
	; // empty
	 ...
	 * @see #addReferenceValue
	 */
	// -beg- preserve=no 39B9B0F80000 size_head337A4EF7002C
	// "TaggedValue::sizeReferenceValue"
	public int sizeReferenceValue()
	// -end- 39B9B0F80000 size_head337A4EF7002C
	// "TaggedValue::sizeReferenceValue"
	; // empty
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 39B9B0F80000 _link_body337A4EF7002C
	// "TaggedValue::_linkReferenceValue"
	public void _linkReferenceValue(ModelElement referenceValue1);
	// -end- 39B9B0F80000 _link_body337A4EF7002C
	// "TaggedValue::_linkReferenceValue"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 39B9B0F80000 _unlink_body337A4EF7002C
	// "TaggedValue::_unlinkReferenceValue"
	public void _unlinkReferenceValue(ModelElement referenceValue1);
	// -end- 39B9B0F80000 _unlink_body337A4EF7002C
	// "TaggedValue::_unlinkReferenceValue"
