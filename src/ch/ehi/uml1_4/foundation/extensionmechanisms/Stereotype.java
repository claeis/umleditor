...
/** The stereotype concept provides a way of branding (classifying) model elements so that theybehave in some respects as if they were instances of new virtual metamodel constructs.
...
public interface Stereotype extends GeneralizableElement , java.io.Serializable
{
   ...
   *  @see #sizeDefinedTag
   */
  // -beg- preserve=no 3386129C0040 add_head3372549100E5 "Stereotype::addDefinedTag"
   ...
   *  @see #addDefinedTag
   */
  // -beg- preserve=no 3386129C0040 remove_head3372549100E5 "Stereotype::removeDefinedTag"
   ...
   *  @see #addDefinedTag
   */
  // -beg- preserve=no 3386129C0040 test_head3372549100E5 "Stereotype::containsDefinedTag"
   ...
   *  @see #addDefinedTag
   */
  // -beg- preserve=no 3386129C0040 get_all_head3372549100E5 "Stereotype::iteratorDefinedTag"
  public java.util.Iterator iteratorDefinedTag()
  // -end- 3386129C0040 get_all_head3372549100E5 "Stereotype::iteratorDefinedTag"
    ; // empty

  /** disconnect all DefinedTags.
   *  @see #addDefinedTag
   */
  // -beg- preserve=no 3386129C0040 remove_all_head3372549100E5 "Stereotype::clearDefinedTag"
  public void clearDefinedTag()
  // -end- 3386129C0040 remove_all_head3372549100E5 "Stereotype::clearDefinedTag"
    ; // empty

  /** returns the number of DefinedTags.
   *  @see #addDefinedTag
   */
  // -beg- preserve=no 3386129C0040 size_head3372549100E5 "Stereotype::sizeDefinedTag"
   ...
   */
  // -beg- preserve=no 3386129C0040 _link_body3372549100E5 "Stereotype::_linkDefinedTag"
  public void _linkDefinedTag(TagDefinition definedTag1);
  // -end- 3386129C0040 _link_body3372549100E5 "Stereotype::_linkDefinedTag"

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 3386129C0040 _unlink_body3372549100E5 "Stereotype::_unlinkDefinedTag"
  public void _unlinkDefinedTag(TagDefinition definedTag1);
  // -end- 3386129C0040 _unlink_body3372549100E5 "Stereotype::_unlinkDefinedTag"
   ...
   */
  // -beg- preserve=no 338613A4007A add_head3372549100E5 "Stereotype::addExtendedElement"
   ...
   */
  // -beg- preserve=no 338613A4007A remove_head3372549100E5 "Stereotype::removeExtendedElement"
  public ModelElement removeExtendedElement(ModelElement extendedElement1)
  // -end- 338613A4007A remove_head3372549100E5 "Stereotype::removeExtendedElement"
    ; // empty

  /** tests if a given ExtendedElement is connected.
   *  @see #addExtendedElement
   */
  // -beg- preserve=no 338613A4007A test_head3372549100E5 "Stereotype::containsExtendedElement"
  public boolean containsExtendedElement(ModelElement extendedElement1)
  // -end- 338613A4007A test_head3372549100E5 "Stereotype::containsExtendedElement"
    ; // empty

  /** used to enumerate all connected ExtendedElements.
   *  @see #addExtendedElement
   */
  // -beg- preserve=no 338613A4007A get_all_head3372549100E5 "Stereotype::iteratorExtendedElement"
  public java.util.Iterator iteratorExtendedElement()
  // -end- 338613A4007A get_all_head3372549100E5 "Stereotype::iteratorExtendedElement"
    ; // empty

  /** disconnect all ExtendedElements.
   *  @see #addExtendedElement
   */
  // -beg- preserve=no 338613A4007A remove_all_head3372549100E5 "Stereotype::clearExtendedElement"
  public void clearExtendedElement()
  // -end- 338613A4007A remove_all_head3372549100E5 "Stereotype::clearExtendedElement"
    ; // empty

  /** returns the number of ExtendedElements.
   *  @see #addExtendedElement
   */
  // -beg- preserve=no 338613A4007A size_head3372549100E5 "Stereotype::sizeExtendedElement"
  public int sizeExtendedElement()
  // -end- 338613A4007A size_head3372549100E5 "Stereotype::sizeExtendedElement"
    ; // empty

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 338613A4007A _link_body3372549100E5 "Stereotype::_linkExtendedElement"
  public void _linkExtendedElement(ModelElement extendedElement1);
  // -end- 338613A4007A _link_body3372549100E5 "Stereotype::_linkExtendedElement"

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 338613A4007A _unlink_body3372549100E5 "Stereotype::_unlinkExtendedElement"
  public void _unlinkExtendedElement(ModelElement extendedElement1);
  // -end- 338613A4007A _unlink_body3372549100E5 "Stereotype::_unlinkExtendedElement"
   ...
   */
  // -beg- preserve=no 364B66900258 add_head3372549100E5 "Stereotype::addStereotypeConstraint"
  public void addStereotypeConstraint(Constraint stereotypeConstraint1)
  // -end- 364B66900258 add_head3372549100E5 "Stereotype::addStereotypeConstraint"
    ; // empty

  /** disconnect a StereotypeConstraint.
   *  @see #addStereotypeConstraint
   */
  // -beg- preserve=no 364B66900258 remove_head3372549100E5 "Stereotype::removeStereotypeConstraint"
  public Constraint removeStereotypeConstraint(Constraint stereotypeConstraint1)
  // -end- 364B66900258 remove_head3372549100E5 "Stereotype::removeStereotypeConstraint"
    ; // empty

  /** tests if a given StereotypeConstraint is connected.
   *  @see #addStereotypeConstraint
   */
  // -beg- preserve=no 364B66900258 test_head3372549100E5 "Stereotype::containsStereotypeConstraint"
  public boolean containsStereotypeConstraint(Constraint stereotypeConstraint1)
  // -end- 364B66900258 test_head3372549100E5 "Stereotype::containsStereotypeConstraint"
    ; // empty

  /** used to enumerate all connected StereotypeConstraints.
   *  @see #addStereotypeConstraint
   */
  // -beg- preserve=no 364B66900258 get_all_head3372549100E5 "Stereotype::iteratorStereotypeConstraint"
  public java.util.Iterator iteratorStereotypeConstraint()
  // -end- 364B66900258 get_all_head3372549100E5 "Stereotype::iteratorStereotypeConstraint"
    ; // empty

  /** disconnect all StereotypeConstraints.
   *  @see #addStereotypeConstraint
   */
  // -beg- preserve=no 364B66900258 remove_all_head3372549100E5 "Stereotype::clearStereotypeConstraint"
  public void clearStereotypeConstraint()
  // -end- 364B66900258 remove_all_head3372549100E5 "Stereotype::clearStereotypeConstraint"
    ; // empty

  /** returns the number of StereotypeConstraints.
   *  @see #addStereotypeConstraint
   */
  // -beg- preserve=no 364B66900258 size_head3372549100E5 "Stereotype::sizeStereotypeConstraint"
  public int sizeStereotypeConstraint()
  // -end- 364B66900258 size_head3372549100E5 "Stereotype::sizeStereotypeConstraint"
    ; // empty

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 364B66900258 _link_body3372549100E5 "Stereotype::_linkStereotypeConstraint"
  public void _linkStereotypeConstraint(Constraint stereotypeConstraint1);
  // -end- 364B66900258 _link_body3372549100E5 "Stereotype::_linkStereotypeConstraint"

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 364B66900258 _unlink_body3372549100E5 "Stereotype::_unlinkStereotypeConstraint"
  public void _unlinkStereotypeConstraint(Constraint stereotypeConstraint1);
  // -end- 364B66900258 _unlink_body3372549100E5 "Stereotype::_unlinkStereotypeConstraint"
