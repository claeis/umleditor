...
public abstract class AbstractDependency extends AbstractModelElement implements Dependency
    ...
    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"changeClient"));
    return;
    ...
    ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"changeSupplier"));
    return;
             ...
             *  @see #sizeClient
             */
            // -beg- preserve=no 33FFE57B03B3 add_head3E42404202F6 "Dependency::addClient"
            public void addClient(ModelElement client1)
            // -end- 33FFE57B03B3 add_head3E42404202F6 "Dependency::addClient"
            {
              // -beg- preserve=no 33FFE57B03B3 add_body3E42404202F6 "Dependency::addClient"
              client.add(client1);
              client1._linkClientDependency(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addClient"));
              return;
             ...
             *  @see #addClient
             */
            // -beg- preserve=no 33FFE57B03B3 remove_head3E42404202F6 "Dependency::removeClient"
            public ModelElement removeClient(ModelElement client1)
            // -end- 33FFE57B03B3 remove_head3E42404202F6 "Dependency::removeClient"
            {
              // -beg- preserve=no 33FFE57B03B3 remove_body3E42404202F6 "Dependency::removeClient"
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeClient"));
              return ret;
             ...
             *  @see #addClient
             */
            // -beg- preserve=no 33FFE57B03B3 test_head3E42404202F6 "Dependency::containsClient"
            public boolean containsClient(ModelElement client1)
            // -end- 33FFE57B03B3 test_head3E42404202F6 "Dependency::containsClient"
            {
              // -beg- preserve=no 33FFE57B03B3 test_body3E42404202F6 "Dependency::containsClient"
             ...
             *  @see #addClient
             */
            // -beg- preserve=no 33FFE57B03B3 get_all_head3E42404202F6 "Dependency::iteratorClient"
            public java.util.Iterator iteratorClient()
            // -end- 33FFE57B03B3 get_all_head3E42404202F6 "Dependency::iteratorClient"
            {
              // -beg- preserve=no 33FFE57B03B3 get_all_body3E42404202F6 "Dependency::iteratorClient"
              return client.iterator();
              // -end- 33FFE57B03B3 get_all_body3E42404202F6 "Dependency::iteratorClient"
            }

            /** disconnect all Clients.
             *  @see #addClient
             */
            // -beg- preserve=no 33FFE57B03B3 remove_all_head3E42404202F6 "Dependency::clearClient"
            public void clearClient()
            // -end- 33FFE57B03B3 remove_all_head3E42404202F6 "Dependency::clearClient"
            {
              // -beg- preserve=no 33FFE57B03B3 remove_all_body3E42404202F6 "Dependency::clearClient"
              if(sizeClient()>0){
                for(java.util.Iterator p = client.iterator(); p.hasNext();){
                  ((ModelElement)p.next())._unlinkClientDependency(this);
                }
                client.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearClient"));
              }
              // -end- 33FFE57B03B3 remove_all_body3E42404202F6 "Dependency::clearClient"
            }

            /** returns the number of Clients.
             *  @see #addClient
             */
            // -beg- preserve=no 33FFE57B03B3 size_head3E42404202F6 "Dependency::sizeClient"
            public int sizeClient()
            // -end- 33FFE57B03B3 size_head3E42404202F6 "Dependency::sizeClient"
            {
              // -beg- preserve=no 33FFE57B03B3 size_body3E42404202F6 "Dependency::sizeClient"
              return client.size();
             ...
             */
            // -beg- preserve=no 33FFE57B03B3 _link_body3E42404202F6 "Dependency::_linkClient"
            public void _linkClient(ModelElement client1)
            {
              client.add(client1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkClient"));
              return;
            }
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33FFE57B03B3 _unlink_body3E42404202F6 "Dependency::_unlinkClient"
            public void _unlinkClient(ModelElement client1)
            {
              client.remove(client1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkClient"));
              return;
            }
             ...
             *  @see #sizeSupplier
             */
            // -beg- preserve=no 335C0D7A02E4 add_head3E42404202F6 "Dependency::addSupplier"
            public void addSupplier(ModelElement supplier1)
            // -end- 335C0D7A02E4 add_head3E42404202F6 "Dependency::addSupplier"
            {
              // -beg- preserve=no 335C0D7A02E4 add_body3E42404202F6 "Dependency::addSupplier"
              supplier.add(supplier1);
              supplier1._linkSupplierDependency(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addSupplier"));
              return;
             ...
             *  @see #addSupplier
             */
            // -beg- preserve=no 335C0D7A02E4 remove_head3E42404202F6 "Dependency::removeSupplier"
            ...
            {
              // -beg- preserve=no 335C0D7A02E4 remove_body3E42404202F6 "Dependency::removeSupplier"
              ModelElement ret=null;
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeSupplier"));
              return ret;
              // -end- 335C0D7A02E4 remove_body3E42404202F6 "Dependency::removeSupplier"
            }

            /** tests if a given Supplier is connected.
             *  @see #addSupplier
             */
            // -beg- preserve=no 335C0D7A02E4 test_head3E42404202F6 "Dependency::containsSupplier"
            public boolean containsSupplier(ModelElement supplier1)
            // -end- 335C0D7A02E4 test_head3E42404202F6 "Dependency::containsSupplier"
            {
              // -beg- preserve=no 335C0D7A02E4 test_body3E42404202F6 "Dependency::containsSupplier"
              return supplier.contains(supplier1);
              // -end- 335C0D7A02E4 test_body3E42404202F6 "Dependency::containsSupplier"
            }

            /** used to enumerate all connected Suppliers.
             *  @see #addSupplier
             */
            // -beg- preserve=no 335C0D7A02E4 get_all_head3E42404202F6 "Dependency::iteratorSupplier"
            public java.util.Iterator iteratorSupplier()
            // -end- 335C0D7A02E4 get_all_head3E42404202F6 "Dependency::iteratorSupplier"
            {
              // -beg- preserve=no 335C0D7A02E4 get_all_body3E42404202F6 "Dependency::iteratorSupplier"
              return supplier.iterator();
              // -end- 335C0D7A02E4 get_all_body3E42404202F6 "Dependency::iteratorSupplier"
            }

            /** disconnect all Suppliers.
             *  @see #addSupplier
             */
            // -beg- preserve=no 335C0D7A02E4 remove_all_head3E42404202F6 "Dependency::clearSupplier"
            public void clearSupplier()
            // -end- 335C0D7A02E4 remove_all_head3E42404202F6 "Dependency::clearSupplier"
            {
              // -beg- preserve=no 335C0D7A02E4 remove_all_body3E42404202F6 "Dependency::clearSupplier"
              if(sizeSupplier()>0){
                for(java.util.Iterator p = supplier.iterator(); p.hasNext();){
                  ((ModelElement)p.next())._unlinkSupplierDependency(this);
                }
                supplier.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearSupplier"));
              }
              // -end- 335C0D7A02E4 remove_all_body3E42404202F6 "Dependency::clearSupplier"
            }

            /** returns the number of Suppliers.
             *  @see #addSupplier
             */
            // -beg- preserve=no 335C0D7A02E4 size_head3E42404202F6 "Dependency::sizeSupplier"
            public int sizeSupplier()
            // -end- 335C0D7A02E4 size_head3E42404202F6 "Dependency::sizeSupplier"
            {
              // -beg- preserve=no 335C0D7A02E4 size_body3E42404202F6 "Dependency::sizeSupplier"
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 335C0D7A02E4 _link_body3E42404202F6 "Dependency::_linkSupplier"
            public void _linkSupplier(ModelElement supplier1)
            {
              supplier.add(supplier1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkSupplier"));
              return;
            }
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 335C0D7A02E4 _unlink_body3E42404202F6 "Dependency::_unlinkSupplier"
            public void _unlinkSupplier(ModelElement supplier1)
            {
              supplier.remove(supplier1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkSupplier"));
              return;
            }
             ...
             */
            // -beg- preserve=no 362409A9000A add_head3E42404202F6 "ModelElement::addPresentation"
            ...
            {
              // -beg- preserve=no 362409A9000A add_body3E42404202F6 "ModelElement::addPresentation"
              super.addPresentation(presentation1);
              // -end- 362409A9000A add_body3E42404202F6 "ModelElement::addPresentation"
            }

            /** disconnect a Presentation.
             *  @see #addPresentation
             */
            // -beg- preserve=no 362409A9000A remove_head3E42404202F6 "ModelElement::removePresentation"
            public PresentationElement removePresentation(PresentationElement presentation1)
            // -end- 362409A9000A remove_head3E42404202F6 "ModelElement::removePresentation"
            {
              // -beg- preserve=no 362409A9000A remove_body3E42404202F6 "ModelElement::removePresentation"
              return super.removePresentation(presentation1);
              // -end- 362409A9000A remove_body3E42404202F6 "ModelElement::removePresentation"
            }

            /** tests if a given Presentation is connected.
             *  @see #addPresentation
             */
            // -beg- preserve=no 362409A9000A test_head3E42404202F6 "ModelElement::containsPresentation"
            public boolean containsPresentation(PresentationElement presentation1)
            // -end- 362409A9000A test_head3E42404202F6 "ModelElement::containsPresentation"
            {
              // -beg- preserve=no 362409A9000A test_body3E42404202F6 "ModelElement::containsPresentation"
              return super.containsPresentation(presentation1);
              // -end- 362409A9000A test_body3E42404202F6 "ModelElement::containsPresentation"
            }

            /** used to enumerate all connected Presentations.
             *  @see #addPresentation
             */
            // -beg- preserve=no 362409A9000A get_all_head3E42404202F6 "ModelElement::iteratorPresentation"
            public java.util.Iterator iteratorPresentation()
            // -end- 362409A9000A get_all_head3E42404202F6 "ModelElement::iteratorPresentation"
            {
              // -beg- preserve=no 362409A9000A get_all_body3E42404202F6 "ModelElement::iteratorPresentation"
              return super.iteratorPresentation();
              // -end- 362409A9000A get_all_body3E42404202F6 "ModelElement::iteratorPresentation"
            }

            /** disconnect all Presentations.
             *  @see #addPresentation
             */
            // -beg- preserve=no 362409A9000A remove_all_head3E42404202F6 "ModelElement::clearPresentation"
            public void clearPresentation()
            // -end- 362409A9000A remove_all_head3E42404202F6 "ModelElement::clearPresentation"
            {
              // -beg- preserve=no 362409A9000A remove_all_body3E42404202F6 "ModelElement::clearPresentation"
              super.clearPresentation();
              // -end- 362409A9000A remove_all_body3E42404202F6 "ModelElement::clearPresentation"
            }

            /** returns the number of Presentations.
             *  @see #addPresentation
             */
            // -beg- preserve=no 362409A9000A size_head3E42404202F6 "ModelElement::sizePresentation"
            public int sizePresentation()
            // -end- 362409A9000A size_head3E42404202F6 "ModelElement::sizePresentation"
            {
              // -beg- preserve=no 362409A9000A size_body3E42404202F6 "ModelElement::sizePresentation"
              return super.sizePresentation();
              // -end- 362409A9000A size_body3E42404202F6 "ModelElement::sizePresentation"
            }

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 362409A9000A _link_body3E42404202F6 "ModelElement::_linkPresentation"
            public void _linkPresentation(PresentationElement presentation1)
            {
              super._linkPresentation(presentation1);
            }
            // -end- 362409A9000A _link_body3E42404202F6 "ModelElement::_linkPresentation"

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 362409A9000A _unlink_body3E42404202F6 "ModelElement::_unlinkPresentation"
            public void _unlinkPresentation(PresentationElement presentation1)
            {
              super._unlinkPresentation(presentation1);
            }
            // -end- 362409A9000A _unlink_body3E42404202F6 "ModelElement::_unlinkPresentation"
