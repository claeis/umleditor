...
public class UmlModel extends AbstractNamespace implements Model , java.io.Serializable
{
  ...
  // -end- 3CE4F53500EC head3C4FDE4A01DE "getValidOwnedElements"
    ...
    {
    // please fill in/modify the following section
    // -beg- preserve=yes 3CE4F53500EC body3C4FDE4A01DE "getValidOwnedElements"
    String ret[]={
      "ch.ehi.uml1_4.implementation.UmlPackage"
      ,"ch.ehi.interlis.metaobjects.MetaObjectFile"
      };
    return ret;
   ...
   */
  // -beg- preserve=no 33598CAA030D add_head3C4FDE4A01DE "Namespace::addOwnedElement"
  public void addOwnedElement(ModelElement ownedElement1)
  // -end- 33598CAA030D add_head3C4FDE4A01DE "Namespace::addOwnedElement"
  {
    // -beg- preserve=no 33598CAA030D add_body3C4FDE4A01DE "Namespace::addOwnedElement"
    super.addOwnedElement(ownedElement1);
    // -end- 33598CAA030D add_body3C4FDE4A01DE "Namespace::addOwnedElement"
  }

  // -beg- preserve=no 33598CAA030D add2_head3C4FDE4A01DE "Namespace::add2OwnedElement"
  ...
  {
    // -beg- preserve=no 33598CAA030D add2_body3C4FDE4A01DE "Namespace::add2OwnedElement"
    super.addOwnedElement(index,ownedElement1);
    // -end- 33598CAA030D add2_body3C4FDE4A01DE "Namespace::add2OwnedElement"
  }

  /** add a link to a OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D addlink_head3C4FDE4A01DE "Namespace::addOwnedElementLink"
  public void addOwnedElementLink(ElementOwnership ownedElement1)
  // -end- 33598CAA030D addlink_head3C4FDE4A01DE "Namespace::addOwnedElementLink"
  {
    // -beg- preserve=no 33598CAA030D addlink_body3C4FDE4A01DE "Namespace::addOwnedElementLink"
    super.addOwnedElementLink(ownedElement1);
    // -end- 33598CAA030D addlink_body3C4FDE4A01DE "Namespace::addOwnedElementLink"
  }

  /** disconnect a OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D remove_head3C4FDE4A01DE "Namespace::removeOwnedElement"
  public ModelElement removeOwnedElement(ModelElement ownedElement1)
  // -end- 33598CAA030D remove_head3C4FDE4A01DE "Namespace::removeOwnedElement"
  {
    // -beg- preserve=no 33598CAA030D remove_body3C4FDE4A01DE "Namespace::removeOwnedElement"
    return super.removeOwnedElement(ownedElement1);
    // -end- 33598CAA030D remove_body3C4FDE4A01DE "Namespace::removeOwnedElement"
  }

  /** disconnect a OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D remove2_head3C4FDE4A01DE "Namespace::remove2OwnedElement"
  public ModelElement removeOwnedElement(int index)
  // -end- 33598CAA030D remove2_head3C4FDE4A01DE "Namespace::remove2OwnedElement"
  {
    // -beg- preserve=no 33598CAA030D remove2_body3C4FDE4A01DE "Namespace::remove2OwnedElement"
    return super.removeOwnedElement(index);
    // -end- 33598CAA030D remove2_body3C4FDE4A01DE "Namespace::remove2OwnedElement"
  }

  /** change a OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D set_head3C4FDE4A01DE "Namespace::setOwnedElement"
  ...
  {
    // -beg- preserve=no 33598CAA030D set_body3C4FDE4A01DE "Namespace::setOwnedElement"
   ...
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D test_head3C4FDE4A01DE "Namespace::containsOwnedElement"
  public boolean containsOwnedElement(ModelElement ownedElement1)
  // -end- 33598CAA030D test_head3C4FDE4A01DE "Namespace::containsOwnedElement"
  {
    // -beg- preserve=no 33598CAA030D test_body3C4FDE4A01DE "Namespace::containsOwnedElement"
    return super.containsOwnedElement(ownedElement1);
    // -end- 33598CAA030D test_body3C4FDE4A01DE "Namespace::containsOwnedElement"
  }

  /** used to enumerate all connected OwnedElements.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D get_all_head3C4FDE4A01DE "Namespace::iteratorOwnedElement"
  public java.util.Iterator iteratorOwnedElement()
  // -end- 33598CAA030D get_all_head3C4FDE4A01DE "Namespace::iteratorOwnedElement"
  {
    // -beg- preserve=no 33598CAA030D get_all_body3C4FDE4A01DE "Namespace::iteratorOwnedElement"
    return super.iteratorOwnedElement();
    // -end- 33598CAA030D get_all_body3C4FDE4A01DE "Namespace::iteratorOwnedElement"
  }

  /** disconnect all OwnedElements.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D remove_all_head3C4FDE4A01DE "Namespace::clearOwnedElement"
  public void clearOwnedElement()
  // -end- 33598CAA030D remove_all_head3C4FDE4A01DE "Namespace::clearOwnedElement"
  {
    // -beg- preserve=no 33598CAA030D remove_all_body3C4FDE4A01DE "Namespace::clearOwnedElement"
    super.clearOwnedElement();
    // -end- 33598CAA030D remove_all_body3C4FDE4A01DE "Namespace::clearOwnedElement"
  }

  /** returns the number of OwnedElements.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D size_head3C4FDE4A01DE "Namespace::sizeOwnedElement"
  public int sizeOwnedElement()
  // -end- 33598CAA030D size_head3C4FDE4A01DE "Namespace::sizeOwnedElement"
  {
    // -beg- preserve=no 33598CAA030D size_body3C4FDE4A01DE "Namespace::sizeOwnedElement"
    return super.sizeOwnedElement();
    // -end- 33598CAA030D size_body3C4FDE4A01DE "Namespace::sizeOwnedElement"
  }

  /** enumerate the link objects of currently connected OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D itlink_head3C4FDE4A01DE "Namespace::getOwnedElementLink"
  public java.util.Iterator iteratorOwnedElementLink()
  // -end- 33598CAA030D itlink_head3C4FDE4A01DE "Namespace::getOwnedElementLink"
  {
    // -beg- preserve=no 33598CAA030D itlink_body3C4FDE4A01DE "Namespace::getOwnedElementLink"
    return super.iteratorOwnedElementLink();
    // -end- 33598CAA030D itlink_body3C4FDE4A01DE "Namespace::getOwnedElementLink"
  }

  /** create a link class for a new link to a OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D createlink_head3C4FDE4A01DE "Namespace::createOwnedElementLink"
  public ElementOwnership createOwnedElementLink()
  // -end- 33598CAA030D createlink_head3C4FDE4A01DE "Namespace::createOwnedElementLink"
  {
    // -beg- preserve=no 33598CAA030D createlink_body3C4FDE4A01DE "Namespace::createOwnedElementLink"
    return super.createOwnedElementLink();
    // -end- 33598CAA030D createlink_body3C4FDE4A01DE "Namespace::createOwnedElementLink"
  }

  /** find a link object for a given OwnedElement.
   *  @see #addOwnedElement
   */
  // -beg- preserve=no 33598CAA030D find_head3C4FDE4A01DE "Namespace::findOwnedElementLink"
  public ElementOwnership findOwnedElementLink(ModelElement ownedElement1)
  // -end- 33598CAA030D find_head3C4FDE4A01DE "Namespace::findOwnedElementLink"
  {
    // -beg- preserve=no 33598CAA030D find_body3C4FDE4A01DE "Namespace::findOwnedElementLink"
    return super.findOwnedElementLink(ownedElement1);
    // -end- 33598CAA030D find_body3C4FDE4A01DE "Namespace::findOwnedElementLink"
  }

  /** DONT USE; link management internal
   */
  // -beg- preserve=no 33598CAA030D _link_body3C4FDE4A01DE "Namespace::_linkOwnedElement"
  ...
  /** DONT USE; link management internal
   */
  // -beg- preserve=no 33598CAA030D _unlink_body3C4FDE4A01DE "Namespace::_unlinkOwnedElement"
  public void _unlinkOwnedElement(ElementOwnership ownedElement1)
  {
    super._unlinkOwnedElement(ownedElement1);
  }
  // -end- 33598CAA030D _unlink_body3C4FDE4A01DE "Namespace::_unlinkOwnedElement"
  ...
  // -end- 3C8F572001F0 set_head3C4FDE4A01DE "author"
  {
    ...
    if(author != value1){
      author = value1;
      ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setAuthor"));
    }
   ...
   *  version of this model (document)
   *  @see #setVersion
   */
   ...
   */
  // -beg- preserve=no 33CD739B02DA add_head3C4FDE4A01DE "Package::addImportedElement"
  ...
  {
    // -beg- preserve=no 33CD739B02DA add_body3C4FDE4A01DE "Package::addImportedElement"
   ...
   */
  // -beg- preserve=no 33CD739B02DA addlink_head3C4FDE4A01DE "Package::addImportedElementLink"
  public void addImportedElementLink(ElementImport importedElement1)
  // -end- 33CD739B02DA addlink_head3C4FDE4A01DE "Package::addImportedElementLink"
  {
    // -beg- preserve=no 33CD739B02DA addlink_body3C4FDE4A01DE "Package::addImportedElementLink"
    ...
    return;
    // -end- 33CD739B02DA addlink_body3C4FDE4A01DE "Package::addImportedElementLink"
  }

  /** disconnect a ImportedElement.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA remove_head3C4FDE4A01DE "Package::removeImportedElement"
  public ModelElement removeImportedElement(ModelElement importedElement1)
  // -end- 33CD739B02DA remove_head3C4FDE4A01DE "Package::removeImportedElement"
  {
    // -beg- preserve=no 33CD739B02DA remove_body3C4FDE4A01DE "Package::removeImportedElement"
    ...
    return ret;
    // -end- 33CD739B02DA remove_body3C4FDE4A01DE "Package::removeImportedElement"
  }

  /** tests if a given ImportedElement is connected.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA test_head3C4FDE4A01DE "Package::containsImportedElement"
  public boolean containsImportedElement(ModelElement importedElement1)
  // -end- 33CD739B02DA test_head3C4FDE4A01DE "Package::containsImportedElement"
  {
    // -beg- preserve=no 33CD739B02DA test_body3C4FDE4A01DE "Package::containsImportedElement"
    return importedElement.contains(findImportedElementLink(importedElement1));
    // -end- 33CD739B02DA test_body3C4FDE4A01DE "Package::containsImportedElement"
  }

  /** used to enumerate all connected ImportedElements.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA get_all_head3C4FDE4A01DE "Package::iteratorImportedElement"
  public java.util.Iterator iteratorImportedElement()
  // -end- 33CD739B02DA get_all_head3C4FDE4A01DE "Package::iteratorImportedElement"
  {
    // -beg- preserve=no 33CD739B02DA get_all_body3C4FDE4A01DE "Package::iteratorImportedElement"
    ...
    // -end- 33CD739B02DA get_all_body3C4FDE4A01DE "Package::iteratorImportedElement"
  }

  /** disconnect all ImportedElements.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA remove_all_head3C4FDE4A01DE "Package::clearImportedElement"
  public void clearImportedElement()
  // -end- 33CD739B02DA remove_all_head3C4FDE4A01DE "Package::clearImportedElement"
  {
    // -beg- preserve=no 33CD739B02DA remove_all_body3C4FDE4A01DE "Package::clearImportedElement"
    ...
    // -end- 33CD739B02DA remove_all_body3C4FDE4A01DE "Package::clearImportedElement"
  }

  /** returns the number of ImportedElements.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA size_head3C4FDE4A01DE "Package::sizeImportedElement"
  public int sizeImportedElement()
  // -end- 33CD739B02DA size_head3C4FDE4A01DE "Package::sizeImportedElement"
  {
    // -beg- preserve=no 33CD739B02DA size_body3C4FDE4A01DE "Package::sizeImportedElement"
    return importedElement.size();
    // -end- 33CD739B02DA size_body3C4FDE4A01DE "Package::sizeImportedElement"
  }

  /** enumerate the link objects of currently connected ImportedElement.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA itlink_head3C4FDE4A01DE "Package::getImportedElementLink"
  public java.util.Iterator iteratorImportedElementLink()
  // -end- 33CD739B02DA itlink_head3C4FDE4A01DE "Package::getImportedElementLink"
  {
    // -beg- preserve=no 33CD739B02DA itlink_body3C4FDE4A01DE "Package::getImportedElementLink"
    return importedElement.iterator();
    // -end- 33CD739B02DA itlink_body3C4FDE4A01DE "Package::getImportedElementLink"
  }

  /** create a link class for a new link to a ImportedElement.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA createlink_head3C4FDE4A01DE "Package::createImportedElementLink"
  public ElementImport createImportedElementLink()
  // -end- 33CD739B02DA createlink_head3C4FDE4A01DE "Package::createImportedElementLink"
  {
    // -beg- preserve=no 33CD739B02DA createlink_body3C4FDE4A01DE "Package::createImportedElementLink"
    // return new ElementImport();
    throw new java.lang.UnsupportedOperationException();
    // -end- 33CD739B02DA createlink_body3C4FDE4A01DE "Package::createImportedElementLink"
  }

  /** find a link object for a given ImportedElement.
   *  @see #addImportedElement
   */
  // -beg- preserve=no 33CD739B02DA find_head3C4FDE4A01DE "Package::findImportedElementLink"
  public ElementImport findImportedElementLink(ModelElement importedElement1)
  // -end- 33CD739B02DA find_head3C4FDE4A01DE "Package::findImportedElementLink"
  {
      // -beg- preserve=no 33CD739B02DA find_body3C4FDE4A01DE "Package::findImportedElementLink"
      ...
      return null;
      // -end- 33CD739B02DA find_body3C4FDE4A01DE "Package::findImportedElementLink"
    }

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 33CD739B02DA _link_body3C4FDE4A01DE "Package::_linkImportedElement"
    ...
    /** DONT USE; link management internal
     */
    // -beg- preserve=no 33CD739B02DA _unlink_body3C4FDE4A01DE "Package::_unlinkImportedElement"
    ...
    // -end- 33CD739B02DA _unlink_body3C4FDE4A01DE "Package::_unlinkImportedElement"
     ...
     */
    // -beg- preserve=no 362409A9000A add_head3C4FDE4A01DE "ModelElement::addPresentation"
    ...
    {
      // -beg- preserve=no 362409A9000A add_body3C4FDE4A01DE "ModelElement::addPresentation"
      super.addPresentation(presentation1);
      // -end- 362409A9000A add_body3C4FDE4A01DE "ModelElement::addPresentation"
    }

    /** disconnect a Presentation.
     *  @see #addPresentation
     */
    // -beg- preserve=no 362409A9000A remove_head3C4FDE4A01DE "ModelElement::removePresentation"
    public PresentationElement removePresentation(PresentationElement presentation1)
    // -end- 362409A9000A remove_head3C4FDE4A01DE "ModelElement::removePresentation"
    {
      // -beg- preserve=no 362409A9000A remove_body3C4FDE4A01DE "ModelElement::removePresentation"
      return super.removePresentation(presentation1);
      // -end- 362409A9000A remove_body3C4FDE4A01DE "ModelElement::removePresentation"
    }

    /** tests if a given Presentation is connected.
     *  @see #addPresentation
     */
    // -beg- preserve=no 362409A9000A test_head3C4FDE4A01DE "ModelElement::containsPresentation"
    public boolean containsPresentation(PresentationElement presentation1)
    // -end- 362409A9000A test_head3C4FDE4A01DE "ModelElement::containsPresentation"
    {
      // -beg- preserve=no 362409A9000A test_body3C4FDE4A01DE "ModelElement::containsPresentation"
      return super.containsPresentation(presentation1);
      // -end- 362409A9000A test_body3C4FDE4A01DE "ModelElement::containsPresentation"
    }

    /** used to enumerate all connected Presentations.
     *  @see #addPresentation
     */
    // -beg- preserve=no 362409A9000A get_all_head3C4FDE4A01DE "ModelElement::iteratorPresentation"
    public java.util.Iterator iteratorPresentation()
    // -end- 362409A9000A get_all_head3C4FDE4A01DE "ModelElement::iteratorPresentation"
    {
      // -beg- preserve=no 362409A9000A get_all_body3C4FDE4A01DE "ModelElement::iteratorPresentation"
      return super.iteratorPresentation();
      // -end- 362409A9000A get_all_body3C4FDE4A01DE "ModelElement::iteratorPresentation"
    }

    /** disconnect all Presentations.
     *  @see #addPresentation
     */
    // -beg- preserve=no 362409A9000A remove_all_head3C4FDE4A01DE "ModelElement::clearPresentation"
    public void clearPresentation()
    // -end- 362409A9000A remove_all_head3C4FDE4A01DE "ModelElement::clearPresentation"
    {
      // -beg- preserve=no 362409A9000A remove_all_body3C4FDE4A01DE "ModelElement::clearPresentation"
      super.clearPresentation();
      // -end- 362409A9000A remove_all_body3C4FDE4A01DE "ModelElement::clearPresentation"
    }

    /** returns the number of Presentations.
     *  @see #addPresentation
     */
    // -beg- preserve=no 362409A9000A size_head3C4FDE4A01DE "ModelElement::sizePresentation"
    public int sizePresentation()
    // -end- 362409A9000A size_head3C4FDE4A01DE "ModelElement::sizePresentation"
    {
      // -beg- preserve=no 362409A9000A size_body3C4FDE4A01DE "ModelElement::sizePresentation"
      return super.sizePresentation();
      // -end- 362409A9000A size_body3C4FDE4A01DE "ModelElement::sizePresentation"
    }

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 362409A9000A _link_body3C4FDE4A01DE "ModelElement::_linkPresentation"
    public void _linkPresentation(PresentationElement presentation1)
    {
      super._linkPresentation(presentation1);
    }
    // -end- 362409A9000A _link_body3C4FDE4A01DE "ModelElement::_linkPresentation"

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 362409A9000A _unlink_body3C4FDE4A01DE "ModelElement::_unlinkPresentation"
    public void _unlinkPresentation(PresentationElement presentation1)
    {
      super._unlinkPresentation(presentation1);
    }
    // -end- 362409A9000A _unlink_body3C4FDE4A01DE "ModelElement::_unlinkPresentation"
     ...
     */
    // -beg- preserve=no 335C14A5019A add_head3C4FDE4A01DE "GeneralizableElement::addGeneralization"
    public void addGeneralization(Generalization generalization1)
    // -end- 335C14A5019A add_head3C4FDE4A01DE "GeneralizableElement::addGeneralization"
    {
      // -beg- preserve=no 335C14A5019A add_body3C4FDE4A01DE "GeneralizableElement::addGeneralization"
      ...
      return;
      // -end- 335C14A5019A add_body3C4FDE4A01DE "GeneralizableElement::addGeneralization"
    }

    /** disconnect a Generalization.
     *  @see #addGeneralization
     */
    // -beg- preserve=no 335C14A5019A remove_head3C4FDE4A01DE "GeneralizableElement::removeGeneralization"
    public Generalization removeGeneralization(Generalization generalization1)
    // -end- 335C14A5019A remove_head3C4FDE4A01DE "GeneralizableElement::removeGeneralization"
    {
      // -beg- preserve=no 335C14A5019A remove_body3C4FDE4A01DE "GeneralizableElement::removeGeneralization"
      ...
      return ret;
      // -end- 335C14A5019A remove_body3C4FDE4A01DE "GeneralizableElement::removeGeneralization"
    }

    /** tests if a given Generalization is connected.
     *  @see #addGeneralization
     */
    // -beg- preserve=no 335C14A5019A test_head3C4FDE4A01DE "GeneralizableElement::containsGeneralization"
    public boolean containsGeneralization(Generalization generalization1)
    // -end- 335C14A5019A test_head3C4FDE4A01DE "GeneralizableElement::containsGeneralization"
    {
      // -beg- preserve=no 335C14A5019A test_body3C4FDE4A01DE "GeneralizableElement::containsGeneralization"
      return generalization.contains(generalization1);
      // -end- 335C14A5019A test_body3C4FDE4A01DE "GeneralizableElement::containsGeneralization"
    }

    /** used to enumerate all connected Generalizations.
     *  @see #addGeneralization
     */
    // -beg- preserve=no 335C14A5019A get_all_head3C4FDE4A01DE "GeneralizableElement::iteratorGeneralization"
    public java.util.Iterator iteratorGeneralization()
    // -end- 335C14A5019A get_all_head3C4FDE4A01DE "GeneralizableElement::iteratorGeneralization"
    {
      // -beg- preserve=no 335C14A5019A get_all_body3C4FDE4A01DE "GeneralizableElement::iteratorGeneralization"
      return generalization.iterator();
      // -end- 335C14A5019A get_all_body3C4FDE4A01DE "GeneralizableElement::iteratorGeneralization"
    }

    /** disconnect all Generalizations.
     *  @see #addGeneralization
     */
    // -beg- preserve=no 335C14A5019A remove_all_head3C4FDE4A01DE "GeneralizableElement::clearGeneralization"
    public void clearGeneralization()
    // -end- 335C14A5019A remove_all_head3C4FDE4A01DE "GeneralizableElement::clearGeneralization"
    {
      // -beg- preserve=no 335C14A5019A remove_all_body3C4FDE4A01DE "GeneralizableElement::clearGeneralization"
      ...
      // -end- 335C14A5019A remove_all_body3C4FDE4A01DE "GeneralizableElement::clearGeneralization"
    }

    /** returns the number of Generalizations.
     *  @see #addGeneralization
     */
    // -beg- preserve=no 335C14A5019A size_head3C4FDE4A01DE "GeneralizableElement::sizeGeneralization"
    public int sizeGeneralization()
    // -end- 335C14A5019A size_head3C4FDE4A01DE "GeneralizableElement::sizeGeneralization"
    {
      // -beg- preserve=no 335C14A5019A size_body3C4FDE4A01DE "GeneralizableElement::sizeGeneralization"
      return generalization.size();
      // -end- 335C14A5019A size_body3C4FDE4A01DE "GeneralizableElement::sizeGeneralization"
    }

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 335C14A5019A _link_body3C4FDE4A01DE "GeneralizableElement::_linkGeneralization"
    ...
    // -end- 335C14A5019A _link_body3C4FDE4A01DE "GeneralizableElement::_linkGeneralization"

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 335C14A5019A _unlink_body3C4FDE4A01DE "GeneralizableElement::_unlinkGeneralization"
    ...
    // -end- 335C14A5019A _unlink_body3C4FDE4A01DE "GeneralizableElement::_unlinkGeneralization"
     ...
     */
    // -beg- preserve=no 335C146B01D6 add_head3C4FDE4A01DE "GeneralizableElement::addSpecialization"
    public void addSpecialization(Generalization specialization1)
    // -end- 335C146B01D6 add_head3C4FDE4A01DE "GeneralizableElement::addSpecialization"
    {
      // -beg- preserve=no 335C146B01D6 add_body3C4FDE4A01DE "GeneralizableElement::addSpecialization"
      ...
      return;
      // -end- 335C146B01D6 add_body3C4FDE4A01DE "GeneralizableElement::addSpecialization"
    }

    /** disconnect a Specialization.
     *  @see #addSpecialization
     */
    // -beg- preserve=no 335C146B01D6 remove_head3C4FDE4A01DE "GeneralizableElement::removeSpecialization"
    public Generalization removeSpecialization(Generalization specialization1)
    // -end- 335C146B01D6 remove_head3C4FDE4A01DE "GeneralizableElement::removeSpecialization"
    {
      // -beg- preserve=no 335C146B01D6 remove_body3C4FDE4A01DE "GeneralizableElement::removeSpecialization"
      Generalization ret=null;
      ...
      return ret;
      // -end- 335C146B01D6 remove_body3C4FDE4A01DE "GeneralizableElement::removeSpecialization"
    }

    /** tests if a given Specialization is connected.
     *  @see #addSpecialization
     */
    // -beg- preserve=no 335C146B01D6 test_head3C4FDE4A01DE "GeneralizableElement::containsSpecialization"
    public boolean containsSpecialization(Generalization specialization1)
    // -end- 335C146B01D6 test_head3C4FDE4A01DE "GeneralizableElement::containsSpecialization"
    {
      // -beg- preserve=no 335C146B01D6 test_body3C4FDE4A01DE "GeneralizableElement::containsSpecialization"
      return specialization.contains(specialization1);
      // -end- 335C146B01D6 test_body3C4FDE4A01DE "GeneralizableElement::containsSpecialization"
    }

    /** used to enumerate all connected Specializations.
     *  @see #addSpecialization
     */
    // -beg- preserve=no 335C146B01D6 get_all_head3C4FDE4A01DE "GeneralizableElement::iteratorSpecialization"
    public java.util.Iterator iteratorSpecialization()
    // -end- 335C146B01D6 get_all_head3C4FDE4A01DE "GeneralizableElement::iteratorSpecialization"
    {
      // -beg- preserve=no 335C146B01D6 get_all_body3C4FDE4A01DE "GeneralizableElement::iteratorSpecialization"
      return specialization.iterator();
      // -end- 335C146B01D6 get_all_body3C4FDE4A01DE "GeneralizableElement::iteratorSpecialization"
    }

    /** disconnect all Specializations.
     *  @see #addSpecialization
     */
    // -beg- preserve=no 335C146B01D6 remove_all_head3C4FDE4A01DE "GeneralizableElement::clearSpecialization"
    public void clearSpecialization()
    // -end- 335C146B01D6 remove_all_head3C4FDE4A01DE "GeneralizableElement::clearSpecialization"
    {
      // -beg- preserve=no 335C146B01D6 remove_all_body3C4FDE4A01DE "GeneralizableElement::clearSpecialization"
      ...
      // -end- 335C146B01D6 remove_all_body3C4FDE4A01DE "GeneralizableElement::clearSpecialization"
    }

    /** returns the number of Specializations.
     *  @see #addSpecialization
     */
    // -beg- preserve=no 335C146B01D6 size_head3C4FDE4A01DE "GeneralizableElement::sizeSpecialization"
    public int sizeSpecialization()
    // -end- 335C146B01D6 size_head3C4FDE4A01DE "GeneralizableElement::sizeSpecialization"
    {
      // -beg- preserve=no 335C146B01D6 size_body3C4FDE4A01DE "GeneralizableElement::sizeSpecialization"
      return specialization.size();
      // -end- 335C146B01D6 size_body3C4FDE4A01DE "GeneralizableElement::sizeSpecialization"
    }

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 335C146B01D6 _link_body3C4FDE4A01DE "GeneralizableElement::_linkSpecialization"
    ...
    // -end- 335C146B01D6 _link_body3C4FDE4A01DE "GeneralizableElement::_linkSpecialization"

    /** DONT USE; link management internal
     */
    // -beg- preserve=no 335C146B01D6 _unlink_body3C4FDE4A01DE "GeneralizableElement::_unlinkSpecialization"
    ...
    // -end- 335C146B01D6 _unlink_body3C4FDE4A01DE "GeneralizableElement::_unlinkSpecialization"
