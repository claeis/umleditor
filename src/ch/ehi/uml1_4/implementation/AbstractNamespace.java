...
package ch.ehi.uml1_4.implementation;
        ...
        // -beg- preserve=no 3CE225CF036F autoimport "AbstractNamespace"
        ...
        // -end- 3CE225CF036F autoimport "AbstractNamespace"
...
public abstract class AbstractNamespace extends AbstractModelElement implements Namespace , java.io.Serializable
        {
          ...
          // -end- 3C8F94DE03A6 head3CE225CF036F "deepDetachOwnedElement"
            // declare any checked exceptions
            // please fill in/modify the following section
            // -beg- preserve=no 3C8F94DE03A6 throws3CE225CF036F "deepDetachOwnedElement"

            // -end- 3C8F94DE03A6 throws3CE225CF036F "deepDetachOwnedElement"
            {
            // please fill in/modify the following section
            // -beg- preserve=yes 3C8F94DE03A6 body3CE225CF036F "deepDetachOwnedElement"
    ...
    remover.unlinkThem();
          ...
          // -end- 3C8F964B01C0 head3CE225CF036F "containsOwnedElement"
            ...
            {
            // please fill in/modify the following section
            // -beg- preserve=yes 3C8F964B01C0 body3CE225CF036F "containsOwnedElement"
    ...
    return false;
           ...
           */
          // -beg- preserve=no 3CC7B8D10067 head3CE225CF036F "deepContainsOwnedElement"
          ...
          // -end- 3CC7B8D10067 head3CE225CF036F "deepContainsOwnedElement"
            // declare any checked exceptions
            // please fill in/modify the following section
            // -beg- preserve=no 3CC7B8D10067 throws3CE225CF036F "deepContainsOwnedElement"

            // -end- 3CC7B8D10067 throws3CE225CF036F "deepContainsOwnedElement"
            {
            // please fill in/modify the following section
            // -beg- preserve=yes 3CC7B8D10067 body3CE225CF036F "deepContainsOwnedElement"
    return ch.ehi.uml1_4.tools.NamespaceUtility.deepContainsOwnedElement(this,aclass,name);
          ...
          // -end- 3CC7B8E5034B head3CE225CF036F "deepGetOwnedElement"
            ...
            {
            // please fill in/modify the following section
            // -beg- preserve=yes 3CC7B8E5034B body3CE225CF036F "deepGetOwnedElement"
    return ch.ehi.uml1_4.tools.NamespaceUtility.deepGetOwnedElement(this,aclass,name);
          ...
          // -end- 3D789EFC0327 head3CE225CF036F "deepContainsElementById"
            // declare any checked exceptions
            // please fill in/modify the following section
            // -beg- preserve=no 3D789EFC0327 throws3CE225CF036F "deepContainsElementById"

            // -end- 3D789EFC0327 throws3CE225CF036F "deepContainsElementById"
            {
            // please fill in/modify the following section
            // -beg- preserve=yes 3D789EFC0327 body3CE225CF036F "deepContainsElementById"
    ...
    return ch.ehi.uml1_4.tools.NamespaceUtility.deepGetElementById(this,id);
           ...
           */
          // -beg- preserve=no 33598CAA030D add_head3CE225CF036F "Namespace::addOwnedElement"
          public void addOwnedElement(ModelElement ownedElement1)
          // -end- 33598CAA030D add_head3CE225CF036F "Namespace::addOwnedElement"
          {
            // -beg- preserve=no 33598CAA030D add_body3CE225CF036F "Namespace::addOwnedElement"
            ...
            ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addOwnedElement"));
            return;
            // -end- 33598CAA030D add_body3CE225CF036F "Namespace::addOwnedElement"
          }

          // -beg- preserve=no 33598CAA030D add2_head3CE225CF036F "Namespace::add2OwnedElement"
          ...
          {
            // -beg- preserve=no 33598CAA030D add2_body3CE225CF036F "Namespace::add2OwnedElement"
            ElementOwnership linkobj=createOwnedElementLink();
            linkobj.setOwnedElement(ownedElement1);
            linkobj.setNamespace(this);
            ...
            ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addOwnedElement"));
            return;
            // -end- 33598CAA030D add2_body3CE225CF036F "Namespace::add2OwnedElement"
          }

          /** add a link to a OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D addlink_head3CE225CF036F "Namespace::addOwnedElementLink"
          public void addOwnedElementLink(ElementOwnership ownedElement1)
          // -end- 33598CAA030D addlink_head3CE225CF036F "Namespace::addOwnedElementLink"
          {
            // -beg- preserve=no 33598CAA030D addlink_body3CE225CF036F "Namespace::addOwnedElementLink"
            ownedElement1.setNamespace(this);
            ownedElement.add(ownedElement1);
            ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addOwnedElementLink"));
            return;
            // -end- 33598CAA030D addlink_body3CE225CF036F "Namespace::addOwnedElementLink"
          }

          /** disconnect a OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D remove_head3CE225CF036F "Namespace::removeOwnedElement"
          public ModelElement removeOwnedElement(ModelElement ownedElement1)
          // -end- 33598CAA030D remove_head3CE225CF036F "Namespace::removeOwnedElement"
          {
            // -beg- preserve=no 33598CAA030D remove_body3CE225CF036F "Namespace::removeOwnedElement"
            ...
            ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeOwnedElement"));
            return ret;
            // -end- 33598CAA030D remove_body3CE225CF036F "Namespace::removeOwnedElement"
          }

          /** disconnect a OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D remove2_head3CE225CF036F "Namespace::remove2OwnedElement"
          public ModelElement removeOwnedElement(int index)
          // -end- 33598CAA030D remove2_head3CE225CF036F "Namespace::remove2OwnedElement"
          {
            // -beg- preserve=no 33598CAA030D remove2_body3CE225CF036F "Namespace::remove2OwnedElement"
            ModelElement ret=null;
            ...
            ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeOwnedElement"));
            return ret;
            // -end- 33598CAA030D remove2_body3CE225CF036F "Namespace::remove2OwnedElement"
          }

          /** change a OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D set_head3CE225CF036F "Namespace::setOwnedElement"
          ...
          {
            // -beg- preserve=no 33598CAA030D set_body3CE225CF036F "Namespace::setOwnedElement"
            ModelElement ret=null;
            ElementOwnership linkobj=(ElementOwnership)ownedElement.get(index);
            ret = linkobj.getOwnedElement();
            linkobj.setOwnedElement(ownedElement1);
            ret._unlinkNamespace(linkobj);
            ownedElement1._linkNamespace(linkobj);
            ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"setOwnedElement"));
            return ret;
           ...
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D test_head3CE225CF036F "Namespace::containsOwnedElement"
          public boolean containsOwnedElement(ModelElement ownedElement1)
          // -end- 33598CAA030D test_head3CE225CF036F "Namespace::containsOwnedElement"
          {
            // -beg- preserve=no 33598CAA030D test_body3CE225CF036F "Namespace::containsOwnedElement"
            return ownedElement.contains(findOwnedElementLink(ownedElement1));
            // -end- 33598CAA030D test_body3CE225CF036F "Namespace::containsOwnedElement"
          }

          /** used to enumerate all connected OwnedElements.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D get_all_head3CE225CF036F "Namespace::iteratorOwnedElement"
          public java.util.Iterator iteratorOwnedElement()
          // -end- 33598CAA030D get_all_head3CE225CF036F "Namespace::iteratorOwnedElement"
          {
            // -beg- preserve=no 33598CAA030D get_all_body3CE225CF036F "Namespace::iteratorOwnedElement"
            ...
            // -end- 33598CAA030D get_all_body3CE225CF036F "Namespace::iteratorOwnedElement"
          }

          /** disconnect all OwnedElements.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D remove_all_head3CE225CF036F "Namespace::clearOwnedElement"
          public void clearOwnedElement()
          // -end- 33598CAA030D remove_all_head3CE225CF036F "Namespace::clearOwnedElement"
          {
            // -beg- preserve=no 33598CAA030D remove_all_body3CE225CF036F "Namespace::clearOwnedElement"
            if(sizeOwnedElement()>0){
              ...
              ownedElement.clear();
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearOwnedElement"));
            }
            // -end- 33598CAA030D remove_all_body3CE225CF036F "Namespace::clearOwnedElement"
          }

          /** returns the number of OwnedElements.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D size_head3CE225CF036F "Namespace::sizeOwnedElement"
          public int sizeOwnedElement()
          // -end- 33598CAA030D size_head3CE225CF036F "Namespace::sizeOwnedElement"
          {
            // -beg- preserve=no 33598CAA030D size_body3CE225CF036F "Namespace::sizeOwnedElement"
            return ownedElement.size();
            // -end- 33598CAA030D size_body3CE225CF036F "Namespace::sizeOwnedElement"
          }

          /** enumerate the link objects of currently connected OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D itlink_head3CE225CF036F "Namespace::getOwnedElementLink"
          public java.util.Iterator iteratorOwnedElementLink()
          // -end- 33598CAA030D itlink_head3CE225CF036F "Namespace::getOwnedElementLink"
          {
            // -beg- preserve=no 33598CAA030D itlink_body3CE225CF036F "Namespace::getOwnedElementLink"
            return ownedElement.iterator();
            // -end- 33598CAA030D itlink_body3CE225CF036F "Namespace::getOwnedElementLink"
          }

          /** create a link class for a new link to a OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D createlink_head3CE225CF036F "Namespace::createOwnedElementLink"
          public ElementOwnership createOwnedElementLink()
          // -end- 33598CAA030D createlink_head3CE225CF036F "Namespace::createOwnedElementLink"
          {
            // -beg- preserve=no 33598CAA030D createlink_body3CE225CF036F "Namespace::createOwnedElementLink"
            return new ElementOwnership();
            // -end- 33598CAA030D createlink_body3CE225CF036F "Namespace::createOwnedElementLink"
          }

          /** find a link object for a given OwnedElement.
           *  @see #addOwnedElement
           */
          // -beg- preserve=no 33598CAA030D find_head3CE225CF036F "Namespace::findOwnedElementLink"
          public ElementOwnership findOwnedElementLink(ModelElement ownedElement1)
          // -end- 33598CAA030D find_head3CE225CF036F "Namespace::findOwnedElementLink"
          {
              // -beg- preserve=no 33598CAA030D find_body3CE225CF036F "Namespace::findOwnedElementLink"
              if(ownedElement1==null) return null;
              for(java.util.Iterator p = ownedElement.iterator(); p.hasNext();){
                ElementOwnership linkobj=(ElementOwnership)p.next();
                if(linkobj.getOwnedElement()==ownedElement1) return linkobj;
              }
              return null;
              // -end- 33598CAA030D find_body3CE225CF036F "Namespace::findOwnedElementLink"
            }

            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33598CAA030D _link_body3CE225CF036F "Namespace::_linkOwnedElement"
            public void _linkOwnedElement(ElementOwnership ownedElement1)
            {
              ownedElement.add(ownedElement1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_linkOwnedElement"));
              return;
            }
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 33598CAA030D _unlink_body3CE225CF036F "Namespace::_unlinkOwnedElement"
            public void _unlinkOwnedElement(ElementOwnership ownedElement1)
            {
              ownedElement.remove(ownedElement1);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"_unlinkOwnedElement"));
              return;
            }
            // -end- 33598CAA030D _unlink_body3CE225CF036F "Namespace::_unlinkOwnedElement"
             ...
             *  @see #sizeDiagram
             */
            // -beg- preserve=no 3C2C4E4F0248 add_head3CE225CF036F "Namespace::addDiagram"
            public void addDiagram(Diagram diagram1)
            // -end- 3C2C4E4F0248 add_head3CE225CF036F "Namespace::addDiagram"
            {
              // -beg- preserve=no 3C2C4E4F0248 add_body3CE225CF036F "Namespace::addDiagram"
              diagram.add(diagram1);
              diagram1._linkNamespace(this);
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"addDiagram"));
              return;
             ...
             *  @see #addDiagram
             */
            // -beg- preserve=no 3C2C4E4F0248 remove_head3CE225CF036F "Namespace::removeDiagram"
            public Diagram removeDiagram(Diagram diagram1)
            // -end- 3C2C4E4F0248 remove_head3CE225CF036F "Namespace::removeDiagram"
            {
              // -beg- preserve=no 3C2C4E4F0248 remove_body3CE225CF036F "Namespace::removeDiagram"
              Diagram ret=null;
              ...
              ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"removeDiagram"));
              return ret;
             ...
             *  @see #addDiagram
             */
            // -beg- preserve=no 3C2C4E4F0248 test_head3CE225CF036F "Namespace::containsDiagram"
            public boolean containsDiagram(Diagram diagram1)
            // -end- 3C2C4E4F0248 test_head3CE225CF036F "Namespace::containsDiagram"
            {
              // -beg- preserve=no 3C2C4E4F0248 test_body3CE225CF036F "Namespace::containsDiagram"
             ...
             *  @see #addDiagram
             */
            // -beg- preserve=no 3C2C4E4F0248 get_all_head3CE225CF036F "Namespace::iteratorDiagram"
            public java.util.Iterator iteratorDiagram()
            // -end- 3C2C4E4F0248 get_all_head3CE225CF036F "Namespace::iteratorDiagram"
            {
              // -beg- preserve=no 3C2C4E4F0248 get_all_body3CE225CF036F "Namespace::iteratorDiagram"
              return diagram.iterator();
              // -end- 3C2C4E4F0248 get_all_body3CE225CF036F "Namespace::iteratorDiagram"
            }

            /** disconnect all Diagrams.
             *  @see #addDiagram
             */
            // -beg- preserve=no 3C2C4E4F0248 remove_all_head3CE225CF036F "Namespace::clearDiagram"
            public void clearDiagram()
            // -end- 3C2C4E4F0248 remove_all_head3CE225CF036F "Namespace::clearDiagram"
            {
              // -beg- preserve=no 3C2C4E4F0248 remove_all_body3CE225CF036F "Namespace::clearDiagram"
              if(sizeDiagram()>0){
                for(java.util.Iterator p = diagram.iterator(); p.hasNext();){
                  ((Diagram)p.next())._unlinkNamespace(this);
                }
                diagram.clear();
                ch.ehi.uml1_4.changepropagation.MetaModel.getInstance().notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this,"clearDiagram"));
              }
              // -end- 3C2C4E4F0248 remove_all_body3CE225CF036F "Namespace::clearDiagram"
            }

            /** returns the number of Diagrams.
             *  @see #addDiagram
             */
            // -beg- preserve=no 3C2C4E4F0248 size_head3CE225CF036F "Namespace::sizeDiagram"
            public int sizeDiagram()
            // -end- 3C2C4E4F0248 size_head3CE225CF036F "Namespace::sizeDiagram"
            {
              // -beg- preserve=no 3C2C4E4F0248 size_body3CE225CF036F "Namespace::sizeDiagram"
              return diagram.size();
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 3C2C4E4F0248 _link_body3CE225CF036F "Namespace::_linkDiagram"
            ...
            /** DONT USE; link management internal
             */
            // -beg- preserve=no 3C2C4E4F0248 _unlink_body3CE225CF036F "Namespace::_unlinkDiagram"
