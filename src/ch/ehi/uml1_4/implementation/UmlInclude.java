...
public class UmlInclude extends AbstractModelElement implements Include {
	 ...
	 */
	// -beg- preserve=no 35FDD995038E attach_head4551A7840119
	// "Include::attachAddition"
	public void attachAddition(UseCase addition1)
	// -end- 35FDD995038E attach_head4551A7840119 "Include::attachAddition"
	{
		// -beg- preserve=no 35FDD995038E attach_body4551A7840119
		// "Include::attachAddition"
		if (addition != null) {
			throw new java.lang.IllegalStateException("already a addition attached");
		}
		if (addition1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as addition");
		}
		addition = addition1;
		addition1._linkBaseInclude(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachAddition"));
		return;
	 ...
	 * @see #attachAddition
	 */
	// -beg- preserve=no 35FDD995038E detach_head4551A7840119
	// "Include::detachAddition"
	public UseCase detachAddition()
	// -end- 35FDD995038E detach_head4551A7840119 "Include::detachAddition"
	{
		// -beg- preserve=no 35FDD995038E detach_body4551A7840119
		// "Include::detachAddition"
		UseCase ret = null;
		if (addition != null) {
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachAddition"));
		return ret;
	 ...
	 * @see #attachAddition
	 */
	// -beg- preserve=no 35FDD995038E get_head4551A7840119
	// "Include::getAddition"
	public UseCase getAddition()
	// -end- 35FDD995038E get_head4551A7840119 "Include::getAddition"
	{
		// -beg- preserve=no 35FDD995038E get_body4551A7840119
		// "Include::getAddition"
		if (addition == null) {
			throw new java.lang.IllegalStateException("no addition attached");
		}
		return addition;
	 ...
	 * @see #attachAddition
	 */
	// -beg- preserve=no 35FDD995038E test_head4551A7840119
	// "Include::containsAddition"
	public boolean containsAddition()
	// -end- 35FDD995038E test_head4551A7840119 "Include::containsAddition"
	{
		// -beg- preserve=no 35FDD995038E test_body4551A7840119
		// "Include::containsAddition"
	 ...
	 */
	// -beg- preserve=no 35FDD995038E _link_body4551A7840119
	// "Include::_linkAddition"
	public void _linkAddition(UseCase addition1) {
		addition = addition1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkAddition"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35FDD995038E _unlink_body4551A7840119
	// "Include::_unlinkAddition"
	public void _unlinkAddition(UseCase addition1) {
		addition = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkAddition"));
		return;
	}
	 ...
	 * @see #containsBase
	 */
	// -beg- preserve=no 35FDD9A50046 attach_head4551A7840119
	// "Include::attachBase"
	public void attachBase(UseCase base1)
	// -end- 35FDD9A50046 attach_head4551A7840119 "Include::attachBase"
	{
		// -beg- preserve=no 35FDD9A50046 attach_body4551A7840119
		// "Include::attachBase"
		if (base != null) {
	 ...
	 * @see #attachBase
	 */
	// -beg- preserve=no 35FDD9A50046 detach_head4551A7840119
	// "Include::detachBase"
	public UseCase detachBase()
	// -end- 35FDD9A50046 detach_head4551A7840119 "Include::detachBase"
	{
		// -beg- preserve=no 35FDD9A50046 detach_body4551A7840119
		// "Include::detachBase"
		UseCase ret = null;
		if (base != null) {
	...
	{
		// -beg- preserve=no 35FDD9A50046 get_body4551A7840119
		// "Include::getBase"
		if (base == null) {
	 ...
	 * @see #attachBase
	 */
	// -beg- preserve=no 35FDD9A50046 test_head4551A7840119
	// "Include::containsBase"
	public boolean containsBase()
	// -end- 35FDD9A50046 test_head4551A7840119 "Include::containsBase"
	{
		// -beg- preserve=no 35FDD9A50046 test_body4551A7840119
		// "Include::containsBase"
		return base != null;
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35FDD9A50046 _link_body4551A7840119
	// "Include::_linkBase"
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 35FDD9A50046 _unlink_body4551A7840119
	// "Include::_unlinkBase"
