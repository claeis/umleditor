...
public class UmlParameter extends AbstractModelElement implements Parameter {
	 ...
	 * @see #containsEvent
	 */
	// -beg- preserve=no 3337AF9D028B attach_head40432B0300AE
	// "Parameter::attachEvent"
	public void attachEvent(Event event1)
	// -end- 3337AF9D028B attach_head40432B0300AE "Parameter::attachEvent"
	{
		// -beg- preserve=no 3337AF9D028B attach_body40432B0300AE
		// "Parameter::attachEvent"
		if (event != null) {
			throw new java.lang.IllegalStateException("already a event attached");
		}
		if (event1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as event");
		}
		event = event1;
		event1._linkParameter(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachEvent"));
		return;
	 ...
	 * @see #attachEvent
	 */
	// -beg- preserve=no 3337AF9D028B detach_head40432B0300AE
	// "Parameter::detachEvent"
	public Event detachEvent()
	// -end- 3337AF9D028B detach_head40432B0300AE "Parameter::detachEvent"
	{
		// -beg- preserve=no 3337AF9D028B detach_body40432B0300AE
		// "Parameter::detachEvent"
		Event ret = null;
		if (event != null) {
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachEvent"));
		return ret;
	...
	{
		// -beg- preserve=no 3337AF9D028B get_body40432B0300AE
		// "Parameter::getEvent"
		if (event == null) {
			throw new java.lang.IllegalStateException("no event attached");
		}
		return event;
	 ...
	 * @see #attachEvent
	 */
	// -beg- preserve=no 3337AF9D028B test_head40432B0300AE
	// "Parameter::containsEvent"
	public boolean containsEvent()
	// -end- 3337AF9D028B test_head40432B0300AE "Parameter::containsEvent"
	{
		// -beg- preserve=no 3337AF9D028B test_body40432B0300AE
		// "Parameter::containsEvent"
		return event != null;
	 ...
	 */
	// -beg- preserve=no 3337AF9D028B _link_body40432B0300AE
	// "Parameter::_linkEvent"
	public void _linkEvent(Event event1) {
		event = event1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkEvent"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3337AF9D028B _unlink_body40432B0300AE
	// "Parameter::_unlinkEvent"
	public void _unlinkEvent(Event event1) {
		event = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkEvent"));
		return;
	}
	 ...
	 */
	// -beg- preserve=no 337D935E0213 add_head40432B0300AE
	// "Parameter::addObjectFlowState"
	...
	{
		// -beg- preserve=no 337D935E0213 add_body40432B0300AE
		// "Parameter::addObjectFlowState"
		...
		return;
		// -end- 337D935E0213 add_body40432B0300AE
		// "Parameter::addObjectFlowState"
	}
	 ...
	 */
	// -beg- preserve=no 337D935E0213 remove_head40432B0300AE
	// "Parameter::removeObjectFlowState"
	public ObjectFlowState removeObjectFlowState(ObjectFlowState objectFlowState1)
	// -end- 337D935E0213 remove_head40432B0300AE
	// "Parameter::removeObjectFlowState"
	{
		// -beg- preserve=no 337D935E0213 remove_body40432B0300AE
		// "Parameter::removeObjectFlowState"
		...
		return ret;
		// -end- 337D935E0213 remove_body40432B0300AE
		// "Parameter::removeObjectFlowState"
	}
	 ...
	 * @see #addObjectFlowState
	 */
	// -beg- preserve=no 337D935E0213 test_head40432B0300AE
	// "Parameter::containsObjectFlowState"
	public boolean containsObjectFlowState(ObjectFlowState objectFlowState1)
	// -end- 337D935E0213 test_head40432B0300AE
	// "Parameter::containsObjectFlowState"
	{
		// -beg- preserve=no 337D935E0213 test_body40432B0300AE
		// "Parameter::containsObjectFlowState"
		return objectFlowState.contains(objectFlowState1);
		// -end- 337D935E0213 test_body40432B0300AE
		// "Parameter::containsObjectFlowState"
	}
	...
	// "Parameter::iteratorObjectFlowState"
	{
		// -beg- preserve=no 337D935E0213 get_all_body40432B0300AE
		// "Parameter::iteratorObjectFlowState"
		return objectFlowState.iterator();
		// -end- 337D935E0213 get_all_body40432B0300AE
		// "Parameter::iteratorObjectFlowState"
	}
	 ...
	 * @see #addObjectFlowState
	 */
	// -beg- preserve=no 337D935E0213 remove_all_head40432B0300AE
	// "Parameter::clearObjectFlowState"
	public void clearObjectFlowState()
	// -end- 337D935E0213 remove_all_head40432B0300AE
	// "Parameter::clearObjectFlowState"
	{
		...
		// -end- 337D935E0213 remove_all_body40432B0300AE
		// "Parameter::clearObjectFlowState"
	}
	 ...
	 * @see #addObjectFlowState
	 */
	// -beg- preserve=no 337D935E0213 size_head40432B0300AE
	// "Parameter::sizeObjectFlowState"
	public int sizeObjectFlowState()
	// -end- 337D935E0213 size_head40432B0300AE "Parameter::sizeObjectFlowState"
	{
		// -beg- preserve=no 337D935E0213 size_body40432B0300AE
		// "Parameter::sizeObjectFlowState"
		return objectFlowState.size();
		// -end- 337D935E0213 size_body40432B0300AE
		// "Parameter::sizeObjectFlowState"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 337D935E0213 _link_body40432B0300AE
	// "Parameter::_linkObjectFlowState"
	...
	// -end- 337D935E0213 _link_body40432B0300AE
	// "Parameter::_linkObjectFlowState"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 337D935E0213 _unlink_body40432B0300AE
	...
	// -end- 337D935E0213 _unlink_body40432B0300AE
	// "Parameter::_unlinkObjectFlowState"
	...
	{
		// -beg- preserve=no 36462DDF008C add_body40432B0300AE
		// "Parameter::addState"
		state.add(state1);
		state1._linkParameter(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "addState"));
		return;
	 ...
	 * @see #addState
	 */
	// -beg- preserve=no 36462DDF008C remove_head40432B0300AE
	...
	{
		// -beg- preserve=no 36462DDF008C remove_body40432B0300AE
		// "Parameter::removeState"
		ObjectFlowState ret = null;
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "removeState"));
		return ret;
	 ...
	 * @see #addState
	 */
	// -beg- preserve=no 36462DDF008C test_head40432B0300AE
	// "Parameter::containsState"
	public boolean containsState(ObjectFlowState state1)
	// -end- 36462DDF008C test_head40432B0300AE "Parameter::containsState"
	{
		// -beg- preserve=no 36462DDF008C test_body40432B0300AE
		// "Parameter::containsState"
	...
	// -end- 36462DDF008C get_all_head40432B0300AE "Parameter::iteratorState"
	{
		...
		// -end- 36462DDF008C get_all_body40432B0300AE
		// "Parameter::iteratorState"
	}
	 ...
	 * @see #addState
	 */
	// -beg- preserve=no 36462DDF008C remove_all_head40432B0300AE
	...
	// -end- 36462DDF008C remove_all_head40432B0300AE "Parameter::clearState"
	{
		...
		if (sizeState() > 0) {
			...
			state.clear();
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "clearState"));
		}
		// -end- 36462DDF008C remove_all_body40432B0300AE
		// "Parameter::clearState"
	}
	 ...
	 * @see #addState
	 */
	// -beg- preserve=no 36462DDF008C size_head40432B0300AE
	// "Parameter::sizeState"
	public int sizeState()
	// -end- 36462DDF008C size_head40432B0300AE "Parameter::sizeState"
	{
		// -beg- preserve=no 36462DDF008C size_body40432B0300AE
		// "Parameter::sizeState"
		return state.size();
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 36462DDF008C _link_body40432B0300AE
	// "Parameter::_linkState"
	public void _linkState(ObjectFlowState state1) {
		state.add(state1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkState"));
		return;
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 36462DDF008C _unlink_body40432B0300AE
	// "Parameter::_unlinkState"
	public void _unlinkState(ObjectFlowState state1) {
		state.remove(state1);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkState"));
		return;
	}
	 ...
	 */
	// -beg- preserve=no 3359946401AE attach_head40432B0300AE
	// "Parameter::attachBehavioralFeature"
	public void attachBehavioralFeature(BehavioralFeature behavioralFeature1)
	// -end- 3359946401AE attach_head40432B0300AE
	// "Parameter::attachBehavioralFeature"
	{
		// -beg- preserve=no 3359946401AE attach_body40432B0300AE
		// "Parameter::attachBehavioralFeature"
		if (behavioralFeature != null) {
			throw new java.lang.IllegalStateException("already a behavioralFeature attached");
		}
		if (behavioralFeature1 == null) {
			throw new java.lang.IllegalArgumentException("null may not be attached as behavioralFeature");
		}
		behavioralFeature = behavioralFeature1;
		behavioralFeature1._linkParameter(this);
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "attachBehavioralFeature"));
		return;
		// -end- 3359946401AE attach_body40432B0300AE
		// "Parameter::attachBehavioralFeature"
	}
	 ...
	 */
	// -beg- preserve=no 3359946401AE detach_head40432B0300AE
	// "Parameter::detachBehavioralFeature"
	public BehavioralFeature detachBehavioralFeature()
	// -end- 3359946401AE detach_head40432B0300AE
	// "Parameter::detachBehavioralFeature"
	{
		// -beg- preserve=no 3359946401AE detach_body40432B0300AE
		// "Parameter::detachBehavioralFeature"
		...
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "detachBehavioralFeature"));
		return ret;
		// -end- 3359946401AE detach_body40432B0300AE
		// "Parameter::detachBehavioralFeature"
	}
	 ...
	 * @see #attachBehavioralFeature
	 */
	// -beg- preserve=no 3359946401AE get_head40432B0300AE
	...
	{
		// -beg- preserve=no 3359946401AE get_body40432B0300AE
		// "Parameter::getBehavioralFeature"
		if (behavioralFeature == null) {
			throw new java.lang.IllegalStateException("no behavioralFeature attached");
		}
		return behavioralFeature;
		// -end- 3359946401AE get_body40432B0300AE
		// "Parameter::getBehavioralFeature"
	}
	 ...
	 * @see #attachBehavioralFeature
	 */
	// -beg- preserve=no 3359946401AE test_head40432B0300AE
	// "Parameter::containsBehavioralFeature"
	public boolean containsBehavioralFeature()
	// -end- 3359946401AE test_head40432B0300AE
	// "Parameter::containsBehavioralFeature"
	{
		// -beg- preserve=no 3359946401AE test_body40432B0300AE
		// "Parameter::containsBehavioralFeature"
		return behavioralFeature != null;
		// -end- 3359946401AE test_body40432B0300AE
		// "Parameter::containsBehavioralFeature"
	}
	 ...
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3359946401AE _link_body40432B0300AE
	// "Parameter::_linkBehavioralFeature"
	public void _linkBehavioralFeature(BehavioralFeature behavioralFeature1) {
		behavioralFeature = behavioralFeature1;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_linkBehavioralFeature"));
		return;
	}
	// -end- 3359946401AE _link_body40432B0300AE
	// "Parameter::_linkBehavioralFeature"

	/**
	 * DONT USE; link management internal
	 */
	// -beg- preserve=no 3359946401AE _unlink_body40432B0300AE
	// "Parameter::_unlinkBehavioralFeature"
	public void _unlinkBehavioralFeature(BehavioralFeature behavioralFeature1) {
		behavioralFeature = null;
		ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
				.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "_unlinkBehavioralFeature"));
		return;
	}
	// -end- 3359946401AE _unlink_body40432B0300AE
	// "Parameter::_unlinkBehavioralFeature"
	...
	// -end- 327BE04D0096 set_head40432B0300AE "defaultValue"
	{
		...
		if (defaultValue != value1 && (defaultValue == null || !defaultValue.equals(value1))) {
			defaultValue = value1;
			ch.ehi.uml1_4.changepropagation.MetaModel.getInstance()
					.notifyChange(new ch.ehi.uml1_4.changepropagation.MetaModelChange(this, "setDefaultValue"));
		}
	...
	/**
	 * get current value of kind Specifies what kind of a Parameter is required.
	 * 
