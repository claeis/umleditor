...
/**
 * The bean information class for ch.softenvironment.view.DecimalTextField.
 */
public class DecimalTextFieldBeanInfo extends java.beans.SimpleBeanInfo {
/**
...
public static java.lang.Class getBeanClass() {
	return ch.softenvironment.view.DecimalTextField.class;
}
/**
...
public static java.lang.String getBeanClassName() {
	return "ch.softenvironment.view.DecimalTextField";
}
public java.beans.BeanDescriptor getBeanDescriptor() {
	java.beans.BeanDescriptor aDescriptor = null;
	try {
		/* Create and return the DecimalTextFieldBeanInfo bean descriptor. */
		aDescriptor = new java.beans.BeanDescriptor(ch.softenvironment.view.DecimalTextField.class);
		/* aDescriptor.setExpert(false); */
		/* aDescriptor.setHidden(false); */
