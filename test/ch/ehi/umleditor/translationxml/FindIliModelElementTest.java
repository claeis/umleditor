...
public class FindIliModelElementTest {
	...
	public void topic() throws Exception {
		...
		ModelElementUtility elementUtility = new ModelElementUtility();
		ModelElement modelElement = elementUtility.findIliModelElementByScopedName(model, scopeName);
		assertEquals("TopicDef89", modelElement.getName().getValue());

		//
		scopeName = "ModelDef4.TopicDef5";
		modelElement = elementUtility.findIliModelElementByScopedName(model, scopeName);
	...
	public void roleDef() throws Exception {
		...
		modelElement = elementUtility.findIliModelElementByScopedName(model, scopedName);
